...
export const incidentEdges: {
   ...
   * @since 4.0.0
   */
  (nodeIndex: NodeIndex): <N, E, T extends Kind = "directed">(graph: Graph<N, E, T> | MutableGraph<N, E, T>) => Array<EdgeIndex>
  /**
   * Returns the indices of all edges incident to a node.
   *
   * Each edge is returned once in graph edge order, including self-loops.
   ...
   * @since 4.0.0
   */
  <N, E, T extends Kind = "directed">(graph: Graph<N, E, T> | MutableGraph<N, E, T>, nodeIndex: NodeIndex): Array<EdgeIndex>
} = dual(2, <N, E, T extends Kind = "directed">(
  graph: Graph<N, E, T> | MutableGraph<N, E, T>,
  nodeIndex: NodeIndex
): Array<EdgeIndex> => {
