...
export const make = /*#__PURE__*/Effect.gen(function* () {
  ...
  const engine = WorkflowEngine.makeUnsafe({
      ...
      return {
        ...
        activity(request) {
          ...
          return Effect.gen(function* () {
            ...
            const context = entry.context.pipe(Context.add(WorkflowEngine.WorkflowInstance, instance), Context.add(Activity.CurrentAttempt, payload.attempt));
    ...
    deferredResult: deferred => WorkflowEngine.WorkflowInstance.pipe(Effect.flatMap(instance => {
