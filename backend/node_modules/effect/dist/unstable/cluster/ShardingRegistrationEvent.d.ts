...
export declare const match: {
    <Cases extends { readonly [Tag in "EntityRegistered" | "SingletonRegistered"]: (args: Extract<ShardingRegistrationEvent, {
        readonly _tag: Tag;
    }>) => any; }>(cases: Cases): (value: ShardingRegistrationEvent) => import("../../Unify.ts").Unify<ReturnType<Cases["EntityRegistered" | "SingletonRegistered"]>>;
    <Cases extends { readonly [Tag in "EntityRegistered" | "SingletonRegistered"]: (args: Extract<ShardingRegistrationEvent, {
        readonly _tag: Tag;
    }>) => any; }>(value: ShardingRegistrationEvent, cases: Cases): import("../../Unify.ts").Unify<ReturnType<Cases["EntityRegistered" | "SingletonRegistered"]>>;
}, 
/**
