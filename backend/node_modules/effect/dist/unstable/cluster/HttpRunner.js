...
export const toHttpEffect = /*#__PURE__*/Effect.gen(function* () {
  ...
  const handlers = yield* Layer.build(RunnerServer.layerHandlers).pipe(Effect.provideService(RpcServer.Protocol, protocol));
  yield* RpcServer.make(Runners.Rpcs, {
    spanPrefix: "RunnerServer",
    disableTracing: true,
    disableFatalDefects: true
  }).pipe(Effect.provideContext(handlers), Effect.provideService(RpcServer.Protocol, protocol), Effect.forkScoped);
  return httpEffect;
});
/**
