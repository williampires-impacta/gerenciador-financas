 ...
 * @since 4.0.0
 */
export const Encoded = Envelope.OpaqueHole;
/**
...
const schemaCaches = /*#__PURE__*/new WeakMap();
/**
 ...
 * @since 4.0.0
 */
export const Reply = (rpc, codecFor) => {
 ...
 * @since 4.0.0
 */
export const serialize = (self, codecFor) => {
 ...
 * @since 4.0.0
 */
export const serializeOrDefect = (self, codecFor) => Effect.catchTag(serialize(self, codecFor), "MalformedMessage", error => Effect.orDie(serialize(ReplyWithContext.fromDefect({
  id: self.reply.id,
 ...
 * @since 4.0.0
 */
export const serializeLastReceived = (self, codecFor) => {
