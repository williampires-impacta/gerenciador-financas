 ...
 * @since 4.0.0
 */
export declare const make: (options: Omit<Runners["Service"], "sendLocal" | "notifyLocal"> & {
    readonly codecFor: RpcSerialization.CodecFor;
}) => Effect.Effect<Runners["Service"], never, MessageStorage.MessageStorage | Snowflake.Generator | ShardingConfig | Scope>;
/**
...
declare const Rpcs_base: RpcGroup.RpcGroup<Rpc.Rpc<"Effect", Schema.Struct<{
    ...
    persisted: Schema.Boolean;
}>, Schema.Void, Schema.Union<[typeof EntityNotAssignedToRunner, typeof MailboxFull, typeof AlreadyProcessingMessage]>, never, never> | Rpc.Rpc<"Ping", Schema.Void, Schema.Void, Schema.Never, never, never> | Rpc.Rpc<"Stream", Schema.Struct<{
    request: typeof Envelope.PartialRequest;
    persisted: Schema.Boolean;
...
declare const RpcClientProtocol_base: Context.ServiceClass<RpcClientProtocol, "effect/cluster/Runners/RpcClientProtocol", {
