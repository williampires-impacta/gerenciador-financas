 ...
 * @since 4.0.0
 */
export const makeRemoteIdUnsafe = () => Uuid.v4Bytes();
/**
 ...
 * @since 4.0.0
 */
export const makeEntryIdUnsafe = (options = {}) => Uuid.v7Bytes(options.msecs ?? DateTime.nowUnsafe().epochMilliseconds);
/**
...
export const makeMemory = /*#__PURE__*/Effect.gen(function* () {
  ...
  return EventJournal.of({
    ...
    withRemoteUncommited: (remoteId, f) => Effect.acquireUseRelease(Effect.sync(() => ensureRemote(remoteId).missing.slice()), entries => Arr.isReadonlyArrayNonEmpty(entries) ? Effect.asSome(f(entries)) : Effect.succeedNone, (entries, exit) => Effect.sync(() => {
