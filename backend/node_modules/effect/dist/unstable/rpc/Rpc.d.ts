...
export declare namespace Custom {
     ...
     * @since 4.0.0
     */
    interface Out<Success extends Schema.Constraint, Error extends Schema.Constraint> {
        readonly success: Success;
        readonly error: Error;
        readonly defect: DefectSchema;
    }
     ...
     * @since 4.0.0
     */
    type Kind<Def extends Custom, Success extends Schema.Constraint, Error extends Schema.Constraint> = (Def & {
        readonly success: Success;
        readonly error: Error;
    })["out"];
}
