 ...
 * @since 4.0.0
 */
export type FromServerEncoded = ResponseChunkEncoded | ResponseExitEncoded | ResponseDefectEncoded | Pong | ClientProtocolError | RequestEncoded;
/**
 ...
 * @since 4.0.0
 */
export declare const ResponseDefectEncoded: (encodedDefect: unknown) => ResponseDefectEncoded;
/**
 ...
 * @since 4.0.0
 */
export declare const EncodedSchema: Schema.Union<readonly [Schema.Struct<{
    ...
    readonly isNotification: Schema.optional<Schema.Literal<true>>;
    ...
    readonly requestId: Schema.Union<readonly [Schema.String, Schema.Number]>;
}>, Schema.Struct<{
    ...
    readonly _tag: Schema.tag<"Eof">;
}>, Schema.Struct<{
    readonly _tag: Schema.tag<"Chunk">;
    readonly requestId: Schema.Union<readonly [Schema.String, Schema.Number]>;
    readonly values: Schema.Uint8Array;
}>, Schema.Struct<{
    readonly _tag: Schema.tag<"Exit">;
    readonly requestId: Schema.Union<readonly [Schema.String, Schema.Number]>;
    readonly exit: Schema.Uint8Array;
}>, Schema.Struct<{
    readonly _tag: Schema.tag<"Defect">;
    readonly defect: Schema.Uint8Array;
}>, Schema.Struct<{
