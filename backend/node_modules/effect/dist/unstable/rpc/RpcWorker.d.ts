 ...
 * @since 4.0.0
 */
export declare const makeInitialMessage: <S extends Schema.Constraint, E, R2>(schema: S, effect: Effect.Effect<S["Type"], E, R2>) => Effect.Effect<readonly [data: unknown, transferables: ReadonlyArray<globalThis.Transferable>], E | Schema.SchemaError, S["EncodingServices"] | R2>;
/**
 ...
 * @since 4.0.0
 */
export declare const layerInitialMessage: <S extends Schema.Constraint, R2>(schema: S, build: Effect.Effect<S["Type"], never, R2>) => Layer.Layer<InitialMessage, never, S["EncodingServices"] | R2>;
/**
 ...
 * @since 4.0.0
 */
export declare const initialMessage: <S extends Schema.Constraint>(schema: S) => Effect.Effect<S["Type"], NoSuchElementError | Schema.SchemaError, Protocol | S["DecodingServices"]>;
export {};
