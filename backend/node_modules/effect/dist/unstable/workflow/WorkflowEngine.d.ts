...
export interface DeferredState {
    ...
    readonly pendingResult: (executionId: string, name: string) => Exit.Exit<unknown, unknown> | undefined;
    /** Tracks and provides a run, retaining pending results across suspension. */
    readonly trackRun: <A, E, R>(instance: WorkflowInstance["Service"], effect: Effect.Effect<A, E, R>) => Effect.Effect<A, E, Exclude<R, WorkflowInstance>>;
    /** Records a completion, preempting a run parked on that deferred. */
    readonly deferredDone: (executionId: string, name: string, exit: Exit.Exit<unknown, unknown>) => Effect.Effect<void>;
}
/**
 ...
 * @since 4.0.0
 */
export declare const makeDeferredState: () => DeferredState;
/**
