 ...
 * @since 4.0.0
 */
export class UnrecognizedOption extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/UnrecognizedOption`)("UnrecognizedOption", {
 ...
 * @since 4.0.0
 */
export class DuplicateOption extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/DuplicateOption`)("DuplicateOption", {
  option: Schema.String,
 ...
 * @since 4.0.0
 */
export class MissingOption extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/MissingOption`)("MissingOption", {
  option: Schema.String
}) {
  /**
 ...
 * @since 4.0.0
 */
export class MissingArgument extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/MissingArgument`)("MissingArgument", {
 ...
 * @since 4.0.0
 */
export class UnexpectedArgument extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/UnexpectedArgument`)("UnexpectedArgument", {
  arguments: /*#__PURE__*/Schema.Array(Schema.String)
}) {
  /**
 ...
 * @since 4.0.0
 */
export class InvalidValue extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/InvalidValue`)("InvalidValue", {
  option: Schema.String,
  value: Schema.String,
 ...
 * @since 4.0.0
 */
export class UnknownSubcommand extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/UnknownSubcommand`)("UnknownSubcommand", {
 ...
 * @since 4.0.0
 */
export class UserError extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/UserError`)("UserError", {
  cause: /*#__PURE__*/Schema.Defect(),
  userMessage: /*#__PURE__*/Schema.optionalKey(Schema.String)
}) {
  /**
 ...
 * @since 4.0.0
 */
export const NonShowHelpErrors = /*#__PURE__*/Schema.Union([UnrecognizedOption, DuplicateOption, MissingOption, MissingArgument, UnexpectedArgument, InvalidValue, UnknownSubcommand, UserError]);
/**
 ...
 * @since 4.0.0
 */
export class ShowHelp extends /*#__PURE__*/Schema.TaggedError(`${TypeId}/ShowHelp`)("ShowHelp", {
