 ...
 */
export declare const toFlagDoc: (single: Param.Single<typeof Param.flagKind, unknown>, metadata: ReturnType<typeof Param.getParamMetadata>) => FlagDoc;
/**
 ...
 */
export declare const makeParser: (cfg: ConfigInternal, options?: {
    readonly allowLeftovers?: boolean | undefined;
} | undefined) => (input: ParsedTokens) => Effect.Effect<Record<string, any>, CliError.CliError, Environment>;
/**
