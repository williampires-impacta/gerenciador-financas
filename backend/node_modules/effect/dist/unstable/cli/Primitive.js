...
import * as Ini from "../encoding/Ini.js";
import * as Toml from "../encoding/Toml.js";
import * as Yaml from "../encoding/Yaml.js";
 ...
 * @since 4.0.0
 */
export const date = /*#__PURE__*/makeSchemaPrimitive("Date", Schema.Date);
/**
 ...
 * @since 4.0.0
 */
export const path = (pathType, mustExist) => {
  const primitive = makePrimitive("Path", Effect.fnUntraced(function* (value) {
...
/** @internal */
export const getPathType = primitive => primitive._tag === "Path" ? primitive.pathType : undefined;
