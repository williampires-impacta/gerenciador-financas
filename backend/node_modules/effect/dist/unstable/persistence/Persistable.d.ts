...
export declare const Class: <Config extends {
    ...
    payload: {};
}>() => <const Tag extends string, A extends Schema.Constraint = Schema.Void, E extends Schema.Constraint = Schema.Never>(tag: Tag, options: {
 ...
 * @since 4.0.0
 */
export declare const exitSchema: <A extends Schema.Constraint, E extends Schema.Constraint>(self: Persistable<A, E>) => Schema.Exit<A, E, Schema.Defect>;
/**
 ...
 * @since 4.0.0
 */
export declare const serializeExit: <A extends Schema.Constraint, E extends Schema.Constraint>(self: Persistable<A, E>, exit: Exit.Exit<A["Type"], E["Type"]>) => Effect.Effect<unknown, Schema.SchemaError, A["EncodingServices"] | E["EncodingServices"]>;
/**
 ...
 * @since 4.0.0
 */
export declare const deserializeExit: <A extends Schema.Constraint, E extends Schema.Constraint>(self: Persistable<A, E>, encoded: unknown) => Effect.Effect<Exit.Exit<A["Type"], E["Type"]>, Schema.SchemaError, A["DecodingServices"] | E["DecodingServices"]>;
