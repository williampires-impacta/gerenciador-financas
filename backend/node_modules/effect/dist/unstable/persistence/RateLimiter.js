...
export function sleep(self, options) {
  if (options === undefined) {
    return options => sleep(self, options);
  }
  return Effect.flatMap(self.consume({
    ...options,
    onExceeded: "delay"
  }), result => {
 ...
 * @since 4.0.0
 */
export class RateLimitExceeded extends /*#__PURE__*/Schema.Error("effect/persistence/RateLimiter/RateLimitExceeded")({
 ...
 * @since 4.0.0
 */
export class RateLimitStoreError extends /*#__PURE__*/Schema.Error("effect/persistence/RateLimiter/RateLimitStoreError")({
 ...
 * @since 4.0.0
 */
export class RateLimiterError extends /*#__PURE__*/Schema.Error(ErrorTypeId)({
