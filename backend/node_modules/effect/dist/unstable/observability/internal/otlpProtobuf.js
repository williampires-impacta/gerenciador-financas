 ...
 * @internal
 */
export const encodeAnyValue = value => {
 ...
 * @internal
 */
export const encodeArrayValue = value => Proto.repeatedField(1, value.values, encodeAnyValue);
/**
 ...
 * @internal
 */
export const encodeKeyValueList = value => Proto.repeatedField(1, value.values, encodeKeyValue);
/**
 ...
 * @internal
 */
export const encodeKeyValue = kv => Proto.concat(Proto.stringField(1, kv.key), Proto.messageField(2, encodeAnyValue(kv.value)));
/**
 ...
 * @internal
 */
export const encodeResource = resource => Proto.concat(Proto.repeatedField(1, resource.attributes, encodeKeyValue), resource.droppedAttributesCount > 0 ? Proto.varintField(2, resource.droppedAttributesCount) : new Uint8Array(0));
/**
 ...
 * @internal
 */
export const encodeStatus = status => Proto.concat(Proto.optionalStringField(2, status.message), Proto.varintField(3, status.code));
/**
 ...
 * @internal
 */
export const encodeEvent = event => Proto.concat(Proto.fixed64Field(1, BigInt(event.timeUnixNano)), Proto.stringField(2, event.name), Proto.repeatedField(3, event.attributes, encodeKeyValue), event.droppedAttributesCount > 0 ? Proto.varintField(4, event.droppedAttributesCount) : new Uint8Array(0));
/**
 ...
 * @internal
 */
export const encodeLink = link => Proto.concat(Proto.bytesFieldFromHex(1, link.traceId), Proto.bytesFieldFromHex(2, link.spanId), Proto.optionalStringField(3, link.traceState), Proto.repeatedField(4, link.attributes, encodeKeyValue), link.droppedAttributesCount > 0 ? Proto.varintField(5, link.droppedAttributesCount) : new Uint8Array(0), link.flags !== undefined ? Proto.fixed32Field(6, link.flags) : new Uint8Array(0));
/**
 ...
 * @internal
 */
export const encodeScopeSpans = scopeSpans => Proto.concat(Proto.messageField(1, encodeInstrumentationScope(scopeSpans.scope)), Proto.repeatedField(2, scopeSpans.spans, encodeSpan), Proto.optionalStringField(3, scopeSpans.schemaUrl));
/**
 ...
 * @internal
 */
export const encodeResourceSpans = resourceSpans => Proto.concat(Proto.messageField(1, encodeResource(resourceSpans.resource)), Proto.repeatedField(2, resourceSpans.scopeSpans, encodeScopeSpans), Proto.optionalStringField(3, resourceSpans.schemaUrl));
/**
 ...
 * @internal
 */
export const encodeTracesData = tracesData => Proto.repeatedField(1, tracesData.resourceSpans, encodeResourceSpans);
/**
 ...
 * @internal
 */
export const encodeGauge = gauge => Proto.repeatedField(1, gauge.dataPoints, encodeNumberDataPoint);
/**
 ...
 * @internal
 */
export const encodeSum = sum => Proto.concat(Proto.repeatedField(1, sum.dataPoints, encodeNumberDataPoint), Proto.varintField(2, sum.aggregationTemporality), Proto.boolField(3, sum.isMonotonic));
/**
 ...
 * @internal
 */
export const encodeHistogram = histogram => Proto.concat(Proto.repeatedField(1, histogram.dataPoints, encodeHistogramDataPoint), Proto.varintField(2, histogram.aggregationTemporality));
/**
 ...
 * @internal
 */
export const encodeMetric = metric => Proto.concat(Proto.stringField(1, metric.name), Proto.optionalStringField(2, metric.description), Proto.optionalStringField(3, metric.unit), metric.gauge !== undefined ? Proto.messageField(5, encodeGauge(metric.gauge)) : new Uint8Array(0), metric.sum !== undefined ? Proto.messageField(7, encodeSum(metric.sum)) : new Uint8Array(0), metric.histogram !== undefined ? Proto.messageField(9, encodeHistogram(metric.histogram)) : new Uint8Array(0));
/**
 ...
 * @internal
 */
export const encodeScopeMetrics = scopeMetrics => Proto.concat(Proto.messageField(1, encodeInstrumentationScope(scopeMetrics.scope)), Proto.repeatedField(2, scopeMetrics.metrics, encodeMetric), Proto.optionalStringField(3, scopeMetrics.schemaUrl));
/**
 ...
 * @internal
 */
export const encodeResourceMetrics = resourceMetrics => Proto.concat(Proto.messageField(1, encodeResource(resourceMetrics.resource)), Proto.repeatedField(2, resourceMetrics.scopeMetrics, encodeScopeMetrics), Proto.optionalStringField(3, resourceMetrics.schemaUrl));
/**
 ...
 * @internal
 */
export const encodeMetricsData = metricsData => Proto.repeatedField(1, metricsData.resourceMetrics, encodeResourceMetrics);
/**
 ...
 * @internal
 */
export const encodeScopeLogs = scopeLogs => Proto.concat(Proto.messageField(1, encodeInstrumentationScope(scopeLogs.scope)), Proto.repeatedField(2, scopeLogs.logRecords, encodeLogRecord), Proto.optionalStringField(3, scopeLogs.schemaUrl));
/**
 ...
 * @internal
 */
export const encodeResourceLogs = resourceLogs => Proto.concat(Proto.messageField(1, encodeResource(resourceLogs.resource)), Proto.repeatedField(2, resourceLogs.scopeLogs, encodeScopeLogs), Proto.optionalStringField(3, resourceLogs.schemaUrl));
/**
 ...
 * @internal
 */
export const encodeLogsData = logsData => Proto.repeatedField(1, logsData.resourceLogs, encodeResourceLogs);
