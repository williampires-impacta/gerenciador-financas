...
export const make = /*#__PURE__*/Effect.fnUntraced(function* (options) {
  ...
  let previousCounterState = new Map();
  let previousHistogramState = new Map();
  let previousFrequencyState = new Map();
  let previousSummaryState = new Map();
  ...
  const snapshot = () => {
    ...
    const onSuccess = isDelta ? Effect.sync(() => {
 ...
 * @since 4.0.0
 */
export const layer = options => Layer.effectDiscard(make(options)).pipe(Layer.provideMerge(Exporter.layerFlusher));
/**
