...
export const Frequency = /*#__PURE__*/metric("Frequency", /*#__PURE__*/Schema.Struct({
  occurrences: /*#__PURE__*/Schema.ReadonlyMap(Schema.String, Schema.Natural)
}));
/**
...
export const Histogram = /*#__PURE__*/metric("Histogram", /*#__PURE__*/Schema.Struct({
  buckets: /*#__PURE__*/Schema.Array(/*#__PURE__*/Schema.Tuple([Schema.Number, Schema.Natural])),
...
export const Summary = /*#__PURE__*/metric("Summary", /*#__PURE__*/Schema.Struct({
  quantiles: /*#__PURE__*/Schema.Array(/*#__PURE__*/Schema.Tuple([/*#__PURE__*/Schema.Finite.check(/*#__PURE__*/Schema.isBetween({
    minimum: 0,
    maximum: 1
  })), /*#__PURE__*/Schema.UndefinedOr(Schema.Number)])),
  count: Schema.Natural,
  min: Schema.Number,
  max: Schema.Number,
  sum: Schema.Number
