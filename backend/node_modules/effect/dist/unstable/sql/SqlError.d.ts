...
export declare class SqlError extends SqlError_base {
     ...
     * @since 4.0.0
     */
    readonly cause: AuthenticationError | AuthorizationError | ConnectionError | ConstraintError | DeadlockError | LockTimeoutError | SerializationError | SqlSyntaxError | StatementTimeoutError | UniqueViolation | UnknownError;
    /**
...
declare const ResultLengthMismatch_base: Schema.Class<ResultLengthMismatch, Schema.TaggedStruct<"ResultLengthMismatch", {
    readonly expected: Schema.Natural;
    readonly actual: Schema.Natural;
}>, import("../../Cause.ts").YieldableError>;
/**
