 ...
 * @since 4.0.0
 */
export class ConnectionError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/ConnectionError")("ConnectionError", ReasonFields) {
  /**
 ...
 * @since 4.0.0
 */
export class AuthenticationError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/AuthenticationError")("AuthenticationError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class AuthorizationError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/AuthorizationError")("AuthorizationError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class SqlSyntaxError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/SqlSyntaxError")("SqlSyntaxError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class UniqueViolation extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/UniqueViolation")("UniqueViolation", UniqueViolationFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class ConstraintError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/ConstraintError")("ConstraintError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class DeadlockError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/DeadlockError")("DeadlockError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class SerializationError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/SerializationError")("SerializationError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class LockTimeoutError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/LockTimeoutError")("LockTimeoutError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class StatementTimeoutError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/StatementTimeoutError")("StatementTimeoutError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class UnknownError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError/UnknownError")("UnknownError", ReasonFields) {
  /**
   * Marks this value as a structured SQL error reason for runtime guards.
   *
   * @since 4.0.0
 ...
 * @since 4.0.0
 */
export class SqlError extends /*#__PURE__*/Schema.TaggedError("effect/sql/SqlError")("SqlError", {
 ...
 * @since 4.0.0
 */
export class ResultLengthMismatch extends /*#__PURE__*/Schema.TaggedError("effect/sql/ResultLengthMismatch")("ResultLengthMismatch", {
