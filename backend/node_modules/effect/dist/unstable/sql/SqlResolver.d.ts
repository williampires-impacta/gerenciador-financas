 ...
 * @since 4.0.0
 */
export declare const ordered: <Req extends Schema.Constraint, Res extends Schema.Constraint, _, E, R>(options: {
 ...
 * @since 4.0.0
 */
export declare const grouped: <Req extends Schema.Constraint, Res extends Schema.Constraint, K, Row, E, R>(options: {
    readonly Request: Req;
 ...
 * @since 4.0.0
 */
export declare const findById: <Id extends Schema.Constraint, Res extends Schema.Constraint, Row, E, R>(options: {
    readonly Id: Id;
    readonly Result: Res;
...
declare const void_: <Req extends Schema.Constraint, _, E, R>(options: {
    readonly Request: Req;
    readonly execute: (requests: Arr.NonEmptyArray<Req["Encoded"]>) => Effect.Effect<ReadonlyArray<_>, E, R>;
