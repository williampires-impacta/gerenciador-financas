 ...
 * @since 4.0.0
 */
export declare const findAll: <Req extends Schema.Constraint, Res extends Schema.Constraint, E, R>(options: {
 ...
 * @since 4.0.0
 */
export declare const findNonEmpty: <Req extends Schema.Constraint, Res extends Schema.Constraint, E, R>(options: {
    readonly Request: Req;
    readonly Result: Res;
    readonly execute: (request: Req["Encoded"]) => Effect.Effect<ReadonlyArray<unknown>, E, R>;
...
declare const void_: <Req extends Schema.Constraint, E, R>(options: {
    readonly Request: Req;
 ...
 * @since 4.0.0
 */
export declare const findOne: <Req extends Schema.Constraint, Res extends Schema.Constraint, E, R>(options: {
    readonly Request: Req;
    readonly Result: Res;
    readonly execute: (request: Req["Encoded"]) => Effect.Effect<ReadonlyArray<unknown>, E, R>;
 ...
 * @since 4.0.0
 */
export declare const findOneOption: <Req extends Schema.Constraint, Res extends Schema.Constraint, E, R>(options: {
    readonly Request: Req;
    readonly Result: Res;
    readonly execute: (request: Req["Encoded"]) => Effect.Effect<ReadonlyArray<unknown>, E, R>;
