...
export declare const schemaJson: <A, I extends Partial<{
    ...
    readonly body: any;
}>, RD>(schema: Schema.ConstraintCodec<A, I, RD, unknown>, options?: (ParseOptions & HttpIncomingMessage.JsonOptions) | undefined) => Effect.Effect<A, HttpServerError.HttpServerError | Schema.SchemaError, HttpServerRequest.HttpServerRequest | HttpServerRequest.ParsedSearchParams | RouteContext | RD>;
/**
