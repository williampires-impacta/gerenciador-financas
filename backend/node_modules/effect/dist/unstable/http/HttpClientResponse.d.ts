...
}, RD>(schema: Schema.ConstraintCodec<A, I, RD, unknown>, options?: (ParseOptions & HttpIncomingMessage.JsonOptions) | undefined) => (self: HttpClientResponse) => Effect.Effect<A, Schema.SchemaError | Error.HttpClientError, RD>;
/**
