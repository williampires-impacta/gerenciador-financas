...
declare const Annotations_base: Schema.Opaque<Annotations, Schema.Struct<{
     ...
     * timestamp.
     */
    readonly lastModified: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
}>, {}> & Omit<Schema.Struct<{
    /**
     * Describes who the intended customer of this object or data is.
     *
...
declare const Icon_base: Schema.Class<Icon, Schema.Struct<{
     ...
     */
    readonly sizes: Schema.decodeTo<Schema.optional<Schema.$Array<Schema.String>>, Schema.optionalKey<Schema.$Array<Schema.String>>, never, never>;
    /**
     * Color theme for which the icon was designed.
     */
    readonly theme: Schema.decodeTo<Schema.optional<Schema.Literals<readonly ["light", "dark"]>>, Schema.optionalKey<Schema.Literals<readonly ["light", "dark"]>>, never, never>;
}>, {}>;
/**
...
declare const Implementation_base: Schema.Opaque<Implementation, Schema.Struct<{
    ...
    readonly icons: Schema.decodeTo<Schema.optional<Schema.$Array<typeof Icon>>, Schema.optionalKey<Schema.$Array<typeof Icon>>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly websiteUrl: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
}>, {}> & Omit<Schema.Struct<{
    readonly name: Schema.String;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly version: Schema.String;
...
declare const ClientCapabilities_base: Schema.Class<ClientCapabilities, Schema.Struct<{
     ...
     */
    readonly sampling: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * Present if the client supports context inclusion during sampling.
         */
        readonly context: Schema.decodeTo<Schema.optional<Schema.Struct<{}>>, Schema.optionalKey<Schema.Struct<{}>>, never, never>;
        /**
         * Present if the client supports tool use during sampling.
         */
        readonly tools: Schema.decodeTo<Schema.optional<Schema.Struct<{}>>, Schema.optionalKey<Schema.Struct<{}>>, never, never>;
    }>>, Schema.optionalKey<Schema.Struct<{
        /**
         * Present if the client supports context inclusion during sampling.
         */
     ...
     */
    readonly elicitation: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * Present if the client supports form-mode elicitation.
         */
        readonly form: Schema.decodeTo<Schema.optional<Schema.Struct<{}>>, Schema.optionalKey<Schema.Struct<{}>>, never, never>;
        /**
         * Present if the client supports URL-mode elicitation.
         */
        readonly url: Schema.decodeTo<Schema.optional<Schema.Struct<{}>>, Schema.optionalKey<Schema.Struct<{}>>, never, never>;
    }>>, Schema.optionalKey<Schema.Struct<{
        /**
         * Present if the client supports form-mode elicitation.
         */
...
declare const ToolUseContent_base: Schema.Class<ToolUseContent, Schema.Struct<{
 ...
 * @since 4.0.0
 */
export declare class ToolUseContent extends ToolUseContent_base {
}
declare const ToolResultContent_base: Schema.Class<ToolResultContent, Schema.Struct<{
     ...
     */
    readonly structuredContent: Schema.decodeTo<Schema.optional<Schema.$Record<Schema.String, Schema.Unknown>>, Schema.optionalKey<Schema.$Record<Schema.String, Schema.Unknown>>, never, never>;
    /**
 ...
 * @since 4.0.0
 */
export declare class ToolResultContent extends ToolResultContent_base {
}
/**
 ...
 * @since 4.0.0
 */
export declare const SamplingMessageContentBlock: Schema.Union<readonly [typeof TextContent, typeof ImageContent, typeof AudioContent, typeof ToolUseContent, typeof ToolResultContent]>;
declare const SamplingMessage_base: Schema.Opaque<SamplingMessage, Schema.Struct<{
    readonly role: Schema.Literals<["user", "assistant"]>;
    readonly content: Schema.Union<readonly [Schema.Union<readonly [typeof TextContent, typeof ImageContent, typeof AudioContent, typeof ToolUseContent, typeof ToolResultContent]>, Schema.$Array<Schema.Union<readonly [typeof TextContent, typeof ImageContent, typeof AudioContent, typeof ToolUseContent, typeof ToolResultContent]>>]>;
    readonly _meta: Schema.decodeTo<Schema.optional<Schema.$Record<Schema.String, Schema.Codec<Schema.Json, Schema.Json, never, never>>>, Schema.optionalKey<Schema.$Record<Schema.String, Schema.Codec<Schema.Json, Schema.Json, never, never>>>, never, never>;
}>, {}> & Omit<Schema.Struct<{
    readonly role: Schema.Literals<["user", "assistant"]>;
    readonly content: Schema.Union<readonly [Schema.Union<readonly [typeof TextContent, typeof ImageContent, typeof AudioContent, typeof ToolUseContent, typeof ToolResultContent]>, Schema.$Array<Schema.Union<readonly [typeof TextContent, typeof ImageContent, typeof AudioContent, typeof ToolUseContent, typeof ToolResultContent]>>]>;
...
declare const ToolChoice_base: Schema.Class<ToolChoice, Schema.Struct<{
     ...
     */
    readonly mode: Schema.decodeTo<Schema.optional<Schema.Literals<readonly ["auto", "required", "none"]>>, Schema.optionalKey<Schema.Literals<readonly ["auto", "required", "none"]>>, never, never>;
}>, {}>;
/**
...
declare const CreateMessage_base: Rpc.Rpc<"sampling/createMessage", Schema.Struct<{
     ...
     */
    tools: Schema.decodeTo<Schema.optional<Schema.$Array<Schema.Struct<{
        /**
         * The name of the tool.
         */
        readonly name: Schema.String;
     ...
     */
    toolChoice: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * Tool-selection mode requested from the client.
         */
        readonly mode: Schema.decodeTo<Schema.optional<Schema.Literals<readonly ["auto", "required", "none"]>>, Schema.optionalKey<Schema.Literals<readonly ["auto", "required", "none"]>>, never, never>;
...
declare const StringSchema_base: Schema.Class<StringSchema, Schema.Struct<{
    readonly type: Schema.tag<"string">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly minLength: Schema.decodeTo<Schema.optional<Schema.Int>, Schema.optionalKey<Schema.Int>, never, never>;
    readonly maxLength: Schema.decodeTo<Schema.optional<Schema.Int>, Schema.optionalKey<Schema.Int>, never, never>;
    readonly format: Schema.decodeTo<Schema.optional<Schema.Literals<readonly ["email", "uri", "date", "date-time"]>>, Schema.optionalKey<Schema.Literals<readonly ["email", "uri", "date", "date-time"]>>, never, never>;
    readonly default: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class StringSchema extends StringSchema_base {
}
declare const NumberSchema_base: Schema.Class<NumberSchema, Schema.Struct<{
    readonly type: Schema.Literals<readonly ["number", "integer"]>;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly minimum: Schema.decodeTo<Schema.optional<Schema.Finite>, Schema.optionalKey<Schema.Finite>, never, never>;
    readonly maximum: Schema.decodeTo<Schema.optional<Schema.Finite>, Schema.optionalKey<Schema.Finite>, never, never>;
    readonly default: Schema.decodeTo<Schema.optional<Schema.Finite>, Schema.optionalKey<Schema.Finite>, never, never>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class NumberSchema extends NumberSchema_base {
}
declare const BooleanSchema_base: Schema.Class<BooleanSchema, Schema.Struct<{
    readonly type: Schema.tag<"boolean">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly default: Schema.decodeTo<Schema.optional<Schema.Boolean>, Schema.optionalKey<Schema.Boolean>, never, never>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class BooleanSchema extends BooleanSchema_base {
}
declare const UntitledSingleSelectEnumSchema_base: Schema.Class<UntitledSingleSelectEnumSchema, Schema.Struct<{
    readonly type: Schema.tag<"string">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly enum: Schema.$Array<Schema.String>;
    readonly default: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class UntitledSingleSelectEnumSchema extends UntitledSingleSelectEnumSchema_base {
}
declare const TitledSingleSelectEnumSchema_base: Schema.Class<TitledSingleSelectEnumSchema, Schema.Struct<{
    readonly type: Schema.tag<"string">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly oneOf: Schema.$Array<Schema.Struct<{
        readonly const: Schema.String;
 ...
 * @since 4.0.0
 */
export declare class TitledSingleSelectEnumSchema extends TitledSingleSelectEnumSchema_base {
}
/**
 ...
 * @since 4.0.0
 */
export declare const SingleSelectEnumSchema: Schema.Union<readonly [typeof UntitledSingleSelectEnumSchema, typeof TitledSingleSelectEnumSchema]>;
declare const UntitledMultiSelectEnumSchema_base: Schema.Class<UntitledMultiSelectEnumSchema, Schema.Struct<{
    readonly type: Schema.tag<"array">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly minItems: Schema.decodeTo<Schema.optional<Schema.Int>, Schema.optionalKey<Schema.Int>, never, never>;
    readonly maxItems: Schema.decodeTo<Schema.optional<Schema.Int>, Schema.optionalKey<Schema.Int>, never, never>;
    readonly items: Schema.Struct<{
        readonly type: Schema.tag<"string">;
        readonly enum: Schema.$Array<Schema.String>;
    }>;
    readonly default: Schema.decodeTo<Schema.optional<Schema.$Array<Schema.String>>, Schema.optionalKey<Schema.$Array<Schema.String>>, never, never>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class UntitledMultiSelectEnumSchema extends UntitledMultiSelectEnumSchema_base {
}
declare const TitledMultiSelectEnumSchema_base: Schema.Class<TitledMultiSelectEnumSchema, Schema.Struct<{
    readonly type: Schema.tag<"array">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly minItems: Schema.decodeTo<Schema.optional<Schema.Int>, Schema.optionalKey<Schema.Int>, never, never>;
    readonly maxItems: Schema.decodeTo<Schema.optional<Schema.Int>, Schema.optionalKey<Schema.Int>, never, never>;
    readonly items: Schema.Struct<{
        readonly anyOf: Schema.$Array<Schema.Struct<{
            readonly const: Schema.String;
            readonly title: Schema.String;
        }>>;
    }>;
 ...
 * @since 4.0.0
 */
export declare class TitledMultiSelectEnumSchema extends TitledMultiSelectEnumSchema_base {
}
/**
 ...
 * @since 4.0.0
 */
export declare const MultiSelectEnumSchema: Schema.Union<readonly [typeof UntitledMultiSelectEnumSchema, typeof TitledMultiSelectEnumSchema]>;
declare const LegacyTitledEnumSchema_base: Schema.Class<LegacyTitledEnumSchema, Schema.Struct<{
    readonly type: Schema.tag<"string">;
    readonly title: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly description: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
    readonly enum: Schema.$Array<Schema.String>;
    readonly enumNames: Schema.decodeTo<Schema.optional<Schema.$Array<Schema.String>>, Schema.optionalKey<Schema.$Array<Schema.String>>, never, never>;
    readonly default: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class LegacyTitledEnumSchema extends LegacyTitledEnumSchema_base {
}
/**
 ...
 * @since 4.0.0
 */
export declare const EnumSchema: Schema.Union<readonly [Schema.Union<readonly [typeof UntitledSingleSelectEnumSchema, typeof TitledSingleSelectEnumSchema]>, Schema.Union<readonly [typeof UntitledMultiSelectEnumSchema, typeof TitledMultiSelectEnumSchema]>, typeof LegacyTitledEnumSchema]>;
/**
 ...
 * @since 4.0.0
 */
export declare const PrimitiveSchemaDefinition: Schema.Union<readonly [typeof StringSchema, typeof NumberSchema, typeof BooleanSchema, Schema.Union<readonly [Schema.Union<readonly [typeof UntitledSingleSelectEnumSchema, typeof TitledSingleSelectEnumSchema]>, Schema.Union<readonly [typeof UntitledMultiSelectEnumSchema, typeof TitledMultiSelectEnumSchema]>, typeof LegacyTitledEnumSchema]>]>;
declare const ElicitRequestFormParams_base: Schema.Class<ElicitRequestFormParams, Schema.Struct<{
    readonly _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
    ...
    readonly mode: Schema.decodeTo<Schema.optional<Schema.Literal<"form">>, Schema.optionalKey<Schema.Literal<"form">>, never, never>;
    readonly message: Schema.String;
    readonly requestedSchema: Schema.Struct<{
        readonly $schema: Schema.decodeTo<Schema.optional<Schema.String>, Schema.optionalKey<Schema.String>, never, never>;
        readonly type: Schema.tag<"object">;
        readonly properties: Schema.$Record<Schema.String, Schema.Union<readonly [typeof StringSchema, typeof NumberSchema, typeof BooleanSchema, Schema.Union<readonly [Schema.Union<readonly [typeof UntitledSingleSelectEnumSchema, typeof TitledSingleSelectEnumSchema]>, Schema.Union<readonly [typeof UntitledMultiSelectEnumSchema, typeof TitledMultiSelectEnumSchema]>, typeof LegacyTitledEnumSchema]>]>>;
        readonly required: Schema.decodeTo<Schema.optional<Schema.$Array<Schema.String>>, Schema.optionalKey<Schema.$Array<Schema.String>>, never, never>;
    }>;
}>, {}>;
/**
 ...
 * @since 4.0.0
 */
export declare class ElicitRequestFormParams extends ElicitRequestFormParams_base {
}
declare const ElicitRequestURLParams_base: Schema.Class<ElicitRequestURLParams, Schema.Struct<{
    readonly _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
 ...
 * @since 4.0.0
 */
export declare class ElicitRequestURLParams extends ElicitRequestURLParams_base {
}
/**
 ...
 * @since 4.0.0
 */
export declare const ElicitRequestParams: Schema.Union<readonly [typeof ElicitRequestFormParams, typeof ElicitRequestURLParams]>;
declare const ElicitAcceptResult_base: Schema.Class<ElicitAcceptResult, Schema.Struct<{
     ...
     */
    readonly content: Schema.decodeTo<Schema.optional<Schema.$Record<Schema.String, Schema.Union<readonly [Schema.String, Schema.Finite, Schema.Boolean, Schema.$Array<Schema.String>]>>>, Schema.optionalKey<Schema.$Record<Schema.String, Schema.Union<readonly [Schema.String, Schema.Finite, Schema.Boolean, Schema.$Array<Schema.String>]>>>, never, never>;
}>, {}>;
/**
...
declare const Elicit_base: Rpc.Rpc<"elicitation/create", Schema.Union<readonly [typeof ElicitRequestFormParams, typeof ElicitRequestURLParams]>, Schema.Union<readonly [typeof ElicitAcceptResult, typeof ElicitDeclineResult]>, Schema.Union<readonly [typeof ParseError, typeof InvalidRequest, typeof MethodNotFound, typeof InvalidParams, typeof InternalError, typeof McpErrorBase]>, never, never>;
/**
...
declare const ElicitationCompleteNotification_base: Rpc.Rpc<"notifications/elicitation/complete", Schema.Struct<{
 ...
 * @since 4.0.0
 */
export declare class ElicitationCompleteNotification extends ElicitationCompleteNotification_base {
}
declare const ElicitationDeclined_base: Schema.Class<ElicitationDeclined, Schema.Struct<{
    ...
    readonly request: Schema.Union<readonly [typeof ElicitRequestFormParams, typeof ElicitRequestURLParams]>;
...
declare const ClientRequestRpcs_base: RpcGroup.RpcGroup<Rpc.Rpc<"completion/complete", Schema.Struct<{
     ...
     */
    uri: Schema.String;
}>, Schema.Struct<{}>, Schema.Union<readonly [typeof ParseError, typeof InvalidRequest, typeof MethodNotFound, typeof InvalidParams, typeof InternalError, typeof McpErrorBase]>, typeof McpServerClientMiddleware, never> | Rpc.Rpc<"tools/call", Schema.Struct<{
    _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
...
declare const ServerNotificationRpcs_base: RpcGroup.RpcGroup<typeof CancelledNotification | typeof ProgressNotification | typeof ResourceListChangedNotification | typeof ResourceUpdatedNotification | typeof PromptListChangedNotification | typeof ToolListChangedNotification | typeof LoggingMessageNotification | typeof ElicitationCompleteNotification>;
/**
