 ...
 * @since 4.0.0
 */
export type NeedsApprovalFunction<Params extends Schema.Constraint> = (params: Params["Type"], context: NeedsApprovalContext) => boolean | Effect.Effect<boolean>;
/**
 ...
 * @since 4.0.0
 */
export type NeedsApproval<Params extends Schema.Constraint> = boolean | NeedsApprovalFunction<Params>;
/**
...
export interface Tool<out Name extends string, out Config extends {
     ...
     */
    setNeedsApproval(needsApproval: NeedsApproval<Config["parameters"]>): Tool<Name, Config, Requirements>;
    /**
     ...
     */
    setSuccess<SuccessSchema extends Schema.Constraint>(schema: SuccessSchema): Tool<Name, {
     ...
     */
    setFailure<FailureSchema extends Schema.Constraint>(schema: FailureSchema): Tool<Name, {
        readonly parameters: Config["parameters"];
     ...
     */
    setParameters<ParametersSchema extends Schema.Constraint>(schema: ParametersSchema): Tool<Name, {
 ...
 * @since 4.0.0
 */
export declare const make: <const Name extends string, Parameters extends Schema.Constraint = typeof EmptyParams, Success extends Schema.Constraint = typeof Schema.Void, Failure extends Schema.Constraint = typeof Schema.Never, Mode extends FailureMode | undefined = undefined, Dependencies extends Array<Context.Key<any, any> | Context.Key<never, any>> = []>(name: Name, options?: {
    /**
...
export declare const dynamic: {
    ...
    <const Name extends string, const Options extends {
        ...
        } ? P extends Schema.Constraint ? P : P extends JsonSchema.JsonSchema ? P : typeof Schema.Unknown : typeof Schema.Unknown;
        ...
        readonly failure: Options extends {
            readonly failure: infer F extends Schema.Constraint;
 ...
 * @since 4.0.0
 */
export declare const getJsonSchemaFromSchema: <S extends Schema.Constraint>(schema: S, options?: {
    readonly transformer?: CodecTransformer;
}) => JsonSchema.JsonSchema;
