 ...
 * @since 4.0.0
 */
export declare const isHttpApiGroup: (u: unknown) => u is Top;
/**
 ...
 * @since 4.0.0
 */
export interface HttpApiGroup<out Id extends string, in out Endpoints extends HttpApiEndpoint.Constraint = never, out TopLevel extends boolean = false> extends Pipeable {
    new (_: never): {};
     ...
     */
    add<const A extends NonEmptyReadonlyArray<HttpApiEndpoint.Constraint>>(...endpoints: A): HttpApiGroup<Id, Endpoints | A[number], TopLevel>;
    /**
 ...
 * @since 4.0.0
 */
export type ToService<ApiId extends string, Group extends Constraint> = Group extends Constraint ? Service<ApiId, Group["identifier"]> : never;
/**
 ...
 * @since 4.0.0
 */
export type WithIdentifier<Group, Identifier extends string> = Extract<Group, {
    readonly identifier: Identifier;
}>;
/**
 ...
 * @since 4.0.0
 */
export type Endpoints<Group> = Group extends HttpApiGroup<infer _Identifier, infer _Endpoints, infer _TopLevel> ? _Endpoints : never;
/**
 ...
 * @since 4.0.0
 */
export type EndpointsWithIdentifier<Group extends Constraint, Identifier extends string> = Endpoints<WithIdentifier<Group, Identifier>>;
/**
 ...
 * @since 4.0.0
 */
export type ClientServices<Group> = Group extends HttpApiGroup<infer _Identifier, infer _Endpoints, infer _TopLevel> ? HttpApiEndpoint.ClientServices<_Endpoints> : never;
/**
 ...
 * @since 4.0.0
 */
export type AddPrefix<Group, Prefix extends PathInput> = Group extends HttpApiGroup<infer _Identifier, infer _Endpoints, infer _TopLevel> ? HttpApiGroup<_Identifier, HttpApiEndpoint.AddPrefix<_Endpoints, Prefix>, _TopLevel> : never;
/**
 ...
 * @since 4.0.0
 */
export type AddMiddleware<Group, Id extends HttpApiMiddleware.AnyId> = Group extends HttpApiGroup<infer _Identifier, infer _Endpoints, infer _TopLevel> ? HttpApiGroup<_Identifier, HttpApiEndpoint.AddMiddleware<_Endpoints, Id>, _TopLevel> : never;
/**
