 ...
 * @since 4.0.0
 */
export declare function fromApi<Id extends string, Groups extends HttpApiGroup.Constraint>(api: HttpApi.HttpApi<Id, Groups>, options?: SchemaRepresentation.ToRepresentationOptions): OpenAPISpec;
/**
