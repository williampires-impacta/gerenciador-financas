 ...
 * @since 4.0.0
 */
export const UuidV4BytesWithGenerate = schema => schema.pipe(Schema.withConstructorDefault(Effect.sync(() => Uuid.v4Bytes())));
/**
 ...
 * @since 4.0.0
 */
export const UuidV4WithGenerate = schema => schema.pipe(Schema.withConstructorDefault(Effect.sync(Uuid.v4String)));
/**
 ...
 * @since 4.0.0
 */
export const UuidV7WithGenerate = schema => schema.pipe(Schema.withConstructorDefault(Effect.clockWith(clock => Effect.succeed(Uuid.v7String(clock.currentTimeMillisUnsafe())))));
/**
