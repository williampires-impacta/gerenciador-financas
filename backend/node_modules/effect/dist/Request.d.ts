...
export declare const makeEntry: <R>(options: {
    ...
    readonly completeUnsafe: (exit: Exit.Exit<[R] extends [Request<infer _A, infer _E, infer _R>] ? _A : never, [R] extends [Request<infer _A, infer _E, infer _R>] ? _E : never>) => void;
}) => Entry<R>;
export {};
