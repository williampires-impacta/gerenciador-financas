 ...
 * @since 4.0.0
 */
export declare function schema<T>(codec: Schema.ConstraintCodec<T, unknown>, path?: string | ConfigProvider.Path): Config<T>;
/**
 ...
 * @since 4.0.0
 */
export declare const Record: <K extends Schema.Record.Key, V extends Schema.Constraint>(key: K, value: V, options?: {
    readonly separator?: string | undefined;
    readonly keyValueSeparator?: string | undefined;
}) => Schema.Union<readonly [Schema.$Record<K, V>, Schema.decodeTo<Schema.toCodecStringTree<Schema.$Record<K, V>>, Schema.String, never, never>]>;
declare const ArrayConfig: <V extends Schema.Constraint>(value: V, options?: {
    readonly separator?: string | undefined;
}) => Schema.Union<readonly [Schema.decodeTo<Schema.toCodecStringTree<Schema.$Array<V>>, Schema.String, never, never>, Schema.$Array<V>]>;
export { 
/**
 ...
 * @since 2.0.0
 */
export declare function fail(err: SourceError | Schema.SchemaError): Config<unknown>;
/**
 ...
 * @since 2.0.0
 */
export declare function literal<L extends SchemaAST.LiteralValue>(literal: L, name?: string): Config<L>;
/**
 ...
 * @since 4.0.0
 */
export declare function literals<const L extends ReadonlyArray<SchemaAST.LiteralValue>>(literals: L, name?: string): Config<L[number]>;
/**
