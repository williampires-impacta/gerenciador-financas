...
export declare class Getter<out T, in E, R = never> extends Pipeable.Class {
    ...
    constructor(run: (input: Option.Option<E>, options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>);
 ...
 * @since 4.0.0
 */
export declare function fail<T, E>(f: (oe: Option.Option<E>, options: SchemaAST.ParseOptions) => SchemaIssue.Issue): Getter<T, E>;
/**
 ...
 * @since 4.0.0
 */
export declare function onNone<T, E extends T = T, R = never>(f: (options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>): Getter<T, E, R>;
/**
 ...
 * @since 4.0.0
 */
export declare function onSome<T, E, R = never>(f: (e: E, options: SchemaAST.ParseOptions) => Effect.Effect<Option.Option<T>, SchemaIssue.Issue, R>): Getter<T, E, R>;
/**
 ...
 * @since 4.0.0
 */
export declare function checkEffect<T, R = never>(f: (input: T, options: SchemaAST.ParseOptions) => Effect.Effect<undefined | boolean | Schema.FilterIssue, never, R>): Getter<T, T, R>;
/**
 ...
 * @since 4.0.0
 */
export declare function transformOrFail<T, E, R = never>(f: (e: E, options: SchemaAST.ParseOptions) => Effect.Effect<T, SchemaIssue.Issue, R>): Getter<T, E, R>;
/**
 ...
 * @since 4.0.0
 */
export declare function withDefault<T, R = never>(defaultValue: Effect.Effect<T, SchemaIssue.Issue, R>): Getter<T, T | undefined, R>;
/**
 ...
 * @since 4.0.0
 */
export type JsonReplacer = ((this: any, key: string, value: any) => any) | Array<string | number> | null;
