...
export function decodeBase64() {
  return transformOrFail((input, options) => Effect.mapErrorEager(Effect.fromResult(Encoding.decodeBase64(input)), () => new SchemaIssue.InvalidValue({
...
export function decodeBase64String() {
  return transformOrFail((input, options) => Result.match(Encoding.decodeBase64String(input), {
...
export function decodeBase64Url() {
  return transformOrFail((input, options) => Result.match(Encoding.decodeBase64Url(input), {
    onFailure: () => Effect.fail(new SchemaIssue.InvalidValue({
...
export function decodeBase64UrlString() {
  return transformOrFail((input, options) => Result.match(Encoding.decodeBase64UrlString(input), {
    onFailure: () => Effect.fail(new SchemaIssue.InvalidValue({
      expected: "a valid Base64Url string"
    }, input, options)),
    onSuccess: Effect.succeed
...
export function decodeHex() {
  return transformOrFail((input, options) => Result.match(Encoding.decodeHex(input), {
    onFailure: () => Effect.fail(new SchemaIssue.InvalidValue({
...
export function decodeHexString() {
  return transformOrFail((input, options) => Result.match(Encoding.decodeHexString(input), {
    onFailure: () => Effect.fail(new SchemaIssue.InvalidValue({
      expected: "a valid hexadecimal string"
    }, input, options)),
    onSuccess: Effect.succeed
