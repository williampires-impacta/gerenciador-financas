...
type MatchOrElseResult<Cases, OrElse extends (...args: Array<any>) => any> = Unify<MatchCasesResult<Cases> | ReturnType<OrElse>>;
type TaggedUnionUtils<Tag extends PropertyKey, Members extends ReadonlyArray<Constraint & {
    ...
    readonly matchOrElse: {
        ...
        }, OrElse extends (value: Exclude<Members[number]["Type"], {
            readonly [K in Tag]: keyof Cases;
        }>) => any>(value: Members[number]["Type"], cases: Cases, orElse: OrElse): MatchOrElseResult<Cases, OrElse>;
        <Cases extends {
            [M in Flattened[number] as M["Type"][Tag]]+?: (value: M["Type"]) => any;
        } & {
            [K in Exclude<keyof Cases, Flattened[number]["Type"][Tag]>]: never;
            ...
            readonly [K in Tag]: keyof Cases;
        }>) => any>(cases: Cases, orElse: OrElse): (value: Members[number]["Type"]) => MatchOrElseResult<Cases, OrElse>;
    };
};
/**
...
export interface TaggedUnion<Cases extends Record<string, Constraint>> extends BottomLazy<SchemaAST.Union<SchemaAST.Objects>, TaggedUnion<Cases>> {
    ...
    readonly matchOrElse: {
        <Output>(value: Cases[keyof Cases]["Type"], cases: {
            [K in keyof Cases]?: (value: Cases[K]["Type"]) => Output;
        }, orElse: (value: Cases[keyof Cases]["Type"]) => Output): Output;
        <Output>(cases: {
            [K in keyof Cases]?: (value: Cases[K]["Type"]) => Output;
        }, orElse: (value: Cases[keyof Cases]["Type"]) => Output): (value: Cases[keyof Cases]["Type"]) => Output;
    };
}
/**
 ...
 * @since 4.0.0
 */
export type GraphIso<T extends Graph_.Kind, Node extends Constraint, Edge extends Constraint> = EncodedGraph<Node["Iso"], Edge["Iso"], T>;
/**
 ...
 * @since 4.0.0
 */
export interface Graph<T extends Graph_.Kind, Node extends Constraint, Edge extends Constraint> extends declareConstructor<Graph_.Graph<Node["Type"], Edge["Type"], T>, Graph_.Graph<Node["Encoded"], Edge["Encoded"], T>, readonly [Node, Edge], GraphIso<T, Node, Edge>> {
 ...
 * @since 4.0.0
 */
export declare function Graph<Node extends Constraint, Edge extends Constraint>(type: "directed", node: Node, edge: Edge): Graph<"directed", Node, Edge>;
export declare function Graph<Node extends Constraint, Edge extends Constraint>(type: "undirected", node: Node, edge: Edge): Graph<"undirected", Node, Edge>;
export declare function Graph<T extends Graph_.Kind, Node extends Constraint, Edge extends Constraint>(type: T, node: Node, edge: Edge): Graph<T, Node, Edge>;
/**
 ...
 * @since 4.0.0
 */
export declare const GraphReviver: SchemaRepresentation.DeclarationReviver<"directed" | "undirected">;
/**
 ...
 * @since 4.0.0
 */
export declare function toRepresentation(schema: Constraint, options?: SchemaRepresentation.ToRepresentationOptions): SchemaRepresentation.Document;
/**
 ...
 * @since 4.0.0
 */
export declare const JsonObject: $Record<String, Codec<Json, Json, never, never>>;
/**
