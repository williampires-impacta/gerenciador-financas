 ...
 * @since 4.0.0
 */
export type Matcher<Input, Filters, RemainingApplied, Result, Flavor, Return = any, Args extends Array<any> = []> = TypeMatcher<Input, Filters, RemainingApplied, Result, Return, Args> | ValueMatcher<Input, Filters, RemainingApplied, Result, Input, Return, Flavor>;
/**
 ...
 * @since 4.0.0
 */
export interface TypeMatcher<in Input, out Filters, out Remaining, out Result, out Return = any, in Args extends Array<any> = []> extends Pipeable {
 ...
 * @since 4.0.0
 */
export interface ValueMatcher<in Input, Filters, out Remaining, out Result, Provided, out Return = any, out Flavor = ValueFlavor> extends Pipeable {
 ...
 * @since 4.0.0
 */
export declare const fn: <Args extends Array<any>, I>(select: (...args: Args) => I) => Matcher<I, Types.Without<never>, I, never, never, any, Args>;
/**
 ...
 * @since 4.0.0
 */
export declare const value: <const I>(i: I) => Matcher<I, Types.Without<never>, I, never, ValueFlavor>;
/**
 ...
 * @since 4.0.0
 */
export declare const withReturnType: <Ret>() => <I, F, R, A, Pr, _, Args extends Array<any>>(self: Matcher<I, F, R, A, Pr, _, Args>) => [Ret] extends [[A] extends [never] ? any : A] ? Matcher<I, F, R, A, Pr, Ret, Args> : "withReturnType constraint does not extend Result type";
/**
 ...
 * @since 4.0.0
 */
export declare const tag: <R, P extends Types.Tags<"_tag", R> & string, Ret, Args extends Array<any>, Fn extends (_: Extract<R, Record<"_tag", P>>, ...args: Args) => Ret>(...pattern: [first: P, ...values: Array<P>, f: Fn]) => <I, F, A, Pr>(self: Matcher<I, F, R, A, Pr, Ret, Args>) => Matcher<I, Types.AddWithout<F, Extract<R, Record<"_tag", P>>>, Types.ApplyFilters<I, Types.AddWithout<F, Extract<R, Record<"_tag", P>>>>, ReturnType<Fn> | A, Pr, Ret, Args>;
/**
 ...
 * @since 4.0.0
 */
export declare const orElse: <RA, Ret, Args extends Array<any>, F extends (_: RA, ...args: Args) => Ret>(f: F) => <I, R, A, Pr>(self: Matcher<I, R, RA, A, Pr, Ret, Args>) => [Pr] extends [never] ? [Args] extends [[]] ? (input: I) => Unify<ReturnType<F> | A> : (...args: Args) => Unify<ReturnType<F> | A> : Unify<ReturnType<F> | A>;
/**
 ...
 * @since 4.0.0
 */
export declare const orElseAbsurd: <I, R, RA, A, Pr, Ret, Args extends Array<any>>(self: Matcher<I, R, RA, A, Pr, Ret, Args>) => [Pr] extends [never] ? [Args] extends [[]] ? (input: I) => Unify<A> : (...args: Args) => Unify<A> : Unify<A>;
/**
 ...
 * @since 4.0.0
 */
export declare const result: <I, F, R, A, Pr, Ret, Args extends Array<any>>(self: Matcher<I, F, R, A, Pr, Ret, Args>) => [Pr] extends [never] ? [Args] extends [[]] ? (input: I) => Result.Result<Unify<A>, R> : (...args: Args) => Result.Result<Unify<A>, R> : Result.Result<Unify<A>, R>;
/**
 ...
 * @since 4.0.0
 */
export declare const option: <I, F, R, A, Pr, Ret, Args extends Array<any>>(self: Matcher<I, F, R, A, Pr, Ret, Args>) => [Pr] extends [never] ? [Args] extends [[]] ? (input: I) => Option.Option<Unify<A>> : (...args: Args) => Option.Option<Unify<A>> : Option.Option<Unify<A>>;
/**
 ...
 * @since 4.0.0
 */
export declare const exhaustive: <I, F, A, Pr, Ret, Args extends Array<any>>(self: Matcher<I, F, never, A, Pr, Ret, Args>) => [Pr] extends [never] ? [Args] extends [[]] ? (u: I) => Unify<A> : (...args: Args) => Unify<A> : Unify<A>;
