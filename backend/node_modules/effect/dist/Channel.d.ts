 ...
 * @since 4.0.0
 */
export declare const runCount: <OutElem, OutErr, OutDone, Env>(self: Channel<OutElem, OutErr, OutDone, unknown, unknown, unknown, Env>) => Effect.Effect<number, OutErr, Env>;
/**
 ...
 * @since 4.0.0
 */
export declare const mkUint8Array: <OutErr, OutDone, Env>(self: Channel<Arr.NonEmptyReadonlyArray<Uint8Array>, OutErr, OutDone, unknown, unknown, unknown, Env>) => Effect.Effect<Uint8Array<ArrayBuffer>, OutErr, Env>;
/**
