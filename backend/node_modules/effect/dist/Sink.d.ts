 ...
 * @since 4.0.0
 */
export declare const fromWritableStream: <A, E>(options: {
...
declare const catch_: {
    <E, A2, E2, R2>(f: (error: Types.NoInfer<E>) => Effect.Effect<A2, E2, R2>): <A, In, L, R>(self: Sink<A, In, L, E, R>) => Sink<A2 | A, In, L, E2, R2 | R>;
