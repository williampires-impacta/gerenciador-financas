 ...
 * @since 4.0.0
 */
export declare function memoize<A extends object, O extends {} | null>(f: (a: A) => O): (ast: A) => O;
/**
 ...
 * @since 4.0.0
 */
export declare function memoizeIdempotent<A extends object>(f: (a: A) => A): (a: A) => A;
