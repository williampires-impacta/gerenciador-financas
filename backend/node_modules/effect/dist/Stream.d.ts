...
export declare const withExecutionPlan: {
     ...
     * @since 3.16.0
     */
    <Input, R2, Provides, PolicyE, RX = never>(policy: ExecutionPlan.ExecutionPlan<{
        provides: Provides;
        input: Input;
        error: PolicyE;
        requirements: R2;
     ...
     * @since 3.16.0
     */
    <A, E extends Input, R, R2, Input, Provides, PolicyE, RX = never>(self: Stream<A, E, R>, policy: ExecutionPlan.ExecutionPlan<{
        provides: Provides;
        input: Input;
        error: PolicyE;
        requirements: R2;
 ...
 * @since 4.0.0
 */
export declare const limitBytes: {
    /**
     * Emits byte chunks until the configured limit would be exceeded, then drops
     * the crossing chunk and switches to a fallback stream.
     *
     ...
     * @since 4.0.0
     */
    <E, R>(self: Stream<Uint8Array, E, R>, bytes: SizeInput, onLimitReached: LazyArg<Stream<Uint8Array, E, R>>): Stream<Uint8Array, E, R>;
};
/**
 ...
 * @since 4.0.0
 */
export declare const mkArrayBuffer: <E, R>(self: Stream<Uint8Array, E, R>) => Effect.Effect<ArrayBuffer, E, R>;
/**
