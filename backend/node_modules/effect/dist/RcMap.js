 ...
 * @since 4.0.0
 */
export const getOption = /*#__PURE__*/dual(2, (self, key) => Effect.uninterruptibleMask(restore => {
  if (self.state._tag === "Closed") {
  ...
  return Scope.addFinalizer(scope, entry.finalizer).pipe(Effect.andThen(Effect.asSome(restore(Deferred.await(entry.deferred)))));
}));
