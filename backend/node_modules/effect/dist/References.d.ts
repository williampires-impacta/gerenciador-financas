 ...
 * @since 4.0.0
 */
export declare const CurrentLogAnnotations: Context.Reference<ReadonlyRecord<string, unknown>>;
/**
 ...
 * @since 4.0.0
 */
export declare const CurrentLogLevel: Context.Reference<Severity>;
/**
 ...
 * @since 4.0.0
 */
export declare const CurrentLogSpans: Context.Reference<ReadonlyArray<[label: string, timestamp: number]>>;
/**
 ...
 * @since 4.0.0
 */
export declare const CurrentStackFrame: Context.Reference<StackFrame | undefined>;
/**
 ...
 * @since 4.0.0
 */
export declare const MinimumLogLevel: Context.Reference<LogLevel>;
/**
 ...
 * @since 4.0.0
 */
export declare const TracerEnabled: Context.Reference<boolean>;
/**
 ...
 * @since 4.0.0
 */
export declare const TracerSpanAnnotations: Context.Reference<ReadonlyRecord<string, unknown>>;
/**
 ...
 * @since 4.0.0
 */
export declare const TracerSpanLinks: Context.Reference<ReadonlyArray<SpanLink>>;
/**
 ...
 * @since 4.0.0
 */
export declare const TracerTimingEnabled: Context.Reference<boolean>;
/**
 ...
 * @since 4.0.0
 */
export declare const UnhandledLogLevel: Context.Reference<Severity | undefined>;
/**
