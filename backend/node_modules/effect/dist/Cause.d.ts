 ...
 * @since 3.2.0
 */
export declare const prettyErrors: <E>(self: Cause<E>, options?: {
 ...
 * @since 4.0.0
 */
export declare const isAsyncFiberError: (u: unknown) => u is AsyncFiberError;
/**
...
export declare const annotate: {
     ...
     * @since 4.0.0
     */
    (annotations: Context.Context<never>, options?: {
        readonly overwrite?: boolean | undefined;
     ...
     * @since 4.0.0
     */
    <E>(self: Cause<E>, annotations: Context.Context<never>, options?: {
        readonly overwrite?: boolean | undefined;
    }): Cause<E>;
};
/**
...
declare const StackTrace_base: Context.ServiceClass<StackTrace, "effect/Cause/StackTrace", StackFrame>;
/**
...
declare const InterruptorStackTrace_base: Context.ServiceClass<InterruptorStackTrace, "effect/Cause/InterruptorStackTrace", StackFrame>;
/**
