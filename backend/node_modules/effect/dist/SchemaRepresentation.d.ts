 ...
 * @since 4.0.0
 */
export declare function toRepresentation(ast: SchemaAST.AST, options?: ToRepresentationOptions): Document;
/**
 ...
 * @since 4.0.0
 */
export declare function toRepresentations(asts: readonly [SchemaAST.AST, ...Array<SchemaAST.AST>], options?: ToRepresentationOptions): MultiDocument;
/**
