//#region src/core/bindings/browser/BrowserOptions.shared.d.ts
 ...
 */
declare const BROWSER_VERSION = "126.0.6478.182";
/**
...
declare const SERVICE_BROWSER = "browser";
/** Durable Object class managing one Chrome session per instance. */
declare const BROWSER_SESSION_CLASS_NAME = "BrowserSession";
/** Loopback route the browser worker calls to launch/inspect/kill Chrome. */
declare const LOOPBACK_TARGET_BROWSER = "browser";
/** Service binding the browser worker uses to reach the loopback route. */
declare const BINDING_BROWSER_LOOPBACK = "SERVICE_LOOPBACK";
/** Durable Object namespace binding for {@link BROWSER_SESSION_CLASS_NAME}. */
declare const BINDING_BROWSER_SESSION = "BrowserSession";
//#endregion
export { BINDING_BROWSER_LOOPBACK, BINDING_BROWSER_SESSION, BROWSER_SESSION_CLASS_NAME, BROWSER_VERSION, BrowserProps, LOOPBACK_TARGET_BROWSER, SERVICE_BROWSER, SessionInfo };
//# sourceMappingURL=BrowserOptions.shared.d.mts.map