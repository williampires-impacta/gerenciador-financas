//#region src/core/bindings/queue/QueueOptions.shared.d.ts
/**
 ...
 */
type QueueContentType = "text" | "json" | "bytes" | "v8";
...
declare const BINDING_QUEUE_CONSUMER = "QUEUE_CONSUMER";
declare const BINDING_QUEUE_PRODUCERS = "QUEUE_PRODUCERS";
declare const BINDING_QUEUE_USER_WORKER = "USER_WORKER";
declare const BINDING_QUEUE_BROKER = "BROKER";
declare const BINDING_QUEUE_NAME = "QUEUE_NAME";
/** Name of the service binding the broker uses to forward to a dead-letter queue. */
declare const BINDING_QUEUE_DLQ: (queueName: string) => string;
//#endregion
export { BINDING_QUEUE_BROKER, BINDING_QUEUE_CONSUMER, BINDING_QUEUE_DLQ, BINDING_QUEUE_NAME, BINDING_QUEUE_PRODUCERS, BINDING_QUEUE_USER_WORKER, QueueConsumer, QueueContentType, QueueProducerEntry };
//# sourceMappingURL=QueueOptions.shared.d.mts.map