...
declare namespace Service_d_exports {
  export { LocalServiceProps, SelfServiceProps, local, remote, self };
}
 ...
 */
declare const local: ({ binding, scriptName, entrypoint, props }: LocalServiceProps) => BindingHook<RegistryProxy>;
 ...
 * assets middleware.
 */
declare const self: (binding: string, { entrypoint }?: SelfServiceProps) => BindingHook;
/**
 * Bind to a deployed Cloudflare Worker via the remote bindings proxy.
 */
declare const remote: (name: string, service: string) => BindingHook<RemoteBindings>;
//#endregion
export { LocalServiceProps, SelfServiceProps, Service_d_exports, local, remote, self };
