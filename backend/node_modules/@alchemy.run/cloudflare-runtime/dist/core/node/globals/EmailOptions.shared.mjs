//#region src/core/globals/EmailOptions.shared.ts
/**
...
*/
const PATH_EMAIL = "/cdn-cgi/handler/email";
/**
...
*/
const PATH_HANDLER_PREFIX = "/cdn-cgi/handler/";
/**
...
*/
const SERVICE_EMAIL_STORAGE = "email:storage";
/** Disk service binding the entry worker writes email replies through. */
const BINDING_EMAIL_DISK = "EMAIL_DISK";
/**
