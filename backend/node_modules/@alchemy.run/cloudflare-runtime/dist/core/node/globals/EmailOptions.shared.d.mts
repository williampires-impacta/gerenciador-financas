//#region src/core/globals/EmailOptions.shared.d.ts
/**
 ...
 */
declare const PATH_EMAIL = "/cdn-cgi/handler/email";
/**
 ...
 */
declare const PATH_HANDLER_PREFIX = "/cdn-cgi/handler/";
/**
 ...
 */
declare const SERVICE_EMAIL_STORAGE = "email:storage";
/** Disk service binding the entry worker writes email replies through. */
declare const BINDING_EMAIL_DISK = "EMAIL_DISK";
/**
 ...
 */
declare const BINDING_EMAIL_DIRECTORY = "EMAIL_DIRECTORY";
//#endregion
export { BINDING_EMAIL_DIRECTORY, BINDING_EMAIL_DISK, PATH_EMAIL, PATH_HANDLER_PREFIX, SERVICE_EMAIL_STORAGE };
//# sourceMappingURL=EmailOptions.shared.d.mts.map