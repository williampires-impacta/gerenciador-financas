import { Worker } from "./workerd/Config.mjs";
import { ContainerImage } from "./Docker.mjs";
import { HyperdriveOrigin } from "./bindings/hyperdrive/HyperdriveOrigin.shared.mjs";
import { QueueConsumer } from "./bindings/queue/QueueOptions.shared.mjs";
import { OutputSink } from "./workerd/Workerd.mjs";
import { BindingHook } from "./PluginContext.mjs";
//#region src/core/RuntimeWorker.d.ts
interface RuntimeWorker<B extends BindingHooks = BindingHooks> {
  ...
  readonly unsafe?: Partial<Worker>;
}
interface WorkerdLogging {
  /**
...
type BindingHooks = ReadonlyArray<BindingHook<any>>;
type Module = {
  name: string;
...
//#endregion
export { Assets, BindingHooks, DurableObjectNamespace, type HyperdriveOrigin, Module, type QueueConsumer, RuntimeWorker, WorkerdLogging, Workflow };
//# sourceMappingURL=RuntimeWorker.d.mts.map