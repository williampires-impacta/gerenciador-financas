import { T as Transport, D as Deferred, h as Message, C as Client, S as Struct, f as Call, A as Answer, b as Method, d as List, P as Pointer, _ as _StructCtor, O as ObjectSize, g as StructCtor, L as ListCtor, i as PointerCtor, a as Orphan, j as ListElementSize, k as PointerType, l as Segment, M as Message$1, m as _ListCtor, I as Interface } from './shared/capnp-es.BwLfaDUO.mjs';
export { B as BaseCall, w as Conn, o as DataCall, F as FuncCall, x as ImportEntry, c as Server, E as ServerCall, z as ServerMethod, n as _Pointer, y as answerPipelineClient, v as clientFromResolution, s as copyCall, q as isDataCall, p as isFuncCall, u as isSameClient, t as placeParams, r as readRawPointer } from './shared/capnp-es.BwLfaDUO.mjs';
import { D as Data } from './shared/capnp-es.O6lzO8x_.mjs';
export { P as Pipeline } from './shared/capnp-es.CHwx9yJq.mjs';
