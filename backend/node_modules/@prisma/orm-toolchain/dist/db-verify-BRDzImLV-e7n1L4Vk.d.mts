...
import "@prisma/cli-engine/protocol";
...
//#region ../../../1-framework/3-tooling/cli/dist/db-verify-BRDzImLV.d.mts
 ...
 */
type CreateControlClient = (options: ControlClientOptions) => ControlClient;
/**
 ...
 */
type DbUpdateFailureCode = 'PLANNING_FAILED' | 'RUNNER_FAILED' | 'DESTRUCTIVE_CHANGES' | 'CONSENT_PLAN_MISMATCH';
/** One planned operation whose class is destructive, as the refusal names it. */
interface DestructivePlanOperation {
  readonly id: string;
  readonly label: string;
}
/**
 ...
 */
interface DestructiveChangesVerdict {
 ...
 */
interface ConsentPlanMismatchVerdict {
...
interface ExecuteDbVerifySuccess {
   ...
   */
  readonly markerDrift: CliStructuredError$2 | null;
}
type ExecuteDbVerifyResult = Result<ExecuteDbVerifySuccess, CliStructuredError$2>;
/**
...
//# sourceMappingURL=db-verify-BRDzImLV-e7n1L4Vk.d.mts.map