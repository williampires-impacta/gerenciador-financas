...
export class ConnectionLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConnectionLimitExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
...
export class InvalidEndpointException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidEndpointException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
...
export const StartSelector = /*@__PURE__*/ S.suspend(() => S.Struct({
    StartSelectorType: StartSelectorType,
    AfterFragmentNumber: S.optional(S.String),
    StartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    ContinuationToken: S.optional(S.String),
})).annotate({ identifier: "StartSelector" });
export const GetMediaInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
    StartSelector: StartSelector,
}).pipe(T.all(T.Http({ method: "POST", uri: "/getMedia" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetMediaInput" });
export const GetMediaOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")),
    Payload: S.optional(T.StreamingOutput).pipe(T.HttpPayload()),
})).annotate({ identifier: "GetMediaOutput" });
/**
 ...
 */
export const getMedia = /*@__PURE__*/ API.make(() => ({
    input: GetMediaInput,
...
//# sourceMappingURL=kinesis-video-media.js.map