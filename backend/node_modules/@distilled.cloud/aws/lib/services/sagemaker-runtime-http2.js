    ...
    if (Region != null) {
        {
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (_.getAttr(PartitionResult, "name") === "aws" &&
                    UseFIPS === false &&
                    UseDualStack === false) {
                    return e(`https://runtime.sagemaker.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}:8443`);
                }
                if (_.getAttr(PartitionResult, "name") === "aws" &&
                    UseFIPS === false &&
                    UseDualStack === true) {
                    return e(`https://runtime.sagemaker.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}:8443`);
                }
                if (_.getAttr(PartitionResult, "name") === "aws" &&
                    UseFIPS === true &&
                    UseDualStack === false) {
                    return e(`https://runtime-fips.sagemaker.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}:8443`);
                }
                if (_.getAttr(PartitionResult, "name") === "aws" &&
                    UseFIPS === true &&
                    UseDualStack === true) {
                    return e(`https://runtime-fips.sagemaker.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}:8443`);
                }
                ...
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://runtime.sagemaker-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true && UseDualStack === false) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://runtime.sagemaker-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseFIPS === false && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://runtime.sagemaker.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class InputValidationError extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InputValidationError", {
...
export class InternalStreamFailure extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InternalStreamFailure", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class ModelError extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ModelError", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
...
export class ModelStreamError extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ModelStreamError", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    ErrorCode: S.optional(S.String),
}) {
}
export class ServiceUnavailableError extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServiceUnavailableError", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    ErrorCode: S.optional(S.String),
}, T.HttpError(503)).pipe(C.withServerError) {
}
export const RequestPayloadPart = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RequestStreamEvent = /*@__PURE__*/ T.InputEventStream(S.Union([S.Struct({ PayloadPart: RequestPayloadPart })]));
...
/*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    ModelInvocationPath: S.optional(S.String).pipe(T.HttpHeader("X-Amzn-SageMaker-Model-Invocation-Path")),
    ModelQueryString: S.optional(S.String).pipe(T.HttpHeader("X-Amzn-SageMaker-Model-Query-String")),
}).pipe(T.all(T.Http({
    method: "POST",
...
export const ResponsePayloadPart = /*@__PURE__*/ S.suspend(() => S.Struct({
    Bytes: S.optional(SensitiveBlob).pipe(T.EventPayload()),
    DataType: S.optional(S.String).pipe(T.EventHeader()),
    CompletionState: S.optional(S.String).pipe(T.EventHeader()),
    P: S.optional(S.String).pipe(T.EventHeader()),
...
export const ResponseStreamEvent = /*@__PURE__*/ T.EventStream(S.Union([
...
/*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    InvokedProductionVariant: S.optional(S.String).pipe(T.HttpHeader("X-Amzn-Invoked-Production-Variant")),
})).annotate({
 ...
 */
export const invokeEndpointWithBidirectionalStream = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=sagemaker-runtime-http2.js.map