            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://ram-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class IdempotentParameterMismatchException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IdempotentParameterMismatchException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "IdempotentParameterMismatch",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidClientTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidClientTokenException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidClientToken", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidMaxResultsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidMaxResultsException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidMaxResults", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidNextTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidNextTokenException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidNextToken", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidParameterException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidParameterException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidParameter", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidPolicyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidPolicyException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidPolicy", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidResourceTypeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidResourceTypeException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceType.Unknown",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidStateTransitionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidStateTransitionException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidStateTransitionException.Unknown",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class MalformedArnException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MalformedArnException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidArn.Malformed", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class MalformedPolicyTemplateException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MalformedPolicyTemplateException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "MalformedPolicyTemplateException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class MissingRequiredParameterException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MissingRequiredParameterException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "MissingRequiredParameter",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class OperationNotPermittedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("OperationNotPermittedException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "OperationNotPermitted", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class PermissionAlreadyExistsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PermissionAlreadyExistsException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "PermissionAlreadyExistsException",
    httpResponseCode: 409,
}), T.HttpError(409))).pipe(C.withConflictError, C.withAlreadyExistsError) {
}
export class PermissionLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PermissionLimitExceededException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "PermissionLimitExceededException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class PermissionVersionsLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PermissionVersionsLimitExceededException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "PermissionVersionsLimitExceededException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ResourceArnNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceArnNotFoundException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceArn.NotFound",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ResourceShareInvitationAlreadyAcceptedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceShareInvitationAlreadyAcceptedException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceShareInvitationArn.AlreadyAccepted",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ResourceShareInvitationAlreadyRejectedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceShareInvitationAlreadyRejectedException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceShareInvitationArn.AlreadyRejected",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ResourceShareInvitationArnNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceShareInvitationArnNotFoundException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceShareInvitationArn.NotFound",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ResourceShareInvitationExpiredException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceShareInvitationExpiredException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceShareInvitationArn.Expired",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ResourceShareLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceShareLimitExceededException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "ResourceShareLimitExceeded",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ServerInternalException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServerInternalException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InternalError", httpResponseCode: 500 }), T.HttpError(500))).pipe(C.withServerError) {
}
export class ServiceUnavailableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServiceUnavailableException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "Unavailable", httpResponseCode: 503 }), T.HttpError(503))).pipe(C.withServerError) {
}
export class TagLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TagLimitExceededException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "TagLimitExceeded", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class TagPolicyViolationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TagPolicyViolationException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "TagPolicyViolation", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ThrottlingException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ThrottlingException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "ThrottlingException", httpResponseCode: 429 }), T.HttpError(429))).pipe(C.withThrottlingError) {
}
export class UnknownResourceException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("UnknownResourceException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidResourceShareArn.NotFound",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class UnmatchedPolicyPermissionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("UnmatchedPolicyPermissionException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "UnmatchedPolicyPermissionException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export const AcceptResourceShareInvitationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareInvitationArn: S.String,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/acceptresourceshareinvitation" }), svc, auth, proto, ver, rules))).annotate({
...
export const ResourceShareAssociation = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ResourceShareAssociationList = /*@__PURE__*/ S.Array(ResourceShareAssociation.pipe(T.XmlName("item")).annotate({
    identifier: "ResourceShareAssociation",
}));
export const ResourceShareInvitation = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AcceptResourceShareInvitationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AssociateResourceShareRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
}).pipe(T.all(T.Http({ method: "POST", uri: "/associateresourceshare" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "AssociateResourceShareRequest",
});
export const AssociateResourceShareResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareAssociations: S.optional(ResourceShareAssociationList),
    clientToken: S.optional(S.String),
})).annotate({
    identifier: "AssociateResourceShareResponse",
});
export const AssociateResourceSharePermissionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.String,
    permissionArn: S.String,
    replace: S.optional(S.Boolean),
    clientToken: S.optional(S.String),
    permissionVersion: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/associateresourcesharepermission" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "AssociateResourceSharePermissionRequest",
});
export const AssociateResourceSharePermissionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreatePermissionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    resourceType: S.String,
    policyTemplate: S.String,
    clientToken: S.optional(S.String),
    tags: S.optional(TagList),
}).pipe(T.all(T.Http({ method: "POST", uri: "/createpermission" }), svc, auth, proto, ver, rules))).annotate({
...
export const ResourceSharePermissionSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreatePermissionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    permission: S.optional(ResourceSharePermissionSummary),
    clientToken: S.optional(S.String),
})).annotate({
    identifier: "CreatePermissionResponse",
});
export const CreatePermissionVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.String,
    policyTemplate: S.String,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/createpermissionversion" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreatePermissionVersionRequest",
});
export const PermissionStatus = /*@__PURE__*/ S.String;
export const ResourceSharePermissionDetail = /*@__PURE__*/ S.suspend(() => S.Struct({
    arn: S.optional(S.String),
    version: S.optional(S.String),
    defaultVersion: S.optional(S.Boolean),
    name: S.optional(S.String),
...
export const CreatePermissionVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ResourceShareConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ retainSharingOnAccountLeaveOrganization: S.optional(S.Boolean) })).annotate({
    identifier: "ResourceShareConfiguration",
});
export const CreateResourceShareRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    resourceArns: S.optional(ResourceArnList),
    principals: S.optional(PrincipalArnOrIdList),
    tags: S.optional(TagList),
...
}).pipe(T.all(T.Http({ method: "POST", uri: "/createresourceshare" }), svc, auth, proto, ver, rules))).annotate({
...
export const ResourceShare = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.optional(S.String),
    name: S.optional(S.String),
    ...
    resourceShareConfiguration: S.optional(ResourceShareConfiguration),
})).annotate({ identifier: "ResourceShare" });
export const CreateResourceShareResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShare: S.optional(ResourceShare),
    clientToken: S.optional(S.String),
})).annotate({
    identifier: "CreateResourceShareResponse",
});
export const DeletePermissionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.String.pipe(T.HttpQuery("permissionArn")),
    clientToken: S.optional(S.String).pipe(T.HttpQuery("clientToken")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/deletepermission" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeletePermissionRequest",
});
export const DeletePermissionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DeletePermissionVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.String.pipe(T.HttpQuery("permissionArn")),
    permissionVersion: S.Number.pipe(T.HttpQuery("permissionVersion")),
    clientToken: S.optional(S.String).pipe(T.HttpQuery("clientToken")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/deletepermissionversion" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeletePermissionVersionRequest",
});
export const DeletePermissionVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    returnValue: S.optional(S.Boolean).pipe(T.XmlName("return")),
    clientToken: S.optional(S.String),
    permissionStatus: S.optional(PermissionStatus),
})).annotate({
...
export const DeleteResourceShareRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.String.pipe(T.HttpQuery("resourceShareArn")),
    clientToken: S.optional(S.String).pipe(T.HttpQuery("clientToken")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/deleteresourceshare" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteResourceShareRequest",
});
export const DeleteResourceShareResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    returnValue: S.optional(S.Boolean).pipe(T.XmlName("return")),
    clientToken: S.optional(S.String),
})).annotate({
    identifier: "DeleteResourceShareResponse",
});
export const DisassociateResourceShareRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.String,
    resourceArns: S.optional(ResourceArnList),
    principals: S.optional(PrincipalArnOrIdList),
    clientToken: S.optional(S.String),
    sources: S.optional(SourceArnOrAccountList),
}).pipe(T.all(T.Http({ method: "POST", uri: "/disassociateresourceshare" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DisassociateResourceShareRequest",
});
export const DisassociateResourceShareResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareAssociations: S.optional(ResourceShareAssociationList),
    clientToken: S.optional(S.String),
})).annotate({
...
/*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    permissionArn: S.String,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/disassociateresourcesharepermission" }), svc, auth, proto, ver, rules))).annotate({
...
export const EnableSharingWithAwsOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(T.Http({ method: "POST", uri: "/enablesharingwithawsorganization" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "EnableSharingWithAwsOrganizationRequest",
});
export const EnableSharingWithAwsOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ returnValue: S.optional(S.Boolean).pipe(T.XmlName("return")) })).annotate({
    identifier: "EnableSharingWithAwsOrganizationResponse",
});
export const GetPermissionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.String,
    permissionVersion: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/getpermission" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetPermissionRequest",
});
export const GetPermissionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ permission: S.optional(ResourceSharePermissionDetail) })).annotate({
    identifier: "GetPermissionResponse",
});
export const GetResourcePoliciesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceArns: ResourceArnList,
    principal: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/getresourcepolicies" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetResourcePoliciesRequest",
});
export const PolicyList = /*@__PURE__*/ S.Array(S.String.pipe(T.XmlName("item")));
export const GetResourcePoliciesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetResourceShareAssociationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/getresourceshareassociations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetResourceShareAssociationsRequest",
});
export const GetResourceShareAssociationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareAssociations: S.optional(ResourceShareAssociationList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetResourceShareAssociationsResponse",
});
export const ResourceShareInvitationArnList = /*@__PURE__*/ S.Array(S.String.pipe(T.XmlName("item")));
export const GetResourceShareInvitationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareInvitationArns: S.optional(ResourceShareInvitationArnList),
    resourceShareArns: S.optional(ResourceShareArnList),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/getresourceshareinvitations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetResourceShareInvitationsRequest",
});
export const ResourceShareInvitationList = /*@__PURE__*/ S.Array(ResourceShareInvitation.pipe(T.XmlName("item")).annotate({
    identifier: "ResourceShareInvitation",
}));
export const GetResourceShareInvitationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const TagFilter = /*@__PURE__*/ S.suspend(() => S.Struct({
    tagKey: S.optional(S.String),
    tagValues: S.optional(TagValueList),
})).annotate({ identifier: "TagFilter" });
export const TagFilters = /*@__PURE__*/ S.Array(TagFilter);
export const GetResourceSharesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArns: S.optional(ResourceShareArnList),
    ...
    permissionVersion: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/getresourceshares" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetResourceSharesRequest",
});
export const ResourceShareList = /*@__PURE__*/ S.Array(ResourceShare.pipe(T.XmlName("item")).annotate({
    identifier: "ResourceShare",
}));
export const GetResourceSharesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListPendingInvitationResourcesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareInvitationArn: S.String,
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
    resourceRegionScope: S.optional(ResourceRegionScopeFilter),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listpendinginvitationresources" }), svc, auth, proto, ver, rules))).annotate({
...
export const Resource = /*@__PURE__*/ S.suspend(() => S.Struct({
    arn: S.optional(S.String),
...
export const ResourceList = /*@__PURE__*/ S.Array(Resource.pipe(T.XmlName("item")).annotate({ identifier: "Resource" }));
export const ListPendingInvitationResourcesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resources: S.optional(ResourceList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListPendingInvitationResourcesResponse",
});
export const ListPermissionAssociationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.optional(S.String),
    permissionVersion: S.optional(S.Number),
    associationStatus: S.optional(ResourceShareAssociationStatus),
    resourceType: S.optional(S.String),
    ...
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listpermissionassociations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListPermissionAssociationsRequest",
});
export const AssociatedPermission = /*@__PURE__*/ S.suspend(() => S.Struct({
    arn: S.optional(S.String),
...
export const AssociatedPermissionList = /*@__PURE__*/ S.Array(AssociatedPermission.pipe(T.XmlName("item")).annotate({
    identifier: "AssociatedPermission",
}));
export const ListPermissionAssociationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListPermissionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceType: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
    permissionType: S.optional(PermissionTypeFilter),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listpermissions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListPermissionsRequest",
});
export const ResourceSharePermissionList = /*@__PURE__*/ S.Array(ResourceSharePermissionSummary.pipe(T.XmlName("item")).annotate({
    identifier: "ResourceSharePermissionSummary",
}));
export const ListPermissionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissions: S.optional(ResourceSharePermissionList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListPermissionsResponse",
});
export const ListPermissionVersionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.String,
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listpermissionversions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListPermissionVersionsRequest",
});
export const ListPermissionVersionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissions: S.optional(ResourceSharePermissionList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListPermissionVersionsResponse",
});
export const ListPrincipalsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceOwner: ResourceOwner,
    resourceArn: S.optional(S.String),
    principals: S.optional(PrincipalArnOrIdList),
    resourceType: S.optional(S.String),
    ...
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listprincipals" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListPrincipalsRequest",
});
export const Principal = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const PrincipalList = /*@__PURE__*/ S.Array(Principal.pipe(T.XmlName("item")).annotate({ identifier: "Principal" }));
export const ListPrincipalsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    principals: S.optional(PrincipalList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListPrincipalsResponse",
});
export const ReplacePermissionAssociationsWorkIdList = /*@__PURE__*/ S.Array(S.String.pipe(T.XmlName("item")));
...
export const ReplacePermissionAssociationsWork = /*@__PURE__*/ S.suspend(() => S.Struct({
    id: S.optional(S.String),
...
export const ReplacePermissionAssociationsWorkList = /*@__PURE__*/ S.Array(ReplacePermissionAssociationsWork.pipe(T.XmlName("item")).annotate({
    identifier: "ReplacePermissionAssociationsWork",
}));
...
export const ListResourcesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceOwner: ResourceOwner,
    principal: S.optional(S.String),
    resourceType: S.optional(S.String),
    resourceArns: S.optional(ResourceArnList),
    ...
    maxResults: S.optional(S.Number),
    resourceRegionScope: S.optional(ResourceRegionScopeFilter),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listresources" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListResourcesRequest",
});
export const ListResourcesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resources: S.optional(ResourceList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListResourcesResponse",
});
export const ListResourceSharePermissionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.String,
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listresourcesharepermissions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListResourceSharePermissionsRequest",
});
export const ListResourceSharePermissionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissions: S.optional(ResourceSharePermissionList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListResourceSharePermissionsResponse",
});
export const ListResourceTypesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
    resourceRegionScope: S.optional(ResourceRegionScopeFilter),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listresourcetypes" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListResourceTypesRequest",
});
export const ServiceNameAndResourceType = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceType: S.optional(S.String),
...
export const ServiceNameAndResourceTypeList = /*@__PURE__*/ S.Array(ServiceNameAndResourceType.pipe(T.XmlName("item")).annotate({
    identifier: "ServiceNameAndResourceType",
}));
export const ListResourceTypesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceTypes: S.optional(ServiceNameAndResourceTypeList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListResourceTypesResponse",
});
export const ListSourceAssociationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArns: S.optional(ResourceShareArnList),
    ...
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listsourceassociations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListSourceAssociationsRequest",
});
export const AssociatedSource = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.optional(S.String),
    sourceId: S.optional(S.String),
    sourceType: S.optional(S.String),
    status: S.optional(S.String),
...
export const AssociatedSourceList = /*@__PURE__*/ S.Array(AssociatedSource.pipe(T.XmlName("item")).annotate({
    identifier: "AssociatedSource",
}));
export const ListSourceAssociationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
/*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    name: S.String,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/promotepermissioncreatedfrompolicy" }), svc, auth, proto, ver, rules))).annotate({
...
/*@__PURE__*/ S.suspend(() => S.Struct({ returnValue: S.optional(S.Boolean).pipe(T.XmlName("return")) })).annotate({
    identifier: "PromoteResourceShareCreatedFromPolicyResponse",
});
export const RejectResourceShareInvitationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareInvitationArn: S.String,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/rejectresourceshareinvitation" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RejectResourceShareInvitationRequest",
});
export const RejectResourceShareInvitationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareInvitation: S.optional(ResourceShareInvitation),
    clientToken: S.optional(S.String),
})).annotate({
    identifier: "RejectResourceShareInvitationResponse",
});
export const ReplacePermissionAssociationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    fromPermissionArn: S.String,
    fromPermissionVersion: S.optional(S.Number),
    toPermissionArn: S.String,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/replacepermissionassociations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ReplacePermissionAssociationsRequest",
});
export const ReplacePermissionAssociationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SetDefaultPermissionVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    permissionArn: S.String,
    permissionVersion: S.Number,
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/setdefaultpermissionversion" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "SetDefaultPermissionVersionRequest",
});
export const SetDefaultPermissionVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    returnValue: S.optional(S.Boolean).pipe(T.XmlName("return")),
    clientToken: S.optional(S.String),
})).annotate({
...
export const TagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    tags: TagList,
    resourceArn: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/tagresource" }), svc, auth, proto, ver, rules))).annotate({
...
export const UntagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    tagKeys: TagKeyList,
    resourceArn: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/untagresource" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UntagResourceRequest",
});
export const UntagResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "UntagResourceResponse",
});
export const UpdateResourceShareRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShareArn: S.String,
    name: S.optional(S.String),
    allowExternalPrincipals: S.optional(S.Boolean),
    clientToken: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/updateresourceshare" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateResourceShareRequest",
});
export const UpdateResourceShareResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    resourceShare: S.optional(ResourceShare),
    clientToken: S.optional(S.String),
})).annotate({
 ...
 */
export const acceptResourceShareInvitation = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const associateResourceShare = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const associateResourceSharePermission = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createPermission = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createPermissionVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createResourceShare = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deletePermission = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deletePermissionVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteResourceShare = /*@__PURE__*/ API.make(() => ({
 ...
 * resource share.
 */
export const disassociateResourceShare = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const disassociateResourceSharePermission = /*@__PURE__*/ API.make(() => ({
 ...
 * management account.
 */
export const enableSharingWithAwsOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getPermission = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getResourcePolicies = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const getResourceShareAssociations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const getResourceShareInvitations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const getResourceShares = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listPendingInvitationResources = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listPermissionAssociations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listPermissions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listPermissionVersions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listPrincipals = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listReplacePermissionAssociationsWork = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listResources = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * when there are no more results to display.
 */
export const listResourceSharePermissions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listResourceTypes = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listSourceAssociations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * it.
 */
export const promotePermissionCreatedFromPolicy = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const promoteResourceShareCreatedFromPolicy = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const rejectResourceShareInvitation = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const replacePermissionAssociations = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const setDefaultPermissionVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateResourceShare = /*@__PURE__*/ API.make(() => ({
