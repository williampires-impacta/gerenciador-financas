            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://mturk-requester-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://mturk-requester-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://mturk-requester.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class RequestError extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("RequestError", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    TurkErrorCode: S.optional(S.String),
}, T.all(T.AwsQueryError({ code: "RequestError", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ServiceFault extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServiceFault", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    TurkErrorCode: S.optional(S.String),
}, T.all(T.AwsQueryError({ code: "ServiceFault", httpResponseCode: 500 }), T.HttpError(500))).pipe(C.withServerError) {
}
export const AcceptQualificationRequestRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AcceptQualificationRequestResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "AcceptQualificationRequestResponse",
});
export const ApproveAssignmentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ApproveAssignmentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "ApproveAssignmentResponse",
});
export const AssociateQualificationWithWorkerRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AssociateQualificationWithWorkerResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "AssociateQualificationWithWorkerResponse",
});
export const CreateAdditionalAssignmentsForHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITId: S.String,
...
export const Locale = /*@__PURE__*/ S.suspend(() => S.Struct({ Country: S.String, Subdivision: S.optional(S.String) })).annotate({ identifier: "Locale" });
export const LocaleList = /*@__PURE__*/ S.Array(Locale);
export const HITAccessActions = /*@__PURE__*/ S.String;
export const QualificationRequirement = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationTypeId: S.String,
...
export const ParameterMapEntry = /*@__PURE__*/ S.suspend(() => S.Struct({ Key: S.optional(S.String), Values: S.optional(StringList) })).annotate({
    identifier: "ParameterMapEntry",
});
export const ParameterMapEntryList = /*@__PURE__*/ S.Array(ParameterMapEntry);
export const PolicyParameter = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReviewPolicy = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicyName: S.String,
    Parameters: S.optional(PolicyParameterList),
})).annotate({ identifier: "ReviewPolicy" });
export const HITLayoutParameter = /*@__PURE__*/ S.suspend(() => S.Struct({ Name: S.String, Value: S.String })).annotate({
    identifier: "HITLayoutParameter",
});
export const HITLayoutParameterList = /*@__PURE__*/ S.Array(HITLayoutParameter);
export const CreateHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const HIT = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "HIT" });
export const CreateHITResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ HIT: S.optional(HIT) }).pipe(ns)).annotate({
    identifier: "CreateHITResponse",
});
export const CreateHITTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    AutoApprovalDelayInSeconds: S.optional(S.Number),
    AssignmentDurationInSeconds: S.Number,
    Reward: S.String,
    Title: S.String,
...
export const CreateHITTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ HITTypeId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "CreateHITTypeResponse",
});
export const CreateHITWithHITTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITTypeId: S.String,
    MaxAssignments: S.optional(S.Number),
    LifetimeInSeconds: S.Number,
    Question: S.optional(S.String),
...
export const CreateHITWithHITTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ HIT: S.optional(HIT) }).pipe(ns)).annotate({
    identifier: "CreateHITWithHITTypeResponse",
});
export const QualificationTypeStatus = /*@__PURE__*/ S.String;
export const CreateQualificationTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Name: S.String,
    Keywords: S.optional(S.String),
    Description: S.String,
...
export const QualificationType = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateQualificationTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ QualificationType: S.optional(QualificationType) }).pipe(ns)).annotate({
    identifier: "CreateQualificationTypeResponse",
});
export const CreateWorkerBlockRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ WorkerId: S.String, Reason: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateWorkerBlockRequest",
});
export const CreateWorkerBlockResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "CreateWorkerBlockResponse",
});
export const DeleteHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HITId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteQualificationTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ QualificationTypeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteQualificationTypeRequest",
});
export const DeleteQualificationTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeleteQualificationTypeResponse",
});
export const DeleteWorkerBlockRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ WorkerId: S.String, Reason: S.optional(S.String) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteWorkerBlockRequest",
});
export const DeleteWorkerBlockResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
...
export const GetAccountBalanceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetAccountBalanceRequest",
});
export const GetAccountBalanceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    AvailableBalance: S.optional(S.String),
    OnHoldBalance: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "GetAccountBalanceResponse",
});
export const GetAssignmentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AssignmentId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetAssignmentRequest",
});
export const AssignmentStatus = /*@__PURE__*/ S.String;
export const Assignment = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetAssignmentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Assignment: S.optional(Assignment), HIT: S.optional(HIT) }).pipe(ns)).annotate({
    identifier: "GetAssignmentResponse",
});
export const GetFileUploadURLRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AssignmentId: S.String, QuestionIdentifier: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetFileUploadURLRequest",
});
export const GetFileUploadURLResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ FileUploadURL: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "GetFileUploadURLResponse",
});
export const GetHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HITId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetHITRequest" });
export const GetHITResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ HIT: S.optional(HIT) }).pipe(ns)).annotate({ identifier: "GetHITResponse" });
export const GetQualificationScoreRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ QualificationTypeId: S.String, WorkerId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetQualificationScoreRequest",
});
export const QualificationStatus = /*@__PURE__*/ S.String;
export const Qualification = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationTypeId: S.optional(S.String),
    WorkerId: S.optional(S.String),
...
})).annotate({ identifier: "Qualification" });
export const GetQualificationScoreResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Qualification: S.optional(Qualification) }).pipe(ns)).annotate({
    identifier: "GetQualificationScoreResponse",
});
export const GetQualificationTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ QualificationTypeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetQualificationTypeRequest",
});
export const GetQualificationTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ QualificationType: S.optional(QualificationType) }).pipe(ns)).annotate({
    identifier: "GetQualificationTypeResponse",
});
export const AssignmentStatusList = /*@__PURE__*/ S.Array(AssignmentStatus);
export const ListAssignmentsForHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITId: S.String,
...
export const ListAssignmentsForHITResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
...
export const ListBonusPaymentsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITId: S.optional(S.String),
    AssignmentId: S.optional(S.String),
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
...
export const BonusPayment = /*@__PURE__*/ S.suspend(() => S.Struct({
    WorkerId: S.optional(S.String),
    BonusAmount: S.optional(S.String),
    AssignmentId: S.optional(S.String),
    Reason: S.optional(S.String),
    GrantTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({ identifier: "BonusPayment" });
export const BonusPaymentList = /*@__PURE__*/ S.Array(BonusPayment);
export const ListBonusPaymentsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NumResults: S.optional(S.Number),
    NextToken: S.optional(S.String),
...
export const ListHITsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListHITsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    NumResults: S.optional(S.Number),
...
export const ListHITsForQualificationTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationTypeId: S.String,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListHITsForQualificationTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    NumResults: S.optional(S.Number),
    HITs: S.optional(HITList),
}).pipe(ns)).annotate({
...
export const ListQualificationRequestsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationTypeId: S.optional(S.String),
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const QualificationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListQualificationRequestsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NumResults: S.optional(S.Number),
    NextToken: S.optional(S.String),
...
export const ListQualificationTypesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListQualificationTypesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NumResults: S.optional(S.Number),
    NextToken: S.optional(S.String),
...
export const ListReviewableHITsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITTypeId: S.optional(S.String),
...
export const ListReviewableHITsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    NumResults: S.optional(S.Number),
    HITs: S.optional(HITList),
}).pipe(ns)).annotate({
...
export const ListReviewPolicyResultsForHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITId: S.String,
...
export const ReviewResultDetail = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReviewActionDetail = /*@__PURE__*/ S.suspend(() => S.Struct({
    ActionId: S.optional(S.String),
...
export const ReviewReport = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListReviewPolicyResultsForHITResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITId: S.optional(S.String),
    AssignmentReviewPolicy: S.optional(ReviewPolicy),
    HITReviewPolicy: S.optional(ReviewPolicy),
...
export const ListWorkerBlocksRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListWorkerBlocksRequest",
});
export const WorkerBlock = /*@__PURE__*/ S.suspend(() => S.Struct({ WorkerId: S.optional(S.String), Reason: S.optional(S.String) })).annotate({ identifier: "WorkerBlock" });
export const WorkerBlockList = /*@__PURE__*/ S.Array(WorkerBlock);
export const ListWorkerBlocksResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    NumResults: S.optional(S.Number),
...
export const ListWorkersWithQualificationTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationTypeId: S.String,
    Status: S.optional(QualificationStatus),
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
...
export const ListWorkersWithQualificationTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    NumResults: S.optional(S.Number),
...
export const NotifyWorkersRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Subject: S.String,
...
export const NotifyWorkersFailureStatus = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const NotifyWorkersResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    NotifyWorkersFailureStatuses: S.optional(NotifyWorkersFailureStatusList),
}).pipe(ns)).annotate({
    identifier: "NotifyWorkersResponse",
});
export const RejectAssignmentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AssignmentId: S.String, RequesterFeedback: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RejectAssignmentRequest",
});
export const RejectAssignmentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "RejectAssignmentResponse",
});
export const RejectQualificationRequestRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationRequestId: S.String,
    Reason: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RejectQualificationRequestRequest",
});
export const RejectQualificationRequestResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "RejectQualificationRequestResponse",
});
export const SendBonusRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    WorkerId: S.String,
...
export const NotificationSpecification = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SendTestEventNotificationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Notification: NotificationSpecification,
    TestEventType: EventType,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "SendTestEventNotificationRequest",
});
export const SendTestEventNotificationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "SendTestEventNotificationResponse",
});
export const UpdateExpirationForHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITId: S.String,
    ExpireAt: S.Date.pipe(T.TimestampFormat("epoch-seconds")),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateExpirationForHITRequest",
});
export const UpdateExpirationForHITResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdateExpirationForHITResponse",
});
export const UpdateHITReviewStatusRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HITId: S.String, Revert: S.optional(S.Boolean) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateHITReviewStatusRequest",
});
export const UpdateHITReviewStatusResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdateHITReviewStatusResponse",
});
export const UpdateHITTypeOfHITRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HITId: S.String, HITTypeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateHITTypeOfHITRequest",
});
export const UpdateHITTypeOfHITResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdateHITTypeOfHITResponse",
});
export const UpdateNotificationSettingsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    HITTypeId: S.String,
...
export const UpdateNotificationSettingsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdateNotificationSettingsResponse",
});
export const UpdateQualificationTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    QualificationTypeId: S.String,
    Description: S.optional(S.String),
    QualificationTypeStatus: S.optional(QualificationTypeStatus),
    Test: S.optional(S.String),
...
export const UpdateQualificationTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ QualificationType: S.optional(QualificationType) }).pipe(ns)).annotate({
 ...
 */
export const acceptQualificationRequest = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const approveAssignment = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const associateQualificationWithWorker = /*@__PURE__*/ API.make(() => ({
 ...
 * exception.
 */
export const createAdditionalAssignmentsForHIT = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createHIT = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createHITType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createHITWithHITType = /*@__PURE__*/ API.make(() => ({
 ...
 * data structure.
 */
export const createQualificationType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createWorkerBlock = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteHIT = /*@__PURE__*/ API.make(() => ({
 ...
 * CreateQualificationType.
 */
export const deleteQualificationType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteWorkerBlock = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const disassociateQualificationFromWorker = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getAccountBalance = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getAssignment = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getFileUploadURL = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getHIT = /*@__PURE__*/ API.make(() => ({
    input: GetHITRequest,
 ...
 */
export const getQualificationScore = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getQualificationType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listAssignmentsForHIT = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listBonusPayments = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listHITs = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listHITsForQualificationType = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listQualificationRequests = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listQualificationTypes = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listReviewableHITs = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listReviewPolicyResultsForHIT = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listWorkerBlocks = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listWorkersWithQualificationType = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * Worker.
 */
export const notifyWorkers = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const rejectAssignment = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const rejectQualificationRequest = /*@__PURE__*/ API.make(() => ({
 ...
 * and the fees.
 */
export const sendBonus = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const sendTestEventNotification = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateExpirationForHIT = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateHITReviewStatus = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateHITTypeOfHIT = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateNotificationSettings = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateQualificationType = /*@__PURE__*/ API.make(() => ({
