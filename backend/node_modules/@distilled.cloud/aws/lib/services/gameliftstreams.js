    ...
    if (Region != null) {
        {
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true) {
                    return e(`https://gameliftstreams-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                }
                return e(`https://gameliftstreams.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
            }
        }
    }
...
export class ConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConflictException", { message: S.String.pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
...
export class ValidationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ValidationException", { message: S.String.pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export const Ipv4CidrBlockList = /*@__PURE__*/ S.Array(S.String);
export const VpcTransitConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ VpcId: S.String, Ipv4CidrBlocks: Ipv4CidrBlockList })).annotate({
    identifier: "VpcTransitConfiguration",
});
export const LocationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AddStreamGroupLocationsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    LocationConfigurations: LocationConfigurations,
}).pipe(T.all(T.Http({ method: "POST", uri: "/streamgroups/{Identifier}/locations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "AddStreamGroupLocationsInput",
});
export const StreamGroupLocationStatus = /*@__PURE__*/ S.String;
export const VpcTransitConfigurationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AddStreamGroupLocationsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Identifier: S.String, Locations: LocationStates })).annotate({
    identifier: "AddStreamGroupLocationsOutput",
});
export const Identifiers = /*@__PURE__*/ S.Array(S.String);
export const AssociateApplicationsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
...
export const AssociateApplicationsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Arn: S.optional(S.String), ApplicationArns: S.optional(ArnList) })).annotate({
    identifier: "AssociateApplicationsOutput",
});
export const RuntimeEnvironmentType = /*@__PURE__*/ S.String;
export const RuntimeEnvironment = /*@__PURE__*/ S.suspend(() => S.Struct({ Type: RuntimeEnvironmentType, Version: S.String })).annotate({
    identifier: "RuntimeEnvironment",
});
export const FilePaths = /*@__PURE__*/ S.Array(S.String);
export const Tags = /*@__PURE__*/ S.Record(S.String, S.String.pipe(S.optional));
export const CreateApplicationInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
}).pipe(T.all(T.Http({ method: "POST", uri: "/applications" }), svc, auth, proto, ver, rules))).annotate({
...
export const ReplicationStatus = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateApplicationOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
...
export const CreateStreamGroupInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Description: S.String,
    ...
    Tags: S.optional(Tags),
    ClientToken: S.optional(S.String).pipe(T.IdempotencyToken()),
}).pipe(T.all(T.Http({ method: "POST", uri: "/streamgroups" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateStreamGroupInput",
});
export const DefaultApplication = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.optional(S.String), Arn: S.optional(S.String) })).annotate({
...
export const CreateStreamGroupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Description: S.optional(S.String),
...
export const CreateStreamSessionConnectionInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ClientToken: S.optional(S.String).pipe(T.IdempotencyToken()),
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
...
export const CreateStreamSessionConnectionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ SignalResponse: S.optional(SensitiveString) })).annotate({
    identifier: "CreateStreamSessionConnectionOutput",
});
export const DeleteApplicationInput = /*@__PURE__*/ S.suspend(() => S.Struct({ Identifier: S.String.pipe(T.HttpLabel("Identifier")) }).pipe(T.all(T.Http({ method: "DELETE", uri: "/applications/{Identifier}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteApplicationInput",
});
export const DeleteApplicationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "DeleteApplicationResponse",
});
export const DeleteStreamGroupInput = /*@__PURE__*/ S.suspend(() => S.Struct({ Identifier: S.String.pipe(T.HttpLabel("Identifier")) }).pipe(T.all(T.Http({ method: "DELETE", uri: "/streamgroups/{Identifier}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DisassociateApplicationsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    ApplicationIdentifiers: Identifiers,
}).pipe(T.all(T.Http({
    method: "POST",
...
export const DisassociateApplicationsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Arn: S.optional(S.String), ApplicationArns: S.optional(ArnList) })).annotate({
    identifier: "DisassociateApplicationsOutput",
});
export const ExportStreamSessionFilesInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    StreamSessionIdentifier: S.String.pipe(T.HttpLabel("StreamSessionIdentifier")),
    OutputUri: S.String,
}).pipe(T.all(T.Http({
...
export const GetApplicationInput = /*@__PURE__*/ S.suspend(() => S.Struct({ Identifier: S.String.pipe(T.HttpLabel("Identifier")) }).pipe(T.all(T.Http({ method: "GET", uri: "/applications/{Identifier}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetApplicationInput",
});
export const GetApplicationOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Description: S.optional(S.String),
    RuntimeEnvironment: S.optional(RuntimeEnvironment),
    ExecutablePath: S.optional(S.String),
...
export const GetStreamGroupInput = /*@__PURE__*/ S.suspend(() => S.Struct({ Identifier: S.String.pipe(T.HttpLabel("Identifier")) }).pipe(T.all(T.Http({ method: "GET", uri: "/streamgroups/{Identifier}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetStreamGroupInput",
});
export const GetStreamGroupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Description: S.optional(S.String),
    DefaultApplication: S.optional(DefaultApplication),
    LocationStates: S.optional(LocationStates),
...
export const GetStreamSessionInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    StreamSessionIdentifier: S.String.pipe(T.HttpLabel("StreamSessionIdentifier")),
}).pipe(T.all(T.Http({
    method: "GET",
...
export const PerformanceStatsConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ SharedWithClient: S.optional(S.Boolean) })).annotate({
    identifier: "PerformanceStatsConfiguration",
});
export const ExportFilesStatus = /*@__PURE__*/ S.String;
export const ExportFilesMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetStreamSessionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListApplicationsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String).pipe(T.HttpQuery("NextToken")),
    MaxResults: S.optional(S.Number).pipe(T.HttpQuery("MaxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/applications" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListApplicationsInput",
});
export const ApplicationSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Id: S.optional(S.String),
    Description: S.optional(S.String),
    Status: S.optional(ApplicationStatus),
...
export const ListApplicationsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Items: S.optional(ApplicationSummaryList),
    NextToken: S.optional(S.String),
})).annotate({
    identifier: "ListApplicationsOutput",
});
export const ListStreamGroupsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String).pipe(T.HttpQuery("NextToken")),
    MaxResults: S.optional(S.Number).pipe(T.HttpQuery("MaxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/streamgroups" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListStreamGroupsInput",
});
export const StreamGroupSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Id: S.optional(S.String),
    Description: S.optional(S.String),
    DefaultApplication: S.optional(DefaultApplication),
...
export const ListStreamGroupsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Items: S.optional(StreamGroupSummaryList),
    NextToken: S.optional(S.String),
})).annotate({
    identifier: "ListStreamGroupsOutput",
});
export const ListStreamSessionsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const StreamSessionSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.optional(S.String),
    UserId: S.optional(S.String),
    Status: S.optional(StreamSessionStatus),
    StatusReason: S.optional(StreamSessionStatusReason),
...
export const ListStreamSessionsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Items: S.optional(StreamSessionSummaryList),
    NextToken: S.optional(S.String),
})).annotate({
    identifier: "ListStreamSessionsOutput",
});
export const ListStreamSessionsByAccountInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Status: S.optional(StreamSessionStatus).pipe(T.HttpQuery("Status")),
    ExportFilesStatus: S.optional(ExportFilesStatus).pipe(T.HttpQuery("ExportFilesStatus")),
    NextToken: S.optional(S.String).pipe(T.HttpQuery("NextToken")),
    MaxResults: S.optional(S.Number).pipe(T.HttpQuery("MaxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/streamsessions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListStreamSessionsByAccountInput",
});
export const ListStreamSessionsByAccountOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Items: S.optional(StreamSessionSummaryList),
    NextToken: S.optional(S.String),
})).annotate({
...
export const RemoveStreamGroupLocationsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    Locations: LocationsList.pipe(T.HttpQuery("locations")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/streamgroups/{Identifier}/locations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RemoveStreamGroupLocationsInput",
});
export const RemoveStreamGroupLocationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "RemoveStreamGroupLocationsResponse",
});
export const LocationList = /*@__PURE__*/ S.Array(S.String);
export const StartStreamSessionInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ClientToken: S.optional(S.String).pipe(T.IdempotencyToken()),
    Description: S.optional(S.String),
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    Protocol: Protocol,
...
export const StartStreamSessionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.optional(S.String),
    Description: S.optional(S.String),
    StreamGroupId: S.optional(S.String),
    UserId: S.optional(S.String),
...
export const TerminateStreamSessionInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    StreamSessionIdentifier: S.String.pipe(T.HttpLabel("StreamSessionIdentifier")),
}).pipe(T.all(T.Http({
    method: "DELETE",
...
export const UpdateApplicationInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    Description: S.optional(S.String),
    ApplicationLogPaths: S.optional(FilePaths),
    ApplicationLogOutputUri: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "PATCH", uri: "/applications/{Identifier}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateApplicationInput",
});
export const UpdateApplicationOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Description: S.optional(S.String),
    RuntimeEnvironment: S.optional(RuntimeEnvironment),
    ExecutablePath: S.optional(S.String),
...
export const UpdateStreamGroupInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    LocationConfigurations: S.optional(LocationConfigurations),
    Description: S.optional(S.String),
    DefaultApplicationIdentifier: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "PATCH", uri: "/streamgroups/{Identifier}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateStreamGroupInput",
});
export const UpdateStreamGroupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    Description: S.optional(S.String),
    DefaultApplication: S.optional(DefaultApplication),
    LocationStates: S.optional(LocationStates),
 ...
 */
export const addStreamGroupLocations = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const associateApplications = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createApplication = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createStreamGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createStreamSessionConnection = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteApplication = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteStreamGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const disassociateApplications = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const exportStreamSessionFiles = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getApplication = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getStreamGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getStreamSession = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listApplications = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listStreamGroups = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listStreamSessions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listStreamSessionsByAccount = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const removeStreamGroupLocations = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const startStreamSession = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const terminateStreamSession = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateApplication = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateStreamGroup = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=gameliftstreams.js.map