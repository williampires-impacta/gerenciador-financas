...
import { SensitiveString, SensitiveBlob } from "../sensitive.js";
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://kms-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class AlreadyExistsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AlreadyExistsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "AlreadyExists", httpResponseCode: 409 }), T.HttpError(409))).pipe(C.withConflictError, C.withAlreadyExistsError) {
}
export class CloudHsmClusterInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CloudHsmClusterInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CloudHsmClusterInUseException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CloudHsmClusterInvalidConfigurationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CloudHsmClusterInvalidConfigurationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CloudHsmClusterInvalidConfigurationException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CloudHsmClusterNotActiveException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CloudHsmClusterNotActiveException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CloudHsmClusterNotActiveException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CloudHsmClusterNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CloudHsmClusterNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CloudHsmClusterNotFoundException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CloudHsmClusterNotRelatedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CloudHsmClusterNotRelatedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CloudHsmClusterNotRelatedException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "ConflictException", httpResponseCode: 409 }), T.HttpError(409))).pipe(C.withConflictError) {
}
export class CustomKeyStoreHasCMKsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CustomKeyStoreHasCMKsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CustomKeyStoreHasCMKsException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CustomKeyStoreInvalidStateException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CustomKeyStoreInvalidStateException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CustomKeyStoreInvalidStateException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CustomKeyStoreNameInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CustomKeyStoreNameInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CustomKeyStoreNameInUseException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class CustomKeyStoreNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CustomKeyStoreNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "CustomKeyStoreNotFoundException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class DependencyTimeoutException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DependencyTimeoutException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "DependencyTimeout", httpResponseCode: 503 }), T.HttpError(503))).pipe(C.withServerError) {
}
export class DisabledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DisabledException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "Disabled", httpResponseCode: 409 }), T.HttpError(409))).pipe(C.withConflictError) {
}
export class DryRunOperationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DryRunOperationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "DryRunOperation", httpResponseCode: 412 }), T.HttpError(412))) {
}
export class ExpiredImportTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ExpiredImportTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "ExpiredImportTokenException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class IncorrectKeyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IncorrectKeyException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "IncorrectKeyException", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class IncorrectKeyMaterialException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IncorrectKeyMaterialException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "IncorrectKeyMaterialException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class IncorrectTrustAnchorException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IncorrectTrustAnchorException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "IncorrectTrustAnchorException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidAliasNameException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidAliasNameException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidAliasName", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidArnException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidArnException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidArn", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidCiphertextException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidCiphertextException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidCiphertext", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidGrantIdException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidGrantIdException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidGrantId", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidGrantTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidGrantTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidGrantToken", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidImportTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidImportTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidImportTokenException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidKeyUsageException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidKeyUsageException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidKeyUsage", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidMarkerException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidMarkerException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidMarker", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class KeyUnavailableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("KeyUnavailableException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "KeyUnavailable", httpResponseCode: 500 }), T.HttpError(500))).pipe(C.withServerError) {
}
export class KMSInternalException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("KMSInternalException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "KMSInternal", httpResponseCode: 500 }), T.HttpError(500))).pipe(C.withServerError) {
}
export class KMSInvalidMacException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("KMSInvalidMacException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "KMSInvalidMac", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class KMSInvalidSignatureException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("KMSInvalidSignatureException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "KMSInvalidSignature", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class KMSInvalidStateException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("KMSInvalidStateException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "KMSInvalidStateException",
    httpResponseCode: 409,
}), T.HttpError(409))).pipe(C.withConflictError) {
}
export class LimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("LimitExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "LimitExceeded", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class MalformedPolicyDocumentException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MalformedPolicyDocumentException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "MalformedPolicyDocument",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class NotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("NotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "NotFound", httpResponseCode: 404 }), T.HttpError(404))).pipe(C.withBadRequestError) {
}
export class TagException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TagException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "TagException", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class UnsupportedOperationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("UnsupportedOperationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "UnsupportedOperation", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksKeyAlreadyInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksKeyAlreadyInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "XksKeyAlreadyInUse", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksKeyInvalidConfigurationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksKeyInvalidConfigurationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksKeyInvalidConfiguration",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksKeyNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksKeyNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksKeyNotFoundException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyIncorrectAuthenticationCredentialException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyIncorrectAuthenticationCredentialException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyIncorrectAuthenticationCredentialException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyInvalidConfigurationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyInvalidConfigurationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyInvalidConfigurationException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyInvalidResponseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyInvalidResponseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyInvalidResponseException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyUriEndpointInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyUriEndpointInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyUriEndpointInUseException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyUriInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyUriInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyUriInUseException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyUriUnreachableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyUriUnreachableException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyUriUnreachableException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyVpcEndpointServiceInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyVpcEndpointServiceInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyVpcEndpointServiceInUseException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyVpcEndpointServiceInvalidConfigurationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyVpcEndpointServiceInvalidConfigurationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyVpcEndpointServiceInvalidConfigurationException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class XksProxyVpcEndpointServiceNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("XksProxyVpcEndpointServiceNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "XksProxyVpcEndpointServiceNotFoundException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export const CancelKeyDeletionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CancelKeyDeletionRequest",
});
export const CancelKeyDeletionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "CancelKeyDeletionResponse",
});
export const ConnectCustomKeyStoreRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ CustomKeyStoreId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ConnectCustomKeyStoreRequest",
});
export const ConnectCustomKeyStoreResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "ConnectCustomKeyStoreResponse",
});
export const CreateAliasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AliasName: S.String, TargetKeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const XksProxyAuthenticationCredentialType = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateCustomKeyStoreRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateCustomKeyStoreResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ CustomKeyStoreId: S.optional(S.String) }).pipe(ns)).annotate({
...
export const GrantConstraints = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateGrantRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
...
export const CreateGrantResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Tag = /*@__PURE__*/ S.suspend(() => S.Struct({ TagKey: S.String, TagValue: S.String })).annotate({ identifier: "Tag" });
...
export const MultiRegionKey = /*@__PURE__*/ S.suspend(() => S.Struct({ Arn: S.optional(S.String), Region: S.optional(S.String) })).annotate({ identifier: "MultiRegionKey" });
export const MultiRegionKeyList = /*@__PURE__*/ S.Array(MultiRegionKey);
export const MultiRegionConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const XksKeyConfigurationType = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.optional(S.String) })).annotate({
    identifier: "XksKeyConfigurationType",
});
export const KeyMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
...
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "DecryptRequest" });
export const DecryptResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
...
export const DeleteAliasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AliasName: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteCustomKeyStoreRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ CustomKeyStoreId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteCustomKeyStoreRequest",
});
export const DeleteCustomKeyStoreResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeleteCustomKeyStoreResponse",
});
export const DeleteImportedKeyMaterialRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, KeyMaterialId: S.optional(S.String) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteImportedKeyMaterialRequest",
});
export const DeleteImportedKeyMaterialResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    KeyMaterialId: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "DeleteImportedKeyMaterialResponse",
});
export const DeriveSharedSecretRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
...
export const DeriveSharedSecretResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
...
export const DescribeCustomKeyStoresRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    CustomKeyStoreId: S.optional(S.String),
...
export const XksProxyConfigurationType = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CustomKeyStoresListEntry = /*@__PURE__*/ S.suspend(() => S.Struct({
    CustomKeyStoreId: S.optional(S.String),
    CustomKeyStoreName: S.optional(S.String),
    CloudHsmClusterId: S.optional(S.String),
    TrustAnchorCertificate: S.optional(S.String),
...
export const DescribeCustomKeyStoresResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeKeyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, GrantTokens: S.optional(GrantTokenList) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeKeyRequest",
});
export const DescribeKeyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyMetadata: S.optional(KeyMetadata) }).pipe(ns)).annotate({
    identifier: "DescribeKeyResponse",
});
export const DisableKeyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DisableKeyRotationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DisableKeyRotationRequest",
});
export const DisableKeyRotationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DisableKeyRotationResponse",
});
export const DisconnectCustomKeyStoreRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ CustomKeyStoreId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DisconnectCustomKeyStoreRequest",
});
export const DisconnectCustomKeyStoreResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DisconnectCustomKeyStoreResponse",
});
export const EnableKeyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const EnableKeyRotationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    RotationPeriodInDays: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "EnableKeyRotationRequest",
});
export const EnableKeyRotationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "EnableKeyRotationResponse",
});
export const EncryptRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    ...
    EncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec),
    DryRun: S.optional(S.Boolean),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "EncryptRequest" });
export const EncryptResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    CiphertextBlob: S.optional(T.Blob),
    KeyId: S.optional(S.String),
    EncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec),
}).pipe(ns)).annotate({
...
export const GenerateDataKeyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    EncryptionContext: S.optional(EncryptionContextType),
...
export const GenerateDataKeyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    CiphertextBlob: S.optional(T.Blob),
    Plaintext: S.optional(SensitiveBlob),
    KeyId: S.optional(S.String),
    CiphertextForRecipient: S.optional(T.Blob),
...
export const GenerateDataKeyPairRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    EncryptionContext: S.optional(EncryptionContextType),
    KeyId: S.String,
...
export const GenerateDataKeyPairResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GenerateDataKeyWithoutPlaintextRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    EncryptionContext: S.optional(EncryptionContextType),
    KeySpec: S.optional(DataKeySpec),
    NumberOfBytes: S.optional(S.Number),
...
export const GenerateDataKeyWithoutPlaintextResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    CiphertextBlob: S.optional(T.Blob),
    KeyId: S.optional(S.String),
    KeyMaterialId: S.optional(S.String),
}).pipe(ns)).annotate({
...
export const GenerateMacRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GenerateMacResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GenerateRandomRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    NumberOfBytes: S.optional(S.Number),
    CustomKeyStoreId: S.optional(S.String),
    Recipient: S.optional(RecipientInfo),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const GenerateRandomResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Plaintext: S.optional(SensitiveBlob),
    CiphertextForRecipient: S.optional(T.Blob),
}).pipe(ns)).annotate({
    identifier: "GenerateRandomResponse",
});
export const GetKeyLastUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetKeyLastUsageRequest",
});
export const KeyLastUsageTrackingOperation = /*@__PURE__*/ S.String;
export const KeyLastUsageData = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetKeyLastUsageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
...
export const GetKeyPolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, PolicyName: S.optional(S.String) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetKeyPolicyRequest",
});
export const GetKeyPolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Policy: S.optional(S.String),
    PolicyName: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "GetKeyPolicyResponse",
});
export const GetKeyRotationStatusRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetKeyRotationStatusRequest",
});
export const GetKeyRotationStatusResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetParametersForImportRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
...
export const GetParametersForImportResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
...
export const GetPublicKeyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, GrantTokens: S.optional(GrantTokenList) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetPublicKeyRequest",
});
export const GetPublicKeyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    PublicKey: S.optional(T.Blob),
    CustomerMasterKeySpec: S.optional(CustomerMasterKeySpec),
    KeySpec: S.optional(KeySpec),
...
export const ImportKeyMaterialRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    ImportToken: T.Blob,
...
export const ImportKeyMaterialResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    KeyMaterialId: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ImportKeyMaterialResponse",
});
export const ListAliasesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    Limit: S.optional(S.Number),
    Marker: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const AliasListEntry = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "AliasListEntry" });
export const AliasList = /*@__PURE__*/ S.Array(AliasListEntry);
export const ListAliasesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListGrantsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Limit: S.optional(S.Number),
    Marker: S.optional(S.String),
    KeyId: S.String,
    GrantId: S.optional(S.String),
...
export const GrantListEntry = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    GrantId: S.optional(S.String),
    Name: S.optional(S.String),
    CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    ...
    GranteeServicePrincipal: S.optional(S.String),
    RetiringServicePrincipal: S.optional(S.String),
})).annotate({ identifier: "GrantListEntry" });
export const GrantList = /*@__PURE__*/ S.Array(GrantListEntry);
export const ListGrantsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListKeyPoliciesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    Limit: S.optional(S.Number),
    Marker: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListKeyPoliciesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListKeyRotationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
...
export const RotationsListEntry = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    KeyMaterialId: S.optional(S.String),
    KeyMaterialDescription: S.optional(S.String),
...
export const ListKeyRotationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListKeysRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ Limit: S.optional(S.Number), Marker: S.optional(S.String) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListKeysRequest",
});
export const KeyListEntry = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.optional(S.String), KeyArn: S.optional(S.String) })).annotate({ identifier: "KeyListEntry" });
export const KeyList = /*@__PURE__*/ S.Array(KeyListEntry);
export const ListKeysResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListResourceTagsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    Limit: S.optional(S.Number),
    Marker: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListResourceTagsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Tags: S.optional(TagList),
    NextMarker: S.optional(S.String),
    Truncated: S.optional(S.Boolean),
}).pipe(ns)).annotate({
...
export const ListRetirableGrantsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Limit: S.optional(S.Number),
    Marker: S.optional(S.String),
    RetiringPrincipal: S.optional(S.String),
    RetiringServicePrincipal: S.optional(S.String),
...
export const PutKeyPolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    PolicyName: S.optional(S.String),
    Policy: S.String,
    BypassPolicyLockoutSafetyCheck: S.optional(S.Boolean),
...
export const ReEncryptRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    CiphertextBlob: S.optional(T.Blob),
...
export const ReEncryptResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    CiphertextBlob: S.optional(T.Blob),
    SourceKeyId: S.optional(S.String),
    KeyId: S.optional(S.String),
    SourceEncryptionAlgorithm: S.optional(EncryptionAlgorithmSpec),
...
export const ReplicateKeyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
...
export const ReplicateKeyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RetireGrantRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    GrantToken: S.optional(S.String),
    KeyId: S.optional(S.String),
    GrantId: S.optional(S.String),
    DryRun: S.optional(S.Boolean),
...
export const RevokeGrantRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    GrantId: S.String,
    DryRun: S.optional(S.Boolean),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const RotateKeyOnDemandRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RotateKeyOnDemandRequest",
});
export const RotateKeyOnDemandResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "RotateKeyOnDemandResponse",
});
export const ScheduleKeyDeletionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, PendingWindowInDays: S.optional(S.Number) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ScheduleKeyDeletionRequest",
});
export const ScheduleKeyDeletionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    DeletionDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    KeyState: S.optional(KeyState),
...
export const SignRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    Message: SensitiveBlob,
    ...
    DryRun: S.optional(S.Boolean),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "SignRequest" });
export const SignResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    Signature: S.optional(T.Blob),
    SigningAlgorithm: S.optional(SigningAlgorithmSpec),
}).pipe(ns)).annotate({ identifier: "SignResponse" });
export const TagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, Tags: TagList }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const UntagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, TagKeys: TagKeyList }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UntagResourceRequest",
});
export const UntagResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UntagResourceResponse",
});
export const UpdateAliasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AliasName: S.String, TargetKeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const UpdateCustomKeyStoreRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const UpdateCustomKeyStoreResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdateCustomKeyStoreResponse",
});
export const UpdateKeyDescriptionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, Description: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateKeyDescriptionRequest",
});
export const UpdateKeyDescriptionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdateKeyDescriptionResponse",
});
export const UpdatePrimaryRegionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ KeyId: S.String, PrimaryRegion: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdatePrimaryRegionRequest",
});
export const UpdatePrimaryRegionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UpdatePrimaryRegionResponse",
});
export const VerifyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.String,
    Message: SensitiveBlob,
    MessageType: S.optional(MessageType),
    Signature: T.Blob,
    ...
    GrantTokens: S.optional(GrantTokenList),
    DryRun: S.optional(S.Boolean),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "VerifyRequest" });
export const VerifyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
    SignatureValid: S.optional(S.Boolean),
    SigningAlgorithm: S.optional(SigningAlgorithmSpec),
}).pipe(ns)).annotate({ identifier: "VerifyResponse" });
export const VerifyMacRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Message: SensitiveBlob,
    KeyId: S.String,
    MacAlgorithm: MacAlgorithmSpec,
    Mac: T.Blob,
...
export const VerifyMacResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    KeyId: S.optional(S.String),
 ...
 */
export const cancelKeyDeletion = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const connectCustomKeyStore = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const createCustomKeyStore = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const createGrant = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const decrypt = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteCustomKeyStore = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteImportedKeyMaterial = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const deriveSharedSecret = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const describeCustomKeyStores = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const describeKey = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const disableKey = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const disableKeyRotation = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const disconnectCustomKeyStore = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const enableKey = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const enableKeyRotation = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const encrypt = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKey = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyPair = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyPairWithoutPlaintext = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyWithoutPlaintext = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateMac = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateRandom = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyLastUsage = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyPolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyRotationStatus = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const getParametersForImport = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const getPublicKey = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const importKeyMaterial = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const listGrants = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeyPolicies = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeyRotations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeys = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const listResourceTags = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const listRetirableGrants = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const putKeyPolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const reEncrypt = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const replicateKey = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const retireGrant = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const revokeGrant = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const rotateKeyOnDemand = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const scheduleKeyDeletion = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const sign = /*@__PURE__*/ API.make(() => ({
    input: SignRequest,
    output: SignResponse,
    errors: [
        DependencyTimeoutException,
 ...
 * For more information, see KMS eventual consistency.
 */
export const updateCustomKeyStore = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const updateKeyDescription = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const updatePrimaryRegion = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information, see KMS eventual consistency.
 */
export const verify = /*@__PURE__*/ API.make(() => ({
    input: VerifyRequest,
 ...
 * For more information, see KMS eventual consistency.
 */
export const verifyMac = /*@__PURE__*/ API.make(() => ({
