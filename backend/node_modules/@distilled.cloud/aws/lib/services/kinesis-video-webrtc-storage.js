...
export const JoinStorageSessionInput = /*@__PURE__*/ S.suspend(() => S.Struct({ channelArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/joinStorageSession" }), svc, auth, proto, ver, rules))).annotate({
...
export const JoinStorageSessionAsViewerInput = /*@__PURE__*/ S.suspend(() => S.Struct({ channelArn: S.String, clientId: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/joinStorageSessionAsViewer" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "JoinStorageSessionAsViewerInput",
});
export const JoinStorageSessionAsViewerResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
 ...
 */
export const joinStorageSession = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const joinStorageSessionAsViewer = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=kinesis-video-webrtc-storage.js.map