            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://route53-recovery-cluster-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://route53-recovery-cluster-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://route53-recovery-cluster.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("DualStack is enabled but this partition does not support DualStack");
                }
                return e(`https://route53-recovery-cluster.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
            }
        }
    }
...
export class EndpointTemporarilyUnavailableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("EndpointTemporarilyUnavailableException", { message: S.String.pipe(T.ErrorMessage()) }, T.HttpError(503)).pipe(C.withServerError) {
}
export class InternalServerException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InternalServerException", {
    message: S.String.pipe(T.ErrorMessage()),
...
export class ServiceLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServiceLimitExceededException", {
    message: S.String.pipe(T.ErrorMessage()),
...
export class ValidationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ValidationException", {
    message: S.String.pipe(T.ErrorMessage()),
    reason: S.optional(S.suspend(() => ValidationExceptionReason).annotate({
        identifier: "ValidationExceptionReason",
    })),
    fields: S.optional(S.suspend(() => ValidationExceptionFieldList).annotate({
        identifier: "ValidationExceptionFieldList",
    })),
}, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export const GetRoutingControlStateRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ RoutingControlArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetRoutingControlStateRequest",
});
export const RoutingControlState = /*@__PURE__*/ S.String;
export const GetRoutingControlStateResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListRoutingControlsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RoutingControl = /*@__PURE__*/ S.suspend(() => S.Struct({
    ControlPanelArn: S.optional(S.String),
...
})).annotate({ identifier: "RoutingControl" });
export const RoutingControls = /*@__PURE__*/ S.Array(RoutingControl);
export const ListRoutingControlsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const UpdateRoutingControlStateRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoutingControlArn: S.String,
    RoutingControlState: RoutingControlState,
...
export const UpdateRoutingControlStateResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "UpdateRoutingControlStateResponse",
});
export const UpdateRoutingControlStateEntry = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoutingControlArn: S.String,
    RoutingControlState: RoutingControlState,
})).annotate({
    identifier: "UpdateRoutingControlStateEntry",
});
export const UpdateRoutingControlStateEntries = /*@__PURE__*/ S.Array(UpdateRoutingControlStateEntry);
export const UpdateRoutingControlStatesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    UpdateRoutingControlStateEntries: UpdateRoutingControlStateEntries,
    SafetyRulesToOverride: S.optional(Arns),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateRoutingControlStatesRequest",
});
export const UpdateRoutingControlStatesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "UpdateRoutingControlStatesResponse",
});
export const ValidationExceptionReason = /*@__PURE__*/ S.String;
export const ValidationExceptionField = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.String, message: S.String })).annotate({
 ...
 */
export const getRoutingControlState = /*@__PURE__*/ API.make(() => ({
 ...
 * routing controls in Route 53 ARC
 */
export const listRoutingControls = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const updateRoutingControlState = /*@__PURE__*/ API.make(() => ({
 ...
 * - Working with routing controls overall
 */
export const updateRoutingControlStates = /*@__PURE__*/ API.make(() => ({
