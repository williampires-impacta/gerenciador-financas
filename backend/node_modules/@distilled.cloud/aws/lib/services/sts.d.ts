...
declare const ExpiredTokenException_base: S.Class<ExpiredTokenException, S.TaggedStruct<"ExpiredTokenException", {
...
export declare class ExpiredTokenException extends /*@__PURE__*/ ExpiredTokenException_base {
}
declare const ExpiredTradeInTokenException_base: S.Class<ExpiredTradeInTokenException, S.TaggedStruct<"ExpiredTradeInTokenException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class ExpiredTradeInTokenException extends /*@__PURE__*/ ExpiredTradeInTokenException_base {
}
declare const IDPCommunicationErrorException_base: S.Class<IDPCommunicationErrorException, S.TaggedStruct<"IDPCommunicationErrorException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class IDPCommunicationErrorException extends /*@__PURE__*/ IDPCommunicationErrorException_base {
}
declare const IDPRejectedClaimException_base: S.Class<IDPRejectedClaimException, S.TaggedStruct<"IDPRejectedClaimException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        AuthError: true;
...
export declare class IDPRejectedClaimException extends /*@__PURE__*/ IDPRejectedClaimException_base {
}
declare const InvalidAuthorizationMessageException_base: S.Class<InvalidAuthorizationMessageException, S.TaggedStruct<"InvalidAuthorizationMessageException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class InvalidAuthorizationMessageException extends /*@__PURE__*/ InvalidAuthorizationMessageException_base {
}
declare const InvalidIdentityTokenException_base: S.Class<InvalidIdentityTokenException, S.TaggedStruct<"InvalidIdentityTokenException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class InvalidIdentityTokenException extends /*@__PURE__*/ InvalidIdentityTokenException_base {
}
declare const JWTPayloadSizeExceededException_base: S.Class<JWTPayloadSizeExceededException, S.TaggedStruct<"JWTPayloadSizeExceededException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class JWTPayloadSizeExceededException extends /*@__PURE__*/ JWTPayloadSizeExceededException_base {
}
declare const MalformedPolicyDocumentException_base: S.Class<MalformedPolicyDocumentException, S.TaggedStruct<"MalformedPolicyDocumentException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class MalformedPolicyDocumentException extends /*@__PURE__*/ MalformedPolicyDocumentException_base {
}
declare const OutboundWebIdentityFederationDisabledException_base: S.Class<OutboundWebIdentityFederationDisabledException, S.TaggedStruct<"OutboundWebIdentityFederationDisabledException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        AuthError: true;
...
export declare class OutboundWebIdentityFederationDisabledException extends /*@__PURE__*/ OutboundWebIdentityFederationDisabledException_base {
}
declare const PackedPolicyTooLargeException_base: S.Class<PackedPolicyTooLargeException, S.TaggedStruct<"PackedPolicyTooLargeException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class PackedPolicyTooLargeException extends /*@__PURE__*/ PackedPolicyTooLargeException_base {
}
declare const RegionDisabledException_base: S.Class<RegionDisabledException, S.TaggedStruct<"RegionDisabledException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        AuthError: true;
...
export declare class RegionDisabledException extends /*@__PURE__*/ RegionDisabledException_base {
}
declare const SessionDurationEscalationException_base: S.Class<SessionDurationEscalationException, S.TaggedStruct<"SessionDurationEscalationException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        AuthError: true;
...
export declare class SessionDurationEscalationException extends /*@__PURE__*/ SessionDurationEscalationException_base {
}
...
export declare const PolicyDescriptorType: S.Schema<PolicyDescriptorType>;
export type PolicyDescriptorListType = PolicyDescriptorType[];
export declare const PolicyDescriptorListType: any;
...
export declare const TagListType: any;
export type TagKeyListType = string[];
export declare const TagKeyListType: any;
...
export declare const ProvidedContext: S.Schema<ProvidedContext>;
export type ProvidedContextsListType = ProvidedContext[];
export declare const ProvidedContextsListType: any;
...
export declare const AssumeRoleRequest: S.Schema<AssumeRoleRequest>;
...
export declare const Credentials: S.Schema<Credentials>;
export type AssumedRoleIdType = string;
export interface AssumedRoleUser {
    AssumedRoleId: string;
    Arn: string;
}
export declare const AssumedRoleUser: S.Schema<AssumedRoleUser>;
...
export declare const AssumeRoleResponse: S.Schema<AssumeRoleResponse>;
...
export declare const AssumeRoleWithSAMLRequest: S.Schema<AssumeRoleWithSAMLRequest>;
...
export declare const AssumeRoleWithSAMLResponse: S.Schema<AssumeRoleWithSAMLResponse>;
...
export declare const AssumeRoleWithWebIdentityRequest: S.Schema<AssumeRoleWithWebIdentityRequest>;
...
export declare const AssumeRoleWithWebIdentityResponse: S.Schema<AssumeRoleWithWebIdentityResponse>;
...
export declare const AssumeRootRequest: S.Schema<AssumeRootRequest>;
export interface AssumeRootResponse {
    Credentials?: Credentials;
    SourceIdentity?: string;
}
export declare const AssumeRootResponse: S.Schema<AssumeRootResponse>;
export type EncodedMessageType = string;
export interface DecodeAuthorizationMessageRequest {
    EncodedMessage: string;
}
export declare const DecodeAuthorizationMessageRequest: S.Schema<DecodeAuthorizationMessageRequest>;
export type DecodedMessageType = string;
export interface DecodeAuthorizationMessageResponse {
    DecodedMessage?: string;
}
export declare const DecodeAuthorizationMessageResponse: S.Schema<DecodeAuthorizationMessageResponse>;
export interface GetAccessKeyInfoRequest {
    AccessKeyId: string;
}
export declare const GetAccessKeyInfoRequest: S.Schema<GetAccessKeyInfoRequest>;
export type AccountType = string;
export interface GetAccessKeyInfoResponse {
    Account?: string;
}
export declare const GetAccessKeyInfoResponse: S.Schema<GetAccessKeyInfoResponse>;
export interface GetCallerIdentityRequest {
}
export declare const GetCallerIdentityRequest: S.Schema<GetCallerIdentityRequest>;
...
export declare const GetCallerIdentityResponse: S.Schema<GetCallerIdentityResponse>;
...
export declare const GetDelegatedAccessTokenRequest: S.Schema<GetDelegatedAccessTokenRequest>;
export interface GetDelegatedAccessTokenResponse {
    Credentials?: Credentials;
    PackedPolicySize?: number;
    AssumedPrincipal?: string;
}
export declare const GetDelegatedAccessTokenResponse: S.Schema<GetDelegatedAccessTokenResponse>;
...
export declare const GetFederationTokenRequest: S.Schema<GetFederationTokenRequest>;
export type FederatedIdType = string;
export interface FederatedUser {
    FederatedUserId: string;
    Arn: string;
}
export declare const FederatedUser: S.Schema<FederatedUser>;
export interface GetFederationTokenResponse {
    Credentials?: Credentials;
    FederatedUser?: FederatedUser;
    PackedPolicySize?: number;
}
export declare const GetFederationTokenResponse: S.Schema<GetFederationTokenResponse>;
export interface GetSessionTokenRequest {
    DurationSeconds?: number;
    SerialNumber?: string;
    TokenCode?: string;
}
export declare const GetSessionTokenRequest: S.Schema<GetSessionTokenRequest>;
export interface GetSessionTokenResponse {
    Credentials?: Credentials;
}
export declare const GetSessionTokenResponse: S.Schema<GetSessionTokenResponse>;
export type WebIdentityTokenAudienceStringType = string;
export type WebIdentityTokenAudienceListType = string[];
export declare const WebIdentityTokenAudienceListType: any;
...
export declare const GetWebIdentityTokenRequest: S.Schema<GetWebIdentityTokenRequest>;
export type WebIdentityTokenType = string | redacted.Redacted<string>;
export interface GetWebIdentityTokenResponse {
    WebIdentityToken?: string | redacted.Redacted<string>;
    Expiration?: Date;
}
export declare const GetWebIdentityTokenResponse: S.Schema<GetWebIdentityTokenResponse>;
...
export type AssumeRoleError = ExpiredTokenException | MalformedPolicyDocumentException | PackedPolicyTooLargeException | RegionDisabledException | CommonErrors;
/**
 ...
 * produces.
 */
export declare const assumeRole: API.OperationMethod<AssumeRoleRequest, AssumeRoleResponse, AssumeRoleError, Creds | HttpClient.HttpClient>;
export type AssumeRoleWithSAMLError = ExpiredTokenException | IDPRejectedClaimException | InvalidIdentityTokenException | MalformedPolicyDocumentException | PackedPolicyTooLargeException | RegionDisabledException | CommonErrors;
/**
 ...
 * *IAM User Guide*.
 */
export declare const assumeRoleWithSAML: API.OperationMethod<AssumeRoleWithSAMLRequest, AssumeRoleWithSAMLResponse, AssumeRoleWithSAMLError, Creds | HttpClient.HttpClient>;
export type AssumeRoleWithWebIdentityError = ExpiredTokenException | IDPCommunicationErrorException | IDPRejectedClaimException | InvalidIdentityTokenException | MalformedPolicyDocumentException | PackedPolicyTooLargeException | RegionDisabledException | CommonErrors;
/**
 ...
 */
export declare const assumeRoleWithWebIdentity: API.OperationMethod<AssumeRoleWithWebIdentityRequest, AssumeRoleWithWebIdentityResponse, AssumeRoleWithWebIdentityError, Creds | HttpClient.HttpClient>;
 ...
 */
export declare const assumeRoot: API.OperationMethod<AssumeRootRequest, AssumeRootResponse, AssumeRootError, Creds | HttpClient.HttpClient>;
 ...
 */
export declare const decodeAuthorizationMessage: API.OperationMethod<DecodeAuthorizationMessageRequest, DecodeAuthorizationMessageResponse, DecodeAuthorizationMessageError, Creds | HttpClient.HttpClient>;
 ...
 */
export declare const getAccessKeyInfo: API.OperationMethod<GetAccessKeyInfoRequest, GetAccessKeyInfoResponse, GetAccessKeyInfoError, Creds | HttpClient.HttpClient>;
 ...
 * *IAM User Guide*.
 */
export declare const getCallerIdentity: API.OperationMethod<GetCallerIdentityRequest, GetCallerIdentityResponse, GetCallerIdentityError, Creds | HttpClient.HttpClient>;
export type GetDelegatedAccessTokenError = ExpiredTradeInTokenException | PackedPolicyTooLargeException | RegionDisabledException | CommonErrors;
/**
 ...
 * resources.
 */
export declare const getDelegatedAccessToken: API.OperationMethod<GetDelegatedAccessTokenRequest, GetDelegatedAccessTokenResponse, GetDelegatedAccessTokenError, Creds | HttpClient.HttpClient>;
export type GetFederationTokenError = MalformedPolicyDocumentException | PackedPolicyTooLargeException | RegionDisabledException | CommonErrors;
/**
 ...
 */
export declare const getFederationToken: API.OperationMethod<GetFederationTokenRequest, GetFederationTokenResponse, GetFederationTokenError, Creds | HttpClient.HttpClient>;
 ...
 * *IAM User Guide*.
 */
export declare const getSessionToken: API.OperationMethod<GetSessionTokenRequest, GetSessionTokenResponse, GetSessionTokenError, Creds | HttpClient.HttpClient>;
export type GetWebIdentityTokenError = JWTPayloadSizeExceededException | OutboundWebIdentityFederationDisabledException | SessionDurationEscalationException | CommonErrors;
/**
 ...
 */
export declare const getWebIdentityToken: API.OperationMethod<GetWebIdentityTokenRequest, GetWebIdentityTokenResponse, GetWebIdentityTokenError, Creds | HttpClient.HttpClient>;
export {};
