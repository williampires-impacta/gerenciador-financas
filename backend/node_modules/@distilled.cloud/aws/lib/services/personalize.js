            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://personalize-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://personalize-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://personalize.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class InvalidInputException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidInputException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class InvalidNextTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidNextTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class LimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("LimitExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ResourceAlreadyExistsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceAlreadyExistsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(403)).pipe(C.withAuthError, C.withAlreadyExistsError) {
}
export class ResourceInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ResourceNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class TooManyTagKeysException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TooManyTagKeysException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class TooManyTagsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TooManyTagsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export const S3DataConfig = /*@__PURE__*/ S.suspend(() => S.Struct({ path: S.String, kmsKeyArn: S.optional(S.String) })).annotate({ identifier: "S3DataConfig" });
export const BatchInferenceJobInput = /*@__PURE__*/ S.suspend(() => S.Struct({ s3DataSource: S3DataConfig })).annotate({
    identifier: "BatchInferenceJobInput",
});
export const BatchInferenceJobOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ s3DataDestination: S3DataConfig })).annotate({
...
export const RankingInfluence = /*@__PURE__*/ S.Record(RankingInfluenceType, S.Number.pipe(S.optional));
export const BatchInferenceJobConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Tag = /*@__PURE__*/ S.suspend(() => S.Struct({ tagKey: SensitiveString, tagValue: SensitiveString })).annotate({ identifier: "Tag" });
export const Tags = /*@__PURE__*/ S.Array(Tag);
export const BatchInferenceJobMode = /*@__PURE__*/ S.String;
export const FieldsForThemeGeneration = /*@__PURE__*/ S.suspend(() => S.Struct({ itemName: S.String })).annotate({
    identifier: "FieldsForThemeGeneration",
});
export const ThemeGenerationConfig = /*@__PURE__*/ S.suspend(() => S.Struct({ fieldsForThemeGeneration: FieldsForThemeGeneration })).annotate({
    identifier: "ThemeGenerationConfig",
});
export const CreateBatchInferenceJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.String,
...
export const CreateBatchInferenceJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ batchInferenceJobArn: S.optional(S.String) })).annotate({
    identifier: "CreateBatchInferenceJobResponse",
});
export const BatchSegmentJobInput = /*@__PURE__*/ S.suspend(() => S.Struct({ s3DataSource: S3DataConfig })).annotate({
    identifier: "BatchSegmentJobInput",
});
export const BatchSegmentJobOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ s3DataDestination: S3DataConfig })).annotate({
    identifier: "BatchSegmentJobOutput",
});
export const CreateBatchSegmentJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.String,
    solutionVersionArn: S.String,
    filterArn: S.optional(S.String),
    numResults: S.optional(S.Number),
...
export const CreateBatchSegmentJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ batchSegmentJobArn: S.optional(S.String) })).annotate({
    identifier: "CreateBatchSegmentJobResponse",
});
export const CampaignConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
    itemExplorationConfig: S.optional(HyperParameters),
    enableMetadataWithRecommendations: S.optional(S.Boolean),
    syncWithLatestSolutionVersion: S.optional(S.Boolean),
    rankingInfluence: S.optional(RankingInfluence),
})).annotate({ identifier: "CampaignConfig" });
export const CreateCampaignRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    solutionVersionArn: S.String,
...
export const CreateCampaignResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ campaignArn: S.optional(S.String) })).annotate({
    identifier: "CreateCampaignResponse",
});
export const DataSource = /*@__PURE__*/ S.suspend(() => S.Struct({ dataLocation: S.optional(S.String) })).annotate({ identifier: "DataSource" });
export const CreateDataDeletionJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.String,
...
export const CreateDataDeletionJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ dataDeletionJobArn: S.optional(S.String) })).annotate({
...
export const DatasetExportJobOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ s3DataDestination: S3DataConfig })).annotate({
    identifier: "DatasetExportJobOutput",
});
export const CreateDatasetExportJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.String,
    datasetArn: S.String,
...
export const CreateDatasetExportJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetExportJobArn: S.optional(S.String) })).annotate({
    identifier: "CreateDatasetExportJobResponse",
});
export const Domain = /*@__PURE__*/ S.String;
export const CreateDatasetGroupRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
...
export const CreateDatasetGroupResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateDatasetImportJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.String,
    datasetArn: S.String,
    dataSource: DataSource,
    roleArn: S.optional(S.String),
...
export const CreateDatasetImportJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetImportJobArn: S.optional(S.String) })).annotate({
    identifier: "CreateDatasetImportJobResponse",
});
export const CreateEventTrackerRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    datasetGroupArn: S.String,
    tags: S.optional(Tags),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const CreateEventTrackerResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    eventTrackerArn: S.optional(S.String),
    trackingId: S.optional(S.String),
})).annotate({
    identifier: "CreateEventTrackerResponse",
});
export const CreateFilterRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    datasetGroupArn: S.String,
...
export const CreateFilterResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ filterArn: S.optional(S.String) })).annotate({
    identifier: "CreateFilterResponse",
});
export const MetricAttribute = /*@__PURE__*/ S.suspend(() => S.Struct({ eventType: S.String, metricName: S.String, expression: S.String })).annotate({
    identifier: "MetricAttribute",
});
export const MetricAttributes = /*@__PURE__*/ S.Array(MetricAttribute);
export const MetricAttributionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ s3DataDestination: S.optional(S3DataConfig), roleArn: S.String })).annotate({
    identifier: "MetricAttributionOutput",
});
export const CreateMetricAttributionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    datasetGroupArn: S.String,
...
export const CreateMetricAttributionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ metricAttributionArn: S.optional(S.String) })).annotate({
    identifier: "CreateMetricAttributionResponse",
});
export const ColumnNamesList = /*@__PURE__*/ S.Array(S.String);
export const ExcludedDatasetColumns = /*@__PURE__*/ S.Record(S.String, ColumnNamesList.pipe(S.optional));
export const IncludedDatasetColumns = /*@__PURE__*/ S.Record(S.String, ColumnNamesList.pipe(S.optional));
export const TrainingDataConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RecommenderConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
    itemExplorationConfig: S.optional(HyperParameters),
...
export const CreateRecommenderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    datasetGroupArn: S.String,
    recipeArn: S.String,
...
export const CreateRecommenderResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.optional(S.String) })).annotate({
    identifier: "CreateRecommenderResponse",
});
export const CreateSchemaRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    schema: S.String,
    domain: S.optional(Domain),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const CreateSchemaResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ schemaArn: S.optional(S.String) })).annotate({
    identifier: "CreateSchemaResponse",
});
export const HPOObjective = /*@__PURE__*/ S.suspend(() => S.Struct({
    type: S.optional(S.String),
    metricName: S.optional(S.String),
    metricRegex: S.optional(S.String),
})).annotate({ identifier: "HPOObjective" });
export const HPOResourceConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
    maxNumberOfTrainingJobs: S.optional(S.String),
    maxParallelTrainingJobs: S.optional(S.String),
})).annotate({
    identifier: "HPOResourceConfig",
});
export const IntegerHyperParameterRange = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ContinuousHyperParameterRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    minValue: S.optional(S.Number),
    maxValue: S.optional(S.Number),
})).annotate({
...
export const CategoricalHyperParameterRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    values: S.optional(CategoricalValues),
})).annotate({
    identifier: "CategoricalHyperParameterRange",
});
export const CategoricalHyperParameterRanges = /*@__PURE__*/ S.Array(CategoricalHyperParameterRange);
export const HyperParameterRanges = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const HPOConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "HPOConfig" });
export const FeatureTransformationParameters = /*@__PURE__*/ S.Record(S.String, S.String.pipe(S.optional));
export const ArnList = /*@__PURE__*/ S.Array(S.String);
export const AutoMLConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
    metricName: S.optional(S.String),
    recipeList: S.optional(ArnList),
})).annotate({ identifier: "AutoMLConfig" });
export const EventParameters = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const EventsConfig = /*@__PURE__*/ S.suspend(() => S.Struct({ eventParametersList: S.optional(EventParametersList) })).annotate({ identifier: "EventsConfig" });
export const ObjectiveSensitivity = /*@__PURE__*/ S.String;
export const OptimizationObjective = /*@__PURE__*/ S.suspend(() => S.Struct({
    itemAttribute: S.optional(S.String),
    objectiveSensitivity: S.optional(ObjectiveSensitivity),
})).annotate({
    identifier: "OptimizationObjective",
});
export const AutoTrainingConfig = /*@__PURE__*/ S.suspend(() => S.Struct({ schedulingExpression: S.optional(S.String) })).annotate({
    identifier: "AutoTrainingConfig",
});
export const SolutionConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "SolutionConfig" });
export const CreateSolutionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
...
export const CreateSolutionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionArn: S.optional(S.String) })).annotate({
    identifier: "CreateSolutionResponse",
});
export const TrainingMode = /*@__PURE__*/ S.String;
export const CreateSolutionVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
export const CreateSolutionVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionVersionArn: S.optional(S.String) })).annotate({
    identifier: "CreateSolutionVersionResponse",
});
export const DeleteCampaignRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ campaignArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteDatasetGroupRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetGroupArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteEventTrackerRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ eventTrackerArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteFilterRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ filterArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteMetricAttributionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ metricAttributionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteRecommenderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteSchemaRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ schemaArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteSolutionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DescribeAlgorithmRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ algorithmArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeAlgorithmRequest",
});
export const AlgorithmImage = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.optional(S.String), dockerURI: S.String })).annotate({ identifier: "AlgorithmImage" });
export const DefaultIntegerHyperParameterRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    minValue: S.optional(S.Number),
    maxValue: S.optional(S.Number),
...
export const DefaultIntegerHyperParameterRanges = /*@__PURE__*/ S.Array(DefaultIntegerHyperParameterRange);
export const DefaultContinuousHyperParameterRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    minValue: S.optional(S.Number),
    maxValue: S.optional(S.Number),
    isTunable: S.optional(S.Boolean),
...
export const DefaultContinuousHyperParameterRanges = /*@__PURE__*/ S.Array(DefaultContinuousHyperParameterRange);
export const DefaultCategoricalHyperParameterRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    values: S.optional(CategoricalValues),
    isTunable: S.optional(S.Boolean),
})).annotate({
...
export const DefaultCategoricalHyperParameterRanges = /*@__PURE__*/ S.Array(DefaultCategoricalHyperParameterRange);
export const DefaultHyperParameterRanges = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Algorithm = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
})).annotate({ identifier: "Algorithm" });
export const DescribeAlgorithmResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ algorithm: S.optional(Algorithm) })).annotate({
    identifier: "DescribeAlgorithmResponse",
});
export const DescribeBatchInferenceJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ batchInferenceJobArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeBatchInferenceJobRequest",
});
export const BatchInferenceJob = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeBatchInferenceJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ batchInferenceJob: S.optional(BatchInferenceJob) })).annotate({
    identifier: "DescribeBatchInferenceJobResponse",
});
export const DescribeBatchSegmentJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ batchSegmentJobArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeBatchSegmentJobRequest",
});
export const BatchSegmentJob = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.optional(S.String),
...
export const DescribeBatchSegmentJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ batchSegmentJob: S.optional(BatchSegmentJob) })).annotate({
    identifier: "DescribeBatchSegmentJobResponse",
});
export const DescribeCampaignRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ campaignArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeCampaignRequest",
});
export const CampaignUpdateSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionVersionArn: S.optional(S.String),
    minProvisionedTPS: S.optional(S.Number),
    campaignConfig: S.optional(CampaignConfig),
    status: S.optional(S.String),
...
export const Campaign = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
export const DescribeCampaignResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ campaign: S.optional(Campaign) })).annotate({
    identifier: "DescribeCampaignResponse",
});
export const DescribeDataDeletionJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ dataDeletionJobArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeDataDeletionJobRequest",
});
export const DataDeletionJob = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.optional(S.String),
...
export const DescribeDataDeletionJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ dataDeletionJob: S.optional(DataDeletionJob) })).annotate({
...
export const DatasetUpdateSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Dataset = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
export const DescribeDatasetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ dataset: S.optional(Dataset) })).annotate({
    identifier: "DescribeDatasetResponse",
});
export const DescribeDatasetExportJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetExportJobArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeDatasetExportJobRequest",
});
export const DatasetExportJob = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.optional(S.String),
...
export const DescribeDatasetExportJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetExportJob: S.optional(DatasetExportJob) })).annotate({
    identifier: "DescribeDatasetExportJobResponse",
});
export const DescribeDatasetGroupRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetGroupArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeDatasetGroupRequest",
});
export const DatasetGroup = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    datasetGroupArn: S.optional(S.String),
    status: S.optional(S.String),
    roleArn: S.optional(S.String),
    ...
    failureReason: S.optional(S.String),
    domain: S.optional(Domain),
})).annotate({ identifier: "DatasetGroup" });
export const DescribeDatasetGroupResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetGroup: S.optional(DatasetGroup) })).annotate({
    identifier: "DescribeDatasetGroupResponse",
});
export const DescribeDatasetImportJobRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetImportJobArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeDatasetImportJobRequest",
});
export const DatasetImportJob = /*@__PURE__*/ S.suspend(() => S.Struct({
    jobName: S.optional(S.String),
...
export const DescribeDatasetImportJobResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetImportJob: S.optional(DatasetImportJob) })).annotate({
    identifier: "DescribeDatasetImportJobResponse",
});
export const DescribeEventTrackerRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ eventTrackerArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeEventTrackerRequest",
});
export const EventTracker = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    eventTrackerArn: S.optional(S.String),
    ...
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({ identifier: "EventTracker" });
export const DescribeEventTrackerResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ eventTracker: S.optional(EventTracker) })).annotate({
    identifier: "DescribeEventTrackerResponse",
});
export const DescribeFeatureTransformationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ featureTransformationArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const FeatureTransformation = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
export const DescribeFeatureTransformationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ featureTransformation: S.optional(FeatureTransformation) })).annotate({
    identifier: "DescribeFeatureTransformationResponse",
});
export const DescribeFilterRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ filterArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeFilterRequest",
});
export const Filter = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    filterArn: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const DescribeFilterResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ filter: S.optional(Filter) })).annotate({
    identifier: "DescribeFilterResponse",
});
export const DescribeMetricAttributionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ metricAttributionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeMetricAttributionRequest",
});
export const MetricAttribution = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
export const DescribeMetricAttributionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ metricAttribution: S.optional(MetricAttribution) })).annotate({
    identifier: "DescribeMetricAttributionResponse",
});
export const DescribeRecipeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ recipeArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeRecipeRequest",
});
export const Recipe = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    recipeArn: S.optional(S.String),
    algorithmArn: S.optional(S.String),
    featureTransformationArn: S.optional(S.String),
...
export const DescribeRecipeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recipe: S.optional(Recipe) })).annotate({
    identifier: "DescribeRecipeResponse",
});
export const DescribeRecommenderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeRecommenderRequest",
});
export const RecommenderUpdateSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    recommenderConfig: S.optional(RecommenderConfig),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    status: S.optional(S.String),
...
export const Recommender = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "Recommender" });
export const DescribeRecommenderResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recommender: S.optional(Recommender) })).annotate({
    identifier: "DescribeRecommenderResponse",
});
export const DescribeSchemaRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ schemaArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeSchemaRequest",
});
export const DatasetSchema = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    schemaArn: S.optional(S.String),
    ...
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    domain: S.optional(Domain),
})).annotate({ identifier: "DatasetSchema" });
export const DescribeSchemaResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ schema: S.optional(DatasetSchema) })).annotate({
    identifier: "DescribeSchemaResponse",
});
export const DescribeSolutionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeSolutionRequest",
});
export const AutoMLResult = /*@__PURE__*/ S.suspend(() => S.Struct({ bestRecipeArn: S.optional(S.String) })).annotate({ identifier: "AutoMLResult" });
export const TrainingType = /*@__PURE__*/ S.String;
export const SolutionVersionSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionVersionArn: S.optional(S.String),
    status: S.optional(S.String),
    trainingMode: S.optional(TrainingMode),
...
export const SolutionUpdateConfig = /*@__PURE__*/ S.suspend(() => S.Struct({
    autoTrainingConfig: S.optional(AutoTrainingConfig),
    eventsConfig: S.optional(EventsConfig),
})).annotate({
    identifier: "SolutionUpdateConfig",
});
export const SolutionUpdateSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Solution = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
...
})).annotate({ identifier: "Solution" });
export const DescribeSolutionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ solution: S.optional(Solution) })).annotate({
    identifier: "DescribeSolutionResponse",
});
export const DescribeSolutionVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionVersionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeSolutionVersionRequest",
});
export const TunedHPOParams = /*@__PURE__*/ S.suspend(() => S.Struct({ algorithmHyperParameters: S.optional(HyperParameters) })).annotate({ identifier: "TunedHPOParams" });
export const SolutionVersion = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    solutionVersionArn: S.optional(S.String),
    solutionArn: S.optional(S.String),
    performHPO: S.optional(S.Boolean),
...
export const DescribeSolutionVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionVersion: S.optional(SolutionVersion) })).annotate({
    identifier: "DescribeSolutionVersionResponse",
});
export const GetSolutionMetricsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionVersionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetSolutionMetricsRequest",
});
export const GetSolutionMetricsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionVersionArn: S.optional(S.String),
    metrics: S.optional(Metrics),
})).annotate({
    identifier: "GetSolutionMetricsResponse",
});
export const ListBatchInferenceJobsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionVersionArn: S.optional(S.String),
...
export const BatchInferenceJobSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    batchInferenceJobArn: S.optional(S.String),
    jobName: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListBatchInferenceJobsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    batchInferenceJobs: S.optional(BatchInferenceJobs),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListBatchInferenceJobsResponse",
});
export const ListBatchSegmentJobsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionVersionArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const BatchSegmentJobSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    batchSegmentJobArn: S.optional(S.String),
    jobName: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListBatchSegmentJobsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    batchSegmentJobs: S.optional(BatchSegmentJobs),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListBatchSegmentJobsResponse",
});
export const ListCampaignsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const CampaignSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    campaignArn: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListCampaignsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    campaigns: S.optional(Campaigns),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListCampaignsResponse",
});
export const ListDataDeletionJobsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DataDeletionJobSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    dataDeletionJobArn: S.optional(S.String),
    datasetGroupArn: S.optional(S.String),
    jobName: S.optional(S.String),
    status: S.optional(S.String),
...
export const ListDataDeletionJobsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    dataDeletionJobs: S.optional(DataDeletionJobs),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListDataDeletionJobsResponse",
});
export const ListDatasetExportJobsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DatasetExportJobSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetExportJobArn: S.optional(S.String),
    jobName: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListDatasetExportJobsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetExportJobs: S.optional(DatasetExportJobs),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListDatasetExportJobsResponse",
});
export const ListDatasetGroupsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListDatasetGroupsRequest",
});
export const DatasetGroupSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    datasetGroupArn: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListDatasetGroupsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroups: S.optional(DatasetGroups),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListDatasetGroupsResponse",
});
export const ListDatasetImportJobsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DatasetImportJobSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetImportJobArn: S.optional(S.String),
    jobName: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListDatasetImportJobsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetImportJobs: S.optional(DatasetImportJobs),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListDatasetImportJobsResponse",
});
export const ListDatasetsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DatasetSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    datasetArn: S.optional(S.String),
    datasetType: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({ identifier: "DatasetSummary" });
export const Datasets = /*@__PURE__*/ S.Array(DatasetSummary);
export const ListDatasetsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasets: S.optional(Datasets), nextToken: S.optional(S.String) })).annotate({
    identifier: "ListDatasetsResponse",
});
export const ListEventTrackersRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const EventTrackerSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    eventTrackerArn: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListEventTrackersResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    eventTrackers: S.optional(EventTrackers),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListEventTrackersResponse",
});
export const ListFiltersRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const FilterSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    filterArn: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    ...
    failureReason: S.optional(S.String),
    status: S.optional(S.String),
})).annotate({ identifier: "FilterSummary" });
export const Filters = /*@__PURE__*/ S.Array(FilterSummary);
export const ListFiltersResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Filters: S.optional(Filters), nextToken: S.optional(S.String) })).annotate({
    identifier: "ListFiltersResponse",
});
export const ListMetricAttributionMetricsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    metricAttributionArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListMetricAttributionMetricsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    metrics: S.optional(MetricAttributes),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListMetricAttributionMetricsResponse",
});
export const ListMetricAttributionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const MetricAttributionSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    metricAttributionArn: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListMetricAttributionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListRecipesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RecipeSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    recipeArn: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    domain: S.optional(Domain),
})).annotate({ identifier: "RecipeSummary" });
export const Recipes = /*@__PURE__*/ S.Array(RecipeSummary);
export const ListRecipesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recipes: S.optional(Recipes), nextToken: S.optional(S.String) })).annotate({
    identifier: "ListRecipesResponse",
});
export const ListRecommendersRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const RecommenderSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    recommenderArn: S.optional(S.String),
    datasetGroupArn: S.optional(S.String),
    recipeArn: S.optional(S.String),
...
export const ListRecommendersResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    recommenders: S.optional(Recommenders),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListRecommendersResponse",
});
export const ListSchemasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListSchemasRequest",
});
export const DatasetSchemaSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    schemaArn: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListSchemasResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ schemas: S.optional(Schemas), nextToken: S.optional(S.String) })).annotate({
    identifier: "ListSchemasResponse",
});
export const ListSolutionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    datasetGroupArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const SolutionSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    solutionArn: S.optional(S.String),
    status: S.optional(S.String),
    creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const ListSolutionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutions: S.optional(Solutions),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "ListSolutionsResponse",
});
export const ListSolutionVersionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionArn: S.optional(S.String),
    nextToken: S.optional(S.String),
    maxResults: S.optional(S.Number),
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListSolutionVersionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const StartRecommenderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StartRecommenderRequest",
});
export const StartRecommenderResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.optional(S.String) })).annotate({
    identifier: "StartRecommenderResponse",
});
export const StopRecommenderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StopRecommenderRequest",
});
export const StopRecommenderResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.optional(S.String) })).annotate({
    identifier: "StopRecommenderResponse",
});
export const StopSolutionVersionCreationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionVersionArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StopSolutionVersionCreationRequest",
});
export const StopSolutionVersionCreationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "StopSolutionVersionCreationResponse",
});
export const TagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ resourceArn: S.String, tags: Tags }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const UntagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ resourceArn: S.String, tagKeys: TagKeys }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UntagResourceRequest",
});
export const UntagResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "UntagResourceResponse",
});
export const UpdateCampaignRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const UpdateCampaignResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ campaignArn: S.optional(S.String) })).annotate({
    identifier: "UpdateCampaignResponse",
});
export const UpdateDatasetRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetArn: S.String, schemaArn: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateDatasetRequest",
});
export const UpdateDatasetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ datasetArn: S.optional(S.String) })).annotate({
    identifier: "UpdateDatasetResponse",
});
export const MetricAttributesNamesList = /*@__PURE__*/ S.Array(S.String);
export const UpdateMetricAttributionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const UpdateMetricAttributionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ metricAttributionArn: S.optional(S.String) })).annotate({
    identifier: "UpdateMetricAttributionResponse",
});
export const UpdateRecommenderRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    recommenderArn: S.String,
    recommenderConfig: RecommenderConfig,
}).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateRecommenderRequest",
});
export const UpdateRecommenderResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ recommenderArn: S.optional(S.String) })).annotate({
    identifier: "UpdateRecommenderResponse",
});
export const UpdateSolutionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    solutionArn: S.String,
    performAutoTraining: S.optional(S.Boolean),
    performIncrementalUpdate: S.optional(S.Boolean),
    solutionUpdateConfig: S.optional(SolutionUpdateConfig),
...
export const UpdateSolutionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ solutionArn: S.optional(S.String) })).annotate({
 ...
 */
export const createBatchInferenceJob = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createBatchSegmentJob = /*@__PURE__*/ API.make(() => ({
 ...
 * - DeleteCampaign
 */
export const createCampaign = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createDataDeletionJob = /*@__PURE__*/ API.make(() => ({
 ...
 * failed.
 */
export const createDatasetExportJob = /*@__PURE__*/ API.make(() => ({
 ...
 * - DeleteDatasetGroup
 */
export const createDatasetGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createDatasetImportJob = /*@__PURE__*/ API.make(() => ({
 ...
 * - DeleteEventTracker
 */
export const createEventTracker = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createFilter = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createMetricAttribution = /*@__PURE__*/ API.make(() => ({
 ...
 * - DeleteRecommender
 */
export const createRecommender = /*@__PURE__*/ API.make(() => ({
 ...
 * - DeleteSchema
 */
export const createSchema = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createSolution = /*@__PURE__*/ API.make(() => ({
 ...
 * - DeleteSolution
 */
export const createSolutionVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteCampaign = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteDatasetGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteEventTracker = /*@__PURE__*/ API.make(() => ({
 ...
 * Deletes a filter.
 */
export const deleteFilter = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteMetricAttribution = /*@__PURE__*/ API.make(() => ({
 ...
 * request.
 */
export const deleteRecommender = /*@__PURE__*/ API.make(() => ({
 ...
 * CreateSchema.
 */
export const deleteSchema = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteSolution = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeAlgorithm = /*@__PURE__*/ API.make(() => ({
 ...
 * the recommendations.
 */
export const describeBatchInferenceJob = /*@__PURE__*/ API.make(() => ({
 ...
 * segments.
 */
export const describeBatchSegmentJob = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeCampaign = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeDataDeletionJob = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeDatasetExportJob = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeDatasetGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeDatasetImportJob = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeEventTracker = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeFeatureTransformation = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeFilter = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeMetricAttribution = /*@__PURE__*/ API.make(() => ({
 ...
 * GetRecommendations API.
 */
export const describeRecipe = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeRecommender = /*@__PURE__*/ API.make(() => ({
 ...
 * CreateSchema.
 */
export const describeSchema = /*@__PURE__*/ API.make(() => ({
 ...
 * For more information on solutions, see CreateSolution.
 */
export const describeSolution = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeSolutionVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getSolutionMetrics = /*@__PURE__*/ API.make(() => ({
 ...
 * version.
 */
export const listBatchInferenceJobs = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listBatchSegmentJobs = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information on campaigns, see CreateCampaign.
 */
export const listCampaigns = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listDataDeletionJobs = /*@__PURE__*/ API.make(() => ({
 ...
 * CreateDataset.
 */
export const listDatasetExportJobs = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listDatasetGroups = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * CreateDataset.
 */
export const listDatasetImportJobs = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listDatasets = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * information on event trackers, see CreateEventTracker.
 */
export const listEventTrackers = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listFilters = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listMetricAttributionMetrics = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listMetricAttributions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listRecipes = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information on recommenders, see CreateRecommender.
 */
export const listRecommenders = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listSchemas = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * For more information on solutions, see CreateSolution.
 */
export const listSolutions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listSolutionVersions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const startRecommender = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const stopRecommender = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const stopSolutionVersionCreation = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateCampaign = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateMetricAttribution = /*@__PURE__*/ API.make(() => ({
 ...
 * operation.
 */
export const updateRecommender = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateSolution = /*@__PURE__*/ API.make(() => ({
