            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://cognito-sync-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://cognito-sync-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://cognito-sync.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class AlreadyStreamedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AlreadyStreamedException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "AlreadyStreamed", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ConcurrentModificationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConcurrentModificationException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "ConcurrentModification",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class DuplicateRequestException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicateRequestException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "DuplicateRequest", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InternalErrorException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InternalErrorException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InternalError", httpResponseCode: 500 }), T.HttpError(500))).pipe(C.withServerError) {
}
export class InvalidConfigurationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidConfigurationException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidConfiguration", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidLambdaFunctionOutputException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidLambdaFunctionOutputException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
...
export class LambdaThrottledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("LambdaThrottledException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "LambdaThrottled", httpResponseCode: 429 }), T.HttpError(429))).pipe(C.withThrottlingError) {
}
export class LimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("LimitExceededException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "LimitExceeded", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class NotAuthorizedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("NotAuthorizedException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "NotAuthorizedError", httpResponseCode: 403 }), T.HttpError(403))).pipe(C.withAuthError) {
}
export class ResourceConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceConflictException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "ResourceConflict", httpResponseCode: 409 }), T.HttpError(409))).pipe(C.withConflictError) {
}
export class ResourceNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceNotFoundException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "ResourceNotFound", httpResponseCode: 404 }), T.HttpError(404))).pipe(C.withBadRequestError) {
}
export class TooManyRequestsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TooManyRequestsException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "TooManyRequests", httpResponseCode: 429 }), T.HttpError(429))).pipe(C.withThrottlingError) {
}
export const BulkPublishRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BulkPublishResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ IdentityPoolId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "BulkPublishResponse",
});
export const DeleteDatasetRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
...
export const DeleteDatasetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Dataset: S.optional(Dataset) }).pipe(ns)).annotate({
    identifier: "DeleteDatasetResponse",
});
export const DescribeDatasetRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
    DatasetName: S.String.pipe(T.HttpLabel("DatasetName")),
}).pipe(T.all(ns, T.Http({
...
export const DescribeDatasetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Dataset: S.optional(Dataset) }).pipe(ns)).annotate({
    identifier: "DescribeDatasetResponse",
});
export const DescribeIdentityPoolUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
}).pipe(T.all(ns, T.Http({ method: "GET", uri: "/identitypools/{IdentityPoolId}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeIdentityPoolUsageRequest",
});
export const IdentityPoolUsage = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeIdentityPoolUsageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ IdentityPoolUsage: S.optional(IdentityPoolUsage) }).pipe(ns)).annotate({
    identifier: "DescribeIdentityPoolUsageResponse",
});
export const DescribeIdentityUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
}).pipe(T.all(ns, T.Http({
    method: "GET",
...
export const IdentityUsage = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityId: S.optional(S.String),
    IdentityPoolId: S.optional(S.String),
    LastModifiedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    DatasetCount: S.optional(S.Number),
    DataStorage: S.optional(S.Number),
})).annotate({ identifier: "IdentityUsage" });
export const DescribeIdentityUsageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ IdentityUsage: S.optional(IdentityUsage) }).pipe(ns)).annotate({
    identifier: "DescribeIdentityUsageResponse",
});
export const GetBulkPublishDetailsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
}).pipe(T.all(ns, T.Http({
    method: "POST",
...
export const GetBulkPublishDetailsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.optional(S.String),
...
export const GetCognitoEventsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
}).pipe(T.all(ns, T.Http({ method: "GET", uri: "/identitypools/{IdentityPoolId}/events" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetCognitoEventsRequest",
});
export const Events = /*@__PURE__*/ S.Record(S.String, S.String.pipe(S.optional));
export const GetCognitoEventsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Events: S.optional(Events) }).pipe(ns)).annotate({
    identifier: "GetCognitoEventsResponse",
});
export const GetIdentityPoolConfigurationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
}).pipe(T.all(ns, T.Http({
    method: "GET",
...
export const PushSync = /*@__PURE__*/ S.suspend(() => S.Struct({
    ApplicationArns: S.optional(ApplicationArnList),
    RoleArn: S.optional(S.String),
})).annotate({ identifier: "PushSync" });
export const StreamingStatus = /*@__PURE__*/ S.String;
export const CognitoStreams = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    RoleArn: S.optional(S.String),
    StreamingStatus: S.optional(StreamingStatus),
})).annotate({ identifier: "CognitoStreams" });
export const GetIdentityPoolConfigurationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.optional(S.String),
...
export const ListDatasetsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListIdentityPoolUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(T.all(ns, T.Http({ method: "GET", uri: "/identitypools" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListIdentityPoolUsageRequest",
});
export const IdentityPoolUsageList = /*@__PURE__*/ S.Array(IdentityPoolUsage);
export const ListIdentityPoolUsageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListRecordsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
    DatasetName: S.String.pipe(T.HttpLabel("DatasetName")),
...
export const Record = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListRecordsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RegisterDeviceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
    Platform: Platform,
    Token: S.String,
...
export const RegisterDeviceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ DeviceId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "RegisterDeviceResponse",
});
export const SetCognitoEventsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    Events: Events,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/identitypools/{IdentityPoolId}/events" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "SetCognitoEventsRequest",
});
export const SetCognitoEventsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "SetCognitoEventsResponse",
});
export const SetIdentityPoolConfigurationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    PushSync: S.optional(PushSync),
    CognitoStreams: S.optional(CognitoStreams),
}).pipe(T.all(ns, T.Http({
...
export const SetIdentityPoolConfigurationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.optional(S.String),
    PushSync: S.optional(PushSync),
    CognitoStreams: S.optional(CognitoStreams),
}).pipe(ns)).annotate({
...
export const SubscribeToDatasetRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
    DatasetName: S.String.pipe(T.HttpLabel("DatasetName")),
...
export const SubscribeToDatasetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "SubscribeToDatasetResponse",
});
export const UnsubscribeFromDatasetRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
    DatasetName: S.String.pipe(T.HttpLabel("DatasetName")),
    DeviceId: S.String.pipe(T.HttpLabel("DeviceId")),
...
export const UnsubscribeFromDatasetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UnsubscribeFromDatasetResponse",
});
export const Operation = /*@__PURE__*/ S.String;
export const RecordPatch = /*@__PURE__*/ S.suspend(() => S.Struct({
    Op: Operation,
    Key: S.String,
    Value: S.optional(S.String),
    SyncCount: S.Number,
    DeviceLastModifiedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({ identifier: "RecordPatch" });
export const RecordPatchList = /*@__PURE__*/ S.Array(RecordPatch);
export const UpdateRecordsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    IdentityPoolId: S.String.pipe(T.HttpLabel("IdentityPoolId")),
    IdentityId: S.String.pipe(T.HttpLabel("IdentityId")),
    DatasetName: S.String.pipe(T.HttpLabel("DatasetName")),
...
export const UpdateRecordsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Records: S.optional(RecordList) }).pipe(ns)).annotate({
 ...
 */
export const bulkPublish = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const describeIdentityPoolUsage = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const describeIdentityUsage = /*@__PURE__*/ API.make(() => ({
 ...
 * This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.
 */
export const getBulkPublishDetails = /*@__PURE__*/ API.make(() => ({
 ...
 * This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.
 */
export const getCognitoEvents = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const getIdentityPoolConfiguration = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const listDatasets = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const listIdentityPoolUsage = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const listRecords = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const registerDevice = /*@__PURE__*/ API.make(() => ({
 ...
 * This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.
 */
export const setCognitoEvents = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const setIdentityPoolConfiguration = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const subscribeToDataset = /*@__PURE__*/ API.make(() => ({
 ...
 * }
 */
export const unsubscribeFromDataset = /*@__PURE__*/ API.make(() => ({
 ...
 * This API can be called with temporary user credentials provided by Cognito Identity or with developer credentials.
 */
export const updateRecords = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=cognito-sync.js.map