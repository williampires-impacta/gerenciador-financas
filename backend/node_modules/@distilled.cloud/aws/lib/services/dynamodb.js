...
const rules = T.EndpointResolver((p, _) => {
    const { Region, UseDualStack = false, UseFIPS = false, Endpoint, AccountId, AccountIdEndpointMode, ResourceArn, ResourceArnList, } = p;
    const e = (u, p = {}, h = {}) => ({
        type: "endpoint",
    ...
    const _p0 = () => ({ metricValues: ["O"] });
    {
        ...
        if (Endpoint != null &&
            ...
            if (Endpoint ===
                ...
                return err("Endpoint override is not supported for dual-stack endpoints. Please enable dual-stack functionality by enabling the configuration. For more details, see: https://docs.aws.amazon.com/sdkref/latest/guide/feature-endpoints.html");
            }
            return e(`${Endpoint}`);
        }
    }
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                ...
                if (UseFIPS === true && UseDualStack === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true &&
                        ...
                        if (AccountIdEndpointMode != null &&
                            ...
                            return err("Invalid Configuration: AccountIdEndpointMode is required and FIPS is enabled, but FIPS account endpoints are not supported");
                        }
                        return e(`https://dynamodb-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    ...
                    if (_.getAttr(PartitionResult, "supportsDualStack") === true) {
                        {
                            ...
                            if (AccountIdEndpointMode != null &&
                                ...
                                return e(`https://${_.getAttr(ParsedArn, "accountId")}.ddb.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`, _p0(), {});
                            }
                        }
                        {
                        ...
                        if (AccountIdEndpointMode != null &&
                            ...
                            if (_.isValidHostLabel(AccountId, false)) {
                                return e(`https://${AccountId}.ddb.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`, _p0(), {});
                            }
                        ...
                        if (AccountIdEndpointMode != null &&
                            ...
                            if (!(UseFIPS === true)) {
                                if (_.getAttr(PartitionResult, "name") === "aws") {
                                    return err("AccountIdEndpointMode is required but no AccountID was provided or able to be loaded");
                                }
                                return err("Invalid Configuration: AccountIdEndpointMode is required but account endpoints are not supported in this partition");
                            }
                            return err("Invalid Configuration: AccountIdEndpointMode is required and FIPS is enabled, but FIPS account endpoints are not supported");
                        }
                        return e(`https://dynamodb.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                ...
                }
                {
                    ...
                    if (AccountIdEndpointMode != null &&
                        ...
                        _.getAttr(ParsedArn, "region") === `${Region}` &&
                        _.isValidHostLabel(_.getAttr(ParsedArn, "accountId"), false)) {
                        return e(`https://${_.getAttr(ParsedArn, "accountId")}.ddb.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`, _p0(), {});
                    }
                }
                {
                    const FirstArn = _.getAttr(ResourceArnList, "[0]");
                ...
                if (AccountIdEndpointMode != null &&
                    ...
                    AccountId != null) {
                    if (_.isValidHostLabel(AccountId, false)) {
                        return e(`https://${AccountId}.ddb.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`, _p0(), {});
                    }
                    return err("Credentials-sourced account ID parameter is invalid");
                }
                if (AccountIdEndpointMode != null &&
...
export class BackupInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("BackupInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError) {
}
export class BackupNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("BackupNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class ConditionalCheckFailedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConditionalCheckFailedException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    Item: S.optional(S.suspend(() => AttributeMap).annotate({ identifier: "AttributeMap" })),
}).pipe(C.withConflictError) {
}
export class ContinuousBackupsUnavailableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ContinuousBackupsUnavailableException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withRetryableError) {
}
export class DuplicateItemException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicateItemException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError) {
}
export class ExportConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ExportConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError) {
}
export class ExportNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ExportNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class GlobalTableAlreadyExistsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("GlobalTableAlreadyExistsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withAlreadyExistsError) {
}
export class GlobalTableNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("GlobalTableNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class IdempotentParameterMismatchException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IdempotentParameterMismatchException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withBadRequestError) {
}
export class ImportConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ImportConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError) {
}
export class ImportNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ImportNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class IndexNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IndexNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class InternalServerError extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InternalServerError", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withServerError, C.withRetryableError) {
}
export class InvalidEndpointException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidEndpointException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(421)).pipe(C.withBadRequestError) {
}
export class InvalidExportTimeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidExportTimeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withBadRequestError) {
}
export class InvalidRestoreTimeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidRestoreTimeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withBadRequestError) {
}
export class ItemCollectionSizeLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ItemCollectionSizeLimitExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withQuotaError) {
}
export class LimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("LimitExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withQuotaError, C.withRetryableError) {
}
export class PointInTimeRecoveryUnavailableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PointInTimeRecoveryUnavailableException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withBadRequestError) {
}
export class PolicyNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class ProvisionedThroughputExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ProvisionedThroughputExceededException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    ThrottlingReasons: S.optional(S.suspend(() => ThrottlingReasonList).annotate({
        identifier: "ThrottlingReasonList",
    })),
}).pipe(C.withThrottlingError, C.withRetryableError) {
}
export class ReplicaAlreadyExistsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ReplicaAlreadyExistsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withAlreadyExistsError) {
}
export class ReplicaNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ReplicaNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class ReplicatedWriteConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ReplicatedWriteConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.Retryable()).pipe(C.withRetryableError) {
}
export class RequestLimitExceeded extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("RequestLimitExceeded", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    ThrottlingReasons: S.optional(S.suspend(() => ThrottlingReasonList).annotate({
        identifier: "ThrottlingReasonList",
    })),
...
export class ResourceInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withRetryableError) {
}
export class ResourceNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
export class TableAlreadyExistsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TableAlreadyExistsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withAlreadyExistsError) {
}
export class TableInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TableInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withRetryableError) {
}
export class TableNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TableNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withNotFoundError) {
}
...
}, T.all(T.AwsQueryError({ code: "Throttling", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError, C.withThrottlingError, C.withRetryableError) {
}
export class TransactionCanceledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TransactionCanceledException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    CancellationReasons: S.optional(S.suspend(() => CancellationReasonList).annotate({
        identifier: "CancellationReasonList",
    })),
}) {
}
export class TransactionConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TransactionConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withRetryableError) {
}
export class TransactionInProgressException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TransactionInProgressException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }).pipe(C.withConflictError, C.withRetryableError) {
}
...
export const MapAttributeValue = /*@__PURE__*/ S.Record(S.String, S.suspend(() => AttributeValue)
    .annotate({ identifier: "AttributeValue" })
    .pipe(S.optional));
export const ListAttributeValue = /*@__PURE__*/ S.Array(S.suspend(() => AttributeValue).annotate({ identifier: "AttributeValue" }));
...
export const PreparedStatementParameters = /*@__PURE__*/ S.Array(S.suspend(() => AttributeValue).annotate({ identifier: "AttributeValue" }));
export const ReturnValuesOnConditionCheckFailure = /*@__PURE__*/ S.String;
export const BatchStatementRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Statement: S.String,
...
export const BatchExecuteStatementInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AttributeMap = /*@__PURE__*/ S.Record(S.String, S.suspend(() => AttributeValue)
    .annotate({ identifier: "AttributeValue" })
    .pipe(S.optional));
export const BatchStatementError = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BatchStatementResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Capacity = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SecondaryIndexesCapacityMap = /*@__PURE__*/ S.Record(S.String, Capacity.pipe(S.optional));
export const ConsumedCapacity = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    CapacityUnits: S.optional(S.Number),
    ReadCapacityUnits: S.optional(S.Number),
    WriteCapacityUnits: S.optional(S.Number),
...
export const BatchExecuteStatementOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Key = /*@__PURE__*/ S.Record(S.String, S.suspend(() => AttributeValue)
    .annotate({ identifier: "AttributeValue" })
    .pipe(S.optional));
export const KeyList = /*@__PURE__*/ S.Array(Key);
export const AttributeNameList = /*@__PURE__*/ S.Array(S.String);
export const ExpressionAttributeNameMap = /*@__PURE__*/ S.Record(S.String, S.String.pipe(S.optional));
export const KeysAndAttributes = /*@__PURE__*/ S.suspend(() => S.Struct({
    Keys: KeyList,
...
export const BatchGetRequestMap = /*@__PURE__*/ S.Record(S.String, KeysAndAttributes.pipe(S.optional));
export const BatchGetItemInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BatchGetItemOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const PutItemInputAttributeMap = /*@__PURE__*/ S.Record(S.String, S.suspend(() => AttributeValue)
    .annotate({ identifier: "AttributeValue" })
    .pipe(S.optional));
export const PutRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ Item: PutItemInputAttributeMap })).annotate({ identifier: "PutRequest" });
export const DeleteRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ Key: Key })).annotate({ identifier: "DeleteRequest" });
export const WriteRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BatchWriteItemRequestMap = /*@__PURE__*/ S.Record(S.String, WriteRequests.pipe(S.optional));
export const ReturnItemCollectionMetrics = /*@__PURE__*/ S.String;
export const BatchWriteItemInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ItemCollectionKeyAttributeMap = /*@__PURE__*/ S.Record(S.String, S.suspend(() => AttributeValue)
    .annotate({ identifier: "AttributeValue" })
    .pipe(S.optional));
export const ItemCollectionSizeEstimateRange = /*@__PURE__*/ S.Array(S.Number);
export const ItemCollectionMetrics = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ItemCollectionMetricsPerTable = /*@__PURE__*/ S.Record(S.String, ItemCollectionMetricsMultiple.pipe(S.optional));
export const BatchWriteItemOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateBackupInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BackupDetails = /*@__PURE__*/ S.suspend(() => S.Struct({
    BackupArn: S.String,
    BackupName: S.String,
...
})).annotate({ identifier: "BackupDetails" });
export const CreateBackupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ BackupDetails: S.optional(BackupDetails) }).pipe(ns)).annotate({
    identifier: "CreateBackupOutput",
});
export const Replica = /*@__PURE__*/ S.suspend(() => S.Struct({ RegionName: S.optional(S.String) })).annotate({ identifier: "Replica" });
export const ReplicaList = /*@__PURE__*/ S.Array(Replica);
export const CreateGlobalTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ProvisionedThroughputOverride = /*@__PURE__*/ S.suspend(() => S.Struct({ ReadCapacityUnits: S.optional(S.Number) })).annotate({
    identifier: "ProvisionedThroughputOverride",
});
export const OnDemandThroughputOverride = /*@__PURE__*/ S.suspend(() => S.Struct({ MaxReadRequestUnits: S.optional(S.Number) })).annotate({
    identifier: "OnDemandThroughputOverride",
});
export const TableStatus = /*@__PURE__*/ S.String;
export const TableWarmThroughputDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReplicaGlobalSecondaryIndexDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReplicaGlobalSecondaryIndexDescriptionList = /*@__PURE__*/ S.Array(ReplicaGlobalSecondaryIndexDescription);
export const TableClass = /*@__PURE__*/ S.String;
export const TableClassSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReplicaDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GlobalTableDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateGlobalTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ GlobalTableDescription: S.optional(GlobalTableDescription) }).pipe(ns)).annotate({
    identifier: "CreateGlobalTableOutput",
});
export const ScalarAttributeType = /*@__PURE__*/ S.String;
export const AttributeDefinition = /*@__PURE__*/ S.suspend(() => S.Struct({ AttributeName: S.String, AttributeType: ScalarAttributeType })).annotate({
...
export const KeySchemaElement = /*@__PURE__*/ S.suspend(() => S.Struct({ AttributeName: S.String, KeyType: KeyType })).annotate({
...
export const Projection = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const LocalSecondaryIndex = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
    KeySchema: KeySchema,
...
export const ProvisionedThroughput = /*@__PURE__*/ S.suspend(() => S.Struct({ ReadCapacityUnits: S.Number, WriteCapacityUnits: S.Number })).annotate({
    identifier: "ProvisionedThroughput",
});
export const OnDemandThroughput = /*@__PURE__*/ S.suspend(() => S.Struct({
    MaxReadRequestUnits: S.optional(S.Number),
    MaxWriteRequestUnits: S.optional(S.Number),
})).annotate({
    identifier: "OnDemandThroughput",
});
export const WarmThroughput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ReadUnitsPerSecond: S.optional(S.Number),
    WriteUnitsPerSecond: S.optional(S.Number),
})).annotate({ identifier: "WarmThroughput" });
export const GlobalSecondaryIndex = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
    KeySchema: KeySchema,
    Projection: Projection,
...
export const StreamSpecification = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SSESpecification = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ProvisionedThroughputDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BillingModeSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    BillingMode: S.optional(BillingMode),
    LastUpdateToPayPerRequestDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({
    identifier: "BillingModeSummary",
});
export const LocalSecondaryIndexDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
    KeySchema: S.optional(KeySchema),
...
export const LocalSecondaryIndexDescriptionList = /*@__PURE__*/ S.Array(LocalSecondaryIndexDescription);
export const GlobalSecondaryIndexDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
    KeySchema: S.optional(KeySchema),
    Projection: S.optional(Projection),
...
export const GlobalSecondaryIndexDescriptionList = /*@__PURE__*/ S.Array(GlobalSecondaryIndexDescription);
export const WitnessStatus = /*@__PURE__*/ S.String;
export const GlobalTableWitnessDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.optional(S.String),
    WitnessStatus: S.optional(WitnessStatus),
})).annotate({
    identifier: "GlobalTableWitnessDescription",
});
export const GlobalTableWitnessDescriptionList = /*@__PURE__*/ S.Array(GlobalTableWitnessDescription);
export const RestoreSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "RestoreSummary" });
export const SSEStatus = /*@__PURE__*/ S.String;
export const SSEDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "SSEDescription" });
export const ArchivalSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const TableDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    AttributeDefinitions: S.optional(AttributeDefinitions),
    TableName: S.optional(S.String),
    KeySchema: S.optional(KeySchema),
...
export const CreateTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableDescription: S.optional(TableDescription) }).pipe(ns)).annotate({
    identifier: "CreateTableOutput",
});
export const DeleteBackupInput = /*@__PURE__*/ S.suspend(() => S.Struct({ BackupArn: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteBackupInput",
});
export const SourceTableDetails = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String,
    TableId: S.String,
    TableArn: S.optional(S.String),
    TableSizeBytes: S.optional(S.Number),
...
export const LocalSecondaryIndexInfo = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
    KeySchema: S.optional(KeySchema),
    Projection: S.optional(Projection),
})).annotate({
...
export const GlobalSecondaryIndexInfo = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
    KeySchema: S.optional(KeySchema),
    Projection: S.optional(Projection),
    ProvisionedThroughput: S.optional(ProvisionedThroughput),
...
export const TimeToLiveDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    TimeToLiveStatus: S.optional(TimeToLiveStatus),
    AttributeName: S.optional(S.String),
})).annotate({
    identifier: "TimeToLiveDescription",
});
export const SourceTableFeatureDetails = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BackupDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DeleteBackupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ BackupDescription: S.optional(BackupDescription) }).pipe(ns)).annotate({
    identifier: "DeleteBackupOutput",
});
export const ComparisonOperator = /*@__PURE__*/ S.String;
export const AttributeValueList = /*@__PURE__*/ S.Array(S.suspend(() => AttributeValue).annotate({ identifier: "AttributeValue" }));
export const ExpectedAttributeValue = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ExpectedAttributeMap = /*@__PURE__*/ S.Record(S.String, ExpectedAttributeValue.pipe(S.optional));
export const ConditionalOperator = /*@__PURE__*/ S.String;
export const ReturnValue = /*@__PURE__*/ S.String;
export const ExpressionAttributeValueMap = /*@__PURE__*/ S.Record(S.String, S.suspend(() => AttributeValue)
    .annotate({ identifier: "AttributeValue" })
    .pipe(S.optional));
export const DeleteItemInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    Key: Key,
...
export const DeleteItemOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DeleteResourcePolicyInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DeleteResourcePolicyOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ RevisionId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "DeleteResourcePolicyOutput",
});
export const DeleteTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableName: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteTableInput",
});
export const DeleteTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableDescription: S.optional(TableDescription) }).pipe(ns)).annotate({
    identifier: "DeleteTableOutput",
});
export const DescribeBackupInput = /*@__PURE__*/ S.suspend(() => S.Struct({ BackupArn: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeBackupInput",
});
export const DescribeBackupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ BackupDescription: S.optional(BackupDescription) }).pipe(ns)).annotate({
    identifier: "DescribeBackupOutput",
});
export const DescribeContinuousBackupsInput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableName: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const PointInTimeRecoveryDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const FailureException = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeContributorInsightsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    IndexName: S.optional(S.String),
...
export const DescribeEndpointsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeEndpointsRequest",
});
export const Endpoint = /*@__PURE__*/ S.suspend(() => S.Struct({ Address: S.String, CachePeriodInMinutes: S.Number })).annotate({ identifier: "Endpoint" });
export const Endpoints = /*@__PURE__*/ S.Array(Endpoint);
export const DescribeEndpointsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Endpoints: Endpoints }).pipe(ns)).annotate({
    identifier: "DescribeEndpointsResponse",
});
export const DescribeExportInput = /*@__PURE__*/ S.suspend(() => S.Struct({ ExportArn: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const IncrementalExportSpecification = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ExportDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeExportOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ ExportDescription: S.optional(ExportDescription) }).pipe(ns)).annotate({
    identifier: "DescribeExportOutput",
});
export const DescribeGlobalTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    GlobalTableName: S.String.pipe(T.ContextParam("ResourceArn")),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeGlobalTableInput",
});
export const DescribeGlobalTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ GlobalTableDescription: S.optional(GlobalTableDescription) }).pipe(ns)).annotate({
    identifier: "DescribeGlobalTableOutput",
});
export const DescribeGlobalTableSettingsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    GlobalTableName: S.String.pipe(T.ContextParam("ResourceArn")),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const AutoScalingPolicyDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicyName: S.optional(S.String),
    TargetTrackingScalingPolicyConfiguration: S.optional(AutoScalingTargetTrackingScalingPolicyConfigurationDescription),
})).annotate({
...
export const AutoScalingSettingsDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReplicaSettingsDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.String,
    ReplicaStatus: S.optional(ReplicaStatus),
...
export const DescribeGlobalTableSettingsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    GlobalTableName: S.optional(S.String),
    ReplicaSettings: S.optional(ReplicaSettingsDescriptionList),
}).pipe(ns)).annotate({
    identifier: "DescribeGlobalTableSettingsOutput",
});
export const DescribeImportInput = /*@__PURE__*/ S.suspend(() => S.Struct({ ImportArn: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeImportInput",
});
export const ImportStatus = /*@__PURE__*/ S.String;
export const S3BucketSource = /*@__PURE__*/ S.suspend(() => S.Struct({
    S3BucketOwner: S.optional(S.String),
    S3Bucket: S.String,
    S3KeyPrefix: S.optional(S.String),
})).annotate({ identifier: "S3BucketSource" });
export const InputFormat = /*@__PURE__*/ S.String;
export const CsvHeaderList = /*@__PURE__*/ S.Array(S.String);
export const CsvOptions = /*@__PURE__*/ S.suspend(() => S.Struct({
    Delimiter: S.optional(S.String),
    HeaderList: S.optional(CsvHeaderList),
})).annotate({ identifier: "CsvOptions" });
export const InputFormatOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ Csv: S.optional(CsvOptions) })).annotate({
    identifier: "InputFormatOptions",
});
export const InputCompressionType = /*@__PURE__*/ S.String;
export const TableCreationParameters = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String,
...
export const ImportTableDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeImportOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ ImportTableDescription: ImportTableDescription }).pipe(ns)).annotate({
    identifier: "DescribeImportOutput",
});
export const DescribeKinesisStreamingDestinationInput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableName: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const KinesisDataStreamDestination = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeLimitsInput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeLimitsInput",
});
export const DescribeLimitsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableName: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeTableInput",
});
export const DescribeTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Table: S.optional(TableDescription) }).pipe(ns)).annotate({
    identifier: "DescribeTableOutput",
});
export const DescribeTableReplicaAutoScalingInput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableName: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ReplicaAutoScalingDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.optional(S.String),
...
export const ReplicaAutoScalingDescriptionList = /*@__PURE__*/ S.Array(ReplicaAutoScalingDescription);
export const TableAutoScalingDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    TableStatus: S.optional(TableStatus),
...
export const DescribeTableReplicaAutoScalingOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableAutoScalingDescription: S.optional(TableAutoScalingDescription),
}).pipe(ns)).annotate({
    identifier: "DescribeTableReplicaAutoScalingOutput",
});
export const DescribeTimeToLiveInput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableName: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeTimeToLiveInput",
});
export const DescribeTimeToLiveOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ TimeToLiveDescription: S.optional(TimeToLiveDescription) }).pipe(ns)).annotate({
    identifier: "DescribeTimeToLiveOutput",
});
export const EnableKinesisStreamingConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    ApproximateCreationDateTimePrecision: S.optional(ApproximateCreationDateTimePrecision),
})).annotate({
    identifier: "EnableKinesisStreamingConfiguration",
});
export const KinesisStreamingDestinationInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    StreamArn: S.String,
...
export const KinesisStreamingDestinationOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    StreamArn: S.optional(S.String),
    DestinationStatus: S.optional(DestinationStatus),
    EnableKinesisStreamingConfiguration: S.optional(EnableKinesisStreamingConfiguration),
...
export const ExecuteStatementInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Statement: S.String,
    Parameters: S.optional(PreparedStatementParameters),
    ConsistentRead: S.optional(S.Boolean),
...
export const ExecuteStatementOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ParameterizedStatement = /*@__PURE__*/ S.suspend(() => S.Struct({
    Statement: S.String,
    Parameters: S.optional(PreparedStatementParameters),
    ReturnValuesOnConditionCheckFailure: S.optional(ReturnValuesOnConditionCheckFailure),
})).annotate({
...
export const ExecuteTransactionInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ItemResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Item: S.optional(AttributeMap) })).annotate({ identifier: "ItemResponse" });
export const ItemResponseList = /*@__PURE__*/ S.Array(ItemResponse);
export const ExecuteTransactionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Responses: S.optional(ItemResponseList),
    ConsumedCapacity: S.optional(ConsumedCapacityMultiple),
}).pipe(ns)).annotate({
    identifier: "ExecuteTransactionOutput",
});
export const ExportTableToPointInTimeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ExportTableToPointInTimeOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ ExportDescription: S.optional(ExportDescription) }).pipe(ns)).annotate({
    identifier: "ExportTableToPointInTimeOutput",
});
export const GetItemInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    Key: Key,
    AttributesToGet: S.optional(AttributeNameList),
    ConsistentRead: S.optional(S.Boolean),
    ...
    ProjectionExpression: S.optional(S.String),
    ExpressionAttributeNames: S.optional(ExpressionAttributeNameMap),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetItemInput" });
export const GetItemOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Item: S.optional(AttributeMap),
    ConsumedCapacity: S.optional(ConsumedCapacity),
}).pipe(ns)).annotate({ identifier: "GetItemOutput" });
export const GetResourcePolicyInput = /*@__PURE__*/ S.suspend(() => S.Struct({ ResourceArn: S.String.pipe(T.ContextParam("ResourceArn")) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetResourcePolicyInput",
});
export const GetResourcePolicyOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Policy: S.optional(S.String),
    RevisionId: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "GetResourcePolicyOutput",
});
export const ImportTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ClientToken: S.optional(S.String).pipe(T.IdempotencyToken()),
...
export const ImportTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ ImportTableDescription: ImportTableDescription }).pipe(ns)).annotate({
    identifier: "ImportTableOutput",
});
export const BackupTypeFilter = /*@__PURE__*/ S.String;
export const ListBackupsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BackupSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    TableId: S.optional(S.String),
    TableArn: S.optional(S.String),
...
export const ContributorInsightsSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    IndexName: S.optional(S.String),
    ContributorInsightsStatus: S.optional(ContributorInsightsStatus),
    ContributorInsightsMode: S.optional(ContributorInsightsMode),
...
export const ListContributorInsightsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ContributorInsightsSummaries: S.optional(ContributorInsightsSummaries),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListContributorInsightsOutput",
});
export const ListExportsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ExportSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    ExportArn: S.optional(S.String),
    ExportStatus: S.optional(ExportStatus),
    ExportType: S.optional(ExportType),
})).annotate({ identifier: "ExportSummary" });
export const ExportSummaries = /*@__PURE__*/ S.Array(ExportSummary);
export const ListExportsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ExportSummaries: S.optional(ExportSummaries),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListExportsOutput",
});
export const ListGlobalTablesInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ImportSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    ImportArn: S.optional(S.String),
    ImportStatus: S.optional(ImportStatus),
    TableArn: S.optional(S.String),
    S3BucketSource: S.optional(S3BucketSource),
    ...
    StartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    EndTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({ identifier: "ImportSummary" });
export const ImportSummaryList = /*@__PURE__*/ S.Array(ImportSummary);
export const ListImportsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ImportSummaryList: S.optional(ImportSummaryList),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListImportsOutput",
});
export const ListTablesInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListTablesOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableNames: S.optional(TableNameList),
    LastEvaluatedTableName: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListTablesOutput",
});
export const ListTagsOfResourceInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResourceArn: S.String.pipe(T.ContextParam("ResourceArn")),
    NextToken: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListTagsOfResourceInput",
});
export const ListTagsOfResourceOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Tags: S.optional(TagList), NextToken: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "ListTagsOfResourceOutput",
});
export const PutItemInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    ...
    ExpressionAttributeValues: S.optional(ExpressionAttributeValueMap),
    ReturnValuesOnConditionCheckFailure: S.optional(ReturnValuesOnConditionCheckFailure),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "PutItemInput" });
export const PutItemOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Attributes: S.optional(AttributeMap),
    ConsumedCapacity: S.optional(ConsumedCapacity),
    ItemCollectionMetrics: S.optional(ItemCollectionMetrics),
}).pipe(ns)).annotate({ identifier: "PutItemOutput" });
export const PutResourcePolicyInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResourceArn: S.String.pipe(T.ContextParam("ResourceArn")),
    Policy: S.String,
    ExpectedRevisionId: S.optional(S.String),
    ConfirmRemoveSelfResourceAccess: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-confirm-remove-self-resource-access")),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "PutResourcePolicyInput",
});
export const PutResourcePolicyOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ RevisionId: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "PutResourcePolicyOutput",
});
export const Select = /*@__PURE__*/ S.String;
export const Condition = /*@__PURE__*/ S.suspend(() => S.Struct({
    AttributeValueList: S.optional(AttributeValueList),
...
export const QueryInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    IndexName: S.optional(S.String),
    ...
    ExpressionAttributeNames: S.optional(ExpressionAttributeNameMap),
    ExpressionAttributeValues: S.optional(ExpressionAttributeValueMap),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "QueryInput" });
export const QueryOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Items: S.optional(ItemList),
    Count: S.optional(S.Number),
    ScannedCount: S.optional(S.Number),
    LastEvaluatedKey: S.optional(Key),
    ConsumedCapacity: S.optional(ConsumedCapacity),
}).pipe(ns)).annotate({ identifier: "QueryOutput" });
export const RestoreTableFromBackupInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RestoreTableFromBackupOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableDescription: S.optional(TableDescription) }).pipe(ns)).annotate({
    identifier: "RestoreTableFromBackupOutput",
});
export const RestoreTableToPointInTimeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    SourceTableArn: S.optional(S.String),
...
export const RestoreTableToPointInTimeOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableDescription: S.optional(TableDescription) }).pipe(ns)).annotate({
    identifier: "RestoreTableToPointInTimeOutput",
});
export const ScanInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    IndexName: S.optional(S.String),
    AttributesToGet: S.optional(AttributeNameList),
    Limit: S.optional(S.Number),
    ...
    ExpressionAttributeValues: S.optional(ExpressionAttributeValueMap),
    ConsistentRead: S.optional(S.Boolean),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "ScanInput" });
export const ScanOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Items: S.optional(ItemList),
    Count: S.optional(S.Number),
    ScannedCount: S.optional(S.Number),
    LastEvaluatedKey: S.optional(Key),
    ConsumedCapacity: S.optional(ConsumedCapacity),
}).pipe(ns)).annotate({ identifier: "ScanOutput" });
export const TagResourceInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResourceArn: S.String.pipe(T.ContextParam("ResourceArn")),
    Tags: TagList,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const Get = /*@__PURE__*/ S.suspend(() => S.Struct({
    Key: Key,
    TableName: S.String,
    ProjectionExpression: S.optional(S.String),
    ExpressionAttributeNames: S.optional(ExpressionAttributeNameMap),
})).annotate({ identifier: "Get" });
...
export const TransactGetItemsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TransactItems: TransactGetItemList,
    ReturnConsumedCapacity: S.optional(ReturnConsumedCapacity),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "TransactGetItemsInput",
});
export const TransactGetItemsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ConsumedCapacity: S.optional(ConsumedCapacityMultiple),
    Responses: S.optional(ItemResponseList),
}).pipe(ns)).annotate({
    identifier: "TransactGetItemsOutput",
});
export const ConditionCheck = /*@__PURE__*/ S.suspend(() => S.Struct({
    Key: Key,
    TableName: S.String,
    ...
    ExpressionAttributeValues: S.optional(ExpressionAttributeValueMap),
    ReturnValuesOnConditionCheckFailure: S.optional(ReturnValuesOnConditionCheckFailure),
})).annotate({ identifier: "ConditionCheck" });
export const Put = /*@__PURE__*/ S.suspend(() => S.Struct({
    Item: PutItemInputAttributeMap,
    TableName: S.String,
    ConditionExpression: S.optional(S.String),
    ExpressionAttributeNames: S.optional(ExpressionAttributeNameMap),
    ExpressionAttributeValues: S.optional(ExpressionAttributeValueMap),
    ReturnValuesOnConditionCheckFailure: S.optional(ReturnValuesOnConditionCheckFailure),
})).annotate({ identifier: "Put" });
export const Delete = /*@__PURE__*/ S.suspend(() => S.Struct({
    Key: Key,
    TableName: S.String,
    ConditionExpression: S.optional(S.String),
    ExpressionAttributeNames: S.optional(ExpressionAttributeNameMap),
...
export const Update = /*@__PURE__*/ S.suspend(() => S.Struct({
    Key: Key,
...
export const TransactWriteItem = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const TransactWriteItemsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const TransactWriteItemsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ConsumedCapacity: S.optional(ConsumedCapacityMultiple),
    ItemCollectionMetrics: S.optional(ItemCollectionMetricsPerTable),
}).pipe(ns)).annotate({
...
export const UntagResourceInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResourceArn: S.String.pipe(T.ContextParam("ResourceArn")),
    TagKeys: TagKeyList,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const PointInTimeRecoverySpecification = /*@__PURE__*/ S.suspend(() => S.Struct({
    PointInTimeRecoveryEnabled: S.Boolean,
    RecoveryPeriodInDays: S.optional(S.Number),
})).annotate({
    identifier: "PointInTimeRecoverySpecification",
});
export const UpdateContinuousBackupsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    PointInTimeRecoverySpecification: PointInTimeRecoverySpecification,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateContinuousBackupsInput",
});
export const UpdateContinuousBackupsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ContinuousBackupsDescription: S.optional(ContinuousBackupsDescription),
}).pipe(ns)).annotate({
    identifier: "UpdateContinuousBackupsOutput",
});
export const ContributorInsightsAction = /*@__PURE__*/ S.String;
export const UpdateContributorInsightsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    IndexName: S.optional(S.String),
...
export const UpdateContributorInsightsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    IndexName: S.optional(S.String),
    ContributorInsightsStatus: S.optional(ContributorInsightsStatus),
    ContributorInsightsMode: S.optional(ContributorInsightsMode),
...
export const CreateReplicaAction = /*@__PURE__*/ S.suspend(() => S.Struct({ RegionName: S.String })).annotate({
    identifier: "CreateReplicaAction",
});
export const DeleteReplicaAction = /*@__PURE__*/ S.suspend(() => S.Struct({ RegionName: S.String })).annotate({
    identifier: "DeleteReplicaAction",
});
export const ReplicaUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    Create: S.optional(CreateReplicaAction),
    Delete: S.optional(DeleteReplicaAction),
})).annotate({ identifier: "ReplicaUpdate" });
export const ReplicaUpdateList = /*@__PURE__*/ S.Array(ReplicaUpdate);
export const UpdateGlobalTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    GlobalTableName: S.String.pipe(T.ContextParam("ResourceArn")),
    ReplicaUpdates: ReplicaUpdateList,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateGlobalTableInput",
});
export const UpdateGlobalTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ GlobalTableDescription: S.optional(GlobalTableDescription) }).pipe(ns)).annotate({
...
export const AutoScalingPolicyUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicyName: S.optional(S.String),
    TargetTrackingScalingPolicyConfiguration: AutoScalingTargetTrackingScalingPolicyConfigurationUpdate,
})).annotate({
    identifier: "AutoScalingPolicyUpdate",
});
export const AutoScalingSettingsUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    MinimumUnits: S.optional(S.Number),
    MaximumUnits: S.optional(S.Number),
    AutoScalingDisabled: S.optional(S.Boolean),
    AutoScalingRoleArn: S.optional(S.String),
...
export const ReplicaSettingsUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.String,
    ReplicaProvisionedReadCapacityUnits: S.optional(S.Number),
    ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate: S.optional(AutoScalingSettingsUpdate),
    ReplicaGlobalSecondaryIndexSettingsUpdate: S.optional(ReplicaGlobalSecondaryIndexSettingsUpdateList),
...
export const UpdateGlobalTableSettingsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    GlobalTableName: S.String.pipe(T.ContextParam("ResourceArn")),
    GlobalTableBillingMode: S.optional(BillingMode),
    GlobalTableProvisionedWriteCapacityUnits: S.optional(S.Number),
    GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate: S.optional(AutoScalingSettingsUpdate),
    GlobalTableGlobalSecondaryIndexSettingsUpdate: S.optional(GlobalTableGlobalSecondaryIndexSettingsUpdateList),
    ReplicaSettingsUpdate: S.optional(ReplicaSettingsUpdateList),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateGlobalTableSettingsInput",
});
export const UpdateGlobalTableSettingsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    GlobalTableName: S.optional(S.String),
    ReplicaSettings: S.optional(ReplicaSettingsDescriptionList),
}).pipe(ns)).annotate({
...
export const AttributeValueUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    Value: S.optional(AttributeValue),
    Action: S.optional(AttributeAction),
})).annotate({
    identifier: "AttributeValueUpdate",
});
export const AttributeUpdates = /*@__PURE__*/ S.Record(S.String, AttributeValueUpdate.pipe(S.optional));
export const UpdateItemInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    Key: Key,
...
export const UpdateItemOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Attributes: S.optional(AttributeMap),
    ConsumedCapacity: S.optional(ConsumedCapacity),
    ItemCollectionMetrics: S.optional(ItemCollectionMetrics),
}).pipe(ns)).annotate({
...
export const UpdateKinesisStreamingConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    ApproximateCreationDateTimePrecision: S.optional(ApproximateCreationDateTimePrecision),
})).annotate({
    identifier: "UpdateKinesisStreamingConfiguration",
});
export const UpdateKinesisStreamingDestinationInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    StreamArn: S.String,
...
export const UpdateKinesisStreamingDestinationOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.optional(S.String),
    StreamArn: S.optional(S.String),
    DestinationStatus: S.optional(DestinationStatus),
    UpdateKinesisStreamingConfiguration: S.optional(UpdateKinesisStreamingConfiguration),
...
export const UpdateGlobalSecondaryIndexAction = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
    ProvisionedThroughput: S.optional(ProvisionedThroughput),
    OnDemandThroughput: S.optional(OnDemandThroughput),
    WarmThroughput: S.optional(WarmThroughput),
...
export const CreateGlobalSecondaryIndexAction = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
    KeySchema: KeySchema,
    Projection: Projection,
    ProvisionedThroughput: S.optional(ProvisionedThroughput),
...
export const DeleteGlobalSecondaryIndexAction = /*@__PURE__*/ S.suspend(() => S.Struct({ IndexName: S.String })).annotate({
    identifier: "DeleteGlobalSecondaryIndexAction",
});
export const GlobalSecondaryIndexUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ReplicaGlobalSecondaryIndex = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
    ProvisionedThroughputOverride: S.optional(ProvisionedThroughputOverride),
    OnDemandThroughputOverride: S.optional(OnDemandThroughputOverride),
})).annotate({
...
export const CreateReplicationGroupMemberAction = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.String,
    KMSMasterKeyId: S.optional(S.String),
    ProvisionedThroughputOverride: S.optional(ProvisionedThroughputOverride),
    OnDemandThroughputOverride: S.optional(OnDemandThroughputOverride),
...
export const UpdateReplicationGroupMemberAction = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.String,
    KMSMasterKeyId: S.optional(S.String),
    ProvisionedThroughputOverride: S.optional(ProvisionedThroughputOverride),
    OnDemandThroughputOverride: S.optional(OnDemandThroughputOverride),
...
export const DeleteReplicationGroupMemberAction = /*@__PURE__*/ S.suspend(() => S.Struct({ RegionName: S.String })).annotate({
    identifier: "DeleteReplicationGroupMemberAction",
});
export const ReplicationGroupUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GlobalTableWitnessGroupUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GlobalTableWitnessGroupUpdateList = /*@__PURE__*/ S.Array(GlobalTableWitnessGroupUpdate);
export const UpdateTableInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    AttributeDefinitions: S.optional(AttributeDefinitions),
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    BillingMode: S.optional(BillingMode),
    ProvisionedThroughput: S.optional(ProvisionedThroughput),
...
export const UpdateTableOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ TableDescription: S.optional(TableDescription) }).pipe(ns)).annotate({
    identifier: "UpdateTableOutput",
});
export const GlobalSecondaryIndexAutoScalingUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
...
export const GlobalSecondaryIndexAutoScalingUpdateList = /*@__PURE__*/ S.Array(GlobalSecondaryIndexAutoScalingUpdate);
...
export const ReplicaAutoScalingUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RegionName: S.String,
    ReplicaGlobalSecondaryIndexUpdates: S.optional(ReplicaGlobalSecondaryIndexAutoScalingUpdateList),
...
export const UpdateTableReplicaAutoScalingInput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const UpdateTableReplicaAutoScalingOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableAutoScalingDescription: S.optional(TableAutoScalingDescription),
}).pipe(ns)).annotate({
    identifier: "UpdateTableReplicaAutoScalingOutput",
});
export const TimeToLiveSpecification = /*@__PURE__*/ S.suspend(() => S.Struct({ Enabled: S.Boolean, AttributeName: S.String })).annotate({
    identifier: "TimeToLiveSpecification",
});
export const UpdateTimeToLiveInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    TimeToLiveSpecification: TimeToLiveSpecification,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateTimeToLiveInput",
});
export const UpdateTimeToLiveOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TimeToLiveSpecification: S.optional(TimeToLiveSpecification),
}).pipe(ns)).annotate({
    identifier: "UpdateTimeToLiveOutput",
});
export const ThrottlingReason = /*@__PURE__*/ S.suspend(() => S.Struct({ reason: S.optional(S.String), resource: S.optional(S.String) })).annotate({
    identifier: "ThrottlingReason",
});
export const ThrottlingReasonList = /*@__PURE__*/ S.Array(ThrottlingReason);
export const CancellationReason = /*@__PURE__*/ S.suspend(() => S.Struct({
    Item: S.optional(AttributeMap),
 ...
 * statement.
 */
export const batchExecuteStatement = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const batchGetItem = /*@__PURE__*/ API.make(() => ({
 ...
 * bytes.
 */
export const batchWriteItem = /*@__PURE__*/ API.make(() => ({
 ...
 * your global table.
 */
export const createGlobalTable = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createTable = /*@__PURE__*/ API.make(() => ({
 ...
 * deleted.
 */
export const deleteItem = /*@__PURE__*/ API.make(() => ({
 ...
 * request again.
 */
export const deleteResourcePolicy = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteTable = /*@__PURE__*/ API.make(() => ({
 ...
 * second.
 */
export const describeBackup = /*@__PURE__*/ API.make(() => ({
 ...
 * second.
 */
export const describeContinuousBackups = /*@__PURE__*/ API.make(() => ({
 ...
 * index.
 */
export const describeContributorInsights = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeEndpoints = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeExport = /*@__PURE__*/ API.make(() => ({
 ...
 * To determine which version you're using, see Determining the global table version you are using. To update existing global tables from version 2017.11.29 (Legacy) to version 2019.11.21 (Current), see Upgrading global tables.
 */
export const describeGlobalTable = /*@__PURE__*/ API.make(() => ({
 ...
 * To determine which version you're using, see Determining the global table version you are using. To update existing global tables from version 2017.11.29 (Legacy) to version 2019.11.21 (Current), see Upgrading global tables.
 */
export const describeGlobalTableSettings = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeImport = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeKinesisStreamingDestination = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeLimits = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeTable = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeTableReplicaAutoScaling = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeTimeToLive = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const disableKinesisStreamingDestination = /*@__PURE__*/ API.make(() => ({
 ...
 * is ACTIVE.
 */
export const enableKinesisStreamingDestination = /*@__PURE__*/ API.make(() => ({
    input: KinesisStreamingDestinationInput,
    output: KinesisStreamingDestinationOutput,
    errors: [
        InternalServerError,
 ...
 */
export const executeStatement = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const executeTransaction = /*@__PURE__*/ API.make(() => ({
 ...
 * window.
 */
export const exportTableToPointInTime = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getItem = /*@__PURE__*/ API.make(() => ({
    input: GetItemInput,
 ...
 */
export const getResourcePolicy = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const importTable = /*@__PURE__*/ API.make(() => ({
 ...
 * list API.
 */
export const listBackups = /*@__PURE__*/ API.make(() => ({
 ...
 * indexes.
 */
export const listContributorInsights = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listExports = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * To determine which version you're using, see Determining the global table version you are using. To update existing global tables from version 2017.11.29 (Legacy) to version 2019.11.21 (Current), see Upgrading global tables.
 */
export const listGlobalTables = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listImports = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * 100 table names.
 */
export const listTables = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listTagsOfResource = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const putItem = /*@__PURE__*/ API.make(() => ({
    input: PutItemInput,
 ...
 */
export const putResourcePolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * index.
 */
export const query = /*@__PURE__*/ API.makePaginated(() => ({
    input: QueryInput,
    output: QueryOutput,
    errors: [
        InternalServerError,
 ...
 */
export const restoreTableFromBackup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const restoreTableToPointInTime = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const scan = /*@__PURE__*/ API.makePaginated(() => ({
    input: ScanInput,
    output: ScanOutput,
    errors: [
        InternalServerError,
 ...
 */
export const transactGetItems = /*@__PURE__*/ API.make(() => ({
 ...
 * - There is a user error, such as an invalid data format.
 */
export const transactWriteItems = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateContinuousBackups = /*@__PURE__*/ API.make(() => ({
 ...
 * for this table.
 */
export const updateContributorInsights = /*@__PURE__*/ API.make(() => ({
 ...
 * capacity units.
 */
export const updateGlobalTable = /*@__PURE__*/ API.make(() => ({
 ...
 * To determine which version you're using, see Determining the global table version you are using. To update existing global tables from version 2017.11.29 (Legacy) to version 2019.11.21 (Current), see Upgrading global tables.
 */
export const updateGlobalTableSettings = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateItem = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateKinesisStreamingDestination = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateTable = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateTableReplicaAutoScaling = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateTimeToLive = /*@__PURE__*/ API.make(() => ({
