    ...
    if (Region != null) {
        {
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                ...
                if (_.getAttr(PartitionResult, "name") === "aws-cn" &&
                    UseFIPS === false &&
                    UseDualStack === false) {
                    return e("https://organizations.cn-northwest-1.amazonaws.com.cn", {
                        authSchemes: [
                            {
                                name: "sigv4",
                                signingName: "organizations",
                ...
                if (_.getAttr(PartitionResult, "name") === "aws-iso" &&
                    UseFIPS === false &&
                    UseDualStack === false) {
                    return e("https://organizations.us-iso-east-1.c2s.ic.gov", {
                        authSchemes: [
                            {
                                name: "sigv4",
                                signingName: "organizations",
                ...
                if (_.getAttr(PartitionResult, "name") === "aws-iso-b" &&
                    UseFIPS === false &&
                    UseDualStack === false) {
                    return e("https://organizations.us-isob-east-1.sc2s.sgov.gov", {
                        authSchemes: [
                            {
                                name: "sigv4",
                                signingName: "organizations",
                ...
                if (_.getAttr(PartitionResult, "name") === "aws-iso-f" &&
                    UseFIPS === false &&
                    UseDualStack === false) {
                    return e("https://organizations.us-isof-south-1.csp.hci.ic.gov", {
                        authSchemes: [
                            {
                                name: "sigv4",
                                signingName: "organizations",
                ...
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://organizations-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://organizations-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://organizations.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class AccessDeniedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccessDeniedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(403)).pipe(C.withAuthError) {
}
export class AccessDeniedForDependencyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccessDeniedForDependencyException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    Reason: S.optional(S.suspend(() => AccessDeniedForDependencyExceptionReason).annotate({
        identifier: "AccessDeniedForDependencyExceptionReason",
    })),
}, T.HttpError(403)).pipe(C.withAuthError) {
}
export class AccountAlreadyClosedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccountAlreadyClosedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class AccountAlreadyRegisteredException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccountAlreadyRegisteredException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class AccountNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccountNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class AccountNotRegisteredException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccountNotRegisteredException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class AccountOwnerNotVerifiedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AccountOwnerNotVerifiedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(403)).pipe(C.withAuthError) {
}
export class AlreadyInOrganizationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AlreadyInOrganizationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class AWSOrganizationsNotInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("AWSOrganizationsNotInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class ChildNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ChildNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class ConcurrentModificationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConcurrentModificationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ConstraintViolationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConstraintViolationException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    Reason: S.optional(S.suspend(() => ConstraintViolationExceptionReason).annotate({
        identifier: "ConstraintViolationExceptionReason",
    })),
}, T.HttpError(409)).pipe(C.withConflictError) {
}
export class CreateAccountStatusNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CreateAccountStatusNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class DestinationParentNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DestinationParentNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class DuplicateAccountException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicateAccountException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class DuplicateHandshakeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicateHandshakeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class DuplicateOrganizationalUnitException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicateOrganizationalUnitException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class DuplicatePolicyAttachmentException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicatePolicyAttachmentException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class DuplicatePolicyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicatePolicyException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class EffectivePolicyNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("EffectivePolicyNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class FinalizingOrganizationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("FinalizingOrganizationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class HandshakeAlreadyInStateException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("HandshakeAlreadyInStateException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class HandshakeConstraintViolationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("HandshakeConstraintViolationException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    Reason: S.optional(S.suspend(() => HandshakeConstraintViolationExceptionReason).annotate({
        identifier: "HandshakeConstraintViolationExceptionReason",
    })),
}, T.HttpError(409)).pipe(C.withConflictError) {
}
export class HandshakeNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("HandshakeNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class InvalidHandshakeTransitionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidHandshakeTransitionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class InvalidInputException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidInputException", {
    message: S.optional(S.String).pipe(T.ErrorMessage()),
    Reason: S.optional(S.suspend(() => InvalidInputExceptionReason).annotate({
        identifier: "InvalidInputExceptionReason",
    })),
}, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class InvalidResponsibilityTransferTransitionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidResponsibilityTransferTransitionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class MalformedPolicyDocumentException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MalformedPolicyDocumentException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class MasterCannotLeaveOrganizationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MasterCannotLeaveOrganizationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class OrganizationalUnitNotEmptyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("OrganizationalUnitNotEmptyException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class OrganizationalUnitNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("OrganizationalUnitNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class OrganizationNotEmptyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("OrganizationNotEmptyException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ParentNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ParentNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class PolicyChangesInProgressException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyChangesInProgressException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class PolicyInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class PolicyNotAttachedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyNotAttachedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class PolicyNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class PolicyTypeAlreadyEnabledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyTypeAlreadyEnabledException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class PolicyTypeNotAvailableForOrganizationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyTypeNotAvailableForOrganizationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class PolicyTypeNotEnabledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PolicyTypeNotEnabledException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ResourcePolicyNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourcePolicyNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class ResponsibilityTransferAlreadyInStatusException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResponsibilityTransferAlreadyInStatusException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class ResponsibilityTransferNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResponsibilityTransferNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class RootNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("RootNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class ServiceException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServiceException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(500)).pipe(C.withServerError) {
}
export class SourceParentNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("SourceParentNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class TargetNotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TargetNotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class TooManyRequestsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TooManyRequestsException", {
    Type: S.optional(S.String),
    message: S.optional(S.String).pipe(T.ErrorMessage()),
}, T.HttpError(429)).pipe(C.withThrottlingError) {
}
export class UnsupportedAPIEndpointException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("UnsupportedAPIEndpointException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(403)).pipe(C.withAuthError) {
}
export const AcceptHandshakeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HandshakeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "AcceptHandshakeRequest",
});
export const HandshakePartyType = /*@__PURE__*/ S.String;
export const HandshakeParty = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: SensitiveString, Type: HandshakePartyType })).annotate({ identifier: "HandshakeParty" });
...
export const HandshakeResource = /*@__PURE__*/ S.suspend(() => S.Struct({
    Value: S.optional(SensitiveString),
    Type: S.optional(HandshakeResourceType),
    Resources: S.optional(S.suspend(() => HandshakeResources).annotate({
        identifier: "HandshakeResources",
    })),
})).annotate({
    identifier: "HandshakeResource",
});
export const HandshakeResources = /*@__PURE__*/ S.Array(S.suspend(() => HandshakeResource).annotate({
    identifier: "HandshakeResource",
}));
export const Handshake = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AcceptHandshakeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
    identifier: "AcceptHandshakeResponse",
});
export const AttachPolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ PolicyId: S.String, TargetId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const CancelHandshakeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HandshakeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CancelHandshakeRequest",
});
export const CancelHandshakeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
    identifier: "CancelHandshakeResponse",
});
export const CloseAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AccountId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const CreateAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateAccountStatus = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
...
export const CreateAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ CreateAccountStatus: S.optional(CreateAccountStatus) }).pipe(ns)).annotate({
    identifier: "CreateAccountResponse",
});
export const CreateGovCloudAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Email: SensitiveString,
    AccountName: SensitiveString,
    RoleName: S.optional(S.String),
    IamUserAccessToBilling: S.optional(IAMUserAccessToBilling),
...
export const CreateGovCloudAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ CreateAccountStatus: S.optional(CreateAccountStatus) }).pipe(ns)).annotate({
    identifier: "CreateGovCloudAccountResponse",
});
export const OrganizationFeatureSet = /*@__PURE__*/ S.String;
export const CreateOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ FeatureSet: S.optional(OrganizationFeatureSet) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const PolicyTypeSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Organization = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
    Arn: S.optional(S.String),
...
export const CreateOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Organization: S.optional(Organization) }).pipe(ns)).annotate({
    identifier: "CreateOrganizationResponse",
});
export const CreateOrganizationalUnitRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ ParentId: S.String, Name: S.String, Tags: S.optional(Tags) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateOrganizationalUnitRequest",
});
export const OrganizationalUnit = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
    Arn: S.optional(S.String),
...
export const CreateOrganizationalUnitResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ OrganizationalUnit: S.optional(OrganizationalUnit) }).pipe(ns)).annotate({
    identifier: "CreateOrganizationalUnitResponse",
});
export const CreatePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Content: S.String,
...
export const PolicySummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
    Arn: S.optional(S.String),
    Name: S.optional(S.String),
...
})).annotate({ identifier: "PolicySummary" });
export const Policy = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicySummary: S.optional(PolicySummary),
    Content: S.optional(S.String),
})).annotate({ identifier: "Policy" });
export const CreatePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Policy: S.optional(Policy) }).pipe(ns)).annotate({
    identifier: "CreatePolicyResponse",
});
export const DeclineHandshakeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HandshakeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeclineHandshakeRequest",
});
export const DeclineHandshakeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
    identifier: "DeclineHandshakeResponse",
});
export const DeleteOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteOrganizationRequest",
});
export const DeleteOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeleteOrganizationResponse",
});
export const DeleteOrganizationalUnitRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ OrganizationalUnitId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteOrganizationalUnitRequest",
});
export const DeleteOrganizationalUnitResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeleteOrganizationalUnitResponse",
});
export const DeletePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ PolicyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeletePolicyRequest",
});
export const DeletePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeletePolicyResponse",
});
export const DeleteResourcePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteResourcePolicyRequest",
});
export const DeleteResourcePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeleteResourcePolicyResponse",
});
export const DeregisterDelegatedAdministratorRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AccountId: S.String, ServicePrincipal: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeregisterDelegatedAdministratorRequest",
});
export const DeregisterDelegatedAdministratorResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeregisterDelegatedAdministratorResponse",
});
export const DescribeAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AccountId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const Account = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
    Arn: S.optional(S.String),
...
export const DescribeAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Account: S.optional(Account) }).pipe(ns)).annotate({
    identifier: "DescribeAccountResponse",
});
export const DescribeCreateAccountStatusRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ CreateAccountRequestId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeCreateAccountStatusRequest",
});
export const DescribeCreateAccountStatusResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ CreateAccountStatus: S.optional(CreateAccountStatus) }).pipe(ns)).annotate({
    identifier: "DescribeCreateAccountStatusResponse",
});
export const EffectivePolicyType = /*@__PURE__*/ S.String;
export const DescribeEffectivePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicyType: EffectivePolicyType,
    TargetId: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeEffectivePolicyRequest",
});
export const EffectivePolicy = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DescribeEffectivePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ EffectivePolicy: S.optional(EffectivePolicy) }).pipe(ns)).annotate({
    identifier: "DescribeEffectivePolicyResponse",
});
export const DescribeHandshakeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ HandshakeId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeHandshakeRequest",
});
export const DescribeHandshakeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
    identifier: "DescribeHandshakeResponse",
});
export const DescribeOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeOrganizationRequest",
});
export const DescribeOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Organization: S.optional(Organization) }).pipe(ns)).annotate({
    identifier: "DescribeOrganizationResponse",
});
export const DescribeOrganizationalUnitRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ OrganizationalUnitId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeOrganizationalUnitRequest",
});
export const DescribeOrganizationalUnitResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ OrganizationalUnit: S.optional(OrganizationalUnit) }).pipe(ns)).annotate({
    identifier: "DescribeOrganizationalUnitResponse",
});
export const DescribePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ PolicyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribePolicyRequest",
});
export const DescribePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Policy: S.optional(Policy) }).pipe(ns)).annotate({
    identifier: "DescribePolicyResponse",
});
export const DescribeResourcePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DescribeResourcePolicyRequest",
});
export const ResourcePolicySummary = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.optional(S.String), Arn: S.optional(S.String) })).annotate({
    identifier: "ResourcePolicySummary",
});
export const ResourcePolicy = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResourcePolicySummary: S.optional(ResourcePolicySummary),
    Content: S.optional(S.String),
})).annotate({ identifier: "ResourcePolicy" });
export const DescribeResourcePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ ResourcePolicy: S.optional(ResourcePolicy) }).pipe(ns)).annotate({
    identifier: "DescribeResourcePolicyResponse",
});
export const DescribeResponsibilityTransferRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const TransferParticipant = /*@__PURE__*/ S.suspend(() => S.Struct({
    ManagementAccountId: S.optional(S.String),
    ManagementAccountEmail: S.optional(SensitiveString),
})).annotate({
    identifier: "TransferParticipant",
});
export const ResponsibilityTransfer = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.optional(S.String),
    Name: S.optional(SensitiveString),
    Id: S.optional(S.String),
...
export const DescribeResponsibilityTransferResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResponsibilityTransfer: S.optional(ResponsibilityTransfer),
}).pipe(ns)).annotate({
    identifier: "DescribeResponsibilityTransferResponse",
});
export const DetachPolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ PolicyId: S.String, TargetId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DisableAWSServiceAccessRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ ServicePrincipal: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DisableAWSServiceAccessRequest",
});
export const DisableAWSServiceAccessResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DisableAWSServiceAccessResponse",
});
export const DisablePolicyTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ RootId: S.String, PolicyType: PolicyType }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DisablePolicyTypeRequest",
});
export const Root = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
    Arn: S.optional(S.String),
    Name: S.optional(S.String),
    PolicyTypes: S.optional(PolicyTypes),
})).annotate({ identifier: "Root" });
export const DisablePolicyTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Root: S.optional(Root) }).pipe(ns)).annotate({
    identifier: "DisablePolicyTypeResponse",
});
export const EnableAllFeaturesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "EnableAllFeaturesRequest",
});
export const EnableAllFeaturesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
    identifier: "EnableAllFeaturesResponse",
});
export const EnableAWSServiceAccessRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ ServicePrincipal: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "EnableAWSServiceAccessRequest",
});
export const EnableAWSServiceAccessResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "EnableAWSServiceAccessResponse",
});
export const EnablePolicyTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ RootId: S.String, PolicyType: PolicyType }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "EnablePolicyTypeRequest",
});
export const EnablePolicyTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Root: S.optional(Root) }).pipe(ns)).annotate({
    identifier: "EnablePolicyTypeResponse",
});
export const InviteAccountToOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const InviteAccountToOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
...
/*@__PURE__*/ S.suspend(() => S.Struct({ Handshake: S.optional(Handshake) }).pipe(ns)).annotate({
    identifier: "InviteOrganizationToTransferResponsibilityResponse",
});
export const LeaveOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "LeaveOrganizationRequest",
});
export const LeaveOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "LeaveOrganizationResponse",
});
export const ListAccountsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListAccountsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Accounts: S.optional(Accounts),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListAccountsResponse",
});
export const ListAccountsForParentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ParentId: S.String,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListAccountsForParentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Accounts: S.optional(Accounts),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
...
export const EnabledServicePrincipal = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListChildrenRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ParentId: S.String,
    ChildType: ChildType,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
...
export const Child = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.optional(S.String), Type: S.optional(ChildType) })).annotate({ identifier: "Child" });
export const Children = /*@__PURE__*/ S.Array(Child);
export const ListChildrenResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListCreateAccountStatusRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListCreateAccountStatusResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    CreateAccountStatuses: S.optional(CreateAccountStatuses),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListCreateAccountStatusResponse",
});
export const ListDelegatedAdministratorsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ServicePrincipal: S.optional(S.String),
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DelegatedAdministrator = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.optional(S.String),
    Arn: S.optional(S.String),
    Email: S.optional(SensitiveString),
    Name: S.optional(SensitiveString),
...
export const ListDelegatedAdministratorsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    DelegatedAdministrators: S.optional(DelegatedAdministrators),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListDelegatedAdministratorsResponse",
});
export const ListDelegatedServicesForAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    AccountId: S.String,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const DelegatedService = /*@__PURE__*/ S.suspend(() => S.Struct({
    ServicePrincipal: S.optional(S.String),
    DelegationEnabledDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({
...
export const ListDelegatedServicesForAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const EffectivePolicyValidationError = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const EffectivePolicyValidationErrors = /*@__PURE__*/ S.Array(EffectivePolicyValidationError);
...
export const HandshakeFilter = /*@__PURE__*/ S.suspend(() => S.Struct({
    ActionType: S.optional(ActionType),
    ParentHandshakeId: S.optional(S.String),
})).annotate({
    identifier: "HandshakeFilter",
});
export const ListHandshakesForAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListHandshakesForAccountResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Handshakes: S.optional(Handshakes),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListHandshakesForAccountResponse",
});
export const ListHandshakesForOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Filter: S.optional(HandshakeFilter),
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListHandshakesForOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Handshakes: S.optional(Handshakes),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
...
export const ListOrganizationalUnitsForParentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ParentId: S.String,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListOrganizationalUnitsForParentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ListParentsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ChildId: S.String,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const Parent = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.optional(S.String), Type: S.optional(ParentType) })).annotate({ identifier: "Parent" });
export const Parents = /*@__PURE__*/ S.Array(Parent);
export const ListParentsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Parents: S.optional(Parents),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListParentsResponse",
});
export const ListPoliciesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Filter: PolicyType,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListPoliciesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Policies: S.optional(Policies),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListPoliciesResponse",
});
export const ListPoliciesForTargetRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    TargetId: S.String,
    Filter: PolicyType,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
...
export const ListPoliciesForTargetResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Policies: S.optional(Policies),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListPoliciesForTargetResponse",
});
export const ListRootsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const ListRootsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Roots: S.optional(Roots), NextToken: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "ListRootsResponse",
});
export const ListTagsForResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ ResourceId: S.String, NextToken: S.optional(S.String) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListTagsForResourceRequest",
});
export const ListTagsForResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Tags: S.optional(Tags), NextToken: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "ListTagsForResourceResponse",
});
export const ListTargetsForPolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicyId: S.String,
    NextToken: S.optional(S.String),
    MaxResults: S.optional(S.Number),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const PolicyTargetSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    TargetId: S.optional(S.String),
    Arn: S.optional(S.String),
    Name: S.optional(S.String),
...
export const ListTargetsForPolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Targets: S.optional(PolicyTargets),
    NextToken: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "ListTargetsForPolicyResponse",
});
export const MoveAccountRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    AccountId: S.String,
...
export const PutResourcePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ Content: S.String, Tags: S.optional(Tags) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "PutResourcePolicyRequest",
});
export const PutResourcePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ ResourcePolicy: S.optional(ResourcePolicy) }).pipe(ns)).annotate({
    identifier: "PutResourcePolicyResponse",
});
export const RegisterDelegatedAdministratorRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AccountId: S.String, ServicePrincipal: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RegisterDelegatedAdministratorRequest",
});
export const RegisterDelegatedAdministratorResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "RegisterDelegatedAdministratorResponse",
});
export const RemoveAccountFromOrganizationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AccountId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "RemoveAccountFromOrganizationRequest",
});
export const RemoveAccountFromOrganizationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "RemoveAccountFromOrganizationResponse",
});
export const TagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ ResourceId: S.String, Tags: Tags }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "TagResourceRequest",
});
export const TagResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "TagResourceResponse",
});
export const TerminateResponsibilityTransferRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.String,
    EndTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "TerminateResponsibilityTransferRequest",
});
export const TerminateResponsibilityTransferResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResponsibilityTransfer: S.optional(ResponsibilityTransfer),
}).pipe(ns)).annotate({
    identifier: "TerminateResponsibilityTransferResponse",
});
export const TagKeys = /*@__PURE__*/ S.Array(S.String);
export const UntagResourceRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ ResourceId: S.String, TagKeys: TagKeys }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UntagResourceRequest",
});
export const UntagResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UntagResourceResponse",
});
export const UpdateOrganizationalUnitRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ OrganizationalUnitId: S.String, Name: S.optional(S.String) }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateOrganizationalUnitRequest",
});
export const UpdateOrganizationalUnitResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ OrganizationalUnit: S.optional(OrganizationalUnit) }).pipe(ns)).annotate({
    identifier: "UpdateOrganizationalUnitResponse",
});
export const UpdatePolicyRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    PolicyId: S.String,
    Name: S.optional(S.String),
    Description: S.optional(S.String),
    Content: S.optional(S.String),
...
export const UpdatePolicyResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Policy: S.optional(Policy) }).pipe(ns)).annotate({
    identifier: "UpdatePolicyResponse",
});
export const UpdateResponsibilityTransferRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ Id: S.String, Name: SensitiveString }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UpdateResponsibilityTransferRequest",
});
export const UpdateResponsibilityTransferResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    ResponsibilityTransfer: S.optional(ResponsibilityTransfer),
}).pipe(ns)).annotate({
 ...
 */
export const acceptHandshake = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const attachPolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * deleted.
 */
export const cancelHandshake = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const closeAccount = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createAccount = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createGovCloudAccount = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const createOrganizationalUnit = /*@__PURE__*/ API.make(() => ({
 ...
 * deleted.
 */
export const declineHandshake = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const deleteOrganizationalUnit = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const deregisterDelegatedAdministrator = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeAccount = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeCreateAccountStatus = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeEffectivePolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * You can call this operation from any account in a organization.
 */
export const describeHandshake = /*@__PURE__*/ API.make(() => ({
 ...
 * root.
 */
export const describeOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeOrganizationalUnit = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describePolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeResourcePolicy = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeResponsibilityTransfer = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const detachPolicy = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const disableAWSServiceAccess = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const disablePolicyType = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const enableAllFeatures = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const enableAWSServiceAccess = /*@__PURE__*/ API.make(() => ({
 ...
 * ListRoots.
 */
export const enablePolicyType = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const inviteAccountToOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const inviteOrganizationToTransferResponsibility = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const leaveOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAccounts = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAccountsForParent = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAccountsWithInvalidEffectivePolicy = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAWSServiceAccessForOrganization = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listChildren = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listCreateAccountStatus = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listDelegatedAdministrators = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listDelegatedServicesForAccount = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listEffectivePolicyValidationErrors = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listHandshakesForAccount = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listHandshakesForOrganization = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listInboundResponsibilityTransfers = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listOrganizationalUnitsForParent = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listOutboundResponsibilityTransfers = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listParents = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listPolicies = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listPoliciesForTarget = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const listRoots = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listTagsForResource = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listTargetsForPolicy = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const moveAccount = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const registerDelegatedAdministrator = /*@__PURE__*/ API.make(() => ({
 ...
 * of an organization do not support tags.
 */
export const removeAccountFromOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * responsibilities for their organization.
 */
export const terminateResponsibilityTransfer = /*@__PURE__*/ API.make(() => ({
 ...
 * You can only call this operation from the management account.
 */
export const updateOrganizationalUnit = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateResponsibilityTransfer = /*@__PURE__*/ API.make(() => ({
