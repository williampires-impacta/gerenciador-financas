    ...
    if (Region != null) {
        {
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (_.getAttr(PartitionResult, "name") === "aws" &&
                    UseFIPS === false &&
                    UseDualStack === true) {
                    return e(`https://metering-marketplace.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                }
                ...
                if (_.getAttr(PartitionResult, "name") === "aws-eusc" &&
                    UseFIPS === false &&
                    UseDualStack === false) {
                ...
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://metering.marketplace-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true && UseDualStack === false) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://metering.marketplace-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                ...
                return e(`https://metering.marketplace.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
            }
        }
    }
    return err("Invalid Configuration: Missing Region");
});
export class CustomerNotEntitledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("CustomerNotEntitledException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class DisabledApiException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DisabledApiException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class DuplicateRequestException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DuplicateRequestException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class ExpiredTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ExpiredTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class IdempotencyConflictException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IdempotencyConflictException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(409)).pipe(C.withConflictError) {
}
export class InternalServiceErrorException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InternalServiceErrorException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidCustomerIdentifierException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidCustomerIdentifierException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidEndpointRegionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidEndpointRegionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidLicenseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidLicenseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidProductCodeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidProductCodeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidPublicKeyVersionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidPublicKeyVersionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidRegionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidRegionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidTagException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidTagException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidUsageAllocationsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidUsageAllocationsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidUsageDimensionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidUsageDimensionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class PlatformNotSupportedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PlatformNotSupportedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class ThrottlingException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ThrottlingException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class TimestampOutOfBoundsException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("TimestampOutOfBoundsException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export const Tag = /*@__PURE__*/ S.suspend(() => S.Struct({ Key: S.String, Value: S.String })).annotate({ identifier: "Tag" });
export const TagList = /*@__PURE__*/ S.Array(Tag);
export const UsageAllocation = /*@__PURE__*/ S.suspend(() => S.Struct({ AllocatedUsageQuantity: S.Number, Tags: S.optional(TagList) })).annotate({
    identifier: "UsageAllocation",
});
export const UsageAllocations = /*@__PURE__*/ S.Array(UsageAllocation);
export const UsageRecord = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BatchMeterUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const UsageRecordResult = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const BatchMeterUsageResult = /*@__PURE__*/ S.suspend(() => S.Struct({
    Results: S.optional(UsageRecordResultList),
    UnprocessedRecords: S.optional(UsageRecordList),
})).annotate({
    identifier: "BatchMeterUsageResult",
});
export const MeterUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const MeterUsageResult = /*@__PURE__*/ S.suspend(() => S.Struct({ MeteringRecordId: S.optional(S.String) })).annotate({
    identifier: "MeterUsageResult",
});
export const RegisterUsageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ProductCode: S.String,
...
export const RegisterUsageResult = /*@__PURE__*/ S.suspend(() => S.Struct({
    PublicKeyRotationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    Signature: S.optional(S.String),
})).annotate({
    identifier: "RegisterUsageResult",
});
export const ResolveCustomerRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ RegistrationToken: S.String }).pipe(T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ResolveCustomerRequest",
});
export const ResolveCustomerResult = /*@__PURE__*/ S.suspend(() => S.Struct({
    CustomerIdentifier: S.optional(S.String),
    ProductCode: S.optional(S.String),
    CustomerAWSAccountId: S.optional(S.String),
    LicenseArn: S.optional(S.String),
 ...
 * Guide.
 */
export const batchMeterUsage = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const meterUsage = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const registerUsage = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const resolveCustomer = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=marketplace-metering.js.map