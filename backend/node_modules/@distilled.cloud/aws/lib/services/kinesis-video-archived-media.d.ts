...
declare const InvalidCodecPrivateDataException_base: S.Class<InvalidCodecPrivateDataException, S.TaggedStruct<"InvalidCodecPrivateDataException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class InvalidCodecPrivateDataException extends /*@__PURE__*/ InvalidCodecPrivateDataException_base {
}
declare const InvalidMediaFrameException_base: S.Class<InvalidMediaFrameException, S.TaggedStruct<"InvalidMediaFrameException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class InvalidMediaFrameException extends /*@__PURE__*/ InvalidMediaFrameException_base {
}
declare const MissingCodecPrivateDataException_base: S.Class<MissingCodecPrivateDataException, S.TaggedStruct<"MissingCodecPrivateDataException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class MissingCodecPrivateDataException extends /*@__PURE__*/ MissingCodecPrivateDataException_base {
}
declare const NoDataRetentionException_base: S.Class<NoDataRetentionException, S.TaggedStruct<"NoDataRetentionException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class NoDataRetentionException extends /*@__PURE__*/ NoDataRetentionException_base {
}
declare const NotAuthorizedException_base: S.Class<NotAuthorizedException, S.TaggedStruct<"NotAuthorizedException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        AuthError: true;
...
export declare class NotAuthorizedException extends /*@__PURE__*/ NotAuthorizedException_base {
}
...
declare const UnsupportedStreamMediaTypeException_base: S.Class<UnsupportedStreamMediaTypeException, S.TaggedStruct<"UnsupportedStreamMediaTypeException", {
    readonly message: any;
}>, import("effect/Cause").YieldableError> & (new (...args: any[]) => {
    "@distilled.cloud/error/categories": {
        BadRequestError: true;
...
export declare class UnsupportedStreamMediaTypeException extends /*@__PURE__*/ UnsupportedStreamMediaTypeException_base {
}
export type StreamName = string;
export type ResourceARN = string;
export type ClipFragmentSelectorType = "PRODUCER_TIMESTAMP" | "SERVER_TIMESTAMP" | (string & {});
export declare const ClipFragmentSelectorType: any;
export interface ClipTimestampRange {
    StartTimestamp: Date;
    EndTimestamp: Date;
}
export declare const ClipTimestampRange: S.Schema<ClipTimestampRange>;
export interface ClipFragmentSelector {
    FragmentSelectorType: ClipFragmentSelectorType;
    TimestampRange: ClipTimestampRange;
}
export declare const ClipFragmentSelector: S.Schema<ClipFragmentSelector>;
export interface GetClipInput {
    StreamName?: string;
    StreamARN?: string;
    ClipFragmentSelector: ClipFragmentSelector;
}
export declare const GetClipInput: S.Schema<GetClipInput>;
export type ContentType = string;
export interface GetClipOutput {
    ContentType?: string;
    Payload?: T.StreamingOutputBody;
}
export declare const GetClipOutput: S.Schema<GetClipOutput>;
export type DASHPlaybackMode = "LIVE" | "LIVE_REPLAY" | "ON_DEMAND" | (string & {});
export declare const DASHPlaybackMode: any;
export type DASHDisplayFragmentTimestamp = "ALWAYS" | "NEVER" | (string & {});
export declare const DASHDisplayFragmentTimestamp: any;
export type DASHDisplayFragmentNumber = "ALWAYS" | "NEVER" | (string & {});
export declare const DASHDisplayFragmentNumber: any;
export type DASHFragmentSelectorType = "PRODUCER_TIMESTAMP" | "SERVER_TIMESTAMP" | (string & {});
export declare const DASHFragmentSelectorType: any;
export interface DASHTimestampRange {
    StartTimestamp?: Date;
    EndTimestamp?: Date;
}
export declare const DASHTimestampRange: S.Schema<DASHTimestampRange>;
export interface DASHFragmentSelector {
    FragmentSelectorType?: DASHFragmentSelectorType;
    TimestampRange?: DASHTimestampRange;
}
export declare const DASHFragmentSelector: S.Schema<DASHFragmentSelector>;
...
export declare const GetHLSStreamingSessionURLInput: S.Schema<GetHLSStreamingSessionURLInput>;
export type HLSStreamingSessionURL = string;
export interface GetHLSStreamingSessionURLOutput {
    HLSStreamingSessionURL?: string;
}
export declare const GetHLSStreamingSessionURLOutput: S.Schema<GetHLSStreamingSessionURLOutput>;
export type ImageSelectorType = "PRODUCER_TIMESTAMP" | "SERVER_TIMESTAMP" | (string & {});
export declare const ImageSelectorType: any;
...
export declare const FormatConfigKey: any;
export type FormatConfigValue = string;
export type FormatConfig = {
    [key in FormatConfigKey]?: string;
};
export declare const FormatConfig: any;
...
export declare const GetImagesInput: S.Schema<GetImagesInput>;
export type ImageError = "NO_MEDIA" | "MEDIA_ERROR" | (string & {});
export declare const ImageError: any;
...
export declare const Image: S.Schema<Image>;
...
export declare const GetImagesOutput: S.Schema<GetImagesOutput>;
export type FragmentNumberString = string;
export type FragmentNumberList = string[];
export declare const FragmentNumberList: any;
export interface GetMediaForFragmentListInput {
    StreamName?: string;
    StreamARN?: string;
    Fragments: string[];
}
export declare const GetMediaForFragmentListInput: S.Schema<GetMediaForFragmentListInput>;
export interface GetMediaForFragmentListOutput {
    ContentType?: string;
    Payload?: T.StreamingOutputBody;
}
export declare const GetMediaForFragmentListOutput: S.Schema<GetMediaForFragmentListOutput>;
export type ListFragmentsMaxResults = number;
export type FragmentSelectorType = "PRODUCER_TIMESTAMP" | "SERVER_TIMESTAMP" | (string & {});
export declare const FragmentSelectorType: any;
export interface TimestampRange {
    StartTimestamp: Date;
    EndTimestamp: Date;
}
export declare const TimestampRange: S.Schema<TimestampRange>;
export interface FragmentSelector {
    FragmentSelectorType: FragmentSelectorType;
    TimestampRange: TimestampRange;
}
export declare const FragmentSelector: S.Schema<FragmentSelector>;
...
export declare const ListFragmentsInput: S.Schema<ListFragmentsInput>;
...
export declare const Fragment: S.Schema<Fragment>;
export type FragmentList = Fragment[];
export declare const FragmentList: any;
export interface ListFragmentsOutput {
    Fragments?: Fragment[];
    NextToken?: string;
}
export declare const ListFragmentsOutput: S.Schema<ListFragmentsOutput>;
export type ErrorMessage = string;
export type GetClipError = ClientLimitExceededException | InvalidArgumentException | InvalidCodecPrivateDataException | InvalidMediaFrameException | MissingCodecPrivateDataException | NoDataRetentionException | NotAuthorizedException | ResourceNotFoundException | UnsupportedStreamMediaTypeException | CommonErrors;
/**
 ...
 */
export declare const getClip: API.OperationMethod<GetClipInput, GetClipOutput, GetClipError, Credentials | HttpClient.HttpClient>;
export type GetDASHStreamingSessionURLError = ClientLimitExceededException | InvalidArgumentException | InvalidCodecPrivateDataException | MissingCodecPrivateDataException | NoDataRetentionException | NotAuthorizedException | ResourceNotFoundException | UnsupportedStreamMediaTypeException | CommonErrors;
/**
 ...
 */
export declare const getDASHStreamingSessionURL: API.OperationMethod<GetDASHStreamingSessionURLInput, GetDASHStreamingSessionURLOutput, GetDASHStreamingSessionURLError, Credentials | HttpClient.HttpClient>;
export type GetHLSStreamingSessionURLError = ClientLimitExceededException | InvalidArgumentException | InvalidCodecPrivateDataException | MissingCodecPrivateDataException | NoDataRetentionException | NotAuthorizedException | ResourceNotFoundException | UnsupportedStreamMediaTypeException | CommonErrors;
/**
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export declare const getHLSStreamingSessionURL: API.OperationMethod<GetHLSStreamingSessionURLInput, GetHLSStreamingSessionURLOutput, GetHLSStreamingSessionURLError, Credentials | HttpClient.HttpClient>;
export type GetImagesError = ClientLimitExceededException | InvalidArgumentException | NoDataRetentionException | NotAuthorizedException | ResourceNotFoundException | CommonErrors;
/**
 ...
 */
export declare const getImages: API.PaginatedOperationMethod<GetImagesInput, GetImagesOutput, GetImagesError, Credentials | HttpClient.HttpClient, Image>;
export type GetMediaForFragmentListError = ClientLimitExceededException | InvalidArgumentException | NotAuthorizedException | ResourceNotFoundException | CommonErrors;
/**
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export declare const getMediaForFragmentList: API.OperationMethod<GetMediaForFragmentListInput, GetMediaForFragmentListOutput, GetMediaForFragmentListError, Credentials | HttpClient.HttpClient>;
export type ListFragmentsError = ClientLimitExceededException | InvalidArgumentException | NotAuthorizedException | ResourceNotFoundException | CommonErrors;
/**
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export declare const listFragments: API.PaginatedOperationMethod<ListFragmentsInput, ListFragmentsOutput, ListFragmentsError, Credentials | HttpClient.HttpClient, Fragment>;
export {};
//# sourceMappingURL=kinesis-video-archived-media.d.ts.map