            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://sts-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class ExpiredTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ExpiredTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "ExpiredTokenException", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class ExpiredTradeInTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ExpiredTradeInTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "ExpiredTradeInTokenException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class IDPCommunicationErrorException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IDPCommunicationErrorException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "IDPCommunicationError", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class IDPRejectedClaimException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("IDPRejectedClaimException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "IDPRejectedClaim", httpResponseCode: 403 }), T.HttpError(403))).pipe(C.withAuthError) {
}
export class InvalidAuthorizationMessageException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidAuthorizationMessageException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "InvalidAuthorizationMessageException",
    httpResponseCode: 400,
}), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class InvalidIdentityTokenException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidIdentityTokenException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "InvalidIdentityToken", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class JWTPayloadSizeExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("JWTPayloadSizeExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
...
export class OutboundWebIdentityFederationDisabledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("OutboundWebIdentityFederationDisabledException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "OutboundWebIdentityFederationDisabledException",
    httpResponseCode: 403,
}), T.HttpError(403))).pipe(C.withAuthError) {
}
export class PackedPolicyTooLargeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PackedPolicyTooLargeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({ code: "PackedPolicyTooLarge", httpResponseCode: 400 }), T.HttpError(400))).pipe(C.withBadRequestError) {
}
export class RegionDisabledException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("RegionDisabledException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "RegionDisabledException",
    httpResponseCode: 403,
}), T.HttpError(403))).pipe(C.withAuthError) {
}
export class SessionDurationEscalationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("SessionDurationEscalationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.all(T.AwsQueryError({
    code: "SessionDurationEscalationException",
    httpResponseCode: 403,
}), T.HttpError(403))).pipe(C.withAuthError) {
}
export const PolicyDescriptorType = /*@__PURE__*/ S.suspend(() => S.Struct({ arn: S.optional(S.String) })).annotate({
...
export const ProvidedContext = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AssumeRoleRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleArn: S.String,
...
export const AssumedRoleUser = /*@__PURE__*/ S.suspend(() => S.Struct({ AssumedRoleId: S.String, Arn: S.String })).annotate({
    identifier: "AssumedRoleUser",
});
export const AssumeRoleResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AssumeRoleWithSAMLRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleArn: S.String,
...
export const AssumeRoleWithSAMLResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Credentials: S.optional(Credentials),
    AssumedRoleUser: S.optional(AssumedRoleUser),
    PackedPolicySize: S.optional(S.Number),
...
export const AssumeRoleWithWebIdentityRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleArn: S.String,
    RoleSessionName: S.String,
...
export const AssumeRoleWithWebIdentityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Credentials: S.optional(Credentials),
...
export const AssumeRootRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const AssumeRootResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Credentials: S.optional(Credentials),
    SourceIdentity: S.optional(S.String),
}).pipe(ns)).annotate({
    identifier: "AssumeRootResponse",
});
export const DecodeAuthorizationMessageRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ EncodedMessage: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DecodeAuthorizationMessageRequest",
});
export const DecodeAuthorizationMessageResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ DecodedMessage: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "DecodeAuthorizationMessageResponse",
});
export const GetAccessKeyInfoRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ AccessKeyId: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetAccessKeyInfoRequest",
});
export const GetAccessKeyInfoResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Account: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "GetAccessKeyInfoResponse",
});
export const GetCallerIdentityRequest = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetCallerIdentityRequest",
});
export const GetCallerIdentityResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetDelegatedAccessTokenRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ TradeInToken: SensitiveString }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetDelegatedAccessTokenRequest",
});
export const GetDelegatedAccessTokenResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Credentials: S.optional(Credentials),
    PackedPolicySize: S.optional(S.Number),
...
export const GetFederationTokenRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    Name: S.String,
    Policy: S.optional(S.String),
    PolicyArns: S.optional(PolicyDescriptorListType),
    DurationSeconds: S.optional(S.Number),
...
export const FederatedUser = /*@__PURE__*/ S.suspend(() => S.Struct({ FederatedUserId: S.String, Arn: S.String })).annotate({ identifier: "FederatedUser" });
export const GetFederationTokenResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    Credentials: S.optional(Credentials),
...
export const GetSessionTokenRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    DurationSeconds: S.optional(S.Number),
    SerialNumber: S.optional(S.String),
    TokenCode: S.optional(S.String),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
...
export const GetSessionTokenResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ Credentials: S.optional(Credentials) }).pipe(ns)).annotate({
    identifier: "GetSessionTokenResponse",
});
export const WebIdentityTokenAudienceListType = /*@__PURE__*/ S.Array(S.String);
export const GetWebIdentityTokenRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetWebIdentityTokenResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
 ...
 * produces.
 */
export const assumeRole = /*@__PURE__*/ API.make(() => ({
 ...
 * *IAM User Guide*.
 */
export const assumeRoleWithSAML = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const assumeRoleWithWebIdentity = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const assumeRoot = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const decodeAuthorizationMessage = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getAccessKeyInfo = /*@__PURE__*/ API.make(() => ({
 ...
 * *IAM User Guide*.
 */
export const getCallerIdentity = /*@__PURE__*/ API.make(() => ({
 ...
 * resources.
 */
export const getDelegatedAccessToken = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getFederationToken = /*@__PURE__*/ API.make(() => ({
 ...
 * *IAM User Guide*.
 */
export const getSessionToken = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getWebIdentityToken = /*@__PURE__*/ API.make(() => ({
