            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://firehose-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                ...
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://firehose.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class ConcurrentModificationException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ConcurrentModificationException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidArgumentException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidArgumentException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
export class InvalidKMSResourceException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidKMSResourceException", {
    code: S.optional(S.String),
    message: S.optional(S.String).pipe(T.ErrorMessage()),
}) {
}
export class InvalidSourceException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidSourceException", {
    code: S.optional(S.String),
    message: S.optional(S.String).pipe(T.ErrorMessage()),
}) {
}
...
export class ResourceInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceInUseException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }) {
}
...
export class ServiceUnavailableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ServiceUnavailableException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(503)).pipe(C.withServerError) {
}
export const DeliveryStreamType = /*@__PURE__*/ S.String;
export const DirectPutSourceConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ ThroughputHintInMBs: S.Number })).annotate({
    identifier: "DirectPutSourceConfiguration",
});
export const KinesisStreamSourceConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ KinesisStreamARN: S.String, RoleARN: S.String })).annotate({
...
/*@__PURE__*/ S.suspend(() => S.Struct({ KeyARN: S.optional(S.String), KeyType: KeyType })).annotate({
    identifier: "DeliveryStreamEncryptionConfigurationInput",
});
export const BufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    SizeInMBs: S.optional(S.Number),
    IntervalInSeconds: S.optional(S.Number),
})).annotate({ identifier: "BufferingHints" });
export const CompressionFormat = /*@__PURE__*/ S.String;
export const NoEncryptionConfig = /*@__PURE__*/ S.String;
export const KMSEncryptionConfig = /*@__PURE__*/ S.suspend(() => S.Struct({ AWSKMSKeyARN: S.String })).annotate({
    identifier: "KMSEncryptionConfig",
});
export const EncryptionConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    NoEncryptionConfig: S.optional(NoEncryptionConfig),
    KMSEncryptionConfig: S.optional(KMSEncryptionConfig),
})).annotate({
    identifier: "EncryptionConfiguration",
});
export const CloudWatchLoggingOptions = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const S3DestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
    BucketARN: S.String,
...
export const ProcessorParameter = /*@__PURE__*/ S.suspend(() => S.Struct({ ParameterName: ProcessorParameterName, ParameterValue: S.String })).annotate({
    identifier: "ProcessorParameter",
});
export const ProcessorParameterList = /*@__PURE__*/ S.Array(ProcessorParameter);
export const Processor = /*@__PURE__*/ S.suspend(() => S.Struct({
    Type: ProcessorType,
    Parameters: S.optional(ProcessorParameterList),
})).annotate({ identifier: "Processor" });
export const ProcessorList = /*@__PURE__*/ S.Array(Processor);
export const ProcessingConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    Enabled: S.optional(S.Boolean),
...
export const SchemaConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const OpenXJsonSerDe = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "OpenXJsonSerDe" });
export const ListOfNonEmptyStrings = /*@__PURE__*/ S.Array(S.String);
export const HiveJsonSerDe = /*@__PURE__*/ S.suspend(() => S.Struct({ TimestampFormats: S.optional(ListOfNonEmptyStrings) })).annotate({ identifier: "HiveJsonSerDe" });
export const Deserializer = /*@__PURE__*/ S.suspend(() => S.Struct({
    OpenXJsonSerDe: S.optional(OpenXJsonSerDe),
    HiveJsonSerDe: S.optional(HiveJsonSerDe),
})).annotate({ identifier: "Deserializer" });
export const InputFormatConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ Deserializer: S.optional(Deserializer) })).annotate({
...
export const ParquetSerDe = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "ParquetSerDe" });
...
export const OrcSerDe = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "OrcSerDe" });
export const Serializer = /*@__PURE__*/ S.suspend(() => S.Struct({
    ParquetSerDe: S.optional(ParquetSerDe),
    OrcSerDe: S.optional(OrcSerDe),
})).annotate({ identifier: "Serializer" });
export const OutputFormatConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ Serializer: S.optional(Serializer) })).annotate({
    identifier: "OutputFormatConfiguration",
});
export const DataFormatConversionConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({ identifier: "RetryOptions" });
export const DynamicPartitioningConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    RetryOptions: S.optional(RetryOptions),
    Enabled: S.optional(S.Boolean),
})).annotate({
    identifier: "DynamicPartitioningConfiguration",
});
export const ExtendedS3DestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
    BucketARN: S.String,
    Prefix: S.optional(S.String),
    ErrorOutputPrefix: S.optional(S.String),
...
export const CopyCommand = /*@__PURE__*/ S.suspend(() => S.Struct({
    DataTableName: S.String,
    DataTableColumns: S.optional(S.String),
    CopyOptions: S.optional(S.String),
})).annotate({ identifier: "CopyCommand" });
export const RedshiftRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
    identifier: "RedshiftRetryOptions",
});
export const RedshiftS3BackupMode = /*@__PURE__*/ S.String;
export const SecretsManagerConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RedshiftDestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
...
export const ElasticsearchBufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    IntervalInSeconds: S.optional(S.Number),
    SizeInMBs: S.optional(S.Number),
})).annotate({
    identifier: "ElasticsearchBufferingHints",
});
export const ElasticsearchRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
...
export const VpcConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DocumentIdOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DefaultDocumentIdFormat: DefaultDocumentIdFormat })).annotate({
    identifier: "DocumentIdOptions",
});
export const ElasticsearchDestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
...
/*@__PURE__*/ S.String;
export const AmazonopensearchserviceBufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    IntervalInSeconds: S.optional(S.Number),
    SizeInMBs: S.optional(S.Number),
})).annotate({
    identifier: "AmazonopensearchserviceBufferingHints",
});
export const AmazonopensearchserviceRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
...
export const SplunkRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
    identifier: "SplunkRetryOptions",
});
export const SplunkS3BackupMode = /*@__PURE__*/ S.String;
export const SplunkBufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    IntervalInSeconds: S.optional(S.Number),
    SizeInMBs: S.optional(S.Number),
})).annotate({
    identifier: "SplunkBufferingHints",
});
export const SplunkDestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const HttpEndpointConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    Url: SensitiveString,
...
export const HttpEndpointBufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    SizeInMBs: S.optional(S.Number),
    IntervalInSeconds: S.optional(S.Number),
})).annotate({
...
export const HttpEndpointCommonAttribute = /*@__PURE__*/ S.suspend(() => S.Struct({ AttributeName: SensitiveString, AttributeValue: SensitiveString })).annotate({
...
export const HttpEndpointRequestConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const HttpEndpointRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
    identifier: "HttpEndpointRetryOptions",
});
export const HttpEndpointS3BackupMode = /*@__PURE__*/ S.String;
export const HttpEndpointDestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Tag = /*@__PURE__*/ S.suspend(() => S.Struct({ Key: S.String, Value: S.optional(S.String) })).annotate({ identifier: "Tag" });
export const TagDeliveryStreamInputTagList = /*@__PURE__*/ S.Array(Tag);
export const AmazonOpenSearchServerlessBufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    IntervalInSeconds: S.optional(S.Number),
    SizeInMBs: S.optional(S.Number),
})).annotate({
    identifier: "AmazonOpenSearchServerlessBufferingHints",
});
export const AmazonOpenSearchServerlessRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
...
export const AuthenticationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ RoleARN: S.String, Connectivity: Connectivity })).annotate({
    identifier: "AuthenticationConfiguration",
});
export const MSKSourceConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SnowflakeRoleConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    Enabled: S.optional(S.Boolean),
...
export const SnowflakeVpcConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ PrivateLinkVpceId: SensitiveString })).annotate({
    identifier: "SnowflakeVpcConfiguration",
});
export const SnowflakeRetryOptions = /*@__PURE__*/ S.suspend(() => S.Struct({ DurationInSeconds: S.optional(S.Number) })).annotate({
    identifier: "SnowflakeRetryOptions",
});
export const SnowflakeS3BackupMode = /*@__PURE__*/ S.String;
export const SnowflakeBufferingHints = /*@__PURE__*/ S.suspend(() => S.Struct({
    SizeInMBs: S.optional(S.Number),
    IntervalInSeconds: S.optional(S.Number),
})).annotate({
    identifier: "SnowflakeBufferingHints",
});
export const SnowflakeDestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const PartitionField = /*@__PURE__*/ S.suspend(() => S.Struct({ SourceName: S.String })).annotate({ identifier: "PartitionField" });
export const PartitionFields = /*@__PURE__*/ S.Array(PartitionField);
export const PartitionSpec = /*@__PURE__*/ S.suspend(() => S.Struct({ Identity: S.optional(PartitionFields) })).annotate({ identifier: "PartitionSpec" });
export const DestinationTableConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DestinationTableConfigurationList = /*@__PURE__*/ S.Array(DestinationTableConfiguration);
export const SchemaEvolutionConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ Enabled: S.Boolean })).annotate({
    identifier: "SchemaEvolutionConfiguration",
});
export const TableCreationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ Enabled: S.Boolean })).annotate({
    identifier: "TableCreationConfiguration",
});
export const IcebergS3BackupMode = /*@__PURE__*/ S.String;
export const CatalogConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    CatalogARN: S.optional(S.String),
    WarehouseLocation: S.optional(S.String),
})).annotate({
    identifier: "CatalogConfiguration",
});
export const IcebergDestinationConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DatabaseColumnList = /*@__PURE__*/ S.suspend(() => S.Struct({
...
/*@__PURE__*/ S.suspend(() => S.Struct({ SecretsManagerConfiguration: SecretsManagerConfiguration })).annotate({
    identifier: "DatabaseSourceAuthenticationConfiguration",
});
export const DatabaseSourceVPCConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ VpcEndpointServiceName: S.String })).annotate({
    identifier: "DatabaseSourceVPCConfiguration",
});
export const DatabaseSourceConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
    Type: DatabaseType,
    Endpoint: S.String,
    Port: S.Number,
...
export const CreateDeliveryStreamInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    DeliveryStreamEncryptionConfigurationInput: S.optional(DeliveryStreamEncryptionConfigurationInput),
    ...
    AmazonopensearchserviceDestinationConfiguration: S.optional(AmazonopensearchserviceDestinationConfiguration),
    ...
    AmazonOpenSearchServerlessDestinationConfiguration: S.optional(AmazonOpenSearchServerlessDestinationConfiguration),
...
export const CreateDeliveryStreamOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ DeliveryStreamARN: S.optional(S.String) }).pipe(ns)).annotate({
    identifier: "CreateDeliveryStreamOutput",
});
export const DeleteDeliveryStreamInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
    AllowForceDelete: S.optional(S.Boolean),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "DeleteDeliveryStreamInput",
});
export const DeleteDeliveryStreamOutput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "DeleteDeliveryStreamOutput",
});
export const DescribeDeliveryStreamInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
...
export const FailureDescription = /*@__PURE__*/ S.suspend(() => S.Struct({ Type: DeliveryStreamFailureType, Details: S.String })).annotate({
    identifier: "FailureDescription",
});
export const DeliveryStreamEncryptionStatus = /*@__PURE__*/ S.String;
export const DeliveryStreamEncryptionConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DirectPutSourceDescription = /*@__PURE__*/ S.suspend(() => S.Struct({ ThroughputHintInMBs: S.optional(S.Number) })).annotate({
    identifier: "DirectPutSourceDescription",
});
export const KinesisStreamSourceDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const MSKSourceDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DatabaseSnapshotInfo = /*@__PURE__*/ S.suspend(() => S.Struct({
    Id: S.String,
    Table: S.String,
...
export const DatabaseSourceDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    DatabaseSourceAuthenticationConfiguration: S.optional(DatabaseSourceAuthenticationConfiguration),
    DatabaseSourceVPCConfiguration: S.optional(DatabaseSourceVPCConfiguration),
})).annotate({
    identifier: "DatabaseSourceDescription",
});
export const SourceDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const S3DestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
    BucketARN: S.String,
    Prefix: S.optional(S.String),
    ErrorOutputPrefix: S.optional(S.String),
...
export const ExtendedS3DestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
    BucketARN: S.String,
    Prefix: S.optional(S.String),
    ErrorOutputPrefix: S.optional(S.String),
...
export const RedshiftDestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.String,
    ClusterJDBCURL: S.String,
    CopyCommand: CopyCommand,
    Username: S.optional(SensitiveString),
...
export const VpcConfigurationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    SubnetIds: SubnetIdList,
    RoleARN: S.String,
    SecurityGroupIds: SecurityGroupIdList,
    VpcId: S.String,
...
export const ElasticsearchDestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.optional(S.String),
    DomainARN: S.optional(S.String),
    ClusterEndpoint: S.optional(S.String),
...
export const SplunkDestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const HttpEndpointDescription = /*@__PURE__*/ S.suspend(() => S.Struct({ Url: S.optional(SensitiveString), Name: S.optional(S.String) })).annotate({
    identifier: "HttpEndpointDescription",
});
export const HttpEndpointDestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SnowflakeDestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const IcebergDestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    DestinationTableConfigurationList: S.optional(DestinationTableConfigurationList),
    SchemaEvolutionConfiguration: S.optional(SchemaEvolutionConfiguration),
    TableCreationConfiguration: S.optional(TableCreationConfiguration),
    BufferingHints: S.optional(BufferingHints),
...
export const DestinationDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    AmazonopensearchserviceDestinationDescription: S.optional(AmazonopensearchserviceDestinationDescription),
    ...
    AmazonOpenSearchServerlessDestinationDescription: S.optional(AmazonOpenSearchServerlessDestinationDescription),
...
export const DeliveryStreamDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
...
export const DescribeDeliveryStreamOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ DeliveryStreamDescription: DeliveryStreamDescription }).pipe(ns)).annotate({
    identifier: "DescribeDeliveryStreamOutput",
});
export const ListDeliveryStreamsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Limit: S.optional(S.Number),
    DeliveryStreamType: S.optional(DeliveryStreamType),
...
export const ListDeliveryStreamsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamNames: DeliveryStreamNameList,
    HasMoreDeliveryStreams: S.Boolean,
}).pipe(ns)).annotate({
    identifier: "ListDeliveryStreamsOutput",
});
export const ListTagsForDeliveryStreamInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
...
export const ListTagsForDeliveryStreamOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Tags: ListTagsForDeliveryStreamOutputTagList,
    HasMoreTags: S.Boolean,
}).pipe(ns)).annotate({
    identifier: "ListTagsForDeliveryStreamOutput",
});
export const Record = /*@__PURE__*/ S.suspend(() => S.Struct({ Data: T.Blob })).annotate({ identifier: "Record" });
export const PutRecordInput = /*@__PURE__*/ S.suspend(() => S.Struct({ DeliveryStreamName: S.String, Record: Record }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({ identifier: "PutRecordInput" });
export const PutRecordOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ RecordId: S.String, Encrypted: S.optional(S.Boolean) }).pipe(ns)).annotate({
    identifier: "PutRecordOutput",
});
export const PutRecordBatchRequestEntryList = /*@__PURE__*/ S.Array(Record);
export const PutRecordBatchInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
    Records: PutRecordBatchRequestEntryList,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "PutRecordBatchInput",
});
export const PutRecordBatchResponseEntry = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const PutRecordBatchOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const StartDeliveryStreamEncryptionInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
    DeliveryStreamEncryptionConfigurationInput: S.optional(DeliveryStreamEncryptionConfigurationInput),
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StartDeliveryStreamEncryptionInput",
});
export const StartDeliveryStreamEncryptionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "StartDeliveryStreamEncryptionOutput",
});
export const StopDeliveryStreamEncryptionInput = /*@__PURE__*/ S.suspend(() => S.Struct({ DeliveryStreamName: S.String }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StopDeliveryStreamEncryptionInput",
});
export const StopDeliveryStreamEncryptionOutput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "StopDeliveryStreamEncryptionOutput",
});
export const TagDeliveryStreamInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
    Tags: TagDeliveryStreamInputTagList,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "TagDeliveryStreamInput",
});
export const TagDeliveryStreamOutput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "TagDeliveryStreamOutput",
});
export const TagKeyList = /*@__PURE__*/ S.Array(S.String);
export const UntagDeliveryStreamInput = /*@__PURE__*/ S.suspend(() => S.Struct({ DeliveryStreamName: S.String, TagKeys: TagKeyList }).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "UntagDeliveryStreamInput",
});
export const UntagDeliveryStreamOutput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
    identifier: "UntagDeliveryStreamOutput",
});
export const S3DestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.optional(S.String),
...
export const ExtendedS3DestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.optional(S.String),
    BucketARN: S.optional(S.String),
    Prefix: S.optional(S.String),
    ErrorOutputPrefix: S.optional(S.String),
...
export const RedshiftDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.optional(S.String),
...
export const ElasticsearchDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.optional(S.String),
    DomainARN: S.optional(S.String),
    ClusterEndpoint: S.optional(S.String),
    IndexName: S.optional(S.String),
...
export const AmazonopensearchserviceDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    RoleARN: S.optional(S.String),
    DomainARN: S.optional(S.String),
    ClusterEndpoint: S.optional(S.String),
    IndexName: S.optional(S.String),
...
export const SplunkDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    HECEndpoint: S.optional(S.String),
    HECEndpointType: S.optional(HECEndpointType),
    HECToken: S.optional(SensitiveString),
    HECAcknowledgmentTimeoutInSeconds: S.optional(S.Number),
...
export const HttpEndpointDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const SnowflakeDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    AccountUrl: S.optional(SensitiveString),
    PrivateKey: S.optional(SensitiveString),
    KeyPassphrase: S.optional(SensitiveString),
    User: S.optional(SensitiveString),
...
export const IcebergDestinationUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
    DestinationTableConfigurationList: S.optional(DestinationTableConfigurationList),
    SchemaEvolutionConfiguration: S.optional(SchemaEvolutionConfiguration),
    TableCreationConfiguration: S.optional(TableCreationConfiguration),
    BufferingHints: S.optional(BufferingHints),
...
export const UpdateDestinationInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    DeliveryStreamName: S.String,
    ...
    AmazonOpenSearchServerlessDestinationUpdate: S.optional(AmazonOpenSearchServerlessDestinationUpdate),
...
export const UpdateDestinationOutput = /*@__PURE__*/ S.suspend(() => S.Struct({}).pipe(ns)).annotate({
 ...
 */
export const createDeliveryStream = /*@__PURE__*/ API.make(() => ({
 ...
 * to be removed.
 */
export const deleteDeliveryStream = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const describeDeliveryStream = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listDeliveryStreams = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listTagsForDeliveryStream = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const putRecord = /*@__PURE__*/ API.make(() => ({
 ...
 * Instead, concatenate the raw data, then perform base64 encoding.
 */
export const putRecordBatch = /*@__PURE__*/ API.make(() => ({
 ...
 * 24-hour period.
 */
export const startDeliveryStreamEncryption = /*@__PURE__*/ API.make(() => ({
 ...
 * 24-hour period.
 */
export const stopDeliveryStreamEncryption = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const tagDeliveryStream = /*@__PURE__*/ API.make(() => ({
 ...
 * This operation has a limit of five transactions per second per account.
 */
export const untagDeliveryStream = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const updateDestination = /*@__PURE__*/ API.make(() => ({
