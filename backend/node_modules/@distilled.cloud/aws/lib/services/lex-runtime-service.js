            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://runtime.lex-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                ...
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        ...
                        return e(`https://runtime.lex-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://runtime.lex.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class BadGatewayException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("BadGatewayException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(502)).pipe(C.withServerError) {
}
...
export class DependencyFailedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("DependencyFailedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(424)) {
}
...
export class LoopDetectedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("LoopDetectedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(508)).pipe(C.withServerError) {
}
export class NotAcceptableException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("NotAcceptableException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(406)).pipe(C.withBadRequestError) {
}
...
export class RequestTimeoutException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("RequestTimeoutException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(408)).pipe(C.withTimeoutError) {
}
export class UnsupportedMediaTypeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("UnsupportedMediaTypeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(415)).pipe(C.withBadRequestError) {
}
export const DeleteSessionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DeleteSessionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetSessionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    botAlias: S.String.pipe(T.HttpLabel("botAlias")),
    userId: S.String.pipe(T.HttpLabel("userId")),
...
export const IntentSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ActiveContextTimeToLive = /*@__PURE__*/ S.suspend(() => S.Struct({
    timeToLiveInSeconds: S.optional(S.Number),
    turnsToLive: S.optional(S.Number),
})).annotate({
    identifier: "ActiveContextTimeToLive",
});
export const ActiveContextParametersMap = /*@__PURE__*/ S.Record(S.String, SensitiveString.pipe(S.optional));
export const ActiveContext = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    timeToLive: ActiveContextTimeToLive,
    parameters: ActiveContextParametersMap,
})).annotate({ identifier: "ActiveContext" });
export const ActiveContextsList = /*@__PURE__*/ S.Array(ActiveContext);
export const GetSessionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const PostContentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    botAlias: S.String.pipe(T.HttpLabel("botAlias")),
    userId: S.String.pipe(T.HttpLabel("userId")),
    sessionAttributes: S.optional(SensitiveString).pipe(T.HttpHeader("x-amz-lex-session-attributes")),
    requestAttributes: S.optional(SensitiveString).pipe(T.HttpHeader("x-amz-lex-request-attributes")),
...
export const PostContentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    encodedInputTranscript: S.optional(SensitiveString).pipe(T.HttpHeader("x-amz-lex-encoded-input-transcript")),
...
export const PostTextRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    botAlias: S.String.pipe(T.HttpLabel("botAlias")),
    userId: S.String.pipe(T.HttpLabel("userId")),
    sessionAttributes: S.optional(StringMap),
...
export const IntentConfidence = /*@__PURE__*/ S.suspend(() => S.Struct({ score: S.optional(S.Number) })).annotate({
    identifier: "IntentConfidence",
});
export const PredictedIntent = /*@__PURE__*/ S.suspend(() => S.Struct({
    intentName: S.optional(S.String),
...
export const SentimentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Button = /*@__PURE__*/ S.suspend(() => S.Struct({ text: S.String, value: S.String })).annotate({ identifier: "Button" });
export const ListOfButtons = /*@__PURE__*/ S.Array(Button);
export const GenericAttachment = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ResponseCard = /*@__PURE__*/ S.suspend(() => S.Struct({
    version: S.optional(S.String),
    contentType: S.optional(ContentType),
    genericAttachments: S.optional(GenericAttachmentList),
})).annotate({ identifier: "ResponseCard" });
export const PostTextResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    intentName: S.optional(S.String),
    nluIntentConfidence: S.optional(IntentConfidence),
...
export const PutSessionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    botAlias: S.String.pipe(T.HttpLabel("botAlias")),
    userId: S.String.pipe(T.HttpLabel("userId")),
    sessionAttributes: S.optional(StringMap),
...
export const PutSessionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    contentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")),
    intentName: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-intent-name")),
    slots: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-slots")),
    sessionAttributes: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-session-attributes")),
 ...
 */
export const deleteSession = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const postContent = /*@__PURE__*/ API.make(() => ({
 ...
 * Conversation Context.
 */
export const postText = /*@__PURE__*/ API.make(() => ({
 ...
 * Sessions.
 */
export const putSession = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=lex-runtime-service.js.map