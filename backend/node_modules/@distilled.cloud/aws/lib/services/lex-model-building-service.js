            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://models.lex-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                ...
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        ...
                        return e(`https://models.lex-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://models.lex.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class BadRequestException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("BadRequestException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
...
export class InternalFailureException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InternalFailureException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(500)).pipe(C.withServerError) {
}
...
export class NotFoundException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("NotFoundException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(404)).pipe(C.withBadRequestError) {
}
export class PreconditionFailedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("PreconditionFailedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(412)) {
}
export class ResourceInUseException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ResourceInUseException", {
    referenceType: S.optional(S.suspend(() => ReferenceType).annotate({
        identifier: "ReferenceType",
    })),
    exampleReference: S.optional(S.suspend(() => ResourceReference).annotate({
        identifier: "ResourceReference",
    })),
    message: S.optional(S.String).pipe(T.ErrorMessage()),
}, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export const CreateBotVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    checksum: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/bots/{name}/versions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateBotVersionRequest",
});
export const Intent = /*@__PURE__*/ S.suspend(() => S.Struct({ intentName: S.String, intentVersion: S.String })).annotate({ identifier: "Intent" });
export const IntentList = /*@__PURE__*/ S.Array(Intent);
export const ContentType = /*@__PURE__*/ S.String;
export const Message = /*@__PURE__*/ S.suspend(() => S.Struct({
    contentType: ContentType,
    content: S.String,
    groupNumber: S.optional(S.Number),
})).annotate({ identifier: "Message" });
export const MessageList = /*@__PURE__*/ S.Array(Message);
export const Prompt = /*@__PURE__*/ S.suspend(() => S.Struct({
    messages: MessageList,
    maxAttempts: S.Number,
    responseCard: S.optional(S.String),
})).annotate({ identifier: "Prompt" });
export const Statement = /*@__PURE__*/ S.suspend(() => S.Struct({ messages: MessageList, responseCard: S.optional(S.String) })).annotate({ identifier: "Statement" });
export const Status = /*@__PURE__*/ S.String;
export const Locale = /*@__PURE__*/ S.String;
export const CreateBotVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateIntentVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    checksum: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/intents/{name}/versions" }), svc, auth, proto, ver, rules))).annotate({
...
export const SlotDefaultValue = /*@__PURE__*/ S.suspend(() => S.Struct({ defaultValue: S.String })).annotate({
    identifier: "SlotDefaultValue",
});
export const SlotDefaultValueList = /*@__PURE__*/ S.Array(SlotDefaultValue);
export const SlotDefaultValueSpec = /*@__PURE__*/ S.suspend(() => S.Struct({ defaultValueList: SlotDefaultValueList })).annotate({
    identifier: "SlotDefaultValueSpec",
});
export const Slot = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    description: S.optional(S.String),
...
export const FollowUpPrompt = /*@__PURE__*/ S.suspend(() => S.Struct({ prompt: Prompt, rejectionStatement: Statement })).annotate({ identifier: "FollowUpPrompt" });
export const CodeHook = /*@__PURE__*/ S.suspend(() => S.Struct({ uri: S.String, messageVersion: S.String })).annotate({ identifier: "CodeHook" });
export const FulfillmentActivityType = /*@__PURE__*/ S.String;
export const FulfillmentActivity = /*@__PURE__*/ S.suspend(() => S.Struct({ type: FulfillmentActivityType, codeHook: S.optional(CodeHook) })).annotate({
    identifier: "FulfillmentActivity",
});
export const KendraConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const InputContext = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.String })).annotate({ identifier: "InputContext" });
export const InputContextList = /*@__PURE__*/ S.Array(InputContext);
export const OutputContext = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String,
    timeToLiveInSeconds: S.Number,
    turnsToLive: S.Number,
})).annotate({ identifier: "OutputContext" });
export const OutputContextList = /*@__PURE__*/ S.Array(OutputContext);
export const CreateIntentVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
...
export const CreateSlotTypeVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    checksum: S.optional(S.String),
}).pipe(T.all(T.Http({ method: "POST", uri: "/slottypes/{name}/versions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateSlotTypeVersionRequest",
});
export const SynonymList = /*@__PURE__*/ S.Array(S.String);
export const EnumerationValue = /*@__PURE__*/ S.suspend(() => S.Struct({ value: S.String, synonyms: S.optional(SynonymList) })).annotate({
...
export const SlotTypeRegexConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ pattern: S.String })).annotate({
    identifier: "SlotTypeRegexConfiguration",
});
export const SlotTypeConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ regexConfiguration: S.optional(SlotTypeRegexConfiguration) })).annotate({
    identifier: "SlotTypeConfiguration",
});
export const SlotTypeConfigurations = /*@__PURE__*/ S.Array(SlotTypeConfiguration);
export const CreateSlotTypeVersionResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
...
export const DeleteBotRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.String.pipe(T.HttpLabel("name")) }).pipe(T.all(T.Http({ method: "DELETE", uri: "/bots/{name}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteBotAliasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    botName: S.String.pipe(T.HttpLabel("botName")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/bots/{botName}/aliases/{name}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteBotChannelAssociationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    botName: S.String.pipe(T.HttpLabel("botName")),
...
export const DeleteBotChannelAssociationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({})).annotate({
    identifier: "DeleteBotChannelAssociationResponse",
});
export const DeleteBotVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    version: S.String.pipe(T.HttpLabel("version")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/bots/{name}/versions/{version}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteIntentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.String.pipe(T.HttpLabel("name")) }).pipe(T.all(T.Http({ method: "DELETE", uri: "/intents/{name}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteIntentVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    version: S.String.pipe(T.HttpLabel("version")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/intents/{name}/versions/{version}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteSlotTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.String.pipe(T.HttpLabel("name")) }).pipe(T.all(T.Http({ method: "DELETE", uri: "/slottypes/{name}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteSlotTypeVersionRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    version: S.String.pipe(T.HttpLabel("version")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/slottypes/{name}/version/{version}" }), svc, auth, proto, ver, rules))).annotate({
...
export const DeleteUtterancesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    userId: S.String.pipe(T.HttpLabel("userId")),
}).pipe(T.all(T.Http({ method: "DELETE", uri: "/bots/{botName}/utterances/{userId}" }), svc, auth, proto, ver, rules))).annotate({
...
export const GetBotRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    versionOrAlias: S.String.pipe(T.HttpLabel("versionOrAlias")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/bots/{name}/versions/{versionOrAlias}" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetBotRequest" });
export const GetBotResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    intents: S.optional(IntentList),
    enableModelImprovements: S.optional(S.Boolean),
    ...
    childDirected: S.optional(S.Boolean),
    detectSentiment: S.optional(S.Boolean),
})).annotate({ identifier: "GetBotResponse" });
export const GetBotAliasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    botName: S.String.pipe(T.HttpLabel("botName")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/bots/{botName}/aliases/{name}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetBotAliasRequest",
});
export const LogType = /*@__PURE__*/ S.String;
export const Destination = /*@__PURE__*/ S.String;
export const LogSettingsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ConversationLogsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    logSettings: S.optional(LogSettingsResponseList),
    iamRoleArn: S.optional(S.String),
})).annotate({
    identifier: "ConversationLogsResponse",
});
export const GetBotAliasResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
...
export const GetBotAliasesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
    nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/bots/{botName}/aliases" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetBotAliasesRequest",
});
export const BotAliasMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    botVersion: S.optional(S.String),
    botName: S.optional(S.String),
...
export const GetBotAliasesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    BotAliases: S.optional(BotAliasMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetBotAliasesResponse",
});
export const GetBotChannelAssociationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    botName: S.String.pipe(T.HttpLabel("botName")),
    botAlias: S.String.pipe(T.HttpLabel("botAlias")),
}).pipe(T.all(T.Http({
...
export const GetBotChannelAssociationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
...
export const GetBotChannelAssociationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
    botAlias: S.String.pipe(T.HttpLabel("botAlias")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
...
export const BotChannelAssociation = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    botAlias: S.optional(S.String),
    botName: S.optional(S.String),
...
export const GetBotChannelAssociationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    botChannelAssociations: S.optional(BotChannelAssociationList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetBotChannelAssociationsResponse",
});
export const GetBotsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
    nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/bots" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetBotsRequest" });
export const BotMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    status: S.optional(Status),
    lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    version: S.optional(S.String),
})).annotate({ identifier: "BotMetadata" });
export const BotMetadataList = /*@__PURE__*/ S.Array(BotMetadata);
export const GetBotsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    bots: S.optional(BotMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetBotsResponse",
});
export const GetBotVersionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/bots/{name}/versions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetBotVersionsRequest",
});
export const GetBotVersionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    bots: S.optional(BotMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetBotVersionsResponse",
});
export const GetBuiltinIntentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ signature: S.String.pipe(T.HttpLabel("signature")) }).pipe(T.all(T.Http({ method: "GET", uri: "/builtins/intents/{signature}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetBuiltinIntentRequest",
});
export const LocaleList = /*@__PURE__*/ S.Array(Locale);
export const BuiltinIntentSlot = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.optional(S.String) })).annotate({
    identifier: "BuiltinIntentSlot",
});
export const BuiltinIntentSlotList = /*@__PURE__*/ S.Array(BuiltinIntentSlot);
export const GetBuiltinIntentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetBuiltinIntentsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    locale: S.optional(Locale).pipe(T.HttpQuery("locale")),
    signatureContains: S.optional(S.String).pipe(T.HttpQuery("signatureContains")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/builtins/intents" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetBuiltinIntentsRequest",
});
export const BuiltinIntentMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
    signature: S.optional(S.String),
    supportedLocales: S.optional(LocaleList),
})).annotate({
...
export const GetBuiltinIntentsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    intents: S.optional(BuiltinIntentMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetBuiltinIntentsResponse",
});
export const GetBuiltinSlotTypesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    locale: S.optional(Locale).pipe(T.HttpQuery("locale")),
    signatureContains: S.optional(S.String).pipe(T.HttpQuery("signatureContains")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/builtins/slottypes" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetBuiltinSlotTypesRequest",
});
export const BuiltinSlotTypeMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
    signature: S.optional(S.String),
    supportedLocales: S.optional(LocaleList),
})).annotate({
...
export const GetBuiltinSlotTypesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetExportRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
...
}).pipe(T.all(T.Http({ method: "GET", uri: "/exports" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetExportRequest",
});
export const ExportStatus = /*@__PURE__*/ S.String;
export const GetExportResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    version: S.optional(S.String),
...
export const GetImportRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ importId: S.String.pipe(T.HttpLabel("importId")) }).pipe(T.all(T.Http({ method: "GET", uri: "/imports/{importId}" }), svc, auth, proto, ver, rules))).annotate({
...
export const GetImportResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    resourceType: S.optional(ResourceType),
...
export const GetIntentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    version: S.String.pipe(T.HttpLabel("version")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/intents/{name}/versions/{version}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetIntentRequest",
});
export const GetIntentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    slots: S.optional(SlotList),
    sampleUtterances: S.optional(IntentUtteranceList),
...
export const GetIntentsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
    nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/intents" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetIntentsRequest",
});
export const IntentMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    version: S.optional(S.String),
})).annotate({ identifier: "IntentMetadata" });
export const IntentMetadataList = /*@__PURE__*/ S.Array(IntentMetadata);
export const GetIntentsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    intents: S.optional(IntentMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetIntentsResponse",
});
export const GetIntentVersionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/intents/{name}/versions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetIntentVersionsRequest",
});
export const GetIntentVersionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    intents: S.optional(IntentMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetIntentVersionsResponse",
});
export const GetMigrationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ migrationId: S.String.pipe(T.HttpLabel("migrationId")) }).pipe(T.all(T.Http({ method: "GET", uri: "/migrations/{migrationId}" }), svc, auth, proto, ver, rules))).annotate({
...
export const MigrationAlert = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "MigrationAlert" });
export const MigrationAlerts = /*@__PURE__*/ S.Array(MigrationAlert);
export const GetMigrationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetMigrationsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/migrations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetMigrationsRequest",
});
export const MigrationSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    migrationId: S.optional(S.String),
    v1BotName: S.optional(S.String),
    v1BotVersion: S.optional(S.String),
    v1BotLocale: S.optional(Locale),
...
export const GetMigrationsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    migrationSummaries: S.optional(MigrationSummaryList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetMigrationsResponse",
});
export const GetSlotTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    version: S.String.pipe(T.HttpLabel("version")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/slottypes/{name}/versions/{version}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetSlotTypeRequest",
});
export const GetSlotTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    enumerationValues: S.optional(EnumerationValues),
    lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const GetSlotTypesRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
    nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/slottypes" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetSlotTypesRequest",
});
export const SlotTypeMetadata = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const GetSlotTypesResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    slotTypes: S.optional(SlotTypeMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
    identifier: "GetSlotTypesResponse",
});
export const GetSlotTypeVersionsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")),
    maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/slottypes/{name}/versions" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetSlotTypeVersionsRequest",
});
export const GetSlotTypeVersionsResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    slotTypes: S.optional(SlotTypeMetadataList),
    nextToken: S.optional(S.String),
})).annotate({
...
export const GetUtterancesViewRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.String.pipe(T.HttpLabel("botName")),
...
export const UtteranceData = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "UtteranceData" });
export const ListOfUtterance = /*@__PURE__*/ S.Array(UtteranceData);
export const UtteranceList = /*@__PURE__*/ S.suspend(() => S.Struct({
    botVersion: S.optional(S.String),
    utterances: S.optional(ListOfUtterance),
})).annotate({ identifier: "UtteranceList" });
export const ListsOfUtterances = /*@__PURE__*/ S.Array(UtteranceList);
export const GetUtterancesViewResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    botName: S.optional(S.String),
...
export const ListTagsForResourceResponse = /*@__PURE__*/ S.suspend(() => S.Struct({ tags: S.optional(TagList) })).annotate({
    identifier: "ListTagsForResourceResponse",
});
export const ProcessBehavior = /*@__PURE__*/ S.String;
export const PutBotRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    description: S.optional(S.String),
    intents: S.optional(IntentList),
    enableModelImprovements: S.optional(S.Boolean),
...
}).pipe(T.all(T.Http({ method: "PUT", uri: "/bots/{name}/versions/$LATEST" }), svc, auth, proto, ver, rules))).annotate({ identifier: "PutBotRequest" });
export const PutBotResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    intents: S.optional(IntentList),
    enableModelImprovements: S.optional(S.Boolean),
    ...
    detectSentiment: S.optional(S.Boolean),
    tags: S.optional(TagList),
})).annotate({ identifier: "PutBotResponse" });
export const LogSettingsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    logType: LogType,
...
export const ConversationLogsRequest = /*@__PURE__*/ S.suspend(() => S.Struct({ logSettings: LogSettingsRequestList, iamRoleArn: S.String })).annotate({
    identifier: "ConversationLogsRequest",
});
export const PutBotAliasRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    description: S.optional(S.String),
    botVersion: S.String,
    botName: S.String.pipe(T.HttpLabel("botName")),
    ...
    tags: S.optional(TagList),
}).pipe(T.all(T.Http({ method: "PUT", uri: "/bots/{botName}/aliases/{name}" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "PutBotAliasRequest",
});
export const PutBotAliasResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    botVersion: S.optional(S.String),
    botName: S.optional(S.String),
...
export const PutIntentRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    description: S.optional(S.String),
    slots: S.optional(SlotList),
    sampleUtterances: S.optional(IntentUtteranceList),
    ...
    inputContexts: S.optional(InputContextList),
    outputContexts: S.optional(OutputContextList),
}).pipe(T.all(T.Http({ method: "PUT", uri: "/intents/{name}/versions/$LATEST" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "PutIntentRequest",
});
export const PutIntentResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    slots: S.optional(SlotList),
    sampleUtterances: S.optional(IntentUtteranceList),
...
export const PutSlotTypeRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.String.pipe(T.HttpLabel("name")),
    description: S.optional(S.String),
    enumerationValues: S.optional(EnumerationValues),
    checksum: S.optional(S.String),
    ...
    parentSlotTypeSignature: S.optional(S.String),
    slotTypeConfigurations: S.optional(SlotTypeConfigurations),
}).pipe(T.all(T.Http({ method: "PUT", uri: "/slottypes/{name}/versions/$LATEST" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "PutSlotTypeRequest",
});
export const PutSlotTypeResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    description: S.optional(S.String),
    enumerationValues: S.optional(EnumerationValues),
    lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
...
export const StartImportRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    payload: T.Blob,
    resourceType: ResourceType,
    mergeStrategy: MergeStrategy,
    tags: S.optional(TagList),
}).pipe(T.all(T.Http({ method: "POST", uri: "/imports" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StartImportRequest",
});
export const StartImportResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    name: S.optional(S.String),
    resourceType: S.optional(ResourceType),
    mergeStrategy: S.optional(MergeStrategy),
    importId: S.optional(S.String),
...
export const StartMigrationRequest = /*@__PURE__*/ S.suspend(() => S.Struct({
    v1BotName: S.String,
    v1BotVersion: S.String,
    v2BotName: S.String,
    v2BotRole: S.String,
    migrationStrategy: MigrationStrategy,
}).pipe(T.all(T.Http({ method: "POST", uri: "/migrations" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "StartMigrationRequest",
});
export const StartMigrationResponse = /*@__PURE__*/ S.suspend(() => S.Struct({
    v1BotName: S.optional(S.String),
    v1BotVersion: S.optional(S.String),
    v1BotLocale: S.optional(Locale),
    v2BotId: S.optional(S.String),
...
export const ResourceReference = /*@__PURE__*/ S.suspend(() => S.Struct({ name: S.optional(S.String), version: S.optional(S.String) })).annotate({
    identifier: "ResourceReference",
});
/**
 ...
 */
export const createBotVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createIntentVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createSlotTypeVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteBot = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteBotAlias = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteBotChannelAssociation = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteBotVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteIntent = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteIntentVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteSlotType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteSlotTypeVersion = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteUtterances = /*@__PURE__*/ API.make(() => ({
 ...
 * `lex:GetBot` action.
 */
export const getBot = /*@__PURE__*/ API.make(() => ({
    input: GetBotRequest,
 ...
 */
export const getBotAlias = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getBotAliases = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getBotChannelAssociation = /*@__PURE__*/ API.make(() => ({
 ...
 * action.
 */
export const getBotChannelAssociations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * action.
 */
export const getBots = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getBotVersions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getBuiltinIntent = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getBuiltinIntents = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getBuiltinSlotTypes = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getExport = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getImport = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getIntent = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getIntents = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getIntentVersions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getMigration = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getMigrations = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getSlotType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getSlotTypes = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getSlotTypeVersions = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const getUtterancesView = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const putBot = /*@__PURE__*/ API.make(() => ({
    input: PutBotRequest,
 ...
 */
export const putBotAlias = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const putIntent = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const putSlotType = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const startImport = /*@__PURE__*/ API.make(() => ({
 ...
 * developer guide.
 */
export const startMigration = /*@__PURE__*/ API.make(() => ({
...
//# sourceMappingURL=lex-model-building-service.js.map