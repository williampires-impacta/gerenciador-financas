            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://kinesisvideo-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://kinesisvideo-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://kinesisvideo.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export class ClientLimitExceededException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("ClientLimitExceededException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class InvalidArgumentException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidArgumentException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class InvalidCodecPrivateDataException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidCodecPrivateDataException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class InvalidMediaFrameException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("InvalidMediaFrameException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class MissingCodecPrivateDataException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("MissingCodecPrivateDataException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class NoDataRetentionException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("NoDataRetentionException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export class NotAuthorizedException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("NotAuthorizedException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(401)).pipe(C.withAuthError) {
}
...
export class UnsupportedStreamMediaTypeException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("UnsupportedStreamMediaTypeException", { message: S.optional(S.String).pipe(T.ErrorMessage()) }, T.HttpError(400)).pipe(C.withBadRequestError) {
}
export const ClipFragmentSelectorType = /*@__PURE__*/ S.String;
export const ClipTimestampRange = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const ClipFragmentSelector = /*@__PURE__*/ S.suspend(() => S.Struct({
    FragmentSelectorType: ClipFragmentSelectorType,
    TimestampRange: ClipTimestampRange,
})).annotate({
    identifier: "ClipFragmentSelector",
});
export const GetClipInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
    ClipFragmentSelector: ClipFragmentSelector,
}).pipe(T.all(T.Http({ method: "POST", uri: "/getClip" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetClipInput" });
export const GetClipOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")),
    Payload: S.optional(T.StreamingOutput).pipe(T.HttpPayload()),
})).annotate({ identifier: "GetClipOutput" });
...
export const DASHTimestampRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    StartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    EndTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({
    identifier: "DASHTimestampRange",
});
export const DASHFragmentSelector = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetDASHStreamingSessionURLInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
...
}).pipe(T.all(T.Http({ method: "POST", uri: "/getDASHStreamingSessionURL" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetDASHStreamingSessionURLInput",
});
export const GetDASHStreamingSessionURLOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ DASHStreamingSessionURL: S.optional(S.String) })).annotate({
...
export const HLSTimestampRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    StartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    EndTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
})).annotate({
    identifier: "HLSTimestampRange",
});
export const HLSFragmentSelector = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetHLSStreamingSessionURLInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
...
}).pipe(T.all(T.Http({ method: "POST", uri: "/getHLSStreamingSessionURL" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetHLSStreamingSessionURLInput",
});
export const GetHLSStreamingSessionURLOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ HLSStreamingSessionURL: S.optional(S.String) })).annotate({
...
export const GetImagesInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
...
}).pipe(T.all(T.Http({ method: "POST", uri: "/getImages" }), svc, auth, proto, ver, rules))).annotate({ identifier: "GetImagesInput" });
export const ImageError = /*@__PURE__*/ S.String;
export const Image = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const GetImagesOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Images: S.optional(Images), NextToken: S.optional(S.String) })).annotate({
    identifier: "GetImagesOutput",
});
export const FragmentNumberList = /*@__PURE__*/ S.Array(S.String);
export const GetMediaForFragmentListInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
    Fragments: FragmentNumberList,
}).pipe(T.all(T.Http({ method: "POST", uri: "/getMediaForFragmentList" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "GetMediaForFragmentListInput",
});
export const GetMediaForFragmentListOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")),
    Payload: S.optional(T.StreamingOutput).pipe(T.HttpPayload()),
})).annotate({
...
export const TimestampRange = /*@__PURE__*/ S.suspend(() => S.Struct({
    StartTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")),
    EndTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")),
})).annotate({ identifier: "TimestampRange" });
export const FragmentSelector = /*@__PURE__*/ S.suspend(() => S.Struct({
    FragmentSelectorType: FragmentSelectorType,
    TimestampRange: TimestampRange,
})).annotate({
    identifier: "FragmentSelector",
});
export const ListFragmentsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    StreamName: S.optional(S.String),
    StreamARN: S.optional(S.String),
    MaxResults: S.optional(S.Number),
    NextToken: S.optional(S.String),
    FragmentSelector: S.optional(FragmentSelector),
}).pipe(T.all(T.Http({ method: "POST", uri: "/listFragments" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListFragmentsInput",
});
export const Fragment = /*@__PURE__*/ S.suspend(() => S.Struct({
...
})).annotate({ identifier: "Fragment" });
export const FragmentList = /*@__PURE__*/ S.Array(Fragment);
export const ListFragmentsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
 ...
 */
export const getClip = /*@__PURE__*/ API.make(() => ({
    input: GetClipInput,
 ...
 */
export const getDASHStreamingSessionURL = /*@__PURE__*/ API.make(() => ({
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export const getHLSStreamingSessionURL = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getImages = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export const getMediaForFragmentList = /*@__PURE__*/ API.make(() => ({
 ...
 * the bottom of this topic, as well as Common Errors.
 */
export const listFragments = /*@__PURE__*/ API.makePaginated(() => ({
...
//# sourceMappingURL=kinesis-video-archived-media.js.map