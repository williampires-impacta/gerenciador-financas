...
import { makeStreamingBodyMiddleware } from "../middleware/streaming-body.js";
import { getMiddleware, getProtocol } from "../traits.js";
import { fillIdempotencyTokens, findIdempotencyTokenProps, } from "./generate-idempotency-tokens.js";
/**
 ...
 */
export const makeRequestBuilder = (operation, options) => {
