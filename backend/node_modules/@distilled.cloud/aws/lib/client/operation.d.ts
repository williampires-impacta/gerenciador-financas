...
export declare namespace Operation {
    type Input<Op extends Operation> = S.Schema.Type<Op["input"]>;
    type Output<Op extends Operation> = S.Schema.Type<Op["output"]>;
    type Error<Op extends Operation> = Instance<Op["errors"][number]>;
}
