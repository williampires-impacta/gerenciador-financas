...
import { getAwsApiService, getEventSchema, isOutputEventStream, isStreamingType, } from "../traits.js";
import { getEncodedPropertySignatures, getIdentifier } from "../util/ast.js";
import { extractJsonErrorCode, extractJsonErrorData, sanitizeErrorCode, } from "../util/error.js";
import { readStreamAsText } from "../util/stream.js";
 ...
 */
function createAwsJsonProtocol(version) {
            ...
            deserializeResponse: Effect.fn(function* (response) {
                ...
                if (streamingOutputProp && response.body) {
                    if (streamingOutputProp.isEventStream) {
                        ...
                        return {
                            [streamingOutputProp.name]: parseEventStreamToUnion(response.body, undefined, streamingOutputProp.eventSchema),
                        };
                    }
 ...
 */
function buildXAmzTarget(ast, operationName) {
...
//# sourceMappingURL=aws-json.js.map