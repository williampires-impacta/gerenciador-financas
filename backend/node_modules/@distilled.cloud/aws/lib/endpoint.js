...
export class Endpoint extends Context.Service()("AWS::Endpoint") {
}
/**
 ...
 */
export const fromEnvironment = Config.string("AWS_ENDPOINT_URL").pipe(Config.option, Effect.map(Option.getOrUndefined));
...
export const of = (endpoint) => Layer.succeed(Endpoint, Effect.succeed(endpoint));
