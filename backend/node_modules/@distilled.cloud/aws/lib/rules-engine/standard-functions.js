...
export const booleanEquals = (a, b) => a === b;
...
export function getAttr(value, path) {
    if (value == null)
        return undefined;
...
export function substring(input, start, stop, reverse) {
...
export function isValidHostLabel(value, allowSubDomains) {
 ...
 */
function isValidSingleHostLabel(label) {
...
//# sourceMappingURL=standard-functions.js.map