...
export declare function partition(region: RulesValue): PartitionInfo | undefined;
...
export declare function isVirtualHostableS3Bucket(value: RulesValue, allowSubDomains?: RulesValue): boolean;
