...
export declare const stringEquals: typeof booleanEquals;
...
export declare function substring(input: RulesValue, start: RulesValue, stop: RulesValue, reverse: RulesValue): RulesValue;
...
export declare function isValidHostLabel(value: RulesValue, allowSubDomains: RulesValue): boolean;
