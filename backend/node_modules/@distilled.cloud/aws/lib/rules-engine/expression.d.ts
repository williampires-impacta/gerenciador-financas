...
export type RulesValue = string | number | boolean | null | undefined | RulesValue[] | Record<string, unknown>;
...
export declare function isEndpointRule(rule: RuleObject): rule is EndpointRuleObject;
