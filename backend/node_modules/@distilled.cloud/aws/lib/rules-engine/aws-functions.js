...
import { isIpAddress, isValidHostLabel } from "./standard-functions.js";
const partitions = partitionsData;
const toPartitionInfo = (o) => ({
    name: o.name,
...
export function partition(region) {
...
export function isVirtualHostableS3Bucket(value, allowSubDomains = false) {
    if (typeof value !== "string") {
        return false;
    }
    if (allowSubDomains) {
...
//# sourceMappingURL=aws-functions.js.map