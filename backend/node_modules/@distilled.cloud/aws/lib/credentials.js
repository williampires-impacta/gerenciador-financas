 ...
 */
const regionFromEnvOrProfile = BrowserCredentials.regionFromEnv.pipe(Effect.catchTag("Alchemy::AWS::MissingRegion", (missing) => Effect.flatMap(Effect.tryPromise({
    ...
    return region === undefined
        ? Effect.fail(new BrowserCredentials.MissingRegion({
...
export const fromChain = () => BrowserCredentials.createLazyProvider(() => _fromNodeProviderChain(), "chain", regionFromEnvOrProfile);
// export const fromSSO = () => createLazyProvider(_fromSSO);
export const fromIni = () => BrowserCredentials.createLazyProvider(_fromIni, "ini", regionFromEnvOrProfile);
export const fromContainerMetadata = () => BrowserCredentials.createLazyProvider(_fromContainerMetadata, "container");
export const fromProcess = () => BrowserCredentials.createLazyProvider(_fromProcess, "process", regionFromEnvOrProfile);
 ...
 */
export const fromSSO = (profileName = "default") => Layer.effect(BrowserCredentials.Credentials, Auth.use((auth) => Effect.succeed(BrowserCredentials.createCachedCredentialsEffect(
