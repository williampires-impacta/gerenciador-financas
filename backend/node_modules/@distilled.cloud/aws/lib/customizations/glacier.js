 ...
 */
export function applyGlacierCustomizations(request, serviceVersion) {
    return {
        ...request,
        headers: {
            ...request.headers,
 ...
 */
export function isGlacier(sdkId) {
 ...
 */
export function requiresGlacierChecksums(operationName) {
 ...
 */
export async function computeTreeHash(data) {
    const bytes = typeof data === "string" ? new TextEncoder().encode(data) : data;
    // 1 MB chunk size
 ...
 */
export async function applyGlacierChecksums(request) {
