...
declare const Auth_base: Context.ServiceClass<Auth, "distilled-aws/AWS/Auth", {
    loadProfile: (profileName: string) => Effect.Effect<AwsProfileConfig, CredentialsError>;
    loadProfileCredentials: (profileName: string) => Effect.Effect<ResolvedCredentials, CredentialsError>;
}>;
