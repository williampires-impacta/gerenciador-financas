...
import { isBooleanAST, isNumberAST } from "./ast.js";
// =============================================================================
// XML Parser
// =============================================================================
/**
 ...
 */
export const escapeXml = (s) => s.replace(/[&<>"']/g, (c) => xmlEscapes[c]);
// =============================================================================
// XML Tag Helpers
// =============================================================================
/**
 ...
 */
export const wrapTag = (tag, content, xmlns) => `<${tag}${xmlns ? ` xmlns="${escapeXml(xmlns)}"` : ""}>${content}</${tag}>`;
// =============================================================================
 ...
 */
export function extractXmlRoot(parsed) {
 ...
 */
export function deserializePrimitive(ast, value) {
    if (isNumberAST(ast))
        return Number(value);
    if (isBooleanAST(ast))
        return value === "true";
 ...
 */
export function unwrapArrayValue(value, primaryTag, fallbackTags = []) {
