 ...
 */
export declare function sanitizeErrorCode(value: string): string;
/**
 ...
 */
export declare function extractJsonErrorCode(body: Record<string, unknown>): string | undefined;
/**
 ...
 */
export declare function extractJsonErrorData(body: Record<string, unknown>): Record<string, unknown>;
