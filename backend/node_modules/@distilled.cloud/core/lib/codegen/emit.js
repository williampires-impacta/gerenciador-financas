...
export const interfaceDecl = (name, fields) => fields.length
 ...
 */
export const suspendRef = (name, typed = false) => typed
...
export const operationConst = (o) => `export const ${o.exportName}: ${o.typeAnnotation} = ${o.pure ?? ""}${o.factory}(() => (${o.config})${o.extraArg ? `, ${o.extraArg}` : ""})${o.castToAnnotation ? ` as any` : ""};\n`;
import { tsKey } from "./naming.js";
/** Interface field line(s): optional doc comment + `  name?: Type;`. */
export const interfaceField = (o) => [
    ...(o.doc ? [`  /** ${o.doc} */`] : []),
    `  ${tsKey(o.name)}${o.optional ? "?" : ""}: ${o.type};`,
];
/** `export type <Op>Error = A | B | <CommonErrors>;` */
export const errorUnionAlias = (opName, errorNames, commonRef) => `export type ${opName}Error = ${[...errorNames, commonRef].join(" | ")};`;
/** Namespaced barrel: `export * as name from "./file.ts";` per entry. */
export const barrel = (header, entries) => header +
