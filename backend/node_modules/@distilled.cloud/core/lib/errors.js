 ...
 */
export const DurationSchema = Schema.declare(Duration.isDuration);
// ============================================================================
 ...
 */
export class Unauthorized extends Schema.TaggedError()("Unauthorized", { message: Schema.String }).pipe(Category.withAuthError) {
}
/**
 ...
 */
export class UnprocessableEntity extends Schema.TaggedError()("UnprocessableEntity", { message: Schema.String }).pipe(Category.withBadRequestError) {
}
/**
 ...
 */
export class Locked extends Schema.TaggedError()("Locked", {
    message: Schema.String,
    retryAfter: Schema.optional(DurationSchema),
 ...
 */
export class ConfigError extends Schema.TaggedError()("ConfigError", { message: Schema.String }).pipe(Category.withConfigurationError) {
}
// ============================================================================
// Error Maps
// ============================================================================
