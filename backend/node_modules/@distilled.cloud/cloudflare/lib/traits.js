...
export { Body, Header, Query, DeepQuery, Label, Http, ResponseCode, HttpBody, FormDataFile, KeyDictionary, UnionCases, applyErrorMatchers, getErrorMatchers, bodySymbol, headerSymbol, querySymbol, deepQuerySymbol, labelSymbol, httpSymbol, responseCodeSymbol, httpBodySymbol, formDataFileSymbol, keyDictionarySymbol, unionCasesSymbol, errorMatchersSymbol, } from "@distilled.cloud/core/trait";
// =============================================================================
// Cloudflare v4 envelope traits
// =============================================================================
export const envelopePayloadRootSymbol = Symbol.for("@distilled.cloud/cloudflare/envelope-payload-root");
/**
...
export const binaryResponseBodySymbol = Symbol.for("@distilled.cloud/cloudflare/binary-response-body");
/**
