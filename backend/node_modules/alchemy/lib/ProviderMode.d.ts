 ...
 */
export declare const ProviderModePolicy: Context.Reference<boolean | undefined>;
declare const ConflictingProviderModeError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "ConflictingProviderModeError";
} & Readonly<A>;
/**
 ...
 */
export declare class ConflictingProviderModeError extends ConflictingProviderModeError_base<{
    message: string;
    fqn: string;
 ...
 * `providerMode` stamp.
 */
export declare const LOCAL_ID_PREFIX = "dev:";
/**
 ...
 */
export declare const hasLocalIdentity: (value: unknown) => boolean;
/**
 ...
 * implementation.
 */
export declare const stampedMode: (row: {
 ...
 */
export declare const defaultProviderMode: Effect.Effect<ProviderMode>;
export {};
//# sourceMappingURL=ProviderMode.d.ts.map