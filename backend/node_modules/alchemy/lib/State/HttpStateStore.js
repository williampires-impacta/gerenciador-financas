 ...
 */
export const describeStateStoreFailure = (e) => {
...
const mapStateStoreError = (eff) => eff.pipe(retryTransient, Effect.tapError(Effect.log), Effect.catch((e) => Effect.fail(new StateStoreError({
