...
export class BearerTokenValidator extends Context.Service()("alchemy/State/BearerTokenValidator") {
}
export class StateAuth extends HttpApiMiddleware.Service()("alchemy/State/StateAuth", {
    security: {
...
export const StateAuthLive = Layer.effect(StateAuth, Effect.gen(function* () {
    const validator = yield* BearerTokenValidator;
    return {
        bearer: (httpEffect, { credential }) => validator
...
export const ListResources = HttpApiEndpoint.get("listResources", "/state/stacks/:stack/stages/:stage/resources", {
    params: StackStage,
    success: Schema.Array(Schema.String),
});
export const GetState = HttpApiEndpoint.get("getState", "/state/stacks/:stack/stages/:stage/resources/:fqn", {
    params: ResourceKey,
    success: Schema.UndefinedOr(ResourceStateSchema),
});
export const SetState = HttpApiEndpoint.put("setState", "/state/stacks/:stack/stages/:stage/resources/:fqn", {
    params: ResourceKey,
    payload: ResourceStateSchema,
    success: ResourceStateSchema,
});
export const DeleteState = HttpApiEndpoint.delete("deleteState", "/state/stacks/:stack/stages/:stage/resources/:fqn", {
    params: ResourceKey,
...
export const GetReplacedResources = HttpApiEndpoint.get("getReplacedResources", "/state/stacks/:stack/stages/:stage/replaced-resources", {
    params: StackStage,
    success: Schema.Array(ResourceStateSchema),
});
export const GetStackOutput = HttpApiEndpoint.get("getStackOutput", "/state/stacks/:stack/stages/:stage/output", {
    params: StackStage,
    success: Schema.UndefinedOr(ResourceStateSchema),
});
export const SetStackOutput = HttpApiEndpoint.put("setStackOutput", "/state/stacks/:stack/stages/:stage/output", {
    params: StackStage,
    payload: ResourceStateSchema,
    success: ResourceStateSchema,
});
 ...
 */
export const STATE_STORE_VERSION = 5;
...
//# sourceMappingURL=HttpStateApi.js.map