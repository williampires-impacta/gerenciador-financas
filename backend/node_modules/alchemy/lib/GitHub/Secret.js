 ...
 * @resource
 */
export const Secret = Resource("GitHub.Secret");
async function encryptValue(plaintext, publicKey) {
...
const upsertSecret = Effect.fn(function* (props) {
...
const deleteSecret = Effect.fn(function* (props) {
    const octokit = yield* octokitFor(props.baseUrl);
    const environment = resolveEnvironmentName(props.environment);
    yield* Effect.tryPromise(async () => {
        try {
