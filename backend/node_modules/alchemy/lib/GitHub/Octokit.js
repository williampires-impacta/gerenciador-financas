...
import { normalizeGitHubBaseUrl } from "./BaseUrl.js";
import { GitHubCredentials } from "./Credentials.js";
export const Octokit = Effect.gen(function* () {
 ...
 * host.
 */
export const octokitFor = (baseUrl) => Effect.gen(function* () {
    const creds = yield* yield* GitHubCredentials;
 ...
 */
export const effectiveGitHubBaseUrl = (baseUrl) => Effect.gen(function* () {
 ...
 */
export const gitHubBaseUrlChanged = (olds, news) => Effect.gen(function* () {
