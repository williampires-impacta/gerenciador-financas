 ...
 */
export declare const makeEntrypointLayer: (tag: any, entrypoint: any) => Layer.Layer<any>;
/**
 ...
 */
export declare const reifyBoundConfigProvider: (base: ConfigProvider.ConfigProvider, env: Record<string, unknown>) => ConfigProvider.ConfigProvider;
