...
export interface FunctionContext extends BaseRuntimeContext {
    ...
    listen<A, Req = never, InitReq = never>(effect: Effect.Effect<FunctionListener<A, Req>, never, InitReq>): Effect.Effect<void, never, Req | InitReq>;
    exports: Effect.Effect<Record<string, any>, never, never>;
}
export type FunctionListener<A = any, Req = never> = (event: any) => Effect.Effect<A, never, Req> | void;
