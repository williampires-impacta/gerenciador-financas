...
import { Schema, SchemaProvider } from "./Schema.js";
export class Providers extends Provider.ProviderCollection()("Drizzle") {
}
/**
 ...
 * ```
 */
export const providers = () => Layer.effect(Providers, Provider.collection([Schema])).pipe(Layer.provide(SchemaProvider()), Layer.orDie);
