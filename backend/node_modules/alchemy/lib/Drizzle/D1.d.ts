 ...
 * @binding
 */
export declare const D1: <TRelations extends AnyRelations = EmptyRelations, E = never, R = never>(database: D1DatabaseSource<E, R>, config?: SQLiteD1Drizzle.EffectDrizzleSQLiteD1Config<TRelations>) => Effect.Effect<EffectSQLiteD1Database<TRelations> & {
