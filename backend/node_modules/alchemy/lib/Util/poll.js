...
export const isPredicateFailed = (e) => Predicate.isTagged(e, "PredicateFailed");
/**
 ...
 */
export const poll = Effect.fn("poll")((input) => input.effect.pipe(Effect.filterOrFail(input.predicate, (actual) => new PredicateFailed({
