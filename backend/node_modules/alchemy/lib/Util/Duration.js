 ...
 */
export const normalizeDurationInput = (input) => {
    const json = input;
...
const wire = (to) => (input) => input === undefined
    ? undefined
 ...
 * a branch.
 */
export const toMillis = (input) => input === undefined
    ? undefined
 ...
 */
export const toSeconds = (input) => input === undefined
    ? undefined
