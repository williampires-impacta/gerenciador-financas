...
const numericId = (ref) => typeof ref === "number" ? ref : /^\d+$/.test(ref) ? Number(ref) : undefined;
const notFound = (kind, ref) => new CatalogNotFound({ kind, ref: String(ref) });
/**
 * Resolve a Hetzner Location by name (`nbg1`, `fsn1`, `hel1`, …) or
 * numeric id.
 */
export const findLocation = (ref) => Effect.gen(function* () {
 ...
 */
export const findServerType = (ref) => Effect.gen(function* () {
    const id = numericId(ref);
    if (id !== undefined) {
 ...
 */
export const findImage = (ref) => Effect.gen(function* () {
    const id = numericId(ref);
    if (id !== undefined) {
 ...
 */
export const findIso = (ref) => Effect.gen(function* () {
    const id = numericId(ref);
    if (id !== undefined) {
 ...
 * numeric id.
 */
export const findLoadBalancerType = (ref) => Effect.gen(function* () {
    const id = numericId(ref);
    if (id !== undefined) {
