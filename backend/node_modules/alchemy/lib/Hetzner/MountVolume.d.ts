 ...
 * @binding
 */
export interface MountVolume extends Binding.Service<MountVolume, "Hetzner.MountVolume", (volume: Volume, options: MountVolumeOptions) => Effect.Effect<MountedVolume>> {
}
