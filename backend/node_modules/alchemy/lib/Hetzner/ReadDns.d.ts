import type { GetZoneRrsetError, GetZoneRrsetResponse, ListZoneRrsetsError, ListZoneRrsetsRequest, ListZoneRrsetsResponse } from "@distilled.cloud/hetzner/zone_rrsets";
 ...
 * @binding
 */
export interface ReadDns extends Binding.Service<ReadDns, "Hetzner.DNS.ReadDns", (zone: Zone) => Effect.Effect<ReadDnsClient>> {
}
export declare const ReadDns: ReadDns;
...
export interface ReadDnsClient {
    ...
    getRecordSet(name: string, type: string): Effect.Effect<GetZoneRrsetResponse, GetZoneRrsetError, RuntimeContext>;
    /** List RRSets in the bound zone. */
    listRecordSets(request?: ListRecordSetsRequestInput): Effect.Effect<ListZoneRrsetsResponse, ListZoneRrsetsError, RuntimeContext>;
}
//# sourceMappingURL=ReadDns.d.ts.map