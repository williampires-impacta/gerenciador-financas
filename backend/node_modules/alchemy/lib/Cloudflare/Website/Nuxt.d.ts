...
export interface NuxtProps<Bindings extends WorkerBindingProps = {}> extends Omit<WorkerProps<Bindings>, "vite" | "main" | "assets" | "source" | "script" | "bundle"> {
    /**
...
export declare const Nuxt: {
    <Self>(): {
        <const Bindings extends WorkerBindingProps = {}, Req = never>(id: string, propsEff?: InputProps<NuxtProps<Bindings>> | Effect.Effect<InputProps<NuxtProps<Bindings>>, never, Req>): Effect.Effect<Self, never, Req | Providers> & {
            new (): Worker<{
                [binding in keyof NormalizedBindings<Bindings, WorkerAssetsConfig>]: NormalizedBindings<Bindings, WorkerAssetsConfig>[binding];
            }>;
        };
    };
    <const Bindings extends WorkerBindingProps = {}, Req = never>(id: string, propsEff?: InputProps<NuxtProps<Bindings>> | Effect.Effect<InputProps<NuxtProps<Bindings>>, never, Req>): Effect.Effect<Worker<{
        [binding in keyof NormalizedBindings<Bindings, WorkerAssetsConfig>]: NormalizedBindings<Bindings, WorkerAssetsConfig>[binding];
    }>, never, Req | Providers>;
};
