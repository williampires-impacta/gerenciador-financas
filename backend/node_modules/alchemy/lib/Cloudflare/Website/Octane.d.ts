...
export interface OctaneProps<Bindings extends WorkerBindingProps = {}> extends Omit<WorkerProps<Bindings>, "vite" | "main" | "assets" | "source" | "script" | "bundle"> {
    /**
 ...
 */
export declare const Octane: {
    <Self>(): {
        <const Bindings extends WorkerBindingProps = {}, Req = never>(id: string, propsEff?: InputProps<OctaneProps<Bindings>> | Effect.Effect<InputProps<OctaneProps<Bindings>>, never, Req>): Effect.Effect<Self, never, Req | Providers> & {
            new (): Worker<{
                [binding in keyof NormalizedBindings<Bindings, WorkerAssetsConfig>]: NormalizedBindings<Bindings, WorkerAssetsConfig>[binding];
            }>;
        };
    };
    <const Bindings extends WorkerBindingProps = {}, Req = never>(id: string, propsEff?: InputProps<OctaneProps<Bindings>> | Effect.Effect<InputProps<OctaneProps<Bindings>>, never, Req>): Effect.Effect<Worker<{
        [binding in keyof NormalizedBindings<Bindings, WorkerAssetsConfig>]: NormalizedBindings<Bindings, WorkerAssetsConfig>[binding];
    }>, never, Req | Providers>;
};
