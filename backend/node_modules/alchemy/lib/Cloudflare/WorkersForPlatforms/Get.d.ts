 ...
 */
export interface Get extends Binding.Service<Get, "Cloudflare.WorkersForPlatforms.Get", (namespace: DispatchNamespaceResource) => Effect.Effect<DispatchNamespaceClient>> {
}
export declare const Get: Get;
declare const DispatchNamespaceError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "DispatchNamespaceError";
} & Readonly<A>;
/** Error raised by dynamic-dispatch runtime operations. */
export declare class DispatchNamespaceError extends DispatchNamespaceError_base<{
...
export interface DispatchNamespaceClient {
    ...
    get(name: string, args?: {
        [key: string]: any;
    }, options?: DynamicDispatchOptions): Effect.Effect<Fetcher, DispatchNamespaceError, RuntimeContext>;
}
export {};
