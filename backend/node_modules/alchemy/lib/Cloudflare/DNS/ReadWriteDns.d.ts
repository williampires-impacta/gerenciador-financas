 ...
 */
export interface ReadWriteDns extends Binding.Service<ReadWriteDns, "Cloudflare.DNS.ReadWriteDns", (zone: Zone) => Effect.Effect<ReadWriteDnsClient>> {
}
export declare const ReadWriteDns: ReadWriteDns;
/** Combined read + write DNS record operations. */
export interface ReadWriteDnsClient extends ReadDnsClient, WriteDnsClient {
}
//# sourceMappingURL=ReadWriteDns.d.ts.map