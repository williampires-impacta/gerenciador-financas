import type { GetRecordError, GetRecordResponse, ListRecordsError, ListRecordsRequest, ListRecordsResponse } from "@distilled.cloud/cloudflare/dns";
 ...
 */
export interface ReadDns extends Binding.Service<ReadDns, "Cloudflare.DNS.ReadDns", (zone: Zone) => Effect.Effect<ReadDnsClient>> {
}
...
export interface ReadDnsClient {
    ...
    getDnsRecord(dnsRecordId: string): Effect.Effect<GetRecordResponse, GetRecordError, RuntimeContext>;
    /** List the DNS records in the bound zone. */
    listDnsRecords(request?: ListRecordsRequestInput): Effect.Effect<ListRecordsResponse, ListRecordsError, RuntimeContext>;
}
