 ...
 */
export declare const ReadWriteDnsLocal: Layer.Layer<ReadWriteDns, never, import("@distilled.cloud/cloudflare").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
//# sourceMappingURL=ReadWriteDnsLocal.d.ts.map