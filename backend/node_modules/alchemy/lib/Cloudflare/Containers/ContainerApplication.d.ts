...
export declare namespace ContainerApplication {
    type InstanceType = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["instanceType"]>;
    type SchedulingPolicy = NonNullable<Containers.CreateContainerApplicationRequest["schedulingPolicy"]>;
    type Observability = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["observability"]>;
    type Secret = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["secrets"]>[number];
    type Disk = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["disk"]>;
    type EnvironmentVariable = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["environmentVariables"]>[number];
    type Label = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["labels"]>[number];
    type Network = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["network"]>;
    type Dns = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["dns"]>;
    type Port = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["ports"]>[number];
    type Check = NonNullable<Containers.CreateContainerApplicationRequest["configuration"]["checks"]>[number];
    type Constraints = {
        tier?: number;
    };
    type Affinities = {
    ...
    type Configuration = Containers.CreateContainerApplicationRequest["configuration"];
    interface Rollout {
 ...
 * image).
 */
export type ContainerApplicationProps = EffectfulContainerProps | ExternalContainerProps | RemoteContainerProps;
/**
...
export type ContainerServices = ContainerApplication | PlatformServices | Server.ProcessServices;
 ...
 */
export interface ContainerApplication<Shape = unknown> extends Resource<ContainerTypeId, ContainerApplicationProps, {
    /**
...
export type DevContainerImage = DevContainerImage.Build | DevContainerImage.Pull | DevContainerImage.Ref;
...
export declare const ContainerProvider: () => import("effect/Layer").Layer<import("../../Provider.ts").Provider<ContainerApplication<unknown>>, never, import("../../AlchemyContext.ts").AlchemyContext | import("../../Artifacts.ts").ArtifactStore | import("../CloudflareEnvironment.ts").CloudflareEnvironment | import("../../Docker/Docker.ts").Docker | import("effect/FileSystem").FileSystem | import("effect/Path").Path | import("../../Stack.ts").Stack | import("../../Stage.ts").Stage | Containers.CloudflareOpContext>;
