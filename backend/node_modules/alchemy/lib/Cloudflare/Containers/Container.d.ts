...
export declare const ContainerTypeId = "Cloudflare.Container";
export type ContainerTypeId = typeof ContainerTypeId;
export declare const ContainerTag: (id: string) => Context.Key<Container.Instance, Container.Instance>;
export declare const isContainer: <T>(value: T) => value is T & Container;
declare const ContainerError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
...
declare const NoContainerInstanceError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "NoContainerInstanceError";
} & Readonly<A>;
/**
 ...
 */
export declare class NoContainerInstanceError extends NoContainerInstanceError_base<{
    readonly message: string;
    readonly cause?: unknown;
}> {
}
declare const ContainerRateLimitedError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "ContainerRateLimitedError";
} & Readonly<A>;
/**
 ...
 */
export declare class ContainerRateLimitedError extends ContainerRateLimitedError_base<{
    readonly message: string;
    readonly cause?: unknown;
}> {
}
declare const ContainerCrashedError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "ContainerCrashedError";
} & Readonly<A>;
/**
 ...
 */
export declare class ContainerCrashedError extends ContainerCrashedError_base<{
    readonly message: string;
    readonly cause?: unknown;
}> {
}
...
import type { EffectfulContainerProps, ExternalContainerProps, RemoteContainerProps } from "./ContainerApplication.ts";
 ...
 */
export type ImageContainerProps<Req = never> = InputProps<ExternalContainerProps> | InputProps<RemoteContainerProps> | Effect.Effect<InputProps<ExternalContainerProps> | InputProps<RemoteContainerProps>, Config.ConfigError, Req>;
 ...
 */
export declare const Container: ResourceClassLike<ContainerApplication> & {
    <DOShape = unknown, const Id extends string = string, PropsReq = never>(id: Id, props: ImageContainerProps<PropsReq>): Container.Decl<Container<Id>, {}, Id, PropsReq, DOShape>;
    <Self>(): {
        <const Id extends string, PropsReq = never>(id: Id, props: ImageContainerProps<PropsReq>): Container.Decl<Self, {}, Id, PropsReq>;
    };
    <Self, Shape>(): {
...
export declare namespace Container {
    interface Decl<Self = any, Shape = any, Id extends string = string, Req = never, DOShape = unknown> extends Effect.Effect<Self, never, Providers | Req>, Rpc<Shape>, Named<Id> {
        ...
        make: <InitReq = never, WorkerReq = never, PropsReq = never>(props: InputProps<EffectfulContainerProps> | Effect.Effect<InputProps<EffectfulContainerProps>, Config.ConfigError, PropsReq>, impl: Effect.Effect<Shape & WorkerShape<WorkerReq>, Config.ConfigError, InitReq>) => Layer.Layer<Application<Self>, never, Providers>;
        of(shape: Shape & WorkerShape): Shape;
    }
    namespace Decl {
        type Any = Decl<any, any, string, any, any>;
    }
    interface Application<Self> {
        "~alchemy/Kind": "ContainerApplication";
        "~alchemy/Self": Self;
    }
    type Instance<Shape = any> = Container & Shape & {
        getTcpPort: (portNumber: number) => Effect.Effect<{
            fetch: {
                (request: HttpClientRequest.HttpClientRequest): Effect.Effect<HttpClientResponse.HttpClientResponse>;
