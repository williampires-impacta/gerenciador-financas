...
import type { R2Error, GetOptions, ListOptions, R2Object, ObjectBody, Objects } from "./BucketTypes.ts";
/**
 * @binding
 * @product R2
 * @category Storage & Databases
 */
export interface ReadBucket extends Binding.Service<ReadBucket, "Cloudflare.R2.ReadBucket", (bucket: Bucket) => Effect.Effect<ReadBucketClient>> {
}
