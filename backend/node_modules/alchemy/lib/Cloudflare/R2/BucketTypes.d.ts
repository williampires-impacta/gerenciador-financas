...
declare const R2Error_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "R2Error";
} & Readonly<A>;
export declare class R2Error extends R2Error_base<{
    message: string;
    cause: Error;
}> {
}
export interface MultipartUpload {
    ...
    uploadPart(partNumber: number, value: ReadableStream | (ArrayBuffer | ArrayBufferView) | string | Blob, options?: UploadPartOptions): Effect.Effect<UploadedPart, R2Error>;
