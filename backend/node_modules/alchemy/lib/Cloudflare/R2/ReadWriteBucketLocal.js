...
import { makeReadWrite } from "./ReadWriteBucketBinding.js";
import { ReadWriteBucket } from "./ReadWriteBucket.js";
import { makeReadWriteR2HttpClient } from "./ReadWriteBucketHttp.js";
/**
 ...
 * ```
 */
export const ReadWriteBucketLocal = Layer.effect(ReadWriteBucket, Effect.suspend(() => makeLocalBucketBinding({
    makeHttpClient: makeReadWriteR2HttpClient,
    makeNativeClient: makeReadWrite,
})));
//# sourceMappingURL=ReadWriteBucketLocal.js.map