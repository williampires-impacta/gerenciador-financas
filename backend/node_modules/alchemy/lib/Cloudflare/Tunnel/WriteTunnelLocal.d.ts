...
import { WriteTunnel } from "./WriteTunnel.ts";
/**
 ...
 * ```
 */
export declare const WriteTunnelLocal: Layer.Layer<WriteTunnel, never, import("../CloudflareEnvironment.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
//# sourceMappingURL=WriteTunnelLocal.d.ts.map