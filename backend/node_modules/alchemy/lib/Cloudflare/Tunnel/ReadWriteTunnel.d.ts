...
import { type ReadTunnelClient } from "./ReadTunnel.ts";
import { type WriteTunnelClient } from "./WriteTunnel.ts";
/**
 ...
 */
export interface ReadWriteTunnel extends Binding.Service<ReadWriteTunnel, "Cloudflare.Tunnel.ReadWriteTunnel", () => Effect.Effect<ReadWriteTunnelClient, never, Worker | CloudflareEnvironment>> {
}
export declare const ReadWriteTunnel: ReadWriteTunnel;
...
export declare const readWriteClient: (auth: TunnelAuth) => ReadWriteTunnelClient;
//# sourceMappingURL=ReadWriteTunnel.d.ts.map