...
import { ReadTunnel } from "./ReadTunnel.ts";
/**
 ...
 * ```
 */
export declare const ReadTunnelLocal: Layer.Layer<ReadTunnel, never, import("../CloudflareEnvironment.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
//# sourceMappingURL=ReadTunnelLocal.d.ts.map