...
const TypeId = "Cloudflare.NetworkInterconnects.Settings";
/**
 ...
 * @category Network
 */
export const NetworkInterconnectSettings = Resource(TypeId);
/**
 * Returns true if the given value is a NetworkInterconnectSettings resource.
 */
export const isNetworkInterconnectSettings = (value) => Predicate.hasProperty(value, "Type") && value.Type === TypeId;
export const NetworkInterconnectSettingsProvider = () => Provider.succeed(NetworkInterconnectSettings, {
    nuke: { singleton: true },
    ...
    read: Effect.fn(function* ({ output }) {
        ...
        const initialDefaultAsn = output !== undefined ? output.initialDefaultAsn : observed.defaultAsn;
        return {
            accountId,
            defaultAsn: observed.defaultAsn,
            initialDefaultAsn,
    ...
    delete: Effect.fn(function* ({ output }) {
        ...
        const observed = yield* cni.getSetting({ accountId });
        if (observed.defaultAsn === initialDefaultAsn)
            return;
