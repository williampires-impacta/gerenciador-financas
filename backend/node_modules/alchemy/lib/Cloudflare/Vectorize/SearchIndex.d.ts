 ...
 * @category AI
 */
export interface SearchIndex extends Binding.Service<SearchIndex, "Cloudflare.Vectorize.SearchIndex", (index: Index) => Effect.Effect<SearchIndexClient>> {
}
export declare const SearchIndex: SearchIndex;
export interface SearchIndexClient {
    ...
    query: (vector: runtime.VectorFloatArray | number[], options?: runtime.VectorizeQueryOptions) => Effect.Effect<runtime.VectorizeMatches>;
    /** Find the nearest neighbors of an existing vector by its id. */
    queryById: (vectorId: string, options?: runtime.VectorizeQueryOptions) => Effect.Effect<runtime.VectorizeMatches>;
