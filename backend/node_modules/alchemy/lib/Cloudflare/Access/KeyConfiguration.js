...
const TypeId = "Cloudflare.Access.KeyConfiguration";
/**
 ...
 */
export const KeyConfiguration = Resource(TypeId);
/**
 * Returns true if the given value is an KeyConfiguration resource.
 */
export const isKeyConfiguration = (value) => Predicate.hasProperty(value, "Type") && value.Type === TypeId;
export const KeyConfigurationProvider = () => Provider.succeed(KeyConfiguration, {
    nuke: { singleton: true },
    ...
    list: Effect.fn(function* () {
        ...
        return [
            toAttributes(accountId, observed, observed.keyRotationIntervalDays ?? undefined),
        ];
    }),
    ...
    delete: Effect.fn(function* ({ output }) {
        ...
        if (initialKeyRotationIntervalDays === undefined)
            return;
        const observed = yield* zeroTrust.getAccessKey({ accountId });
...
const toAttributes = (accountId, observed, initialKeyRotationIntervalDays) => ({
    accountId,
