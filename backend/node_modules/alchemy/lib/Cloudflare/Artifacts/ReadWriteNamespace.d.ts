 ...
 */
export interface ReadWriteNamespace extends Binding.Service<ReadWriteNamespace, "Cloudflare.Artifacts.ReadWriteNamespace", (namespace: Artifacts.Namespace) => Effect.Effect<ReadWriteNamespaceClient>> {
}
export declare const ReadWriteNamespace: ReadWriteNamespace;
declare const ArtifactsError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "ArtifactsError";
} & Readonly<A>;
export declare class ArtifactsError extends ArtifactsError_base<{
    message: string;
    cause: Error;
}> {
}
...
export interface WriteNamespaceClient {
    /** Effect resolving to the raw Cloudflare runtime binding. */
    raw: Effect.Effect<Artifacts, never, RuntimeContext>;
    create(name: string, opts?: CreateOptions): Effect.Effect<ArtifactsCreateRepoResult, ArtifactsError, RuntimeContext>;
    delete(name: string): Effect.Effect<boolean, ArtifactsError, RuntimeContext>;
    import(opts: ImportOptions): Effect.Effect<ArtifactsCreateRepoResult, ArtifactsError, RuntimeContext>;
}
/**
 ...
 * @category Developer Platform
 */
export interface ReadNamespace extends Binding.Service<ReadNamespace, "Cloudflare.Artifacts.ReadNamespace", (namespace: Artifacts.Namespace) => Effect.Effect<ReadNamespaceClient>> {
}
 ...
 * @category Developer Platform
 */
export interface WriteNamespace extends Binding.Service<WriteNamespace, "Cloudflare.Artifacts.WriteNamespace", (namespace: Artifacts.Namespace) => Effect.Effect<WriteNamespaceClient>> {
}
export declare const WriteNamespace: WriteNamespace;
export {};
//# sourceMappingURL=ReadWriteNamespace.d.ts.map