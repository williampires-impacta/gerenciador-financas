...
export const PERMISSION_GROUPS = [
    ...
    },
    {
        ...
        description: "Grants full access to API-Gateway Management (including API Shield) across the whole account",
        scopes: ["com.cloudflare.api.account"],
    },
    {
        id: "05a2a65760a546439ed29762b163cece",
        name: "Account API Gateway Read",
        description: "Grants read access to API-Gateway Management (including API Shield) across the whole account",
        scopes: ["com.cloudflare.api.account"],
    },
    {
    ...
    },
    {
        ...
        name: "Billing Read",
        description: "Grants read access to billing profile, subscriptions, usage data and access to fetch invoices and entitlements",
        scopes: ["com.cloudflare.api.account"],
    },
    {
    ...
    },
    {
        ...
        description: "Can view, edit, create, and delete Connectivity Directory Services, including the ability to create Services that bind to Cloudflare Tunnel",
        scopes: ["com.cloudflare.api.account"],
    },
    {
        id: "95fa65ba51fd49c4a6ac4c8c78ebac93",
        name: "Connectivity Directory Bind",
        description: "Can read, list, and bind to Connectivity Directory services, as well as read and list Cloudflare Tunnels",
        scopes: ["com.cloudflare.api.account"],
    },
    {
    ...
    },
    {
        ...
        description: "Grants write access to the Zero Trust seats your organization can use (and be billed for)",
        scopes: ["com.cloudflare.api.account"],
    },
    {
 ...
 */
export const PERMISSION_GROUPS_BY_NAME = (() => {
    const map = {};
