 ...
 * @category AI
 */
export interface QuerySearchNamespace extends Binding.Service<QuerySearchNamespace, "Cloudflare.AI.SearchNamespace", (namespace: SearchNamespace) => Effect.Effect<QuerySearchNamespaceClient>> {
}
export declare const QuerySearchNamespace: QuerySearchNamespace;
/**
...
export interface QuerySearchNamespaceClient {
     ...
     */
    list(params?: runtime.AiSearchListInstancesParams): Effect.Effect<runtime.AiSearchListResponse, SearchError, RuntimeContext>;
    /**
     * Search across multiple instances in the bound namespace (requires
     * `ai_search_options.instance_ids`).
     */
    search(params: runtime.AiSearchMultiSearchRequest): Effect.Effect<runtime.AiSearchMultiSearchResponse, SearchError, RuntimeContext>;
}
//# sourceMappingURL=QuerySearchNamespace.d.ts.map