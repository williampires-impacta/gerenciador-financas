...
declare const TypeId: "Cloudflare.Workers.VersionMetadata";
 ...
 */
export interface VersionMetadata extends Binding.Service<VersionMetadata, TypeId, VersionMetadataAccessor> {
    /**
...
export declare const VersionMetadata: VersionMetadata;
export declare const isVersionMetadata: (value: unknown) => value is VersionMetadataBinding;
export {};
