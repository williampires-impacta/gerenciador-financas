...
const TypeId = "Cloudflare.Workers.AccountSetting";
/**
 ...
 */
export const AccountSetting = Resource(TypeId);
/**
 * Returns true if the given value is a AccountSetting resource.
 */
export const isAccountSetting = (value) => Predicate.hasProperty(value, "Type") && value.Type === TypeId;
export const AccountSettingProvider = () => Provider.succeed(AccountSetting, {
    nuke: { singleton: true },
    ...
    read: Effect.fn(function* ({ output }) {
        ...
        return toAttributes(acct, observed, output !== undefined
            ? output.initialDefaultUsageModel
            : (observed.defaultUsageModel ?? undefined), output !== undefined
    ...
    list: Effect.fn(function* () {
        ...
        return [
            toAttributes(accountId, observed, observed.defaultUsageModel ?? undefined, observed.greenCompute ?? undefined),
        ];
    }),
    reconcile: Effect.fn(function* ({ news, output }) {
        ...
        const initialDefaultUsageModel = output !== undefined
            ? output.initialDefaultUsageModel
            : (observed.defaultUsageModel ?? undefined);
        const initialGreenCompute = output !== undefined
            ? output.initialGreenCompute
            : (observed.greenCompute ?? undefined);
        ...
        const dirty = (news.defaultUsageModel !== undefined &&
            (observed.defaultUsageModel ?? undefined) !==
    ...
    delete: Effect.fn(function* ({ output }) {
        ...
        const observed = yield* workers.getAccountSetting({ accountId });
        const dirty = (initialDefaultUsageModel !== undefined &&
            (observed.defaultUsageModel ?? undefined) !==
                initialDefaultUsageModel) ||
...
const toAttributes = (accountId, observed, initialDefaultUsageModel, initialGreenCompute) => ({
    accountId,
