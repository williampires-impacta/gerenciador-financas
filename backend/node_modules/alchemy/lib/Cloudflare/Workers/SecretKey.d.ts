...
declare const TypeId: "Cloudflare.Workers.SecretKey";
 ...
 */
export type SecretKeyUsage = "encrypt" | "decrypt" | "sign" | "verify" | "deriveKey" | "deriveBits" | "wrapKey" | "unwrapKey";
/**
 ...
 */
export type SecretKeyAccessor = Effect.Effect<CryptoKey, never, RuntimeContext>;
...
export declare const SecretKey: SecretKey;
export declare const isSecretKey: (value: unknown) => value is SecretKeyBinding;
export {};
