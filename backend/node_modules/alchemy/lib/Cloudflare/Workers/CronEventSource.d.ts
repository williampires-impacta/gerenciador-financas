 ...
 */
export declare const cron: <Req = never>(expression: string, process: (controller: cf.ScheduledController) => Effect.Effect<void, unknown, Req>) => Effect.Effect<void, never, CronEventSource | Exclude<Req, RuntimeContext>>;
export type CronEventSourceService = <Req = never>(expression: string, process: (controller: cf.ScheduledController) => Effect.Effect<void, unknown, Req>) => Effect.Effect<void, never, Exclude<Req, RuntimeContext>>;
declare const CronEventSource_base: Context.ServiceClass<CronEventSource, "Cloudflare.Workers.CronEventSource", CronEventSourceService>;
export declare class CronEventSource extends CronEventSource_base {
}
export declare const CronEventSourceLive: Layer.Layer<CronEventSource, never, Worker<any>>;
export {};
//# sourceMappingURL=CronEventSource.d.ts.map