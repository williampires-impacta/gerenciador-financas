...
declare const WorkerEntrypointTypeId: WorkerEntrypointTypeId;
 ...
 */
export declare const WorkerEntrypoint: (worker: Worker, entrypointOrOptions?: string | WorkerEntrypointOptions) => WorkerEntrypointBinding;
/** Structural guard for {@link WorkerEntrypointBinding} `env` values. */
export declare const isWorkerEntrypoint: (value: unknown) => value is WorkerEntrypointBinding;
export {};
//# sourceMappingURL=WorkerEntrypoint.d.ts.map