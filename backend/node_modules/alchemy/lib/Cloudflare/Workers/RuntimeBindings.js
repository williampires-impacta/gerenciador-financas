import { Ai, AiSearch, AnalyticsEngine, Artifacts, Assets, Browser, D1, Data, DispatchNamespace, DurableObjectNamespace, Flagship, Hyperdrive, Images, Json, KvNamespace, MtlsCertificate, Pipelines, Queue, R2Bucket, RateLimit, SecretKey, SecretsStore, SendEmail, Service, Stream as StreamSim, Text, Vectorize, VersionMetadata, VpcService, WasmModule, WorkerLoader, Workflows, } from "@alchemy.run/cloudflare-runtime/core/bindings";
...
export const toRuntimeBinding = Effect.fn(function* (b, 
/**
 ...
 */
devRemote) {
    const unsupported = () => new WorkerValidationError({
            ...
            if (b.queueId !== undefined && !isLocalId(b.queueId)) {
                ...
                if (url === undefined || token === undefined) {
                    ...
                    return yield* new WorkerValidationError({
                        message: `Queue binding "${b.name}" targets a live queue ` +
 ...
 */
export const materializeRuntimeBindings = Effect.fn(function* (config, options) {
...
//# sourceMappingURL=RuntimeBindings.js.map