import type { DurableObjectNamespace, HyperdriveOrigin, QueueConsumer, RuntimeWorker, Workflow } from "@alchemy.run/cloudflare-runtime/core";
 ...
 */
export declare const DEFAULT_DEV_PORT = 1337;
...
export declare const VITE_CHILD_READY_PREFIX = "<ALCHEMY_VITE_ADDRESS>";
export declare const VITE_CHILD_READY_SUFFIX = "</ALCHEMY_VITE_ADDRESS>";
/**
...
//# sourceMappingURL=ViteChild.shared.d.ts.map