...
import { viteBuildInProcess } from "./Sources/Vite.js";
/**
...
const readConfig = Effect.gen(function* () {
    ...
    return NodeV8.deserialize(Buffer.concat(chunks));
});
const program = Effect.gen(function* () {
    const config = yield* readConfig;
    const fs = yield* FileSystem.FileSystem;
    const { clientDirectory, base, serverBundle, externalWorkspaces } = yield* viteBuildInProcess(config.rootDir, config.env, {
        main: config.main,
...
//# sourceMappingURL=ViteBuildChildRunner.js.map