import { isPythonMain } from "./Sources/Python.js";
...
export const getCompatibility = (props) => {
    const userFlags = props.compatibility?.flags ?? [];
    const python = isPythonMain(props.main);
    if (python && !props.isExternal) {
        throw new Error("Python Workers cannot have an inline Effect implementation: the " +
    ...
    if (!props.isExternal &&
        ...
        throw new Error(`The "no_${CROSS_REQUEST_PROMISE_RESOLUTION}" compatibility flag is not supported: ` +
