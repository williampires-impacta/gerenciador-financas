...
declare const SendEmailTypeId: "Cloudflare.Email.SendEmail";
...
export declare const isSendEmail: (value: unknown) => value is SendEmail;
export declare const SendEmail: (id: string, props?: SendEmailProps) => Effect.Effect<SendEmail>;
export {};
