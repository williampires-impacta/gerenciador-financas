...
const TypeId = "Cloudflare.Intel.IndicatorFeedPermission";
/**
 ...
 */
export const IndicatorFeedPermission = Resource(TypeId);
/**
 * Returns true if the given value is an IndicatorFeedPermission resource.
 */
export const isIndicatorFeedPermission = (value) => Predicate.hasProperty(value, "Type") && value.Type === TypeId;
export const IndicatorFeedPermissionProvider = () => Provider.succeed(IndicatorFeedPermission, {
    ...
    diff: Effect.fn(function* ({ olds, news }) {
        ...
        if (typeof olds?.accountTag === "string" &&
...
//# sourceMappingURL=IndicatorFeedPermission.js.map