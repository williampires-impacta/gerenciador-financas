 ...
 */
export declare const CREDENTIALS_FILE = "cloudflare-state-store";
/**
 ...
 */
export declare const isStateStoreCredentialsStale: (credentials: StoredStateStoreCredentials, currentAccountId: string) => boolean;
//# sourceMappingURL=CredentialsFile.d.ts.map