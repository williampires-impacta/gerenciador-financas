...
declare const TypeId: "Cloudflare.Stream.Stream";
...
export declare const isStream: (value: unknown) => value is StreamBinding;
/**
...
export interface StreamClient {
     ...
     */
    createDirectUpload(params: cf.StreamDirectUploadCreateParams): StreamEffect<cf.StreamDirectUpload>;
    ...
    watermarks: {
        ...
        generate(input: ReadableStream | string, params: cf.StreamWatermarkCreateParams): StreamEffect<cf.StreamWatermark>;
