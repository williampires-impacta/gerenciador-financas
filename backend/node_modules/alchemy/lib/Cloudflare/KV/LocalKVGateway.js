 ...
 */
export const makeProxyKVNamespaceHelpers = (namespaceId, 
/**
...
ambient) => {
    ...
    const raw = Effect.die(new NamespaceError({
        message: "A locally-emulated KV namespace has no long-lived native binding outside a Worker; use get/put/delete/list/getWithMetadata (each runs through a scoped local gateway).",
        cause: new Error("unsupported"),
    }));
    return { raw, use, tryPromise };
};
//# sourceMappingURL=LocalKVGateway.js.map