...
import { makeReadWriteKVClient } from "./ReadWriteNamespaceBinding.js";
import { makeLocalKVNamespaceBinding } from "./NamespaceLocal.js";
import { ReadWriteNamespace } from "./ReadWriteNamespace.js";
import { makeReadWriteKVHttpClient } from "./ReadWriteNamespaceHttp.js";
/**
 ...
 */
export const ReadWriteNamespaceLocal = Layer.effect(ReadWriteNamespace, Effect.suspend(() => makeLocalKVNamespaceBinding({
    makeHttpClient: makeReadWriteKVHttpClient,
    makeNativeClient: makeReadWriteKVClient,
})));
//# sourceMappingURL=ReadWriteNamespaceLocal.js.map