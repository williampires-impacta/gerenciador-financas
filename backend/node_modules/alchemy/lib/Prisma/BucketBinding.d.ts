 ...
 */
export declare const bucketAccessKeyLogicalId: (bucket: Pick<Bucket, "LogicalId">, capability: BucketCapability) => string;
/**
...
}) => Effect.Effect<(bucket: Bucket) => Effect.Effect<Client, never, never>, never, never>;
