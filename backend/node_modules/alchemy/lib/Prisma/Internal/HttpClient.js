 ...
 */
export class PrismaUploadClient extends EffectContext.Service()("alchemy/Prisma/UploadClient") {
}
export const PrismaUploadClientLive = Layer.effect(PrismaUploadClient, Effect.gen(function* () {
