 ...
 */
export const physicalInstanceName = (name, instanceId) => {
    const instanceToken = instanceId.replaceAll(/[^a-zA-Z0-9]/g, "");
    const effectiveSuffix = instanceToken.length >= 12
...
//# sourceMappingURL=EnvName.js.map