...
import { BucketAccessKey } from "./BucketAccessKey.js";
/**
 ...
 */
export const bucketAccessKeyLogicalId = (bucket, capability) => `${bucket.LogicalId}${capability}BucketAccessKey`;
/**
...
export const makeBucketBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* (bucket) {
        const key = yield* Key(bucketAccessKeyLogicalId(bucket, options.capability), { bucket, role: options.role });
