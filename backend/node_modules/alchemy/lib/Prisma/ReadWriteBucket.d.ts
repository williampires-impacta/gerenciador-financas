...
export interface ReadWriteBucket extends Binding.Service<ReadWriteBucket, "Prisma.ReadWriteBucket", (bucket: Bucket) => Effect.Effect<ReadWriteBucketClient>> {
}
/**
 ...
 * @binding
 */
export declare const ReadWriteBucket: ReadWriteBucket;
/**
 * Build a read-write bucket client from a bound bucket key's credentials.
 */
export declare const makeReadWriteBucketClient: (credentials: BucketCredentials) => ReadWriteBucketClient;
/**
 ...
 * ```
 */
export declare const ReadWriteBucketBinding: Layer.Layer<ReadWriteBucket, never, never>;
//# sourceMappingURL=ReadWriteBucket.d.ts.map