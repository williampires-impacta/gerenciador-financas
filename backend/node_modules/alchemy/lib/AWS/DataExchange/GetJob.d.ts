 ...
 * @binding
 */
export interface GetJob extends Binding.Service<GetJob, "AWS.DataExchange.GetJob", () => Effect.Effect<(request: dataexchange.GetJobRequest) => Effect.Effect<dataexchange.GetJobResponse, dataexchange.GetJobError>>> {
}
