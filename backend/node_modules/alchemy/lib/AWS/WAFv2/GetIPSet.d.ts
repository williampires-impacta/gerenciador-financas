 ...
 * @binding
 */
export interface GetIPSet extends Binding.Service<GetIPSet, "AWS.WAFv2.GetIPSet", (ipSet: IPSet) => Effect.Effect<() => Effect.Effect<WAFV2.GetIPSetResponse, WAFV2.GetIPSetError>>> {
}
export declare const GetIPSet: GetIPSet;
