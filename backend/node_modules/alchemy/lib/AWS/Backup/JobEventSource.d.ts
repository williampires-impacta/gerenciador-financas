...
export type BackupEventKind = "backup-job" | "restore-job" | "copy-job" | "recovery-point" | "backup-vault" | "backup-plan";
 ...
 * ```
 */
export declare const consumeBackupEvents: <StreamReq = never, Req = never>(props: BackupEventSourceProps, process: (events: Stream.Stream<BackupEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
