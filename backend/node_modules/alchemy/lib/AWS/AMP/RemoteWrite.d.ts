 ...
 * @binding
 */
export interface RemoteWrite extends Binding.Service<RemoteWrite, "AWS.AMP.RemoteWrite", (workspace: Workspace) => Effect.Effect<(request: RemoteWriteRequest) => Effect.Effect<void, PrometheusApiError | Credentials.CredentialsError>>> {
}
export declare const RemoteWrite: RemoteWrite;
//# sourceMappingURL=RemoteWrite.d.ts.map