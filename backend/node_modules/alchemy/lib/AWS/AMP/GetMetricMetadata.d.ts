 ...
 * @binding
 */
export interface GetMetricMetadata extends Binding.Service<GetMetricMetadata, "AWS.AMP.GetMetricMetadata", (workspace: Workspace) => Effect.Effect<(request: GetMetricMetadataRequest) => Effect.Effect<Record<string, PrometheusMetricMetadata[]>, PrometheusApiError | Credentials.CredentialsError>>> {
}
export declare const GetMetricMetadata: GetMetricMetadata;
//# sourceMappingURL=GetMetricMetadata.d.ts.map