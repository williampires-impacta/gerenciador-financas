declare const PrometheusApiError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "AWS.AMP.PrometheusApiError";
} & Readonly<A>;
/**
 ...
 */
export declare class PrometheusApiError extends PrometheusApiError_base<{
...
export {};
//# sourceMappingURL=PrometheusTypes.d.ts.map