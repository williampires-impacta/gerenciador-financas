...
export interface GetLabelsClient {
    ...
    labelNames(request?: GetLabelsRequest): Effect.Effect<string[], PrometheusApiError | Credentials.CredentialsError>;
    /** List the values of one label (`api/v1/label/{name}/values`). */
    labelValues(request: GetLabelValuesRequest): Effect.Effect<string[], PrometheusApiError | Credentials.CredentialsError>;
}
/**
 ...
 * @binding
 */
export interface GetLabels extends Binding.Service<GetLabels, "AWS.AMP.GetLabels", (workspace: Workspace) => Effect.Effect<GetLabelsClient>> {
}
export declare const GetLabels: GetLabels;
