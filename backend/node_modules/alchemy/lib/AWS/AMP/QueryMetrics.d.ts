...
import type { PrometheusApiError, PrometheusInstantResult, PrometheusRangeResult, PrometheusTime } from "./PrometheusTypes.ts";
...
export interface QueryMetricsClient {
    ...
    query(request: QueryMetricsRequest): Effect.Effect<PrometheusInstantResult, PrometheusApiError | Credentials.CredentialsError>;
    /** Evaluate a PromQL expression over a time range (`api/v1/query_range`). */
    queryRange(request: QueryRangeRequest): Effect.Effect<PrometheusRangeResult, PrometheusApiError | Credentials.CredentialsError>;
}
/**
 ...
 * @binding
 */
export interface QueryMetrics extends Binding.Service<QueryMetrics, "AWS.AMP.QueryMetrics", (workspace: Workspace) => Effect.Effect<QueryMetricsClient>> {
}
export declare const QueryMetrics: QueryMetrics;
