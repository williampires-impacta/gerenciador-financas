...
export const ListWorkspacesHttp = Layer.effect(ListWorkspaces, Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn("AWS.AMP.ListWorkspaces")(function* (request) {
            return yield* listWorkspaces(request ?? {});
        });
    });
}));
//# sourceMappingURL=ListWorkspacesHttp.js.map