 ...
 * @binding
 */
export interface GetSeries extends Binding.Service<GetSeries, "AWS.AMP.GetSeries", (workspace: Workspace) => Effect.Effect<(request: GetSeriesRequest) => Effect.Effect<PrometheusSeries[], PrometheusApiError | Credentials.CredentialsError>>> {
}
export declare const GetSeries: GetSeries;
//# sourceMappingURL=GetSeries.d.ts.map