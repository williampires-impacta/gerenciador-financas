...
const pushLengthDelimited = (out, fieldNumber, payload) => {
...
export const encodeWriteRequest = (timeseries) => {
    const out = [];
 ...
 */
export const snappyCompress = (input) => {
    const header = [];
...
//# sourceMappingURL=RemoteWriteCodec.js.map