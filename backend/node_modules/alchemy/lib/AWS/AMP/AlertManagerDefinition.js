...
import { decodeDefinition, encodeDefinition } from "./internal.js";
/**
 ...
 * @resource
 */
export const AlertManagerDefinition = Resource("AWS.AMP.AlertManagerDefinition");
export const AlertManagerDefinitionProvider = () => Provider.effect(AlertManagerDefinition, Effect.gen(function* () {
    ...
    const waitActive = Effect.fn(function* (workspaceId) {
        return yield* amp.describeAlertManagerDefinition({ workspaceId }).pipe(Effect.map((r) => r.alertManagerDefinition), Effect.repeat({
    ...
    return {
        ...
        reconcile: Effect.fn(function* ({ news, session }) {
            ...
            if (existing === undefined) {
                ...
                const currentDefinition = existing.data !== undefined
