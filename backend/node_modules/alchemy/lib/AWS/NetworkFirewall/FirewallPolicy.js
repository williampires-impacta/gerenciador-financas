 ...
 * @resource
 */
export const FirewallPolicy = Resource("AWS.NetworkFirewall.FirewallPolicy");
export const FirewallPolicyProvider = () => Provider.effect(FirewallPolicy, Effect.gen(function* () {
    const createName = Effect.fn(function* (id, props) {
        return (props.firewallPolicyName ??
    ...
    return FirewallPolicy.Provider.of({
        ...
        list: () => Effect.gen(function* () {
            ...
            const items = yield* Effect.forEach(metas, (meta) => nfw
                .describeFirewallPolicy({ FirewallPolicyArn: meta.Arn })
                .pipe(Effect.map((r) => toAttrs(r.FirewallPolicyResponse)), Effect.catchTag("ResourceNotFoundException", () => Effect.succeed(undefined))), { concurrency: 5 });
        ...
        reconcile: Effect.fn(function* ({ id, news, output, session }) {
            ...
            const definitionDiffers = !deepEqual(news.firewallPolicy, observed.FirewallPolicy) ||
