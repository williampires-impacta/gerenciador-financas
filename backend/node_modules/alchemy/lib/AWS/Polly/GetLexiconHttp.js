...
import { GetLexicon } from "./GetLexicon.js";
...
export const GetLexiconHttp = Layer.effect(GetLexicon, Effect.gen(function* () {
    const getLexicon = yield* polly.getLexicon;
    return Effect.fn(function* (lexicon) {
...
//# sourceMappingURL=GetLexiconHttp.js.map