...
export interface CommitTransactionRequest extends Omit<rdsdata.CommitTransactionRequest, "resourceArn" | "secretArn"> {
}
/**
 ...
 * @binding
 */
export interface CommitTransaction extends Binding.Service<CommitTransaction, "AWS.RDSData.CommitTransaction", (cluster: DBCluster, options: CommitTransactionOptions) => Effect.Effect<(request: CommitTransactionRequest) => Effect.Effect<rdsdata.CommitTransactionResponse, rdsdata.CommitTransactionError, RuntimeContext>>> {
}
