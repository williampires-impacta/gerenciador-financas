 ...
 */
export declare const makeRDSDataHttpBinding: <Req, I, A, E, R>(options: {
     ...
     */
    makeInput: (request: Req, context: {
        resourceArn: string;
        secretArn: string;
        database: string | undefined;
        schema: string | undefined;
    }) => I;
}) => Effect.Effect<(cluster: DBCluster, bindOptions: RDSDataBindingOptions) => Effect.Effect<(request?: Req | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
