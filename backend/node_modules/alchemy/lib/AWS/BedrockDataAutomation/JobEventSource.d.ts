 ...
 * ```
 */
export declare const consumeDataAutomationJobEvents: <StreamReq = never, Req = never>(props: DataAutomationJobEventSourceProps, process: (events: Stream.Stream<DataAutomationJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
