 ...
 */
export const makeDocDBAccountHttpBinding = (options) => Effect.gen(function* () {
 ...
 * creation).
 */
export const makeDocDBClusterHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
 ...
 * instance ARN.
 */
export const makeDocDBInstanceHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
