 ...
 * @binding
 */
export interface StartDBCluster extends Binding.Service<StartDBCluster, "AWS.DocDB.StartDBCluster", (cluster: DBCluster) => Effect.Effect<() => Effect.Effect<docdb.StartDBClusterResult, docdb.StartDBClusterError>>> {
}
