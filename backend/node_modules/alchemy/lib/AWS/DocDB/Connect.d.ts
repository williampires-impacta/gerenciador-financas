 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.DocDB.Connect", (cluster: DBCluster, options?: ConnectOptions) => Effect.Effect<Effect.Effect<MongoConnectionInfo, secretsmanager.GetSecretValueError, RuntimeContext>>> {
}
 ...
 */
export declare const formatMongoConnectionUrl: (options: MongoConnectionUrlOptions) => Redacted.Redacted<string>;
