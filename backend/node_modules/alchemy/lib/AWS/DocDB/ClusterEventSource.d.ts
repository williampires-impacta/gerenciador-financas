...
type ChangesHandler<TDoc, Req> = (stream: Stream.Stream<DocumentDBRecord<TDoc>>) => Effect.Effect<void, never, Req>;
/**
 ...
 * ```
 */
export declare function consumeClusterChanges<TDoc = unknown, Req = never>(cluster: DBCluster, props: ClusterEventSourceProps, process: ChangesHandler<TDoc, Req>): Effect.Effect<void, never, ClusterEventSource>;
declare const ClusterEventSource_base: Context.ServiceClass<ClusterEventSource, "AWS.DocDB.ClusterEventSource", ClusterEventSourceService>;
export declare class ClusterEventSource extends ClusterEventSource_base {
}
export type ClusterEventSourceService = <TDoc = unknown, Req = never>(cluster: DBCluster, props: ClusterEventSourceProps, process: (stream: Stream.Stream<DocumentDBRecord<TDoc>>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
export {};
//# sourceMappingURL=ClusterEventSource.d.ts.map