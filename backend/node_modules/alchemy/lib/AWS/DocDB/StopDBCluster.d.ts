 ...
 * @binding
 */
export interface StopDBCluster extends Binding.Service<StopDBCluster, "AWS.DocDB.StopDBCluster", (cluster: DBCluster) => Effect.Effect<() => Effect.Effect<docdb.StopDBClusterResult, docdb.StopDBClusterError>>> {
}
