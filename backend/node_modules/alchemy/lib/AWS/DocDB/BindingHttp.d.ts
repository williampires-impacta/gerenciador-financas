 ...
 */
export declare const makeDocDBAccountHttpBinding: <I, A, E, R>(options: {
 ...
 * creation).
 */
export declare const makeDocDBClusterHttpBinding: <I extends {
 ...
 * instance ARN.
 */
export declare const makeDocDBInstanceHttpBinding: <I extends {
