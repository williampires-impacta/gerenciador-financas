...
import { GetDownloadUrlForLayer } from "./GetDownloadUrlForLayer.js";
/** HTTP implementation of {@link GetDownloadUrlForLayer} over the ECR API. */
export const GetDownloadUrlForLayerHttp = Layer.effect(GetDownloadUrlForLayer, makeEcrRepositoryHttpBinding({
    capability: "GetDownloadUrlForLayer",
    operation: ecr.getDownloadUrlForLayer,
    iamActions: ["ecr:GetDownloadUrlForLayer"],
}));
//# sourceMappingURL=GetDownloadUrlForLayerHttp.js.map