 ...
 * ```
 */
export declare const consumeImageActions: <StreamReq = never, Req = never>(props: ImageActionsProps, process: (events: Stream.Stream<ImageActionEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
 ...
 * ```
 */
export declare const consumeImageScans: <StreamReq = never, Req = never>(props: ImageScansProps, process: (events: Stream.Stream<ImageScanEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ImageActionEventSource.d.ts.map