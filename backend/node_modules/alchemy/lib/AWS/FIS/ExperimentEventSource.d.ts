 ...
 * ```
 */
export declare const consumeExperimentEvents: <StreamReq = never, Req = never>(props: ExperimentEventSourceProps, process: (events: Stream.Stream<ExperimentEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ExperimentEventSource.d.ts.map