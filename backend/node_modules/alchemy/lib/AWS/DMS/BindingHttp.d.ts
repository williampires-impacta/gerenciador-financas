 ...
 * grants `actions` on `*`.
 */
export declare const makeDmsEndpointScopedHttpBinding: <I extends {
    EndpointArn: string;
}, A, E, R>(options: {
...
}) => Effect.Effect<(endpoint: Endpoint) => Effect.Effect<(request?: Omit<I, "EndpointArn"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeDmsInstanceScopedHttpBinding: <I extends {
...
}) => Effect.Effect<(instance: ReplicationInstance) => Effect.Effect<(request?: Omit<I, "ReplicationInstanceArn"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeDmsConnectionScopedHttpBinding: <I extends {
    ReplicationInstanceArn: string;
    EndpointArn: string;
}, A, E, R>(options: {
    ...
    actions: readonly string[];
}) => Effect.Effect<(instance: ReplicationInstance, endpoint: Endpoint) => Effect.Effect<(request?: Omit<I, "EndpointArn" | "ReplicationInstanceArn"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 * Build the impl Effect for an account-level operation (no target resource).
 * The deploy-time half grants `actions` on `*`.
 */
export declare const makeDmsAccountHttpBinding: <I, A, E, R>(options: {
