 ...
 */
export type CanaryEventDetailType = "Synthetics Canary Status Change" | "Synthetics Canary TestRun Successful" | "Synthetics Canary TestRun Failure";
/**
 ...
 * ```
 */
export declare const consumeCanaryEvents: <StreamReq = never, Req = never>(props: CanaryEventSourceProps, process: (events: Stream.Stream<CanaryEventRecord, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=CanaryEventSource.d.ts.map