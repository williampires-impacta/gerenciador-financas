 ...
 */
export declare const makeSyntheticsCanaryHttpBinding: <I extends {
    Name: string;
}, A, E, R>(options: {
...
}) => Effect.Effect<(canary: Canary) => Effect.Effect<(request?: Omit<I, "Name"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeSyntheticsAccountHttpBinding: <I, A, E, R>(options: {
