 ...
 */
export const applicationArn = (region, accountId, applicationId) => `arn:aws:appconfig:${region}:${accountId}:application/${applicationId}`;
/**
 * Build the ARN of an AppConfig environment.
 * `arn:aws:appconfig:{region}:{account}:application/{appId}/environment/{envId}`
 */
export const environmentArn = (region, accountId, applicationId, environmentId) => `arn:aws:appconfig:${region}:${accountId}:application/${applicationId}/environment/${environmentId}`;
/**
 ...
 */
export const configurationProfileArn = (region, accountId, applicationId, configurationProfileId) => `arn:aws:appconfig:${region}:${accountId}:application/${applicationId}/configurationprofile/${configurationProfileId}`;
/**
 * Build the ARN of an AppConfig deployment strategy.
 * `arn:aws:appconfig:{region}:{account}:deploymentstrategy/{id}`
 */
export const deploymentStrategyArn = (region, accountId, deploymentStrategyId) => `arn:aws:appconfig:${region}:${accountId}:deploymentstrategy/${deploymentStrategyId}`;
/**
 ...
 */
export const configurationDataArn = (region, accountId, applicationId, environmentId, configurationProfileId) => `arn:aws:appconfig:${region}:${accountId}:application/${applicationId}/environment/${environmentId}/configuration/${configurationProfileId}`;
/**
 * Build the ARN of an AppConfig extension association.
 * `arn:aws:appconfig:{region}:{account}:extensionassociation/{id}`
 */
export const extensionAssociationArn = (region, accountId, extensionAssociationId) => `arn:aws:appconfig:${region}:${accountId}:extensionassociation/${extensionAssociationId}`;
 ...
 */
export const readAppConfigTags = Effect.fn(function* (arn) {
 ...
 */
export const syncAppConfigTags = Effect.fn(function* (arn, desiredTags) {
