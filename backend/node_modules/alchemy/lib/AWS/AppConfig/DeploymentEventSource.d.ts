 ...
 */
export type DeploymentEventType = "ON_DEPLOYMENT_START" | "ON_DEPLOYMENT_STEP" | "ON_DEPLOYMENT_BAKING" | "ON_DEPLOYMENT_COMPLETE" | "ON_DEPLOYMENT_ROLLED_BACK";
/**
...
type DeploymentEventsHandler<Req> = (events: Stream.Stream<DeploymentEventRecord>) => Effect.Effect<void, never, Req>;
/**
 ...
 * ```
 */
export declare function consumeDeploymentEvents<Req = never>(target: Application | Environment, process: DeploymentEventsHandler<Req>): Effect.Effect<void, never, DeploymentEventSource>;
export declare function consumeDeploymentEvents<Req = never>(target: Application | Environment, props: DeploymentEventSourceProps, process: DeploymentEventsHandler<Req>): Effect.Effect<void, never, DeploymentEventSource>;
/**
 ...
 * @binding
 */
export interface DeploymentEventSource extends Binding.Service<DeploymentEventSource, "AWS.AppConfig.DeploymentEventSource", DeploymentEventSourceService> {
}
export declare const DeploymentEventSource: DeploymentEventSource;
export type DeploymentEventSourceService = <Req = never>(target: Application | Environment, props: DeploymentEventSourceProps, process: (events: Stream.Stream<DeploymentEventRecord>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
export {};
//# sourceMappingURL=DeploymentEventSource.d.ts.map