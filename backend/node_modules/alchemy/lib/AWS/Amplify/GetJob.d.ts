 ...
 * @binding
 */
export interface GetJob extends Binding.Service<GetJob, "AWS.Amplify.GetJob", (app: App) => Effect.Effect<(request: GetJobRequest) => Effect.Effect<amplify.GetJobResult, amplify.GetJobError>>> {
}
