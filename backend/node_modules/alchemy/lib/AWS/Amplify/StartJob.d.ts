 ...
 * @binding
 */
export interface StartJob extends Binding.Service<StartJob, "AWS.Amplify.StartJob", (app: App) => Effect.Effect<(request: StartJobRequest) => Effect.Effect<amplify.StartJobResult, amplify.StartJobError>>> {
}
