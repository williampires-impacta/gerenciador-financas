...
import { TranslateKeyMaterial, } from "./TranslateKeyMaterial.js";
/**
 ...
 * ARN itself).
 */
export const TranslateKeyMaterialHttp = Layer.effect(TranslateKeyMaterial, Effect.gen(function* () {
    const translateKeyMaterial = yield* paymentcryptographydata.translateKeyMaterial;
    return Effect.fn(function* (...keys) {
        ...
        return Effect.fn(`AWS.PaymentCryptography.TranslateKeyMaterial(${keys
...
//# sourceMappingURL=TranslateKeyMaterialHttp.js.map