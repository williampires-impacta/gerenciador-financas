 ...
 * @binding
 */
export interface ListRules extends Binding.Service<ListRules, "AWS.Rbin.ListRules", () => Effect.Effect<(request: rbin.ListRulesRequest) => Effect.Effect<rbin.ListRulesResponse, rbin.ListRulesError>>> {
}
