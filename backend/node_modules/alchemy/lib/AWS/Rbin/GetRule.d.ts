 ...
 * @binding
 */
export interface GetRule extends Binding.Service<GetRule, "AWS.Rbin.GetRule", (rule: Rule) => Effect.Effect<() => Effect.Effect<rbin.GetRuleResponse, rbin.GetRuleError>>> {
}
export declare const GetRule: GetRule;
