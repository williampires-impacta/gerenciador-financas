 ...
 * @binding
 */
export interface ListJobs extends Binding.Service<ListJobs, "AWS.Glacier.ListJobs", (vault: Vault) => Effect.Effect<(request?: ListJobsRequest) => Effect.Effect<glacier.ListJobsOutput, glacier.ListJobsError>>> {
}
