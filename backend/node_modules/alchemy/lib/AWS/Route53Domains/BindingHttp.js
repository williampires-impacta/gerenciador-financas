...
import { withRoute53DomainsRegion } from "./internal.js";
/**
 ...
 */
export const makeRoute53DomainsHttpBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn(`AWS.Route53Domains.${options.capability}`)(function* (request) {
