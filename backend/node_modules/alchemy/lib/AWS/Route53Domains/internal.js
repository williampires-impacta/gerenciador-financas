...
export const ROUTE53_DOMAINS_REGION = "us-east-1";
export const withRoute53DomainsRegion = (effect) => effect.pipe(Effect.provideService(AwsRegion, Effect.succeed(ROUTE53_DOMAINS_REGION)));
