...
import { makeAppSyncApiHttpBinding } from "./BindingHttp.js";
import { GetIntrospectionSchema } from "./GetIntrospectionSchema.js";
/**
 ...
 * `apiId`.
 */
export const GetIntrospectionSchemaHttp = Layer.effect(GetIntrospectionSchema, makeAppSyncApiHttpBinding({
    tag: "AWS.AppSync.GetIntrospectionSchema",
    actions: ["appsync:GetIntrospectionSchema"],
    operation: appsync.getIntrospectionSchema,
}));
//# sourceMappingURL=GetIntrospectionSchemaHttp.js.map