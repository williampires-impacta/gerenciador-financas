...
declare const GraphQLApiError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "GraphQLApiError";
} & Readonly<A>;
/**
 ...
 */
export declare class GraphQLApiError extends GraphQLApiError_base<{
...
export interface GraphQLClient {
     ...
     */
    execute<T = unknown>(request: GraphQLRequest): Effect.Effect<GraphQLResult<T>, GraphQLApiError | Credentials.CredentialsError>;
}
/**
 ...
 * @binding
 */
export interface GraphQL extends Binding.Service<GraphQL, "AWS.AppSync.GraphQL", (api: GraphqlApi) => Effect.Effect<GraphQLClient>> {
}
