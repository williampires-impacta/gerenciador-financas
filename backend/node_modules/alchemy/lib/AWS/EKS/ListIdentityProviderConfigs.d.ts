 ...
 * @binding
 */
export interface ListIdentityProviderConfigs extends Binding.Service<ListIdentityProviderConfigs, "AWS.EKS.ListIdentityProviderConfigs", (cluster: Cluster) => Effect.Effect<(request?: Omit<eks.ListIdentityProviderConfigsRequest, "clusterName">) => Effect.Effect<eks.ListIdentityProviderConfigsResponse, eks.ListIdentityProviderConfigsError>>> {
}
export declare const ListIdentityProviderConfigs: ListIdentityProviderConfigs;
//# sourceMappingURL=ListIdentityProviderConfigs.d.ts.map