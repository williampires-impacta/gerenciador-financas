 ...
 * @binding
 */
export interface ListPodIdentityAssociations extends Binding.Service<ListPodIdentityAssociations, "AWS.EKS.ListPodIdentityAssociations", (cluster: Cluster) => Effect.Effect<(request?: Omit<eks.ListPodIdentityAssociationsRequest, "clusterName">) => Effect.Effect<eks.ListPodIdentityAssociationsResponse, eks.ListPodIdentityAssociationsError>>> {
}
export declare const ListPodIdentityAssociations: ListPodIdentityAssociations;
//# sourceMappingURL=ListPodIdentityAssociations.d.ts.map