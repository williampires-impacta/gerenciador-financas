 ...
 * @binding
 */
export interface Ingest extends Binding.Service<Ingest, "AWS.OSIS.Ingest", (pipeline: Pipeline) => Effect.Effect<(request: IngestRequest) => Effect.Effect<void, PipelineIngestError | Credentials.CredentialsError>>> {
}
export declare const Ingest: Ingest;
