 ...
 * @binding
 */
export interface ListStreams extends Binding.Service<ListStreams, "AWS.IVS.ListStreams", () => Effect.Effect<(request?: ivs.ListStreamsRequest) => Effect.Effect<ivs.ListStreamsResponse, ivs.ListStreamsError>>> {
}
