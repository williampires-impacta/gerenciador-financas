 ...
 */
export const makeNotificationsHttpBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn(`AWS.Notifications.${options.capability}`)(function* (request) {
            ...
            return yield* pinNotificationsRegion(op((request ?? {})));
        });
    });
});
/**
 ...
 */
export const makeNotificationConfigurationHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* pinNotificationsRegion(options.operation);
    return Effect.fn(function* (configuration) {
        ...
        return Effect.fn(`AWS.Notifications.${options.capability}(${configuration.LogicalId})`)(function* (request) {
            // Call-site region pin — see makeNotificationsHttpBinding above.
            return yield* pinNotificationsRegion(op({
                ...request,
