 ...
 * @binding
 */
export interface CreateBackup extends Binding.Service<CreateBackup, "AWS.DynamoDB.CreateBackup", <T extends Table>(table: T) => Effect.Effect<(request: CreateBackupRequest) => Effect.Effect<DynamoDB.CreateBackupOutput, DynamoDB.CreateBackupError>>> {
}
