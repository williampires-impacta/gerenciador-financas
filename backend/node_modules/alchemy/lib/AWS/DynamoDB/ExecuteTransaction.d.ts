 ...
 * @binding
 */
export interface ExecuteTransaction extends Binding.Service<ExecuteTransaction, "AWS.DynamoDB.ExecuteTransaction", (...tables: ExecuteTransactionTables) => Effect.Effect<(request: ExecuteTransactionRequest) => Effect.Effect<DynamoDB.ExecuteTransactionOutput, DynamoDB.ExecuteTransactionError>>> {
}
export declare const ExecuteTransaction: ExecuteTransaction;
