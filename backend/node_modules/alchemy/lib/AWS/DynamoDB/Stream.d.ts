 ...
 * @binding
 */
export interface TableEventSource extends Binding.Service<TableEventSource, "AWS.DynamoDB.TableEventSource", TableEventSourceService> {
}
export declare const TableEventSource: TableEventSource;
export type TableEventSourceService = <Data = unknown, StreamReq = never, Req = never>(table: Table, props: StreamsProps, process: (stream: Stream.Stream<StreamRecord<Data>, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
 ...
 * ```
 */
export declare const consumeTableChanges: <Data = unknown, Req = never, StreamReq = never>(table: Table, props: StreamsProps | undefined, handler: (stream: Stream.Stream<StreamRecord<Data>, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, TableEventSource>;
