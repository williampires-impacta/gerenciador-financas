...
import { TransactWriteItems, } from "./TransactWriteItems.js";
export const TransactWriteItemsHttp = Layer.effect(TransactWriteItems, Effect.gen(function* () {
    ...
    return Effect.fn(function* (...tables) {
        ...
        const getTableName = Effect.fn(function* (tableId) {
            ...
            if (!TableName) {
                return yield* Effect.die(new Error(`TransactWriteItems request references unbound table '${tableId}'`));
            }
        ...
        return Effect.fn(`AWS.DynamoDB.TransactWriteItems(${sortedTables})`)(function* (request) {
            const transactItems = yield* Effect.forEach(request.TransactItems, (item) => Effect.gen(function* () {
                ...
                return yield* Effect.die(new Error("TransactWriteItems request item must include one DynamoDB operation"));
            }));
...
//# sourceMappingURL=TransactWriteItemsHttp.js.map