 ...
 * @binding
 */
export interface DeleteItem extends Binding.Service<DeleteItem, "AWS.DynamoDB.DeleteItem", <T extends Table>(table: T) => Effect.Effect<(request: DeleteItemRequest) => Effect.Effect<DynamoDB.DeleteItemOutput, DynamoDB.DeleteItemError>>> {
}
