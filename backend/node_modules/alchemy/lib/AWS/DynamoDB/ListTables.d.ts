 ...
 * @binding
 */
export interface ListTables extends Binding.Service<ListTables, "AWS.DynamoDB.ListTables", () => Effect.Effect<(request?: ListTablesRequest) => Effect.Effect<DynamoDB.ListTablesOutput, DynamoDB.ListTablesError>>> {
}
