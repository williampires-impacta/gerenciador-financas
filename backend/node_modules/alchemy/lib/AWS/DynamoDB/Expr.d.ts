...
export interface ArrayIndex<List extends Expr = any, Number extends NumberLiteral | ValueRef = NumberLiteral | ValueRef> {
    kind: "array-index";
    list: List;
    number: Number;
}
export type Operator = "and" | "or" | "=" | "<" | "<=" | ">=" | ">";
export interface OperatorExpr<Left extends Expr = any, Op extends Operator = Operator, Right extends Expr = any> {
    kind: "op";
    left: Left;
    op: Op;
    right: Right;
