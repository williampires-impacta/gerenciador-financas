 ...
 * @binding
 */
export interface Query extends Binding.Service<Query, "AWS.DynamoDB.Query", <T extends Table>(table: T) => Effect.Effect<(request: QueryRequest) => Effect.Effect<DynamoDB.QueryOutput, DynamoDB.QueryError>>> {
}
