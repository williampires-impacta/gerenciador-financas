 ...
 * @binding
 */
export interface PutItem extends Binding.Service<PutItem, "AWS.DynamoDB.PutItem", <T extends Table>(table: T) => Effect.Effect<(request: PutItemRequest) => Effect.Effect<DynamoDB.PutItemOutput, DynamoDB.PutItemError>>> {
}
export declare const PutItem: PutItem;
//# sourceMappingURL=PutItem.d.ts.map