 ...
 * @binding
 */
export interface Scan extends Binding.Service<Scan, "AWS.DynamoDB.Scan", <T extends Table>(table: T) => Effect.Effect<(request: ScanRequest) => Effect.Effect<DynamoDB.ScanOutput, DynamoDB.ScanError>>> {
}
