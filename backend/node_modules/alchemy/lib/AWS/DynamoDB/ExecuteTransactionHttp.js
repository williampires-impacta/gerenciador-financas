...
export const ExecuteTransactionHttp = Layer.effect(ExecuteTransaction, Effect.gen(function* () {
    ...
    return Effect.fn(function* (...tables) {
        ...
        return Effect.fn(`AWS.DynamoDB.ExecuteTransaction(${tables})`)(function* (request) {
            return yield* executeTransaction(request);
        });
    });
}));
//# sourceMappingURL=ExecuteTransactionHttp.js.map