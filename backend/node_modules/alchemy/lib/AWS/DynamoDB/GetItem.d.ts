 ...
 * @binding
 */
export interface GetItem extends Binding.Service<GetItem, "AWS.DynamoDB.GetItem", <T extends Table>(table: T) => Effect.Effect<(request: GetItemRequest) => Effect.Effect<DynamoDB.GetItemOutput, DynamoDB.GetItemError>>> {
}
