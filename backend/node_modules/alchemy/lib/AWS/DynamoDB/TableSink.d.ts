...
export type TableSinkError = DynamoDB.BatchWriteItemError | BatchRetryExhaustedError<TableSinkEntry>;
/**
 ...
 * @binding
 */
export interface TableSink extends Binding.Service<TableSink, "AWS.DynamoDB.TableSink", (table: Table) => Effect.Effect<Sink.Sink<void, TableSinkEntry, readonly TableSinkEntry[], TableSinkError>>> {
}
export declare const TableSink: TableSink;
//# sourceMappingURL=TableSink.d.ts.map