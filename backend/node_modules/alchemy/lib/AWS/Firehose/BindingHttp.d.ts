 ...
 */
export declare const makeDeliveryStreamHttpBinding: <I extends {
...
}) => Effect.Effect<(deliveryStream: DeliveryStream) => Effect.Effect<(request: Omit<I, "DeliveryStreamName">) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeFirehoseAccountHttpBinding: <I, A, E, R>(options: {
