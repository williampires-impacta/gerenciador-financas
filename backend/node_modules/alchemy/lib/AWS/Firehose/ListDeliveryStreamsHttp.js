...
import { makeFirehoseAccountHttpBinding } from "./BindingHttp.js";
import { ListDeliveryStreams } from "./ListDeliveryStreams.js";
/**
 ...
 * binding.
 */
export const ListDeliveryStreamsHttp = Layer.effect(ListDeliveryStreams, makeFirehoseAccountHttpBinding({
    tag: "AWS.Firehose.ListDeliveryStreams",
    operation: Firehose.listDeliveryStreams,
    actions: ["firehose:ListDeliveryStreams"],
}));
//# sourceMappingURL=ListDeliveryStreamsHttp.js.map