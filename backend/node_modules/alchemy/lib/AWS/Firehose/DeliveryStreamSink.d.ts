...
export type DeliveryStreamSinkError = Firehose.PutRecordBatchError | BatchRetryExhaustedError<DeliveryStreamSinkRecord>;
/**
 ...
 * @binding
 */
export interface DeliveryStreamSink extends Binding.Service<DeliveryStreamSink, "AWS.Firehose.DeliveryStreamSink", (deliveryStream: DeliveryStream) => Effect.Effect<Sink.Sink<void, DeliveryStreamSinkRecord, readonly DeliveryStreamSinkRecord[], DeliveryStreamSinkError>>> {
}
export declare const DeliveryStreamSink: DeliveryStreamSink;
//# sourceMappingURL=DeliveryStreamSink.d.ts.map