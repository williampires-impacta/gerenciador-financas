 ...
 * ```
 */
export declare const consumePipelineEvents: <StreamReq = never, Req = never>(props: PipelineEventSourceProps, process: (events: Stream.Stream<PipelineEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=PipelineEventSource.d.ts.map