 ...
 * @binding
 */
export interface Search extends Binding.Service<Search, "AWS.ResourceExplorer.Search", <V extends View>(view: V) => Effect.Effect<(request: SearchRequest) => Effect.Effect<RE2.SearchOutput, RE2.SearchError>>> {
}
