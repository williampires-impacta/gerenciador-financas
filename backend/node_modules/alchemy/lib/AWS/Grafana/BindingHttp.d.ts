 ...
 */
export declare const makeGrafanaAccountHttpBinding: <I, A, E, R>(options: {
 ...
 */
export declare const makeGrafanaWorkspaceHttpBinding: <I extends {
    workspaceId: string;
}, A, E, R>(options: {
    ...
    actions: readonly string[];
}) => Effect.Effect<(workspace: Workspace) => Effect.Effect<(request?: Omit<I, "workspaceId"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
