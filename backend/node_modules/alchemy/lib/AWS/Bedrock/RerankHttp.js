...
export const RerankHttp = Layer.effect(Rerank, Effect.gen(function* () {
    ...
    return Effect.fn(function* (model, ...additionalModels) {
        ...
        return Effect.fn(`AWS.Bedrock.Rerank(${model})`)(function* (request) {
            return yield* rerank(request);
        });
    });
}));
//# sourceMappingURL=RerankHttp.js.map