 ...
 */
export const createAgentCoreName = Effect.fn(function* (id) {
 ...
 */
export const createGatewayName = Effect.fn(function* (id) {
 ...
 */
export const readAgentCoreTags = Effect.fn(function* (resourceArn) {
 ...
 */
export const syncAgentCoreTags = Effect.fn(function* (resourceArn, desired) {
 ...
 */
export const retryWhileValidation = (self) => Effect.retry(self, {
