 ...
 * ```
 */
export declare const consumeQueryStateChanges: <StreamReq = never, Req = never>(props: QueryStateChangesProps, process: (events: Stream.Stream<QueryStateChangeEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=QueryStateChangeEventSource.d.ts.map