 ...
 */
export interface RunQueryRequest extends Omit<athena.StartQueryExecutionInput, "WorkGroup" | "ResultConfiguration"> {
}
/**
...
declare const AthenaQueryFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "AthenaQueryFailed";
} & Readonly<A>;
/**
 ...
 */
export declare class AthenaQueryFailed extends AthenaQueryFailed_base<{
    readonly queryExecutionId: string;
 ...
 * @binding
 */
export interface Query extends Binding.Service<Query, "AWS.Athena.Query", (workGroup: WorkGroup, resultsBucket: Bucket) => Effect.Effect<(request: RunQueryRequest) => Effect.Effect<QueryResult, athena.StartQueryExecutionError | athena.GetQueryExecutionError | athena.GetQueryResultsError | AthenaQueryFailed>>> {
}
