 ...
 * @binding
 */
export interface Query extends Binding.Service<Query, "AWS.Timestream.Query", (table: Table) => Effect.Effect<(request: QueryRequest) => Effect.Effect<TSQ.QueryResponse, TSQ.QueryError | TSQ.DescribeEndpointsError>>> {
}
