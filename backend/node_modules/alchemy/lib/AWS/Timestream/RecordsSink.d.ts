...
export type RecordsSinkError = Exclude<TSW.WriteRecordsError | TSW.DescribeEndpointsError, TSW.RejectedRecordsException> | BatchRetryExhaustedError<RecordsSinkRecord>;
/**
 ...
 * @binding
 */
export interface RecordsSink extends Binding.Service<RecordsSink, "AWS.Timestream.RecordsSink", (table: Table, props?: RecordsSinkProps) => Effect.Effect<Sink.Sink<void, RecordsSinkRecord, readonly RecordsSinkRecord[], RecordsSinkError>>> {
}
export declare const RecordsSink: RecordsSink;
//# sourceMappingURL=RecordsSink.d.ts.map