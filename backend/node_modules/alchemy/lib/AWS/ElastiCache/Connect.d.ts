 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.ElastiCache.Connect", (cache: ServerlessCache) => Effect.Effect<Effect.Effect<CacheConnectionInfo, never, RuntimeContext>>> {
}
