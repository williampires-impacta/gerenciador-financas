...
export interface Campaign extends Resource<"AWS.IoTFleetWise.Campaign", CampaignProps, {
 ...
 * @resource
 */
export declare const Campaign: import("../../Resource.ts").ResourceClass<Campaign>;
export declare const CampaignProvider: () => import("effect/Layer").Layer<Provider.Provider<Campaign>, never, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient | import("@distilled.cloud/aws/Region").Region | import("../../Stack.ts").Stack | import("../../Stage.ts").Stage>;
