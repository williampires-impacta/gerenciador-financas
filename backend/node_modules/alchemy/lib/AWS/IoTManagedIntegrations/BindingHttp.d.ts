 ...
 * request fields).
 */
export declare const makeManagedThingHttpBinding: <I extends object, A, E, R, K extends "Identifier" | "ManagedThingId">(options: {
    /**
    ...
    key: K;
}) => Effect.Effect<(thing: ManagedThing) => Effect.Effect<(request?: Omit<I, K> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 * `Resource: ["*"]`).
 */
export declare const makeManagedIntegrationsHttpBinding: <I extends object, A, E, R>(options: {
    /**
     * Short capability name used in the binding sid and runtime span, e.g.
