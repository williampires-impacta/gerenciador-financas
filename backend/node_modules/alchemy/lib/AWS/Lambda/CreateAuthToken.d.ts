 ...
 * @binding
 */
export interface CreateAuthToken extends Binding.Service<CreateAuthToken, "AWS.Lambda.CreateAuthToken", (image: MicrovmImage) => Effect.Effect<(request: CreateAuthTokenRequest) => Effect.Effect<microvms.CreateMicrovmAuthTokenResponse, microvms.CreateMicrovmAuthTokenError>>> {
}
export declare const CreateAuthToken: CreateAuthToken;
