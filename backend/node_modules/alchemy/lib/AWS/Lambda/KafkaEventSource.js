...
import { KafkaEventSource as MSKKafkaEventSource, } from "../Kafka/ClusterEventSource.js";
import { EventSourceMapping } from "./EventSourceMapping.js";
import * as Lambda from "./Function.js";
export const isMSKEvent = (event) => event?.eventSource === "aws:kafka" &&
...
const topicArnGlob = (clusterArn) => `${clusterArn.replace(":cluster/", ":topic/")}/*`;
const groupArnGlob = (clusterArn) => `${clusterArn.replace(":cluster/", ":group/")}/*`;
/** @binding */
export const KafkaEventSource = Layer.effect(MSKKafkaEventSource, Effect.gen(function* () {
...
//# sourceMappingURL=KafkaEventSource.js.map