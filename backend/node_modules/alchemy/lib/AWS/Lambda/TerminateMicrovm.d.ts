 ...
 * @binding
 */
export interface TerminateMicrovm extends Binding.Service<TerminateMicrovm, "AWS.Lambda.TerminateMicrovm", (image: MicrovmImage) => Effect.Effect<(request: TerminateMicrovmRequest) => Effect.Effect<microvms.TerminateMicrovmResponse, microvms.TerminateMicrovmError>>> {
}
export declare const TerminateMicrovm: TerminateMicrovm;
//# sourceMappingURL=TerminateMicrovm.d.ts.map