...
import { findCwdForBundle } from "../../Bundle/TempRoot.js";
 ...
 */
export const buildMicrovmDockerfile = (userDockerfile, runtime, port) => {
    const base = userDockerfile?.trim() ?? `FROM ${MICROVM_BASE_DOCKER_IMAGE}`;
    const installRuntime = runtime === "bun"
 ...
 */
export const bundleMicrovmProgram = Effect.fn(function* ({ main, runtime, handler = "default", isExternal = false, external = [], port, build, }) {
 ...
 */
export const readContextDirectory = Effect.fn(function* (dir) {
    const fs = yield* FileSystem.FileSystem;
...
//# sourceMappingURL=MicrovmBundle.js.map