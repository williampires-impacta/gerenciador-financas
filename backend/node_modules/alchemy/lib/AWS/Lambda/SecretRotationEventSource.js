...
import { RotationEventSource as SecretsManagerRotationEventSource, } from "../SecretsManager/RotationEventSource.js";
import { RotationSchedule } from "../SecretsManager/RotationSchedule.js";
 ...
 */
export const isSecretRotationEvent = (event) => typeof event?.Step === "string" && typeof event?.SecretId === "string";
/**
 ...
 * @binding
 */
export const SecretRotationEventSource = Layer.effect(SecretsManagerRotationEventSource, 
...
Effect.gen(function* () {
    ...
    return Effect.fn(function* (secret, props, process) {
...
//# sourceMappingURL=SecretRotationEventSource.js.map