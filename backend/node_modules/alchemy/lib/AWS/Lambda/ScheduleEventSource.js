...
import { createScheduleRoute, createScheduleRouteId, isScheduleEvent, ScheduleEventSource as SchedulerScheduleEventSource, } from "../Scheduler/ScheduleEventSource.js";
 ...
 * @binding
 */
export const ScheduleEventSource = Layer.effect(SchedulerScheduleEventSource, Effect.gen(function* () {
