...
import { DestinationEventSource as IoTWirelessDestinationEventSource, } from "../IoTWireless/DestinationEventSource.js";
 ...
 * sending device's id.
 */
export const isWirelessUplinkMessage = (event) => event != null &&
    typeof event === "object" &&
 ...
 * @binding
 */
export const WirelessDestinationEventSource = Layer.effect(IoTWirelessDestinationEventSource, 
...
Effect.gen(function* () {
    ...
    return Effect.fn(function* (destination, process) {
...
//# sourceMappingURL=WirelessDestinationEventSource.js.map