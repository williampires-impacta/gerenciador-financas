 ...
 * @binding
 */
export interface GetMicrovm extends Binding.Service<GetMicrovm, "AWS.Lambda.GetMicrovm", (image: MicrovmImage) => Effect.Effect<(request: GetMicrovmRequest) => Effect.Effect<microvms.GetMicrovmResponse, microvms.GetMicrovmError>>> {
}
export declare const GetMicrovm: GetMicrovm;
//# sourceMappingURL=GetMicrovm.d.ts.map