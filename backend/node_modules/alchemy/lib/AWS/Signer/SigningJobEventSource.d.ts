 ...
 * ```
 */
export declare const consumeSigningJobEvents: <StreamReq = never, Req = never>(props: SigningJobEventSourceProps, process: (events: Stream.Stream<SigningJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=SigningJobEventSource.d.ts.map