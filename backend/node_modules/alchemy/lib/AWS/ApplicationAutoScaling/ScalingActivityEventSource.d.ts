 ...
 * ```
 */
export declare const consumeScalingActivityEvents: <StreamReq = never, Req = never>(target: ScalableTarget, props: ScalingActivityEventSourceProps, process: (events: Stream.Stream<ScalingActivityEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ScalingActivityEventSource.d.ts.map