 ...
 * @resource
 */
export const Namespace = Resource("AWS.S3Tables.Namespace");
const createNamespaceName = (id, props) => Effect.gen(function* () {
    if (props.namespace) {
...
export const NamespaceProvider = () => Provider.succeed(Namespace, {
    ...
    read: Effect.fn(function* ({ id, olds, output }) {
        ...
        if (typeof tableBucketArn !== "string")
            return undefined;
    ...
    reconcile: Effect.fn(function* ({ id, news, output, session }) {
        ...
        let ns = yield* s3tables
            .getNamespace({ tableBucketARN: tableBucketArn, namespace })
            .pipe(Effect.map((n) => n), Effect.catchTag("NotFoundException", () => Effect.succeed(undefined)));
