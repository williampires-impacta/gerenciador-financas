 ...
 */
export declare const userPoolTriggerSourcePrefixes: Record<UserPoolTriggerName, string>;
 ...
 */
export type UserPoolTriggerHandler<T extends UserPoolTriggerName, Req = never> = (event: UserPoolTriggerEvent<T>) => Effect.Effect<UserPoolTriggerEvent<T> | void, never, Req>;
export type UserPoolTriggerEventSourceService = <T extends UserPoolTriggerName, Req = never>(userPool: UserPool, props: UserPoolTriggerProps<T>, handler: UserPoolTriggerHandler<T, Req>) => Effect.Effect<void, never, never>;
/**
 ...
 * @binding
 */
export interface UserPoolTriggerEventSource extends Binding.Service<UserPoolTriggerEventSource, "AWS.Cognito.UserPoolTriggerEventSource", UserPoolTriggerEventSourceService> {
}
export declare const UserPoolTriggerEventSource: UserPoolTriggerEventSource;
/**
 ...
 * ```
 */
export declare function onUserPoolTrigger<T extends UserPoolTriggerName, Req = never>(userPool: UserPool, props: UserPoolTriggerProps<T>, handler: UserPoolTriggerHandler<T, Req>): Effect.Effect<void, never, UserPoolTriggerEventSource>;
/**
 ...
 */
export declare const onPreSignUp: <Req = never>(userPool: UserPool, handler: UserPoolTriggerHandler<"PreSignUp", Req>) => Effect.Effect<void, never, UserPoolTriggerEventSource>;
/**
 * Handle the `PostConfirmation` trigger — runs after a user confirms their
 * account (welcome emails, provisioning rows, analytics).
 */
export declare const onPostConfirmation: <Req = never>(userPool: UserPool, handler: UserPoolTriggerHandler<"PostConfirmation", Req>) => Effect.Effect<void, never, UserPoolTriggerEventSource>;
/**
 ...
 */
export declare const onPreTokenGeneration: <Req = never>(userPool: UserPool, handler: UserPoolTriggerHandler<"PreTokenGeneration", Req>) => Effect.Effect<void, never, UserPoolTriggerEventSource>;
/**
 ...
 */
export declare const onCustomMessage: <Req = never>(userPool: UserPool, handler: UserPoolTriggerHandler<"CustomMessage", Req>) => Effect.Effect<void, never, UserPoolTriggerEventSource>;
/**
 ...
 * ```
 */
export declare const autoConfirmUser: <E extends lambda.PreSignUpTriggerEvent>(event: E, options?: {
