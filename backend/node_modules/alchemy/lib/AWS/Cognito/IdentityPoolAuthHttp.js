...
import { IdentityPoolAuth, } from "./IdentityPoolAuth.js";
/**
 ...
 * attached.
 */
export const IdentityPoolAuthHttp = Layer.effect(IdentityPoolAuth, Effect.gen(function* () {
    ...
    return Effect.fn(function* (pool) {
        ...
        if (!globalThis.__ALCHEMY_RUNTIME__) {
            ...
            if (isBindingHost(host)) {
                ...
                yield* host.bind `Allow(${host}, AWS.Cognito.IdentityPoolAuth(${pool}))`({ policyStatements: [] });
            }
        }
        ...
        const authClient = {
            ...
            getId: Effect.fn(`AWS.Cognito.IdentityPoolAuth.getId(${pool.LogicalId})`)(function* (request = {}) {
                return yield* getId({
                    ...request,
                    IdentityPoolId: yield* IdentityPoolId,
                });
            }),
            getCredentialsForIdentity: methods.plain("getCredentialsForIdentity", getCredentialsForIdentity),
...
//# sourceMappingURL=IdentityPoolAuthHttp.js.map