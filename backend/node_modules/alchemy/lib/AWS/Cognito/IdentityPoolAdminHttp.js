...
import { IdentityPoolAdmin, } from "./IdentityPoolAdmin.js";
/**
 ...
 * credentials.
 */
export const IdentityPoolAdminHttp = Layer.effect(IdentityPoolAdmin, Effect.gen(function* () {
    ...
    const getOpenIdTokenForDeveloperIdentity = yield* ci.getOpenIdTokenForDeveloperIdentity;
    return Effect.fn(function* (pool) {
        ...
        const methods = cognitoMethods("AWS.Cognito.IdentityPoolAdmin", pool.LogicalId);
        const withPool = methods.injecting(Effect.map(IdentityPoolId, (id) => ({
            IdentityPoolId: id,
        })));
        const adminClient = {
            ...
            lookupDeveloperIdentity: withPool("lookupDeveloperIdentity", lookupDeveloperIdentity),
            mergeDeveloperIdentities: withPool("mergeDeveloperIdentities", mergeDeveloperIdentities),
            unlinkDeveloperIdentity: withPool("unlinkDeveloperIdentity", unlinkDeveloperIdentity),
            getOpenIdTokenForDeveloperIdentity: withPool("getOpenIdTokenForDeveloperIdentity", getOpenIdTokenForDeveloperIdentity),
        };
        return adminClient;
    });
}));
//# sourceMappingURL=IdentityPoolAdminHttp.js.map