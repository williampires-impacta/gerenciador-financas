...
import { UserPoolAuth } from "./UserPoolAuth.js";
/**
 ...
 * are attached.
 */
export const UserPoolAuthHttp = Layer.effect(UserPoolAuth, Effect.gen(function* () {
    ...
    return Effect.fn(function* (client) {
        ...
        if (!globalThis.__ALCHEMY_RUNTIME__) {
            ...
            if (isBindingHost(host)) {
                ...
                yield* host.bind `Allow(${host}, AWS.Cognito.UserPoolAuth(${client}))`({ policyStatements: [] });
            }
        }
        const methods = cognitoMethods("AWS.Cognito.UserPoolAuth", client.LogicalId);
        const withClient = methods.injecting(Effect.map(ClientId, (id) => ({ ClientId: id })));
        const authClient = {
            ...
            getTokensFromRefreshToken: withClient("getTokensFromRefreshToken", getTokensFromRefreshToken),
            ...
            getUserAttributeVerificationCode: methods.plain("getUserAttributeVerificationCode", getUserAttributeVerificationCode),
...
//# sourceMappingURL=UserPoolAuthHttp.js.map