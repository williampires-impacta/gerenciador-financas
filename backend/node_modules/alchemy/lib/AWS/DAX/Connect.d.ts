 ...
 * @binding
 */
export interface ConnectRead extends Binding.Service<ConnectRead, "AWS.DAX.ConnectRead", (cluster: Cluster) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
 ...
 * @binding
 */
export interface ConnectWrite extends Binding.Service<ConnectWrite, "AWS.DAX.ConnectWrite", (cluster: Cluster) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
 ...
 * @binding
 */
export interface ConnectReadWrite extends Binding.Service<ConnectReadWrite, "AWS.DAX.ConnectReadWrite", (cluster: Cluster) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
