...
export interface ListTableStreamsRequest extends Omit<keyspacesstreams.ListStreamsInput, "keyspaceName" | "tableName"> {
}
/**
...
export interface TableStreamsClient {
     ...
     */
    listStreams: (request?: ListTableStreamsRequest) => Effect.Effect<keyspacesstreams.ListStreamsOutput, keyspacesstreams.ListStreamsError>;
    /**
     * Describe a stream: status, view type, retention, and shard composition.
     */
    getStream: (request: keyspacesstreams.GetStreamInput) => Effect.Effect<keyspacesstreams.GetStreamOutput, keyspacesstreams.GetStreamError>;
    /**
     * Obtain an iterator positioned in a shard (`TRIM_HORIZON`, `LATEST`,
     * `AT_SEQUENCE_NUMBER`, or `AFTER_SEQUENCE_NUMBER`).
     */
    getShardIterator: (request: keyspacesstreams.GetShardIteratorInput) => Effect.Effect<keyspacesstreams.GetShardIteratorOutput, keyspacesstreams.GetShardIteratorError>;
    /**
     * Read change records from a shard iterator.
     */
    getRecords: (request: keyspacesstreams.GetRecordsInput) => Effect.Effect<keyspacesstreams.GetRecordsOutput, keyspacesstreams.GetRecordsError>;
}
/**
 ...
 * @binding
 */
export interface TableStreams extends Binding.Service<TableStreams, "AWS.Keyspaces.TableStreams", <T extends Table>(table: T) => Effect.Effect<TableStreamsClient>> {
}
export declare const TableStreams: TableStreams;
//# sourceMappingURL=TableStreams.d.ts.map