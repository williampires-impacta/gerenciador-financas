...
export interface GetPoliciesClient {
     ...
     */
    batchGetPolicy(request: GetPoliciesRequest): Effect.Effect<AVP.BatchGetPolicyOutput, AVP.BatchGetPolicyError>;
}
/**
 ...
 * @binding
 */
export interface GetPolicies extends Binding.Service<GetPolicies, "AWS.VerifiedPermissions.GetPolicies", <S extends PolicyStore>(store: S) => Effect.Effect<GetPoliciesClient>> {
}
export declare const GetPolicies: GetPolicies;
