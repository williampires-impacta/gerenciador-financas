 ...
 * @resource
 */
export const ApplicationCloudWatchLoggingOption = Resource("AWS.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOption");
/**
...
const findOption = (detail, logStreamArn) => detail?.CloudWatchLoggingOptionDescriptions?.find((option) => option.LogStreamARN === logStreamArn);
export const ApplicationCloudWatchLoggingOptionProvider = () => Provider.effect(ApplicationCloudWatchLoggingOption, Effect.gen(function* () {
    return ApplicationCloudWatchLoggingOption.Provider.of({
        ...
        read: Effect.fn(function* ({ olds, output }) {
            ...
            if (!applicationName || !logStreamArn)
                return undefined;
        ...
        reconcile: Effect.fn(function* ({ news, session }) {
            ...
            const ensureOption = Effect.gen(function* () {
                ...
                return response.CloudWatchLoggingOptionDescriptions?.find((option) => option.LogStreamARN === logStreamArn);
            });
            ...
            yield* session.note(`CloudWatch logging option ${option.CloudWatchLoggingOptionId ?? logStreamArn}`);
            return {
                applicationName,
                logStreamArn,
                cloudWatchLoggingOptionId: option.CloudWatchLoggingOptionId,
        ...
        delete: Effect.fn(function* ({ output }) {
            ...
            const removeOption = Effect.gen(function* () {
                ...
                const optionId = option?.CloudWatchLoggingOptionId ??
...
//# sourceMappingURL=ApplicationCloudWatchLoggingOption.js.map