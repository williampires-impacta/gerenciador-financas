 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.MemoryDB.Connect", (cluster: Cluster, options?: ConnectOptions) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
