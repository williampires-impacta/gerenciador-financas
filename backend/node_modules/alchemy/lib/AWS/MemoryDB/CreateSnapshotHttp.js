...
import { makeMemoryDBClusterHttpBinding, SNAPSHOT_ARN_WILDCARD, } from "./BindingHttp.js";
import { CreateSnapshot } from "./CreateSnapshot.js";
export const CreateSnapshotHttp = Layer.effect(CreateSnapshot, makeMemoryDBClusterHttpBinding({
