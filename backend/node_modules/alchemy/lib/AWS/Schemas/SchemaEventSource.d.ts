 ...
 * ```
 */
export declare const consumeSchemaEvents: <StreamReq = never, Req = never>(props: SchemaEventSourceProps, process: (events: Stream.Stream<SchemaEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=SchemaEventSource.d.ts.map