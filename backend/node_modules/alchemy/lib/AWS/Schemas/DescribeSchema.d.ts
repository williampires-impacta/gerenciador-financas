 ...
 * @binding
 */
export interface DescribeSchema extends Binding.Service<DescribeSchema, "AWS.Schemas.DescribeSchema", (schema: Schema) => Effect.Effect<(request?: {
...
export declare const DescribeSchema: DescribeSchema;
