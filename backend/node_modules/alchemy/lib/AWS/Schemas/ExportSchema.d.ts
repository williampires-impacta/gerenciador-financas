 ...
 * @binding
 */
export interface ExportSchema extends Binding.Service<ExportSchema, "AWS.Schemas.ExportSchema", (schema: Schema) => Effect.Effect<(request?: {
...
export declare const ExportSchema: ExportSchema;
