 ...
 * @binding
 */
export interface SearchSchemas extends Binding.Service<SearchSchemas, "AWS.Schemas.SearchSchemas", (registry: Registry) => Effect.Effect<(request?: {
...
export declare const SearchSchemas: SearchSchemas;
