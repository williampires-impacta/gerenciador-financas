...
export { normalizePolicyDocument, Policy, PolicyProvider, stringifyPolicyDocument, type IamAction, type PolicyDocument, type PolicyStatement, type ServiceControlPolicyDocument, type ServiceControlPolicyStatement, } from "./Policy.ts";
...
export { ServiceLinkedRole, ServiceLinkedRoleDeletionFailed, ServiceLinkedRoleProvider, } from "./ServiceLinkedRole.ts";
export { ServiceSpecificCredential, ServiceSpecificCredentialProvider, } from "./ServiceSpecificCredential.ts";
