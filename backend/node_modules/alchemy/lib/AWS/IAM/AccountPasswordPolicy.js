 ...
 * @resource
 */
export const AccountPasswordPolicy = Resource("AWS.IAM.AccountPasswordPolicy");
export const AccountPasswordPolicyProvider = () => Provider.succeed(AccountPasswordPolicy, {
    ...
    list: () => iam.getAccountPasswordPolicy({}).pipe(Effect.map((response) => [response.PasswordPolicy]), Effect.catchTag("NoSuchEntityException", () => Effect.succeed([]))),
