 ...
 * ```
 */
export declare const consumeBuildEvents: <StreamReq = never, Req = never>(props: BuildEventSourceProps, process: (events: Stream.Stream<BuildEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=BuildEventSource.d.ts.map