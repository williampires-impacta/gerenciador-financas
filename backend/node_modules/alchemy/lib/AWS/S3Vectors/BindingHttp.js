 ...
 */
export const makeVectorsHttpBinding = (options) => Effect.gen(function* () {
...
export const makeReadVectorsClient = Effect.gen(function* () {
    ...
    return (IndexArn, label) => ({
        query: Effect.fn(`${label}.query`)(function* (request) {
            const indexArn = yield* IndexArn;
            return yield* queryVectors({ ...request, indexArn });
        }),
        get: Effect.fn(`${label}.get`)(function* (request) {
            const indexArn = yield* IndexArn;
            return yield* getVectors({ ...request, indexArn });
        }),
        list: Effect.fn(`${label}.list`)(function* (request) {
            const indexArn = yield* IndexArn;
...
export const makeWriteVectorsClient = Effect.gen(function* () {
    ...
    return (IndexArn, label) => ({
        put: Effect.fn(`${label}.put`)(function* (request) {
            const indexArn = yield* IndexArn;
            return yield* putVectors({ ...request, indexArn });
        }),
        delete: Effect.fn(`${label}.delete`)(function* (request) {
            const indexArn = yield* IndexArn;
