...
export interface WriteVectorsClient {
    ...
    readonly put: (request: PutVectorsRequest) => Effect.Effect<s3vectors.PutVectorsOutput, s3vectors.PutVectorsError>;
    /** Delete vectors by key. */
    readonly delete: (request: DeleteVectorsRequest) => Effect.Effect<s3vectors.DeleteVectorsOutput, s3vectors.DeleteVectorsError>;
}
/**
 ...
 * @binding
 */
export interface VectorsWrite extends Binding.Service<VectorsWrite, "AWS.S3Vectors.VectorsWrite", <I extends Index>(index: I) => Effect.Effect<WriteVectorsClient>> {
}
export declare const VectorsWrite: VectorsWrite;
export {};
//# sourceMappingURL=VectorsWrite.d.ts.map