...
export interface ReadVectorsClient {
    ...
    readonly query: (request: QueryVectorsRequest) => Effect.Effect<s3vectors.QueryVectorsOutput, s3vectors.QueryVectorsError>;
    /** Fetch vectors by key. */
    readonly get: (request: GetVectorsRequest) => Effect.Effect<s3vectors.GetVectorsOutput, s3vectors.GetVectorsError>;
    /** List vectors (paginated / segmented scan). */
    readonly list: (request: ListVectorsRequest) => Effect.Effect<s3vectors.ListVectorsOutput, s3vectors.ListVectorsError>;
}
/**
 ...
 * @binding
 */
export interface VectorsRead extends Binding.Service<VectorsRead, "AWS.S3Vectors.VectorsRead", <I extends Index>(index: I) => Effect.Effect<ReadVectorsClient>> {
}
export declare const VectorsRead: VectorsRead;
export {};
//# sourceMappingURL=VectorsRead.d.ts.map