 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.DSQL.Connect", (cluster: Cluster, options?: ConnectOptions) => Effect.Effect<Effect.Effect<SqlConnectionInfo, CredentialsError, RuntimeContext>>> {
}
