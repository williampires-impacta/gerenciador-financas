 ...
 * ```
 */
const ExceptionSubscriptionResource = Resource("AWS.SecurityLake.ExceptionSubscription");
...
const observeSubscription = securitylake
    ...
    .pipe(Effect.map((response) => response.notificationEndpoint !== undefined &&
    ...
    : undefined), Effect.catchTag([
    "AccessDeniedException",
    "ResourceNotFoundException",
    "UnauthorizedException",
], () => Effect.succeed(undefined)));
export const ExceptionSubscriptionProvider = () => Provider.effect(ExceptionSubscriptionResource, Effect.gen(function* () {
    return {
        ...
        reconcile: Effect.fn(function* ({ news, session }) {
            ...
            if (observed === undefined) {
                yield* securitylake
                    ...
                    .pipe(Effect.catchTag("ConflictException", () => securitylake
                    .updateDataLakeExceptionSubscription(desired)
                    .pipe(retryWhileConflict)));
            }
            else if (observed.subscriptionProtocol !== desired.subscriptionProtocol ||
        ...
        delete: Effect.fn(function* () {
            yield* securitylake.deleteDataLakeExceptionSubscription({}).pipe(retryWhileConflict, 
...
//# sourceMappingURL=ExceptionSubscription.js.map