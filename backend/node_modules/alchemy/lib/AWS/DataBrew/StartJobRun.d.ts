 ...
 * @binding
 */
export interface StartJobRun extends Binding.Service<StartJobRun, "AWS.DataBrew.StartJobRun", <J extends Job>(job: J) => Effect.Effect<() => Effect.Effect<SVC.StartJobRunResponse, SVC.StartJobRunError>>> {
}
