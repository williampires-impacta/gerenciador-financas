...
import { StopJobRun } from "./StopJobRun.js";
export const StopJobRunHttp = Layer.effect(StopJobRun, makeDataBrewJobHttpBinding({
    tag: "AWS.DataBrew.StopJobRun",
    operation: databrew.stopJobRun,
    actions: ["databrew:StopJobRun"],
}));
//# sourceMappingURL=StopJobRunHttp.js.map