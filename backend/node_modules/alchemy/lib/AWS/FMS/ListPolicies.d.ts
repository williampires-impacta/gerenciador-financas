 ...
 * @binding
 */
export interface ListPolicies extends Binding.Service<ListPolicies, "AWS.FMS.ListPolicies", () => Effect.Effect<(request?: ListPoliciesRequest) => Effect.Effect<fms.ListPoliciesResponse, fms.ListPoliciesError>>> {
}
