...
import { ListResolverRuleAssociations } from "./ListResolverRuleAssociations.js";
/**
 ...
 */
export const ListResolverRuleAssociationsHttp = Layer.effect(ListResolverRuleAssociations, Effect.gen(function* () {
    ...
    return Effect.fn(function* (rule) {
        ...
        return Effect.fn(`AWS.Route53Resolver.ListResolverRuleAssociations(${rule.LogicalId})`)(function* (request) {
            return yield* op({
                ...request,
                Filters: [
...
//# sourceMappingURL=ListResolverRuleAssociationsHttp.js.map