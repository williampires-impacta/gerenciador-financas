 ...
 * ```
 */
export declare const consumeGroupEvents: <StreamReq = never, Req = never>(props: GroupEventSourceProps, process: (events: Stream.Stream<GroupEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=GroupEventSource.d.ts.map