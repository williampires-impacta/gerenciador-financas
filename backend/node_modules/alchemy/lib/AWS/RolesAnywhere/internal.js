 ...
 */
export const toTagRecord = (tags) => Object.fromEntries((tags ?? []).map((t) => [unwrap(t.key), unwrap(t.value)]));
/**
 ...
 */
export const readRolesAnywhereTags = Effect.fn(function* (arn) {
 ...
 */
export const syncRolesAnywhereTags = Effect.fn(function* (arn, desiredTags) {
