 ...
 * ```
 */
export declare const consumeImageEvents: <StreamReq = never, Req = never>(props: ImageEventSourceProps, process: (events: Stream.Stream<ImageEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ImageEventSource.d.ts.map