...
const pinContactsRegion = (effect) => effect.pipe(Effect.provideService(Region, Effect.succeed(US_EAST_1)));
/**
 ...
 */
export const makeEmailContactHttpBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* (contact) {
        ...
        return Effect.fn(`${options.tag}(${contact.LogicalId})`)(function* (request) {
            ...
            return yield* pinContactsRegion(op({ ...request, arn }));
        });
    });
});
