...
import { makeIotTopicHttpBinding } from "./BindingHttp.js";
import { GetRetainedMessage } from "./GetRetainedMessage.js";
/**
 ...
 */
export const GetRetainedMessageHttp = Layer.effect(GetRetainedMessage, makeIotTopicHttpBinding({
    tag: "AWS.IoT.GetRetainedMessage",
    operation: iotdata.getRetainedMessage,
    actions: ["iot:GetRetainedMessage"],
}));
//# sourceMappingURL=GetRetainedMessageHttp.js.map