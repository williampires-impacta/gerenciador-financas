 ...
 * ```
 */
export declare function consumeTopicMessages<Req = never>(topicFilter: string, process: MessagesHandler<Req>): Effect.Effect<void, never, TopicRuleEventSource>;
export declare function consumeTopicMessages<Req = never>(topicFilter: string, props: TopicRuleEventSourceProps, process: MessagesHandler<Req>): Effect.Effect<void, never, TopicRuleEventSource>;
declare const TopicRuleEventSource_base: Context.ServiceClass<TopicRuleEventSource, "AWS.IoT.TopicRuleEventSource", TopicRuleEventSourceService>;
/**
 ...
 * @binding
 */
export declare class TopicRuleEventSource extends TopicRuleEventSource_base {
}
export type TopicRuleEventSourceService = <Req = never>(topicFilter: string, props: TopicRuleEventSourceProps, process: (stream: Stream.Stream<IoTMessage>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
export {};
