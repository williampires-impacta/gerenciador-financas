...
import { DescribeThing } from "./DescribeThing.js";
/**
 ...
 * API.
 */
export const DescribeThingHttp = Layer.effect(DescribeThing, makeIotThingHttpBinding({
    tag: "AWS.IoT.DescribeThing",
    operation: iot.describeThing,
    actions: ["iot:DescribeThing"],
}));
//# sourceMappingURL=DescribeThingHttp.js.map