...
import { ListNamedShadowsForThing } from "./ListNamedShadowsForThing.js";
/**
 ...
 */
export const ListNamedShadowsForThingHttp = Layer.effect(ListNamedShadowsForThing, makeIotThingHttpBinding({
    tag: "AWS.IoT.ListNamedShadowsForThing",
    operation: iotdata.listNamedShadowsForThing,
    actions: ["iot:ListNamedShadowsForThing"],
}));
//# sourceMappingURL=ListNamedShadowsForThingHttp.js.map