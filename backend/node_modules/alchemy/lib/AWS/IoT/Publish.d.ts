 ...
 * @binding
 */
export interface Publish extends Binding.Service<Publish, "AWS.IoT.Publish", (topicFilter?: string) => Effect.Effect<(request: PublishRequest) => Effect.Effect<iotdata.PublishResponse, iotdata.PublishError>>> {
}
