...
import type { BulkResponse, IndexDocumentOptions, OpenSearchApiError, WriteDocumentOptions, WriteDocumentResponse } from "./DataPlaneTypes.ts";
...
export interface WriteDomainClient {
     ...
     */
    indexDocument(index: string, document: unknown, options?: IndexDocumentOptions): Effect.Effect<WriteDocumentResponse, OpenSearchApiError | Credentials.CredentialsError>;
    /**
     * Partially update one document (`POST /{index}/_update/{id}`). The body
     * is the update API's envelope, e.g. `{ doc: { plays: 42 } }`.
     */
    updateDocument(index: string, id: string, body: unknown, options?: WriteDocumentOptions): Effect.Effect<WriteDocumentResponse, OpenSearchApiError | Credentials.CredentialsError>;
    /**
     ...
     */
    deleteDocument(index: string, id: string, options?: WriteDocumentOptions): Effect.Effect<WriteDocumentResponse, OpenSearchApiError | Credentials.CredentialsError>;
    /**
     ...
     */
    bulk(operations: ReadonlyArray<unknown>, options?: WriteDocumentOptions): Effect.Effect<BulkResponse, OpenSearchApiError | Credentials.CredentialsError>;
}
/**
 ...
 * @binding
 */
export interface DomainWrite extends Binding.Service<DomainWrite, "AWS.OpenSearch.DomainWrite", (domain: Domain) => Effect.Effect<WriteDomainClient>> {
}
export declare const DomainWrite: DomainWrite;
//# sourceMappingURL=DomainWrite.d.ts.map