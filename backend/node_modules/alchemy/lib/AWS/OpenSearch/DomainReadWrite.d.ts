...
export interface ReadWriteDomainClient extends ReadDomainClient, WriteDomainClient {
     ...
     */
    request(method: "GET" | "HEAD" | "POST" | "PUT" | "DELETE" | "PATCH", path: string, options?: {
 ...
 * @binding
 */
export interface DomainReadWrite extends Binding.Service<DomainReadWrite, "AWS.OpenSearch.DomainReadWrite", (domain: Domain) => Effect.Effect<ReadWriteDomainClient>> {
}
export declare const DomainReadWrite: DomainReadWrite;
//# sourceMappingURL=DomainReadWrite.d.ts.map