declare const OpenSearchApiError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "AWS.OpenSearch.ApiError";
} & Readonly<A>;
/**
 ...
 */
export declare class OpenSearchApiError extends OpenSearchApiError_base<{
...
export {};
//# sourceMappingURL=DataPlaneTypes.d.ts.map