...
export interface AccountSettings extends Resource<"AWS.SES.AccountSettings", AccountSettingsProps, {
 ...
 * @resource
 */
export declare const AccountSettings: import("../../Resource.ts").ResourceClass<AccountSettings>;
export declare const AccountSettingsProvider: () => import("effect/Layer").Layer<Provider.Provider<AccountSettings>, never, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
