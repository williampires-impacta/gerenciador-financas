...
export type EmailEventKind = "send" | "reject" | "delivery" | "delivery-delay" | "bounce" | "complaint" | "open" | "click" | "rendering-failure" | "subscription";
 ...
 * ```
 */
export declare const consumeEmailEvents: <StreamReq = never, Req = never>(props: EmailEventSourceProps, process: (events: Stream.Stream<EmailEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
