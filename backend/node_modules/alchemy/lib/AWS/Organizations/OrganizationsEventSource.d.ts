 ...
 */
export type OrganizationsEventName = "CreateAccountResult" | "CreateOrganizationalUnit" | "DeleteOrganizationalUnit" | "MoveAccount" | "RemoveAccountFromOrganization" | "CloseAccount" | "InviteAccountToOrganization" | "AcceptHandshake" | "DeclineHandshake" | "CancelHandshake" | "AttachPolicy" | "DetachPolicy" | "TagResource" | "UntagResource";
/**
 ...
 * ```
 */
export declare const consumeOrganizationsEvents: <StreamReq = never, Req = never>(props: OrganizationsEventSourceProps, process: (events: Stream.Stream<OrganizationsEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=OrganizationsEventSource.d.ts.map