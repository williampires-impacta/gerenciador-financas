...
import { ListInternetEvents } from "./ListInternetEvents.js";
export const ListInternetEventsHttp = Layer.effect(ListInternetEvents, makeInternetMonitorAccountHttpBinding({
    tag: "AWS.InternetMonitor.ListInternetEvents",
    operation: im.listInternetEvents,
    actions: ["internetmonitor:ListInternetEvents"],
}));
//# sourceMappingURL=ListInternetEventsHttp.js.map