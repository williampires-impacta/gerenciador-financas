 ...
 */
export declare const makeInternetMonitorMonitorHttpBinding: <I extends {
    MonitorName: string;
}, A, E, R>(options: {
...
}) => Effect.Effect<(monitor: Monitor) => Effect.Effect<(request?: Omit<I, "MonitorName"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeInternetMonitorAccountHttpBinding: <I, A, E, R>(options: {
