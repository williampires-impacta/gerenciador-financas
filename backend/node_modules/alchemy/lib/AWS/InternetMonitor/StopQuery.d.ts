 ...
 * @binding
 */
export interface StopQuery extends Binding.Service<StopQuery, "AWS.InternetMonitor.StopQuery", (monitor: Monitor) => Effect.Effect<(request: StopQueryRequest) => Effect.Effect<im.StopQueryOutput, im.StopQueryError>>> {
}
