 ...
 * ```
 */
export declare const consumeTransformationEvents: <StreamReq = never, Req = never>(props: TransformationEventSourceProps, process: (events: Stream.Stream<TransformationEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
/**
 ...
 * ```
 */
export declare const consumeAcknowledgementEvents: <StreamReq = never, Req = never>(props: AcknowledgementEventSourceProps, process: (events: Stream.Stream<AcknowledgementEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=TransformationEventSource.d.ts.map