 ...
 */
export type FlowEventDetailType = "AppFlow Start Flow Run Report" | "AppFlow End Flow Run Report" | "AppFlow Event Flow Report" | (string & {});
 ...
 * ```
 */
export declare const flowEvents: ({ flowNames, detailTypes, statuses, }?: FlowEventsOptions) => {
    source: string[];
    "detail-type"?: FlowEventDetailType[] | undefined;
    detail?: {
        "flow-name"?: string[] | undefined;
        status?: string[] | undefined;
    } | undefined;
};
//# sourceMappingURL=flowEvents.d.ts.map