 ...
 * @binding
 */
export interface StopFlow extends Binding.Service<StopFlow, "AWS.AppFlow.StopFlow", (flow: Flow) => Effect.Effect<() => Effect.Effect<appflow.StopFlowResponse, appflow.StopFlowError>>> {
}
