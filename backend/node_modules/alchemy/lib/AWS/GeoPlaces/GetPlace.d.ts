 ...
 * @binding
 */
export interface GetPlace extends Binding.Service<GetPlace, "AWS.GeoPlaces.GetPlace", () => Effect.Effect<(request: geoPlaces.GetPlaceRequest) => Effect.Effect<geoPlaces.GetPlaceResponse, geoPlaces.GetPlaceError>>> {
}
