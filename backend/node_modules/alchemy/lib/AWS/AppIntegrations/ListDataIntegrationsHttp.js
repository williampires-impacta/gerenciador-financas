...
import { ListDataIntegrations } from "./ListDataIntegrations.js";
/**
 ...
 */
export const ListDataIntegrationsHttp = Layer.effect(ListDataIntegrations, makeAppIntegrationsAccountHttpBinding({
    name: "ListDataIntegrations",
    operation: appintegrations.listDataIntegrations,
    iamActions: ["app-integrations:ListDataIntegrations"],
}));
//# sourceMappingURL=ListDataIntegrationsHttp.js.map