...
export type ConfigEventKind = "compliance" | "configuration-item" | "snapshot-delivery" | "history-delivery";
 ...
 * ```
 */
export declare const consumeConfigEvents: <StreamReq = never, Req = never>(props: ConfigEventSourceProps, process: (events: Stream.Stream<ConfigEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ConfigEventSource.d.ts.map