...
export const fetchObservedTags = Effect.fn(function* (arn) {
    return yield* codeconnections.listTagsForResource({ ResourceArn: arn }).pipe(Effect.map((res) => toTagRecord(res.Tags)), Effect.catchTag("ResourceNotFoundException", () => Effect.succeed({})));
});
/**
 ...
 */
export const syncResourceTags = Effect.fn(function* (arn, desiredTags) {
