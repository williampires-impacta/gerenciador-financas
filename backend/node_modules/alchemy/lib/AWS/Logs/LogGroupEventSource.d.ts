...
type LogEventsHandler<Req> = (events: Stream.Stream<LogEventRecord>) => Effect.Effect<void, never, Req>;
/**
 ...
 * @binding
 */
export declare function consumeLogEvents<G extends LogGroup, Req = never>(logGroup: G, process: LogEventsHandler<Req>): Effect.Effect<void, never, LogGroupEventSource>;
export declare function consumeLogEvents<G extends LogGroup, Req = never>(logGroup: G, props: LogGroupEventSourceProps, process: LogEventsHandler<Req>): Effect.Effect<void, never, LogGroupEventSource>;
declare const LogGroupEventSource_base: Context.ServiceClass<LogGroupEventSource, "AWS.Logs.LogGroupEventSource", LogGroupEventSourceService>;
export declare class LogGroupEventSource extends LogGroupEventSource_base {
}
export type LogGroupEventSourceService = <Req = never>(logGroup: LogGroup, props: LogGroupEventSourceProps, process: (events: Stream.Stream<LogEventRecord>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
export {};
