...
export type LogEventSinkError = Logs.PutLogEventsError | BatchRetryExhaustedError<Logs.InputLogEvent>;
/**
 ...
 * @binding
 */
export interface LogEventSink extends Binding.Service<LogEventSink, "AWS.Logs.LogEventSink", (logGroup: LogGroup, props: LogEventSinkProps) => Effect.Effect<Sink.Sink<void, Logs.InputLogEvent, readonly Logs.InputLogEvent[], LogEventSinkError>>> {
}
export declare const LogEventSink: LogEventSink;
//# sourceMappingURL=LogEventSink.d.ts.map