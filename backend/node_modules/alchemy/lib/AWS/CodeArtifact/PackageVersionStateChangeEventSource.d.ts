 ...
 */
export type PackageVersionState = "Unfinished" | "Published" | "Unlisted" | "Archived" | "Disposed" | "Deleted";
/**
 ...
 * ```
 */
export declare const consumePackageVersionStateChanges: <StreamReq = never, Req = never>(props: PackageVersionStateChangesProps, process: (events: Stream.Stream<PackageVersionStateChangeEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=PackageVersionStateChangeEventSource.d.ts.map