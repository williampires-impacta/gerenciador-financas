 ...
 * @binding
 */
export interface KafkaEventSource extends Binding.Service<KafkaEventSource, "AWS.Kafka.KafkaEventSource", KafkaEventSourceService> {
}
export declare const KafkaEventSource: KafkaEventSource;
export type KafkaEventSourceService = <StreamReq = never, Req = never>(cluster: ServerlessCluster, props: KafkaEventSourceProps, process: (stream: Stream.Stream<MSKRecord, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
/**
 ...
 * ```
 */
export declare const consumeKafkaTopic: <C extends ServerlessCluster, Req = never, StreamReq = never>(cluster: C, props: KafkaEventSourceProps, process: (stream: Stream.Stream<MSKRecord, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, KafkaEventSource>;
