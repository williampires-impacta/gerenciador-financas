 ...
 */
export declare const connectEnvPrefix: (logicalId: string) => string;
/**
 ...
 * @binding
 */
export interface ConnectRead extends Binding.Service<ConnectRead, "AWS.Kafka.ConnectRead", (cluster: ServerlessCluster) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
export declare const ConnectRead: ConnectRead;
/**
 ...
 * @binding
 */
export interface ConnectWrite extends Binding.Service<ConnectWrite, "AWS.Kafka.ConnectWrite", (cluster: ServerlessCluster) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
export declare const ConnectWrite: ConnectWrite;
/**
 ...
 * @binding
 */
export interface ConnectReadWrite extends Binding.Service<ConnectReadWrite, "AWS.Kafka.ConnectReadWrite", (cluster: ServerlessCluster) => Effect.Effect<Effect.Effect<ClusterConnectionInfo, never, RuntimeContext>>> {
}
export declare const ConnectReadWrite: ConnectReadWrite;
