 ...
 * @binding
 */
export interface TopicEventSource extends Binding.Service<TopicEventSource, "AWS.SNS.TopicEventSource", TopicEventSourceService> {
}
export declare const TopicEventSource: TopicEventSource;
export type TopicEventSourceService = <StreamReq = never, Req = never>(topic: Topic, props: TopicEventSourceProps, process: (stream: Stream.Stream<TopicNotification, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
type TopicEventSourceHandler<Req, StreamReq> = (stream: Stream.Stream<TopicNotification, never, StreamReq>) => Effect.Effect<void, never, Req>;
/**
 ...
 * ```
 */
export declare function consumeTopicNotifications<T extends Topic, Req = never, StreamReq = never>(topic: T, process: TopicEventSourceHandler<Req, StreamReq>): Effect.Effect<void, never, TopicEventSource>;
export declare function consumeTopicNotifications<T extends Topic, Req = never, StreamReq = never>(topic: T, props: TopicEventSourceProps, process: TopicEventSourceHandler<Req, StreamReq>): Effect.Effect<void, never, TopicEventSource>;
export {};
