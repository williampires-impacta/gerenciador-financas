 ...
 * @binding
 */
export interface TopicSink extends Binding.Service<TopicSink, "AWS.SNS.TopicSink", (topic: Topic) => Effect.Effect<Sink.Sink<void, TopicSinkEntry, readonly TopicSinkEntry[], TopicSinkError>>> {
}
export declare const TopicSink: TopicSink;
//# sourceMappingURL=TopicSink.d.ts.map