 ...
 * @binding
 */
export interface Unsubscribe extends Binding.Service<Unsubscribe, "AWS.SNS.Unsubscribe", () => Effect.Effect<(request: UnsubscribeRequest) => Effect.Effect<sns.UnsubscribeResponse, sns.UnsubscribeError>>> {
}
