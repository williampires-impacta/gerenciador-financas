 ...
 * @binding
 */
export interface Subscribe extends Binding.Service<Subscribe, "AWS.SNS.Subscribe", (topic: Topic) => Effect.Effect<(request: SubscribeRequest) => Effect.Effect<sns.SubscribeResponse, sns.SubscribeError>>> {
}
