 ...
 * @binding
 */
export interface TagResource extends Binding.Service<TagResource, "AWS.SNS.TagResource", (topic: Topic) => Effect.Effect<(request: TagResourceRequest) => Effect.Effect<sns.TagResourceResponse, sns.TagResourceError>>> {
}
