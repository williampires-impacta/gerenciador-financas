 ...
 * ```
 */
export declare const consumeImagingEvents: <StreamReq = never, Req = never>(props: ImagingEventSourceProps, process: (events: Stream.Stream<MedicalImagingEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ImagingEventSource.d.ts.map