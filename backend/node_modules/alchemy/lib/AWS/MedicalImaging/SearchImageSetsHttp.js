...
import { SearchImageSets } from "./SearchImageSets.js";
export const SearchImageSetsHttp = Layer.effect(SearchImageSets, makeMedicalImagingDatastoreHttpBinding({
    tag: "AWS.MedicalImaging.SearchImageSets",
    operation: medicalimaging.searchImageSets,
    actions: ["medical-imaging:SearchImageSets"],
}));
//# sourceMappingURL=SearchImageSetsHttp.js.map