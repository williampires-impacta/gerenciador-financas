...
import { ImportSshPublicKey } from "./ImportSshPublicKey.js";
export const ImportSshPublicKeyHttp = Layer.effect(ImportSshPublicKey, makeTransferUserHttpBinding({
    tag: "AWS.Transfer.ImportSshPublicKey",
    operation: transfer.importSshPublicKey,
    actions: ["transfer:ImportSshPublicKey"],
}));
//# sourceMappingURL=ImportSshPublicKeyHttp.js.map