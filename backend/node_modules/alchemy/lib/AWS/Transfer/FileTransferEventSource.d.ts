...
export type FileTransferEventKind = "file-upload-completed" | "file-upload-failed" | "file-download-completed" | "file-download-failed";
 ...
 * ```
 */
export declare const consumeFileTransferEvents: <StreamReq = never, Req = never>(props: FileTransferEventSourceProps, process: (events: Stream.Stream<FileTransferEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=FileTransferEventSource.d.ts.map