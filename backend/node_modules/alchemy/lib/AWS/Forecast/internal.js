 ...
 */
export const toTagRecord = (tags) => Object.fromEntries((tags ?? []).map((t) => [unredact(t.Key), unredact(t.Value)]));
/**
 ...
 */
export const readForecastTags = Effect.fn(function* (arn) {
 ...
 */
export const syncForecastTags = Effect.fn(function* (arn, desiredTags) {
 ...
 */
export const toForecastName = (name) => {
