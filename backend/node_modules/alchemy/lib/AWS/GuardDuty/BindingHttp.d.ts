 ...
 */
export declare const makeGuardDutyDetectorHttpBinding: <I extends {
    DetectorId: string;
}, A, E, R>(options: {
...
}) => Effect.Effect<(detector: Detector) => Effect.Effect<(request?: Omit<I, "DetectorId"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeGuardDutyAccountHttpBinding: <I, A, E, R>(options: {
