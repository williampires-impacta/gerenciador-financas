...
import { GetSamplingTargets } from "./GetSamplingTargets.js";
/**
 ...
 * ```
 */
export const GetSamplingTargetsHttp = Layer.effect(GetSamplingTargets, makeXRayHttpBinding({
    tag: "AWS.XRay.GetSamplingTargets",
    operation: xray.getSamplingTargets,
    actions: ["xray:GetSamplingTargets"],
}));
//# sourceMappingURL=GetSamplingTargetsHttp.js.map