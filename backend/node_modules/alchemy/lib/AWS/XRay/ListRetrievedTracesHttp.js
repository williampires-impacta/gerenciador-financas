...
import { ListRetrievedTraces } from "./ListRetrievedTraces.js";
/**
 ...
 * ```
 */
export const ListRetrievedTracesHttp = Layer.effect(ListRetrievedTraces, makeXRayHttpBinding({
    tag: "AWS.XRay.ListRetrievedTraces",
    operation: xray.listRetrievedTraces,
    actions: ["xray:ListRetrievedTraces"],
}));
//# sourceMappingURL=ListRetrievedTracesHttp.js.map