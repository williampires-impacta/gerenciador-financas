...
import { GetTraceSegmentDestination } from "./GetTraceSegmentDestination.js";
/**
 ...
 * ```
 */
export const GetTraceSegmentDestinationHttp = Layer.effect(GetTraceSegmentDestination, makeXRayHttpBinding({
    tag: "AWS.XRay.GetTraceSegmentDestination",
    operation: xray.getTraceSegmentDestination,
    actions: ["xray:GetTraceSegmentDestination"],
}));
//# sourceMappingURL=GetTraceSegmentDestinationHttp.js.map