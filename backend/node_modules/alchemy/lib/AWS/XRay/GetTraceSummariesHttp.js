...
import { GetTraceSummaries } from "./GetTraceSummaries.js";
/**
 ...
 * ```
 */
export const GetTraceSummariesHttp = Layer.effect(GetTraceSummaries, makeXRayHttpBinding({
    tag: "AWS.XRay.GetTraceSummaries",
    operation: xray.getTraceSummaries,
    actions: ["xray:GetTraceSummaries"],
}));
//# sourceMappingURL=GetTraceSummariesHttp.js.map