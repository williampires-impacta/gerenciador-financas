...
import { BatchGetTraces } from "./BatchGetTraces.js";
 ...
 * ```
 */
export const BatchGetTracesHttp = Layer.effect(BatchGetTraces, makeXRayHttpBinding({
    tag: "AWS.XRay.BatchGetTraces",
    operation: xray.batchGetTraces,
    actions: ["xray:BatchGetTraces"],
}));
//# sourceMappingURL=BatchGetTracesHttp.js.map