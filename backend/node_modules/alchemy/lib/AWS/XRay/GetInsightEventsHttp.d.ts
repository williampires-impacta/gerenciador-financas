 ...
 * ```
 */
export declare const GetInsightEventsHttp: Layer.Layer<GetInsightEvents, never, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
//# sourceMappingURL=GetInsightEventsHttp.d.ts.map