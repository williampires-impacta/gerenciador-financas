...
import { PutTraceSegments } from "./PutTraceSegments.js";
/**
 ...
 * ```
 */
export const PutTraceSegmentsHttp = Layer.effect(PutTraceSegments, makeXRayHttpBinding({
    tag: "AWS.XRay.PutTraceSegments",
    operation: xray.putTraceSegments,
    actions: ["xray:PutTraceSegments"],
}));
//# sourceMappingURL=PutTraceSegmentsHttp.js.map