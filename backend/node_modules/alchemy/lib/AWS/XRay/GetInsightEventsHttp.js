...
import { GetInsightEvents } from "./GetInsightEvents.js";
/**
 ...
 * ```
 */
export const GetInsightEventsHttp = Layer.effect(GetInsightEvents, makeXRayHttpBinding({
    tag: "AWS.XRay.GetInsightEvents",
    operation: xray.getInsightEvents,
    actions: ["xray:GetInsightEvents"],
}));
//# sourceMappingURL=GetInsightEventsHttp.js.map