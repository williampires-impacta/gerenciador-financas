...
import { GetServiceGraph } from "./GetServiceGraph.js";
/**
 ...
 * ```
 */
export const GetServiceGraphHttp = Layer.effect(GetServiceGraph, makeXRayHttpBinding({
    tag: "AWS.XRay.GetServiceGraph",
    operation: xray.getServiceGraph,
    actions: ["xray:GetServiceGraph"],
}));
//# sourceMappingURL=GetServiceGraphHttp.js.map