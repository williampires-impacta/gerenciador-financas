...
import { PutTelemetryRecords } from "./PutTelemetryRecords.js";
/**
 ...
 * ```
 */
export const PutTelemetryRecordsHttp = Layer.effect(PutTelemetryRecords, makeXRayHttpBinding({
    tag: "AWS.XRay.PutTelemetryRecords",
    operation: xray.putTelemetryRecords,
    actions: ["xray:PutTelemetryRecords"],
}));
//# sourceMappingURL=PutTelemetryRecordsHttp.js.map