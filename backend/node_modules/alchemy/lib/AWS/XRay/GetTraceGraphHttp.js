...
import { GetTraceGraph } from "./GetTraceGraph.js";
/**
 ...
 * ```
 */
export const GetTraceGraphHttp = Layer.effect(GetTraceGraph, makeXRayHttpBinding({
    tag: "AWS.XRay.GetTraceGraph",
    operation: xray.getTraceGraph,
    actions: ["xray:GetTraceGraph"],
}));
//# sourceMappingURL=GetTraceGraphHttp.js.map