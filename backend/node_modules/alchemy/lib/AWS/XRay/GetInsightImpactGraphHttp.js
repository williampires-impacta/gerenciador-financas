...
import { GetInsightImpactGraph } from "./GetInsightImpactGraph.js";
/**
 ...
 * ```
 */
export const GetInsightImpactGraphHttp = Layer.effect(GetInsightImpactGraph, makeXRayHttpBinding({
    tag: "AWS.XRay.GetInsightImpactGraph",
    operation: xray.getInsightImpactGraph,
    actions: ["xray:GetInsightImpactGraph"],
}));
//# sourceMappingURL=GetInsightImpactGraphHttp.js.map