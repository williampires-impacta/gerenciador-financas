...
import { CancelTraceRetrieval } from "./CancelTraceRetrieval.js";
/**
 ...
 * ```
 */
export const CancelTraceRetrievalHttp = Layer.effect(CancelTraceRetrieval, makeXRayHttpBinding({
    tag: "AWS.XRay.CancelTraceRetrieval",
    operation: xray.cancelTraceRetrieval,
    actions: ["xray:CancelTraceRetrieval"],
}));
//# sourceMappingURL=CancelTraceRetrievalHttp.js.map