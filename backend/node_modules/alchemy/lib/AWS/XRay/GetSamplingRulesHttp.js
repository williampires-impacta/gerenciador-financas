...
import { GetSamplingRules } from "./GetSamplingRules.js";
/**
 ...
 * ```
 */
export const GetSamplingRulesHttp = Layer.effect(GetSamplingRules, makeXRayHttpBinding({
    tag: "AWS.XRay.GetSamplingRules",
    operation: xray.getSamplingRules,
    actions: ["xray:GetSamplingRules"],
}));
//# sourceMappingURL=GetSamplingRulesHttp.js.map