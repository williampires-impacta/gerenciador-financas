...
import { StartTraceRetrieval } from "./StartTraceRetrieval.js";
/**
 ...
 * ```
 */
export const StartTraceRetrievalHttp = Layer.effect(StartTraceRetrieval, makeXRayHttpBinding({
    tag: "AWS.XRay.StartTraceRetrieval",
    operation: xray.startTraceRetrieval,
    actions: ["xray:StartTraceRetrieval"],
}));
//# sourceMappingURL=StartTraceRetrievalHttp.js.map