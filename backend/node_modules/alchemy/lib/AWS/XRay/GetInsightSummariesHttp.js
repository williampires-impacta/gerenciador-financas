...
import { GetInsightSummaries } from "./GetInsightSummaries.js";
/**
 ...
 * ```
 */
export const GetInsightSummariesHttp = Layer.effect(GetInsightSummaries, makeXRayHttpBinding({
    tag: "AWS.XRay.GetInsightSummaries",
    operation: xray.getInsightSummaries,
    actions: ["xray:GetInsightSummaries"],
}));
//# sourceMappingURL=GetInsightSummariesHttp.js.map