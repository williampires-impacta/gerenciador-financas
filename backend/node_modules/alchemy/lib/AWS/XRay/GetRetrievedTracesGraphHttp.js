...
import { GetRetrievedTracesGraph } from "./GetRetrievedTracesGraph.js";
/**
 ...
 * ```
 */
export const GetRetrievedTracesGraphHttp = Layer.effect(GetRetrievedTracesGraph, makeXRayHttpBinding({
    tag: "AWS.XRay.GetRetrievedTracesGraph",
    operation: xray.getRetrievedTracesGraph,
    actions: ["xray:GetRetrievedTracesGraph"],
}));
//# sourceMappingURL=GetRetrievedTracesGraphHttp.js.map