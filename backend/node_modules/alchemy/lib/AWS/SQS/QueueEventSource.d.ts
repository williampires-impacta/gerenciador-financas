 ...
 * ```
 */
export declare function consumeQueueMessages<Q extends Queue, Req = never>(queue: Q, process: MessagesHandler<Req>): Effect.Effect<void, never, QueueEventSource>;
export declare function consumeQueueMessages<Q extends Queue, Req = never>(queue: Q, props: MessagesProps, process: MessagesHandler<Req>): Effect.Effect<void, never, QueueEventSource>;
/**
 ...
 * @binding
 */
export interface QueueEventSource extends Binding.Service<QueueEventSource, "AWS.SQS.QueueEventSource", QueueEventSourceService> {
}
export declare const QueueEventSource: QueueEventSource;
...
export type QueueEventSourceService = <Req = never>(bucket: Queue, props: MessagesProps, process: (stream: Stream.Stream<SQSRecord>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
export {};
