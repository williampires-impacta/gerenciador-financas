 ...
 * @binding
 */
export interface QueueSink extends Binding.Service<QueueSink, "AWS.SQS.QueueSink", (queue: Queue) => Effect.Effect<Sink.Sink<void, QueueSinkEntry, readonly QueueSinkEntry[], QueueSinkError>>> {
}
export declare const QueueSink: QueueSink;
//# sourceMappingURL=QueueSink.d.ts.map