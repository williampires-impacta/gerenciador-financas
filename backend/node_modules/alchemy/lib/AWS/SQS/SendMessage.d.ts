 ...
 * @binding
 */
export interface SendMessage extends Binding.Service<SendMessage, "AWS.SQS.SendMessage", (queue: Queue) => Effect.Effect<(request: SendMessageRequest) => Effect.Effect<sqs.SendMessageResult, sqs.SendMessageError>>> {
}
