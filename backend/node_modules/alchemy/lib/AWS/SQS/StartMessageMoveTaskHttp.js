...
import { StartMessageMoveTask, } from "./StartMessageMoveTask.js";
...
export const StartMessageMoveTaskHttp = Layer.effect(StartMessageMoveTask, Effect.gen(function* () {
    const startMessageMoveTask = yield* sqs.startMessageMoveTask;
    return Effect.fn(function* (source, options) {
        ...
        return Effect.fn(`AWS.SQS.StartMessageMoveTask(${source.LogicalId})`)(function* (request) {
...
//# sourceMappingURL=StartMessageMoveTaskHttp.js.map