...
export interface StartMessageMoveTaskRequest extends Omit<sqs.StartMessageMoveTaskRequest, "SourceArn" | "DestinationArn"> {
}
/**
 ...
 * @binding
 */
export interface StartMessageMoveTask extends Binding.Service<StartMessageMoveTask, "AWS.SQS.StartMessageMoveTask", (source: Queue, options?: {
    /**
     ...
     */
    destination?: Queue;
}) => Effect.Effect<(request?: StartMessageMoveTaskRequest) => Effect.Effect<sqs.StartMessageMoveTaskResult, sqs.StartMessageMoveTaskError>>> {
}
export declare const StartMessageMoveTask: StartMessageMoveTask;
//# sourceMappingURL=StartMessageMoveTask.d.ts.map