 ...
 * bespoke.
 */
const grantOnQueue = (tag, queue, actions) => Effect.gen(function* () {
 ...
 */
export const makeQueueUrlHttpBinding = (options) => Effect.gen(function* () {
 ...
 */
export const makeQueueArnHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
    return Effect.fn(function* (queue) {
 ...
 */
export const makeQueueGrantHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
    return Effect.fn(function* (queue) {
        yield* grantOnQueue(options.tag, queue, options.actions);
        return Effect.fn(`${options.tag}(${queue.LogicalId})`)(function* (request) {
