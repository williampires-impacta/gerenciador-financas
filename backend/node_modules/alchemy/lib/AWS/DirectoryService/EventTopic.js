 ...
 * @resource
 */
export const EventTopic = Resource("AWS.DirectoryService.EventTopic");
export const EventTopicProvider = () => Provider.effect(EventTopic, Effect.gen(function* () {
    const readEventTopic = Effect.fn(function* (directoryId, topicName) {
    ...
    const toAttrs = (directoryId, topicName, topic) => ({
        directoryId,
        topicName,
    ...
    return {
        ...
        reconcile: Effect.fn(function* ({ news, session }) {
            ...
            if (observed === undefined) {
                return yield* Effect.fail(new Error(`event topic '${props.topicName}' on '${props.directoryId}' not visible after register`));
            }
...
//# sourceMappingURL=EventTopic.js.map