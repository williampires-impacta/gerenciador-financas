 ...
 */
export const retryWhileInvalidPrincipal = (self) => Effect.retry(self, {
 ...
 */
export const observePrincipalPermissions = Effect.fn("AWS.LakeFormation.observePrincipalPermissions")(function* (principal, resource, catalogId) {
