...
const toExpressionPairs = (expression) => (expression ?? []).map((e) => ({
    tagKey: e.TagKey,
    tagValues: [...e.TagValues].sort(),
}));
const toWireExpression = (expression) => expression.map((e) => ({ TagKey: e.tagKey, TagValues: e.tagValues }));
 ...
 * @resource
 */
export const LFTagExpression = Resource("AWS.LakeFormation.LFTagExpression");
export const LFTagExpressionProvider = () => Provider.effect(LFTagExpression, Effect.gen(function* () {
