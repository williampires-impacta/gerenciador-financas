...
export const GetParametersHttp = Layer.effect(GetParameters, Effect.gen(function* () {
    const getParameters = yield* SSM.getParameters;
    return Effect.fn(function* (...parameters) {
                ...
                yield* host.bind `Allow(${host}, AWS.SSM.GetParameters(${sorted}))`({
                    policyStatements: [
                        ...
                        },
                        {
                            ...
                            Effect: "Allow",
                            Action: ["kms:Decrypt"],
                            Resource: sorted.map((parameter) => Output.all(parameter.parameterArn, parameter.keyArn).pipe(Output.map(([parameterArn, keyArn]) => keyArn ?? parameterArn))),
                        },
                    ],
                });
            }
        }
        return Effect.fn(`AWS.SSM.GetParameters(${parameters})`)(function* (request = {}) {
...
//# sourceMappingURL=GetParametersHttp.js.map