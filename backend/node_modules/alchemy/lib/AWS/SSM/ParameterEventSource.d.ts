 ...
 * ```
 */
export declare const consumeParameterEvents: <StreamReq = never, Req = never>(props: ParameterEventSourceProps, process: (events: Stream.Stream<ParameterEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ParameterEventSource.d.ts.map