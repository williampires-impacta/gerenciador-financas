 ...
 */
export declare const makeQAppHttpBinding: <I extends {
    instanceId: string;
}, A, E, R>(options: {
    /**
    ...
    injectAppId?: boolean;
}) => Effect.Effect<(app: QApp) => Effect.Effect<(request?: Omit<I, "appId" | "instanceId"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeQAppsInstanceHttpBinding: <I extends {
    instanceId: string;
}, A, E, R>(options: {
    /**
     * Short capability name used in the binding sid and runtime span, e.g.
    ...
    operation: Effect.Effect<(input: I) => Effect.Effect<A, E>, never, R>;
}) => Effect.Effect<(app: QApp) => Effect.Effect<(request?: Omit<I, "instanceId"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
