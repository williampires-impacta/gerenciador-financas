 ...
 * @binding
 */
export interface Select extends Binding.Service<Select, "AWS.SimpleDB.Select", (domain: Domain) => Effect.Effect<(request: SelectRequest) => Effect.Effect<sdb.SelectResponse, sdb.SelectError, RuntimeContext>>> {
}
