...
import { registerSimpleDbBinding } from "./Binding.js";
import { Select } from "./Select.js";
export const SelectHttp = Layer.effect(Select, Effect.gen(function* () {
    ...
    return Effect.fn(function* (domain) {
        ...
        return Effect.fn(`AWS.SimpleDB.Select(${domain.LogicalId})`)(function* (request) {
            const { SelectExpression, ...rest } = request;
            const name = yield* domainName;
            return yield* select({
                ...rest,
                SelectExpression: typeof SelectExpression === "function"
...
//# sourceMappingURL=SelectHttp.js.map