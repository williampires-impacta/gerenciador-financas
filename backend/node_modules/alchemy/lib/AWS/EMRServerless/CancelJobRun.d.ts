 ...
 * @binding
 */
export interface CancelJobRun extends Binding.Service<CancelJobRun, "AWS.EMRServerless.CancelJobRun", (application: Application) => Effect.Effect<(request: CancelJobRunInput) => Effect.Effect<emr.CancelJobRunResponse, emr.CancelJobRunError>>> {
}
