 ...
 * ```
 */
export declare const consumeJobRunEvents: <StreamReq = never, Req = never>(props: JobRunEventSourceProps, process: (events: Stream.Stream<JobRunEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=JobRunEventSource.d.ts.map