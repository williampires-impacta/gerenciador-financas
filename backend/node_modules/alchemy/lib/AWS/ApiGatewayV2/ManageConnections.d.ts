...
export interface ManageConnectionsClient {
     ...
     */
    readonly postToConnection: (request: PostToConnectionRequest) => Effect.Effect<mgmt.PostToConnectionResponse, mgmt.PostToConnectionError>;
    /**
     * Get metadata (connect time, last active time, source identity) about a
     * connection.
     */
    readonly getConnection: (request: GetConnectionRequest) => Effect.Effect<mgmt.GetConnectionResponse, mgmt.GetConnectionError>;
    /**
     * Forcibly disconnect a WebSocket client.
     */
    readonly deleteConnection: (request: DeleteConnectionRequest) => Effect.Effect<mgmt.DeleteConnectionResponse, mgmt.DeleteConnectionError>;
}
/**
 ...
 * @binding
 */
export interface ManageConnections extends Binding.Service<ManageConnections, "AWS.ApiGatewayV2.ManageConnections", <S extends ApiGatewayV2Stage>(stage: S) => Effect.Effect<ManageConnectionsClient>> {
}
export declare const ManageConnections: ManageConnections;
//# sourceMappingURL=ManageConnections.d.ts.map