...
export type WebSocketEventSourceService = <Req = never>(api: Api, props: WebSocketRouteProps, handler: (event: WebSocketEvent) => Effect.Effect<WebSocketResult, never, Req>) => Effect.Effect<void, never, never>;
declare const WebSocketEventSource_base: Context.ServiceClass<WebSocketEventSource, "AWS.ApiGatewayV2.WebSocketEventSource", WebSocketEventSourceService>;
/**
 ...
 * @binding
 */
export declare class WebSocketEventSource extends WebSocketEventSource_base {
}
/**
 ...
 * ```
 */
export declare function onWebSocketRoute<Req = never>(api: Api, props: WebSocketRouteProps, handler: (event: WebSocketEvent) => Effect.Effect<WebSocketResult, never, Req>): Effect.Effect<void, never, WebSocketEventSource>;
export {};
