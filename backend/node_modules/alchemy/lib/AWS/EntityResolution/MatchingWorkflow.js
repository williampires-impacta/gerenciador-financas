...
import { readEntityResolutionTags, retryRolePropagation, syncEntityResolutionTags, } from "./internal.js";
/**
 ...
 * @resource
 */
export const MatchingWorkflow = Resource("AWS.EntityResolution.MatchingWorkflow");
export const MatchingWorkflowProvider = () => Provider.effect(MatchingWorkflow, Effect.gen(function* () {
    ...
    return {
        ...
        list: () => entityresolution.listMatchingWorkflows.items({}).pipe(Stream.map((summary) => ({
            workflowName: summary.workflowName,
            workflowArn: summary.workflowArn,
        })), Stream.runCollect, Effect.map((chunk) => Array.from(chunk))),
    };
}));
//# sourceMappingURL=MatchingWorkflow.js.map