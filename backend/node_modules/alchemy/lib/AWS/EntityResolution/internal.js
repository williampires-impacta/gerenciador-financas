 ...
 */
export const readEntityResolutionTags = Effect.fn(function* (arn) {
 ...
 */
export const syncEntityResolutionTags = Effect.fn(function* (arn, desiredTags) {
 ...
 */
export const retryRolePropagation = (self) => Effect.retry(self, {
    while: (e) => e instanceof entityresolution.AccessDeniedException &&
