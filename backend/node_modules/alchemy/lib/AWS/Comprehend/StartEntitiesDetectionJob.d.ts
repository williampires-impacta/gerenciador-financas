 ...
 */
export interface StartEntitiesDetectionJobRequest extends Omit<comprehend.StartEntitiesDetectionJobRequest, "DataAccessRoleArn"> {
    /**
 ...
 * @binding
 */
export interface StartEntitiesDetectionJob extends Binding.Service<StartEntitiesDetectionJob, "AWS.Comprehend.StartEntitiesDetectionJob", <R extends Role>(dataAccessRole: R) => Effect.Effect<(request: StartEntitiesDetectionJobRequest) => Effect.Effect<comprehend.StartEntitiesDetectionJobResponse, comprehend.StartEntitiesDetectionJobError>>> {
}
export declare const StartEntitiesDetectionJob: StartEntitiesDetectionJob;
//# sourceMappingURL=StartEntitiesDetectionJob.d.ts.map