 ...
 */
export interface StartPiiEntitiesDetectionJobRequest extends Omit<comprehend.StartPiiEntitiesDetectionJobRequest, "DataAccessRoleArn"> {
    /**
 ...
 * @binding
 */
export interface StartPiiEntitiesDetectionJob extends Binding.Service<StartPiiEntitiesDetectionJob, "AWS.Comprehend.StartPiiEntitiesDetectionJob", <R extends Role>(dataAccessRole: R) => Effect.Effect<(request: StartPiiEntitiesDetectionJobRequest) => Effect.Effect<comprehend.StartPiiEntitiesDetectionJobResponse, comprehend.StartPiiEntitiesDetectionJobError>>> {
}
export declare const StartPiiEntitiesDetectionJob: StartPiiEntitiesDetectionJob;
//# sourceMappingURL=StartPiiEntitiesDetectionJob.d.ts.map