 ...
 * @binding
 */
export interface ListClusters extends Binding.Service<ListClusters, "AWS.EMR.ListClusters", () => Effect.Effect<(request?: SVC.ListClustersInput) => Effect.Effect<SVC.ListClustersOutput, SVC.ListClustersError>>> {
}
