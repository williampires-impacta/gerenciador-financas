 ...
 */
export declare const makeEmrClusterHttpBinding: <I, A, E, R>(options: {
...
}) => Effect.Effect<<C extends Cluster>(cluster: C) => Effect.Effect<(request?: Omit<I, "ClusterId" | "JobFlowId" | "TargetResourceArn"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeEmrAccountHttpBinding: <I, A, E, R>(options: {
