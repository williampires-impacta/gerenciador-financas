 ...
 * @binding
 */
export interface GetAccessPoint extends Binding.Service<GetAccessPoint, "AWS.S3Control.GetAccessPoint", (accessPoint: AccessPoint) => Effect.Effect<() => Effect.Effect<s3control.GetAccessPointResult, s3control.GetAccessPointError>>> {
}
export declare const GetAccessPoint: GetAccessPoint;
