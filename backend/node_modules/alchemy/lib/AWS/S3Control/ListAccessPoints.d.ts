 ...
 * @binding
 */
export interface ListAccessPoints extends Binding.Service<ListAccessPoints, "AWS.S3Control.ListAccessPoints", () => Effect.Effect<(request?: Omit<s3control.ListAccessPointsRequest, "AccountId">) => Effect.Effect<s3control.ListAccessPointsResult, s3control.ListAccessPointsError | sts.GetCallerIdentityError>>> {
}
export declare const ListAccessPoints: ListAccessPoints;
//# sourceMappingURL=ListAccessPoints.d.ts.map