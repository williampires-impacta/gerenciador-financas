...
import { ListAccessPoints } from "./ListAccessPoints.js";
export const ListAccessPointsHttp = Layer.effect(ListAccessPoints, makeS3ControlAccountHttpBinding({
    tag: "AWS.S3Control.ListAccessPoints",
    operation: s3control.listAccessPoints,
    actions: ["s3:ListAccessPoints"],
}));
//# sourceMappingURL=ListAccessPointsHttp.js.map