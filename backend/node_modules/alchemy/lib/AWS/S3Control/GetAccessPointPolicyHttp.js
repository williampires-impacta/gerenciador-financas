...
import { GetAccessPointPolicy } from "./GetAccessPointPolicy.js";
export const GetAccessPointPolicyHttp = Layer.effect(GetAccessPointPolicy, makeS3ControlAccessPointHttpBinding({
    tag: "AWS.S3Control.GetAccessPointPolicy",
    operation: s3control.getAccessPointPolicy,
    actions: ["s3:GetAccessPointPolicy"],
}));
//# sourceMappingURL=GetAccessPointPolicyHttp.js.map