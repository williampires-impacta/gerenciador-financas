 ...
 * @resource
 */
export const LicenseConfiguration = Resource("AWS.LicenseManager.LicenseConfiguration");
/**
 ...
 */
const isLive = (status) => status !== "DELETED";
export const LicenseConfigurationProvider = () => Provider.effect(LicenseConfiguration, Effect.gen(function* () {
    ...
    const getByArn = Effect.fn(function* (arn) {
        ...
        if (found === undefined || !isLive(found.Status))
            return undefined;
        return found;
    });
    ...
    return LicenseConfiguration.Provider.of({
        ...
        reconcile: Effect.fn(function* ({ id, news, output, session }) {
            ...
            if (news.licenseCount !== undefined &&
            ...
            if (news.licenseRules !== undefined &&
