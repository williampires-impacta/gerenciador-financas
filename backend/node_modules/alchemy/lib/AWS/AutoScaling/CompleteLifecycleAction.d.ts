 ...
 */
export interface CompleteLifecycleActionRequest extends Omit<autoscaling.CompleteLifecycleActionType, "AutoScalingGroupName"> {
}
/**
 * Extend the heartbeat timeout on a paused lifecycle action. The Auto Scaling
 * group name is injected by the binding.
 */
export interface RecordLifecycleActionHeartbeatRequest extends Omit<autoscaling.RecordLifecycleActionHeartbeatType, "AutoScalingGroupName"> {
}
export interface CompleteLifecycleActionClient {
     ...
     */
    complete: (request: CompleteLifecycleActionRequest) => Effect.Effect<autoscaling.CompleteLifecycleActionAnswer, autoscaling.CompleteLifecycleActionError>;
    /**
     * Extend the wait state by resetting the heartbeat timeout, buying more time
     * before the hook's `defaultResult` is applied.
     */
    heartbeat: (request: RecordLifecycleActionHeartbeatRequest) => Effect.Effect<autoscaling.RecordLifecycleActionHeartbeatAnswer, autoscaling.RecordLifecycleActionHeartbeatError>;
}
/**
 ...
 * @binding
 */
export interface CompleteLifecycleAction extends Binding.Service<CompleteLifecycleAction, "AWS.AutoScaling.CompleteLifecycleAction", (group: AutoScalingGroup) => Effect.Effect<CompleteLifecycleActionClient>> {
}
export declare const CompleteLifecycleAction: CompleteLifecycleAction;
//# sourceMappingURL=CompleteLifecycleAction.d.ts.map