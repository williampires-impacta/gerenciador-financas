 ...
 */
export declare const makeGroupHttpBinding: <I extends object, A, E, R>(options: {
     ...
     */
    resource?: "group" | "*";
}) => Effect.Effect<(group: AutoScalingGroup) => Effect.Effect<(request?: Omit<I, "AutoScalingGroupName"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
