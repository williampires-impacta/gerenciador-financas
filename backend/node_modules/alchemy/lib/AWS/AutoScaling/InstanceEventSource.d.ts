 ...
 */
export type InstanceEventType = "EC2 Instance Launch Successful" | "EC2 Instance Launch Unsuccessful" | "EC2 Instance Terminate Successful" | "EC2 Instance Terminate Unsuccessful";
/**
 ...
 * ```
 */
export declare const consumeInstanceEvents: <StreamReq = never, Req = never>(group: AutoScalingGroup, props: InstanceEventSourceProps, process: (events: Stream.Stream<InstanceEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=InstanceEventSource.d.ts.map