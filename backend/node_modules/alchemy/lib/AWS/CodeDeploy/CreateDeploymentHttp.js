 ...
 * application.
 */
export const CreateDeploymentHttp = Layer.effect(CreateDeployment, Effect.gen(function* () {
    ...
    return Effect.fn(function* (group) {
                ...
                yield* host.bind `Allow(${host}, AWS.CodeDeploy.CreateDeployment(${group}))`({
                    policyStatements: [
                        ...
                        },
                        {
                            ...
                            Resource: [
                                Output.map(group.deploymentGroupArn, (arn) => arn.replace(/:deploymentgroup:.*$/, ":deploymentconfig:*")),
                            ],
                        },
                        {
                            Effect: "Allow",
                            ...
                            Resource: [
                                Output.map(group.deploymentGroupArn, (arn) => arn.replace(/:deploymentgroup:([^/]+)\/.*$/, ":application:$1")),
                            ],
                        },
                    ],
                });
        ...
        return Effect.fn(`AWS.CodeDeploy.CreateDeployment(${group.LogicalId})`)(function* (request) {
            return yield* op({
                ...request,
