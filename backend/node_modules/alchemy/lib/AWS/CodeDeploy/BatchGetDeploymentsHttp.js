...
import { BatchGetDeployments } from "./BatchGetDeployments.js";
 ...
 */
export const BatchGetDeploymentsHttp = Layer.effect(BatchGetDeployments, Effect.gen(function* () {
    ...
    return Effect.fn(function* (group) {
        ...
        return Effect.fn(`AWS.CodeDeploy.BatchGetDeployments(${group.LogicalId})`)(function* (request) {
            return yield* op(request);
        });
    });
}));
//# sourceMappingURL=BatchGetDeploymentsHttp.js.map