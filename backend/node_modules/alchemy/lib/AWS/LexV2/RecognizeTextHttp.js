...
import { RecognizeText } from "./RecognizeText.js";
/**
 ...
 */
export const RecognizeTextHttp = Layer.effect(RecognizeText, makeLexAliasHttpBinding({
    capability: "RecognizeText",
    iamActions: ["lex:RecognizeText"],
    operation: lexr.recognizeText,
}));
//# sourceMappingURL=RecognizeTextHttp.js.map