 ...
 */
export type CodeHookHandler<Req = never> = (event: CodeHookEvent) => Effect.Effect<CodeHookResponse, never, Req>;
export type CodeHookEventSourceService = <Req = never>(alias: BotAlias, props: CodeHookProps, handler: CodeHookHandler<Req>) => Effect.Effect<void, never, never>;
/**
 ...
 * @binding
 */
export interface CodeHookEventSource extends Binding.Service<CodeHookEventSource, "AWS.LexV2.CodeHookEventSource", CodeHookEventSourceService> {
}
export declare const CodeHookEventSource: CodeHookEventSource;
/**
 ...
 * ```
 */
export declare function onCodeHook<Req = never>(alias: BotAlias, props: CodeHookProps, handler: CodeHookHandler<Req>): Effect.Effect<void, never, CodeHookEventSource>;
/**
 ...
 * ```
 */
export declare const fulfillIntent: (event: CodeHookEvent, options?: {
    /** Plain-text message to relay to the user. */
    message?: string;
    /** The intent's final state. @default "Fulfilled" */
    state?: "Fulfilled" | "Failed";
}) => CodeHookResponse;
//# sourceMappingURL=CodeHookEventSource.d.ts.map