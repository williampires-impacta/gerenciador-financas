...
import * as Lambda from "../Lambda/Function.js";
import { Permission as LambdaPermission } from "../Lambda/Permission.js";
import { CodeHookEventSource, } from "./CodeHookEventSource.js";
/**
 ...
 */
export const isCodeHookEvent = (event) => typeof event?.messageVersion === "string" &&
 ...
 * @binding
 */
export const LambdaCodeHookEventSource = Layer.effect(CodeHookEventSource, Effect.gen(function* () {
    // this layer can only be used in a Lambda Function
    const host = yield* Lambda.Function;
    return Effect.fn(function* (alias, props, handler) {
...
//# sourceMappingURL=LambdaCodeHookEventSource.js.map