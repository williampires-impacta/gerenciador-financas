 ...
 * @binding
 */
export interface GetSession extends Binding.Service<GetSession, "AWS.LexV2.GetSession", (alias: BotAlias) => Effect.Effect<(request: GetSessionRequest) => Effect.Effect<lexr.GetSessionResponse, lexr.GetSessionError>>> {
}
