 ...
 * ```
 */
const PlanResource = Resource("AWS.SSMContacts.Plan");
export { PlanResource as Plan };
export const PlanProvider = () => Provider.effect(PlanResource, Effect.gen(function* () {
    ...
    return PlanResource.Provider.of({
        ...
        read: Effect.fn(function* ({ olds, output }) {
            ...
            const hasPlan = (contact.Plan.Stages?.length ?? 0) > 0 ||
