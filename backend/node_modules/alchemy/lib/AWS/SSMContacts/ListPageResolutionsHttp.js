...
import { ListPageResolutions } from "./ListPageResolutions.js";
export const ListPageResolutionsHttp = Layer.effect(ListPageResolutions, makeAccountHttpBinding({
    tag: "AWS.SSMContacts.ListPageResolutions",
    operation: ssm.listPageResolutions,
    actions: ["ssm-contacts:ListPageResolutions"],
}));
//# sourceMappingURL=ListPageResolutionsHttp.js.map