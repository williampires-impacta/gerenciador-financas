...
export type MetricSinkError = cloudwatch.PutMetricDataError | BatchRetryExhaustedError<MetricSinkDatum>;
/**
 ...
 * @binding
 */
export interface MetricSink extends Binding.Service<MetricSink, "AWS.CloudWatch.MetricSink", (props: MetricSinkProps) => Effect.Effect<Sink.Sink<void, MetricSinkDatum, readonly MetricSinkDatum[], MetricSinkError>>> {
}
export declare const MetricSink: MetricSink;
