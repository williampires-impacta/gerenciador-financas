 ...
 * @binding
 */
export interface Search extends Binding.Service<Search, "AWS.DataZone.Search", (domain: Domain) => Effect.Effect<(request: SearchRequest) => Effect.Effect<datazone.SearchOutput, datazone.SearchError>>> {
}
