 ...
 * @binding
 */
export interface GetAsset extends Binding.Service<GetAsset, "AWS.DataZone.GetAsset", (domain: Domain) => Effect.Effect<(request: GetAssetRequest) => Effect.Effect<datazone.GetAssetOutput, datazone.GetAssetError>>> {
}
