 ...
 * ```
 */
export declare const consumeDataZoneEvents: <StreamReq = never, Req = never>(props: DataZoneEventSourceProps, process: (events: Stream.Stream<DataZoneEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=DataZoneEventSource.d.ts.map