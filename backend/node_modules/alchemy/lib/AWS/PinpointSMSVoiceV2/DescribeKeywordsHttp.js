...
import { DescribeKeywords } from "./DescribeKeywords.js";
export const DescribeKeywordsHttp = Layer.effect(DescribeKeywords, makeSmsVoicePhoneNumberHttpBinding({
    tag: "AWS.PinpointSMSVoiceV2.DescribeKeywords",
    operation: smsvoice.describeKeywords,
    actions: ["sms-voice:DescribeKeywords"],
}));
//# sourceMappingURL=DescribeKeywordsHttp.js.map