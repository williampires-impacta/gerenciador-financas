 ...
 */
export type ControlTowerLifecycleEventName = "CreateManagedAccount" | "UpdateManagedAccount" | "EnableGuardrail" | "DisableGuardrail" | "SetupLandingZone" | "UpdateLandingZone" | "RegisterOrganizationalUnit" | "DeregisterOrganizationalUnit" | "PrecheckOrganizationalUnit";
/**
 ...
 * ```
 */
export declare const consumeLifecycleEvents: <StreamReq = never, Req = never>(props: LifecycleEventSourceProps, process: (events: Stream.Stream<ControlTowerLifecycleEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=LifecycleEventSource.d.ts.map