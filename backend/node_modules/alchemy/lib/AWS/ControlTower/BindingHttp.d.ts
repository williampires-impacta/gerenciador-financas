 ...
 */
export declare const makeControlTowerHttpBinding: <Res extends ControlTowerBindable, I extends object, K extends keyof I & string, A, E, R, IdReq = never>(options: {
    /**
 ...
 */
export declare const makeControlTowerAccountHttpBinding: <I extends object, A, E, R>(options: {
    /**
     * Short capability name used in the binding sid and runtime span, e.g.
     * `"ListBaselines"`.
     */
