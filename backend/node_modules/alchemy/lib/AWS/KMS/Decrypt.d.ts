 ...
 * @binding
 */
export interface Decrypt extends Binding.Service<Decrypt, "AWS.KMS.Decrypt", (key: Key | AliasName) => Effect.Effect<(request: DecryptRequest) => Effect.Effect<kms.DecryptResponse, kms.DecryptError>>> {
}
