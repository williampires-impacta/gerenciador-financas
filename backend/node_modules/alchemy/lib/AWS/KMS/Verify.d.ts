 ...
 * @binding
 */
export interface Verify extends Binding.Service<Verify, "AWS.KMS.Verify", (key: Key | AliasName) => Effect.Effect<(request: VerifyRequest) => Effect.Effect<kms.VerifyResponse, kms.VerifyError>>> {
}
