 ...
 * @binding
 */
export interface VerifyMac extends Binding.Service<VerifyMac, "AWS.KMS.VerifyMac", (key: Key | AliasName) => Effect.Effect<(request: VerifyMacRequest) => Effect.Effect<kms.VerifyMacResponse, kms.VerifyMacError>>> {
}
