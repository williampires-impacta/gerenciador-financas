 ...
 * @binding
 */
export interface Sign extends Binding.Service<Sign, "AWS.KMS.Sign", (key: Key | AliasName) => Effect.Effect<(request: SignRequest) => Effect.Effect<kms.SignResponse, kms.SignError>>> {
}
