 ...
 * @binding
 */
export interface Encrypt extends Binding.Service<Encrypt, "AWS.KMS.Encrypt", (key: Key | AliasName) => Effect.Effect<(request: EncryptRequest) => Effect.Effect<kms.EncryptResponse, kms.EncryptError>>> {
}
