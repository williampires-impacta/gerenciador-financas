...
export interface LocationEfs extends Resource<"AWS.DataSync.LocationEfs", LocationEfsProps, {
 ...
 * @resource
 */
export declare const LocationEfs: import("../../Resource.ts").ResourceClass<LocationEfs>;
export declare const LocationEfsProvider: () => import("effect/Layer").Layer<Provider.Provider<LocationEfs>, never, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient | import("../../Stack.ts").Stack | import("../../Stage.ts").Stage>;
//# sourceMappingURL=LocationEfs.d.ts.map