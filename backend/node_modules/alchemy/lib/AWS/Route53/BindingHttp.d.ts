 ...
 */
export declare const makeRoute53ZoneHttpBinding: <I, A, E, R>(options: {
     ...
     */
    wildcardIam?: boolean;
}) => Effect.Effect<(zone: HostedZone) => Effect.Effect<(request?: Omit<I, "HostedZoneId" | "Id"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 * check's ARN.
 */
export declare const makeRoute53HealthCheckHttpBinding: <I extends {
    ...
    actions: readonly string[];
}) => Effect.Effect<(healthCheck: HealthCheck) => Effect.Effect<(request?: Omit<I, "HealthCheckId"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 * (default `*`).
 */
export declare const makeRoute53AccountHttpBinding: <I, A, E, R>(options: {
