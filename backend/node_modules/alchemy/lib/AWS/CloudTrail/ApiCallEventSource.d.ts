 ...
 * ```
 */
export declare const consumeApiCallEvents: <StreamReq = never, Req = never>(props: ApiCallEventsProps, process: (events: Stream.Stream<ApiCallEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ApiCallEventSource.d.ts.map