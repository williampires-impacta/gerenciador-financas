 ...
 */
export type WorkflowRunEventState = "Started" | "Queued" | "Running" | "Succeeded" | "Failed" | "Stopped" | "Timeout";
/**
 * Task-instance states MWAA Serverless publishes as
 * `MWAA Serverless Task {State}` detail-types.
 */
export type TaskEventState = "Queued" | "Scheduled" | "Upstream Failed" | "Running" | "Succeeded" | "Failed" | "Up For Retry" | "Timeout";
 ...
 * ```
 */
export declare const consumeWorkflowRunEvents: <StreamReq = never, Req = never>(props: WorkflowRunEventSourceProps, process: (events: Stream.Stream<WorkflowRunEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=WorkflowRunEventSource.d.ts.map