 ...
 * @binding
 */
export interface StartDBCluster extends Binding.Service<StartDBCluster, "AWS.RDS.StartDBCluster", (cluster: DBCluster) => Effect.Effect<() => Effect.Effect<rds.StartDBClusterResult, rds.StartDBClusterError>>> {
}
