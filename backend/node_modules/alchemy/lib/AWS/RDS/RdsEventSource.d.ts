 ...
 */
export type RdsEventKind = "db-instance" | "db-cluster" | "db-snapshot" | "db-cluster-snapshot" | "db-parameter-group" | "db-security-group" | "db-proxy" | "blue-green-deployment";
 ...
 * ```
 */
export declare const consumeRdsEvents: <StreamReq = never, Req = never>(props: RdsEventSourceProps, process: (events: Stream.Stream<RdsEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=RdsEventSource.d.ts.map