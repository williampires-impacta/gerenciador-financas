 ...
 */
export declare const makeRdsAccountHttpBinding: <I, A, E, R>(options: {
 ...
 * creation).
 */
export declare const makeRdsClusterHttpBinding: <I extends {
 ...
 */
export declare const makeRdsInstanceHttpBinding: <I extends {
