 ...
 * @binding
 */
export interface DescribeEvents extends Binding.Service<DescribeEvents, "AWS.RDS.DescribeEvents", () => Effect.Effect<(request?: rds.DescribeEventsMessage) => Effect.Effect<rds.EventsMessage, rds.DescribeEventsError>>> {
}
