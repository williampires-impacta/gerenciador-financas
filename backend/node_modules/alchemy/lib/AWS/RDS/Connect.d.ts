...
export interface ConnectionInfo {
     ...
     */
    refreshPassword?: Effect.Effect<Redacted.Redacted<string>, Credentials.CredentialsError>;
}
 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.RDS.Connect", (resource: ConnectResource, options: ConnectOptions) => Effect.Effect<Effect.Effect<ConnectionInfo, secretsmanager.GetSecretValueError | Credentials.CredentialsError, RuntimeContext>>> {
}
