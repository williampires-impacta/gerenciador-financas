 ...
 * @binding
 */
export interface StopDBCluster extends Binding.Service<StopDBCluster, "AWS.RDS.StopDBCluster", (cluster: DBCluster) => Effect.Effect<() => Effect.Effect<rds.StopDBClusterResult, rds.StopDBClusterError>>> {
}
