...
export interface StartResourceScanRequest extends Omit<aa.StartResourceScanRequest, "analyzerArn"> {
}
/**
 ...
 * @binding
 */
export interface StartResourceScan extends Binding.Service<StartResourceScan, "AWS.AccessAnalyzer.StartResourceScan", (analyzer: Analyzer) => Effect.Effect<(request: StartResourceScanRequest) => Effect.Effect<aa.StartResourceScanResponse, aa.StartResourceScanError>>> {
}
export declare const StartResourceScan: StartResourceScan;
