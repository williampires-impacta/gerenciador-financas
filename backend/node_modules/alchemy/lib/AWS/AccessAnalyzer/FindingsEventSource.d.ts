 ...
 * ```
 */
export declare const consumeFindings: <StreamReq = never, Req = never>(props: FindingsEventSourceProps, process: (events: Stream.Stream<FindingEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=FindingsEventSource.d.ts.map