 ...
 * @binding
 */
export interface DeleteBackup extends Binding.Service<DeleteBackup, "AWS.FSx.DeleteBackup", () => Effect.Effect<(request: fsx.DeleteBackupRequest) => Effect.Effect<fsx.DeleteBackupResponse, fsx.DeleteBackupError>>> {
}
