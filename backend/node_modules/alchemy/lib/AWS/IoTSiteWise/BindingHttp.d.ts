 ...
 */
export declare const makeSiteWiseAssetHttpBinding: <I, A, E, R, Req>(options: {
    /**
...
}) => Effect.Effect<(asset: Asset) => Effect.Effect<(request: Req) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 * `Resource: ["*"]`.
 */
export declare const makeSiteWiseAccountHttpBinding: <I, A, E, R>(options: {
