...
import { GetInstrumentationConfigurationStatus } from "./GetInstrumentationConfigurationStatus.js";
/**
 ...
 */
export const GetInstrumentationConfigurationStatusHttp = Layer.effect(GetInstrumentationConfigurationStatus, Effect.gen(function* () {
    ...
    return Effect.fn(function* (configuration) {
        ...
        return Effect.fn(`${tag}(${configuration.LogicalId})`)(function* (request) {
            return yield* op({
                ...request,
...
//# sourceMappingURL=GetInstrumentationConfigurationStatusHttp.js.map