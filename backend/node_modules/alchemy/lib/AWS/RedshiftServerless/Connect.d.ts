 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.RedshiftServerless.Connect", (workgroup: Workgroup, options?: ConnectOptions) => Effect.Effect<Effect.Effect<WorkgroupConnectionInfo, serverless.GetCredentialsError, RuntimeContext>>> {
}
