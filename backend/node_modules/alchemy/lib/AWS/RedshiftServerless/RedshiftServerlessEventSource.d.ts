 ...
 * ```
 */
export declare const consumeRedshiftServerlessEvents: <StreamReq = never, Req = never>(props: RedshiftServerlessEventSourceProps, process: (events: Stream.Stream<RedshiftServerlessEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=RedshiftServerlessEventSource.d.ts.map