 ...
 */
export declare const makeCloudControlHttpBinding: <I, A, E, R>(options: {
...
}) => Effect.Effect<(bindOptions?: CloudControlBindingOptions | undefined) => Effect.Effect<(request?: I | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
