 ...
 * ```
 */
export declare const consumeTranscriptionJobEvents: <StreamReq = never, Req = never>(props: TranscriptionJobEventSourceProps, process: (events: Stream.Stream<TranscriptionJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
 ...
 * ```
 */
export declare const consumeCallAnalyticsJobEvents: <StreamReq = never, Req = never>(props: CallAnalyticsJobEventSourceProps, process: (events: Stream.Stream<CallAnalyticsJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
 ...
 * ```
 */
export declare const consumeMedicalScribeJobEvents: <StreamReq = never, Req = never>(props: MedicalScribeJobEventSourceProps, process: (events: Stream.Stream<MedicalScribeJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
 ...
 * ```
 */
export declare const consumeVocabularyEvents: <StreamReq = never, Req = never>(props: VocabularyEventSourceProps, process: (events: Stream.Stream<VocabularyEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
 ...
 * ```
 */
export declare const consumeLanguageModelEvents: <StreamReq = never, Req = never>(props: LanguageModelEventSourceProps, process: (events: Stream.Stream<LanguageModelEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=JobEventSource.d.ts.map