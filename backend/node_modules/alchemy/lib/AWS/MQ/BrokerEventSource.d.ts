...
export interface RabbitMQEvent {
    ...
    readonly eventSourceArn: string;
    readonly rmqMessagesByQueue: {
        readonly [queue: string]: MQMessage[];
    };
}
 ...
 */
export declare function consumeBrokerMessages<B extends Broker, Req = never>(broker: B, props: BrokerEventSourceProps, process: MessagesHandler<Req>): Effect.Effect<void, never, BrokerEventSource>;
declare const BrokerEventSource_base: Context.ServiceClass<BrokerEventSource, "AWS.MQ.BrokerEventSource", BrokerEventSourceService>;
/**
 ...
 * @binding
 */
export declare class BrokerEventSource extends BrokerEventSource_base {
}
export type BrokerEventSourceService = <Req = never>(broker: Broker, props: BrokerEventSourceProps, process: (stream: Stream.Stream<MQMessage>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
export {};
