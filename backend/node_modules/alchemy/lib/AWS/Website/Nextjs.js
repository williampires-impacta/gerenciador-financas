...
import { Table } from "../DynamoDB/Table.js";
import { EventSourceMapping } from "../Lambda/EventSourceMapping.js";
import { Function as LambdaFunction, } from "../Lambda/Function.js";
import { Bucket } from "../S3/Bucket.js";
import { Queue } from "../SQS/Queue.js";
 ...
 * @resource
 */
export const Nextjs = Effect.fn("AWS.Website.Nextjs")(function* (id, props = {}) {
    ...
    const fromDist = (relative) => Output.map((dir) => {
        if (!dir) {
    ...
    const bucket = props.assets?.bucket ??
        (yield* Bucket("Bucket", {
        ...
        policyStatements: [
            {
                ...
                Resource: [Output.interpolate `${cacheBucket.bucketArn}/*`],
            },
            {
                Effect: "Allow",
            ...
            },
            {
                ...
                Resource: [revalidationQueue.queueArn],
            },
            {
                Effect: "Allow",
                Action: [
                ...
                Resource: [
                    tagCacheTable.tableArn,
                    Output.interpolate `${tagCacheTable.tableArn}/index/*`,
                ],
            },
        ],
    });
    ...
    const serverHost = Output.map(urlHost)(server.functionUrl);
    const imageHost = Output.map(urlHost)(imageFunction.functionUrl);
    const siteProps = {
