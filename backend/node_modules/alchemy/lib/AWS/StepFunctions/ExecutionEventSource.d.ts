 ...
 * ```
 */
export declare const consumeExecutionEvents: <StreamReq = never, Req = never>(props: ExecutionEventSourceProps, process: (events: Stream.Stream<ExecutionEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ExecutionEventSource.d.ts.map