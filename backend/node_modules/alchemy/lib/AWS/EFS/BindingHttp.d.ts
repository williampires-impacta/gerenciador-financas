 ...
 */
export declare const makeEfsFileSystemHttpBinding: <I extends {
    FileSystemId?: string;
}, A, E, R>(options: {
...
}) => Effect.Effect<(fileSystem: FileSystem) => Effect.Effect<(request?: Omit<I, "FileSystemId"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeEfsAccountHttpBinding: <I, A, E, R>(options: {
