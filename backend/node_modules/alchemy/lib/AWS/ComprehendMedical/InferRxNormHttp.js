...
import { InferRxNorm } from "./InferRxNorm.js";
export const InferRxNormHttp = Layer.effect(InferRxNorm, makeComprehendMedicalHttpBinding({
    capability: "InferRxNorm",
    iamActions: ["comprehendmedical:InferRxNorm"],
    operation: comprehendmedical.inferRxNorm,
}));
//# sourceMappingURL=InferRxNormHttp.js.map