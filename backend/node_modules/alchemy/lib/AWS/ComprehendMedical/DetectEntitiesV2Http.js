...
import { DetectEntitiesV2 } from "./DetectEntitiesV2.js";
export const DetectEntitiesV2Http = Layer.effect(DetectEntitiesV2, makeComprehendMedicalHttpBinding({
    capability: "DetectEntitiesV2",
    iamActions: ["comprehendmedical:DetectEntitiesV2"],
    operation: comprehendmedical.detectEntitiesV2,
}));
//# sourceMappingURL=DetectEntitiesV2Http.js.map