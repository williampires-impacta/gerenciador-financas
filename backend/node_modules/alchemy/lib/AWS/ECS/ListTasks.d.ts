 ...
 * @binding
 */
export interface ListTasks extends Binding.Service<ListTasks, "AWS.ECS.ListTasks", (cluster: Cluster) => Effect.Effect<(request: ListTasksRequest) => Effect.Effect<ECS.ListTasksResponse, ECS.ListTasksError>>> {
}
