 ...
 * @binding
 */
export declare const every: (id: string, schedule: string, props: ScheduleProps) => import("effect/Effect").Effect<Scheduler.Schedule, never, import("../Providers.ts").Providers>;
