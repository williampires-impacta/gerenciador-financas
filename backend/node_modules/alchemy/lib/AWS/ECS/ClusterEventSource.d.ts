...
export type ClusterEventKind = "task-state-change" | "container-instance-state-change" | "deployment-state-change" | "service-action";
 ...
 * ```
 */
export declare const consumeClusterEvents: <StreamReq = never, Req = never>(props: ClusterEventSourceProps, process: (events: Stream.Stream<ClusterEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
