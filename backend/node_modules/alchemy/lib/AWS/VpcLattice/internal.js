 ...
 */
export const retryOnConflict = (effect) => Effect.retry(effect, {
 ...
 */
export const waitUntilStable = (observe) => Effect.repeat(observe, {
 ...
 */
export const waitUntilAbsent = (observe) => Effect.repeat(observe, {
