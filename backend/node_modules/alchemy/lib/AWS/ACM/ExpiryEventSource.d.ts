 ...
 * ```
 */
export declare const consumeExpiryEvents: <StreamReq = never, Req = never>(props: ExpiryEventSourceProps, process: (events: Stream.Stream<ExpiryEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ExpiryEventSource.d.ts.map