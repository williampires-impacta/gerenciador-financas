 ...
 */
export const makeExportHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
    return Effect.fn(function* (dataExport) {
        ...
        return Effect.fn(`AWS.BCMDataExports.${options.capability}(${dataExport.LogicalId})`)(function* (request) {
            return yield* op({ ...request, ExportArn: yield* ExportArn });
        });
    });
});
/**
 ...
 * not resource-scoped.
 */
export const makeDataExportsAccountHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
    return Effect.fn(function* () {
        ...
        return Effect.fn(`AWS.BCMDataExports.${options.capability}`)(function* (request) {
