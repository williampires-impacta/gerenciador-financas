 ...
 * @binding
 */
export interface ListExports extends Binding.Service<ListExports, "AWS.BCMDataExports.ListExports", () => Effect.Effect<(request?: ListExportsRequest) => Effect.Effect<bcm.ListExportsResponse, bcm.ListExportsError>>> {
}
