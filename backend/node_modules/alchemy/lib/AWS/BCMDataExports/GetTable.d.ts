 ...
 * @binding
 */
export interface GetTable extends Binding.Service<GetTable, "AWS.BCMDataExports.GetTable", () => Effect.Effect<(request: GetTableRequest) => Effect.Effect<bcm.GetTableResponse, bcm.GetTableError>>> {
}
