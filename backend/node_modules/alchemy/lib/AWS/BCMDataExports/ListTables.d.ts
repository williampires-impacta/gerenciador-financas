 ...
 * @binding
 */
export interface ListTables extends Binding.Service<ListTables, "AWS.BCMDataExports.ListTables", () => Effect.Effect<(request?: ListTablesRequest) => Effect.Effect<bcm.ListTablesResponse, bcm.ListTablesError>>> {
}
