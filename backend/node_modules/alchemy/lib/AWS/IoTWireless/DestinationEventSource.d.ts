 ...
 * bound destination.
 */
export type WirelessUplinkHandlerFn<Req = never> = (stream: Stream.Stream<WirelessUplinkMessage>) => Effect.Effect<void, never, Req>;
export type DestinationEventSourceService = <Req = never>(destination: Destination, process: WirelessUplinkHandlerFn<Req>) => Effect.Effect<void, never, never>;
/**
 ...
 * @binding
 */
export interface DestinationEventSource extends Binding.Service<DestinationEventSource, "AWS.IoTWireless.DestinationEventSource", DestinationEventSourceService> {
}
export declare const DestinationEventSource: DestinationEventSource;
/**
 ...
 * ```
 */
export declare function consumeUplinks<Req = never>(destination: Destination, process: WirelessUplinkHandlerFn<Req>): Effect.Effect<void, never, DestinationEventSource>;
//# sourceMappingURL=DestinationEventSource.d.ts.map