 ...
 */
export type ResourceShareEventName = "Resource Share Association" | "Resource Share Invitation" | (string & {});
/**
 ...
 * ```
 */
export declare const consumeResourceShareEvents: <StreamReq = never, Req = never>(props: ResourceShareEventSourceProps, process: (events: Stream.Stream<ResourceShareEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ResourceShareEventSource.d.ts.map