...
import { ListEventBuses } from "./ListEventBuses.js";
/**
 ...
 * binding.
 */
export const ListEventBusesHttp = Layer.effect(ListEventBuses, makeEventBridgeAccountHttpBinding({
    tag: "AWS.EventBridge.ListEventBuses",
    operation: eventbridge.listEventBuses,
    actions: ["events:ListEventBuses"],
}));
//# sourceMappingURL=ListEventBusesHttp.js.map