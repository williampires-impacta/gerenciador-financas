...
import { EnableRule } from "./EnableRule.js";
/**
 ...
 */
export const EnableRuleHttp = Layer.effect(EnableRule, makeEventBridgeRuleHttpBinding({
    tag: "AWS.EventBridge.EnableRule",
    operation: eventbridge.enableRule,
    actions: ["events:EnableRule"],
    ruleNameKey: "Name",
}));
//# sourceMappingURL=EnableRuleHttp.js.map