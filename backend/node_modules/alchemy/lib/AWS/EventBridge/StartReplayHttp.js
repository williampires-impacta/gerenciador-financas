 ...
 * using the binding.
 */
export const StartReplayHttp = Layer.effect(StartReplay, Effect.gen(function* () {
    ...
    return Effect.fn(function* (archive) {
        ...
        return Effect.fn(`AWS.EventBridge.StartReplay(${archive.LogicalId})`)(function* (request) {
...
//# sourceMappingURL=StartReplayHttp.js.map