...
import { DisableRule } from "./DisableRule.js";
/**
 ...
 */
export const DisableRuleHttp = Layer.effect(DisableRule, makeEventBridgeRuleHttpBinding({
    tag: "AWS.EventBridge.DisableRule",
    operation: eventbridge.disableRule,
    actions: ["events:DisableRule"],
    ruleNameKey: "Name",
}));
//# sourceMappingURL=DisableRuleHttp.js.map