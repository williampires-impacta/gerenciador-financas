 ...
 * @binding
 */
export interface PutEvents extends Binding.Service<PutEvents, "AWS.EventBridge.PutEvents", (bus?: EventBus) => Effect.Effect<(request: PutEventsRequest) => Effect.Effect<eventbridge.PutEventsResponse, eventbridge.PutEventsError>>> {
}
