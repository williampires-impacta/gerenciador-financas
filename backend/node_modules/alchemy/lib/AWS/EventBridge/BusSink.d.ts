 ...
 * @binding
 */
export interface BusSink extends Binding.Service<BusSink, "AWS.EventBridge.BusSink", (bus?: EventBus) => Effect.Effect<Sink.Sink<void, BusSinkEntry, readonly BusSinkEntry[], BusSinkError>>> {
}
export declare const BusSink: BusSink;
//# sourceMappingURL=BusSink.d.ts.map