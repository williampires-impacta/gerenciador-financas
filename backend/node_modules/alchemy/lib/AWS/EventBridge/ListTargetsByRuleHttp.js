...
import { makeEventBridgeRuleHttpBinding } from "./BindingHttp.js";
import { ListTargetsByRule } from "./ListTargetsByRule.js";
/**
 ...
 */
export const ListTargetsByRuleHttp = Layer.effect(ListTargetsByRule, makeEventBridgeRuleHttpBinding({
    tag: "AWS.EventBridge.ListTargetsByRule",
    operation: eventbridge.listTargetsByRule,
    actions: ["events:ListTargetsByRule"],
    ruleNameKey: "Rule",
}));
//# sourceMappingURL=ListTargetsByRuleHttp.js.map