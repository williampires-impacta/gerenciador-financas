...
import { makeEventBridgeBusHttpBinding } from "./BindingHttp.js";
import { DescribeEventBus } from "./DescribeEventBus.js";
/**
 ...
 */
export const DescribeEventBusHttp = Layer.effect(DescribeEventBus, makeEventBridgeBusHttpBinding({
    tag: "AWS.EventBridge.DescribeEventBus",
    operation: eventbridge.describeEventBus,
    actions: ["events:DescribeEventBus"],
    busNameKey: "Name",
}));
//# sourceMappingURL=DescribeEventBusHttp.js.map