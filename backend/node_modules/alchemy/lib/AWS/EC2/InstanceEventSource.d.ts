 ...
 */
export type InstanceState = "pending" | "running" | "shutting-down" | "stopping" | "stopped" | "terminated";
/**
 ...
 * ```
 */
export declare const consumeInstanceStateEvents: <StreamReq = never, Req = never>(instance: Instance, props: InstanceStateEventSourceProps, process: (events: Stream.Stream<InstanceStateChangeEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
