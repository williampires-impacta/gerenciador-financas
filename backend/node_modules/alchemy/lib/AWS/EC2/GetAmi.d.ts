 ...
 * @binding
 */
export interface GetAmi extends Binding.Service<GetAmi, "AWS.EC2.GetAmi", (options: FindImageOptions) => Effect.Effect<() => Effect.Effect<ec2.Image | undefined, ec2.DescribeImagesError>>> {
}
export declare const GetAmi: GetAmi;
/**
 ...
 */
export declare const getAmi: <Req = never>(args_0: Effect.Effect<FindImageOptions, never, Req> | import("../../Input.ts").Input<FindImageOptions>) => import("../../Output.ts").ObjectExpr<{
    PlatformDetails?: string;
    UsageOperation?: string;
    BlockDeviceMappings?: ec2.BlockDeviceMapping[];
    Description?: string;
    EnaSupport?: boolean;
    Hypervisor?: ec2.HypervisorType;
    ImageOwnerAlias?: string;
    Name?: string;
    RootDeviceName?: string;
    RootDeviceType?: ec2.DeviceType;
    SriovNetSupport?: string;
    StateReason?: ec2.StateReason;
    Tags?: ec2.Tag[];
    VirtualizationType?: ec2.VirtualizationType;
    BootMode?: ec2.BootModeValues;
    TpmSupport?: ec2.TpmSupportValues;
    DeprecationTime?: string;
    ImdsSupport?: ec2.ImdsSupportValues;
    ...
    ImageWatermarks?: ec2.ImageWatermark[];
    ImageId?: string;
    ...
    Architecture?: ec2.ArchitectureValues;
    ImageType?: ec2.ImageTypeValues;
    KernelId?: string;
    RamdiskId?: string;
    Platform?: ec2.PlatformValues;
} | undefined, Req | GetAmi>;
