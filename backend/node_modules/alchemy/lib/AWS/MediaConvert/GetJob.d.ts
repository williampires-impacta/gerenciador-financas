 ...
 * @binding
 */
export interface GetJob extends Binding.Service<GetJob, "AWS.MediaConvert.GetJob", () => Effect.Effect<(request: mediaconvert.GetJobRequest) => Effect.Effect<mediaconvert.GetJobResponse, mediaconvert.GetJobError>>> {
}
