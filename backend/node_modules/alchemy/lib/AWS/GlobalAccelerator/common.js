...
export const GA_REGION = "us-west-2";
// NOTE: the Region service's value is an Effect<RegionName>, not a string.
export const withGaRegion = (effect) => effect.pipe(Effect.provideService(AwsRegion, Effect.succeed(GA_REGION)));
/**
 ...
 */
export const retryGaTransaction = (self) => Effect.retry(self, {
    while: (e) => e._tag === "TransactionInProgressException" ||
 ...
 */
export const retryGaDeletion = (self) => Effect.retry(self, {
    while: (e) => e._tag === "TransactionInProgressException" ||
        e._tag === "ConflictException" ||
 ...
 */
export const retryUntilAcceleratorDeletable = (self) => Effect.retry(self, {
    while: (e) => e._tag === "AcceleratorNotDisabledException" ||
 ...
 */
export const retryUntilListenerDeletable = (self) => Effect.retry(self, {
