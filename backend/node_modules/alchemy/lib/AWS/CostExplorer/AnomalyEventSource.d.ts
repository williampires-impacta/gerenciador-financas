 ...
 * ```
 */
export declare const consumeAnomalyEvents: <StreamReq = never, Req = never>(props: AnomalyEventSourceProps, process: (events: Stream.Stream<AnomalyEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=AnomalyEventSource.d.ts.map