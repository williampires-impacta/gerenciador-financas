 ...
 */
export const makeCostExplorerHttpBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn(`AWS.CostExplorer.${options.capability}`)(function* (request) {
 ...
 */
export const makeAnomalyMonitorHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* pinCe(options.operation);
    return Effect.fn(function* (monitor) {
        ...
        return Effect.fn(`AWS.CostExplorer.${options.capability}(${monitor.LogicalId})`)(function* (request) {
            // Call-site region pin — see makeCostExplorerHttpBinding above.
            return yield* pinCe(op({
                ...request,
 ...
 */
export const makeCostCategoryHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* pinCe(options.operation);
    return Effect.fn(function* (category) {
        ...
        return Effect.fn(`AWS.CostExplorer.${options.capability}(${category.LogicalId})`)(function* (request) {
            // Call-site region pin — see makeCostExplorerHttpBinding above.
            return yield* pinCe(op({
                ...request,
