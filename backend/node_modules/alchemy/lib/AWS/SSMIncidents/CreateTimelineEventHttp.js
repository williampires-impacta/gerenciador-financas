...
import { CreateTimelineEvent } from "./CreateTimelineEvent.js";
export const CreateTimelineEventHttp = Layer.effect(CreateTimelineEvent, makeIncidentsAccountHttpBinding({
    tag: "AWS.SSMIncidents.CreateTimelineEvent",
    operation: incidents.createTimelineEvent,
    actions: ["ssm-incidents:CreateTimelineEvent"],
}));
//# sourceMappingURL=CreateTimelineEventHttp.js.map