 ...
 */
export declare const makeIncidentsResponsePlanHttpBinding: <I extends {
...
}) => Effect.Effect<(plan: ResponsePlan) => Effect.Effect<(request?: Omit<I, "responsePlanArn"> | undefined) => Effect.Effect<A, E, never>, never, never>, never, R>;
/**
 ...
 */
export declare const makeIncidentsAccountHttpBinding: <I, A, E, R>(options: {
