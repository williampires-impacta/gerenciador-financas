 ...
 * ```
 */
export declare const consumeHarvestJobEvents: <StreamReq = never, Req = never>(props: HarvestJobEventSourceProps, process: (events: Stream.Stream<MediaPackageV2HarvestJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=HarvestJobEventSource.d.ts.map