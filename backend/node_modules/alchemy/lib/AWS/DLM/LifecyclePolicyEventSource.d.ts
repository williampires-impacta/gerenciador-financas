 ...
 * ```
 */
export declare const consumePolicyEvents: <StreamReq = never, Req = never>(props: LifecyclePolicyEventSourceProps, process: (events: Stream.Stream<LifecyclePolicyEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=LifecyclePolicyEventSource.d.ts.map