 ...
 * every request.
 */
export const makeDlmPolicyHttpBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* (policy) {
        ...
        return Effect.fn(`${options.tag}(${policy.LogicalId})`)(function* (request) {
            ...
            return yield* op({ ...request, PolicyId: policyId });
        });
    });
});
/**
 ...
 */
export const makeDlmAccountHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
