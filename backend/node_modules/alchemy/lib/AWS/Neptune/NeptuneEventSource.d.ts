 ...
 */
export type NeptuneEventKind = "db-cluster" | "db-instance" | "db-cluster-snapshot" | "db-parameter-group";
 ...
 * ```
 */
export declare const consumeNeptuneEvents: <StreamReq = never, Req = never>(props: NeptuneEventSourceProps, process: (events: Stream.Stream<NeptuneEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=NeptuneEventSource.d.ts.map