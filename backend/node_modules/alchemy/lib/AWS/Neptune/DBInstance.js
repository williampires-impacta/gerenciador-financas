 ...
 * @resource
 */
export const DBInstance = Resource("AWS.Neptune.DBInstance");
...
export const DBInstanceProvider = () => Provider.effect(DBInstance, Effect.gen(function* () {
    ...
    return {
        ...
        list: () => neptune.describeDBInstances
            .pages({ Filters: [{ Name: "engine", Values: ["neptune"] }] })
            .pipe(Stream.runCollect, Effect.map((chunk) => Array.from(chunk).flatMap((page) => (page.DBInstances ?? [])
