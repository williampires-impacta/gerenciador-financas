 ...
 */
export const makeNeptuneAccountHttpBinding = (options) => Effect.gen(function* () {
 ...
 * creation).
 */
export const makeNeptuneClusterHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
 ...
 * instance ARN.
 */
export const makeNeptuneInstanceHttpBinding = (options) => Effect.gen(function* () {
    const op = yield* options.operation;
