...
import { ListEventPredictions } from "./ListEventPredictions.js";
/**
 ...
 */
export const ListEventPredictionsHttp = Layer.effect(ListEventPredictions, Effect.gen(function* () {
    ...
    return Effect.fn(function* (detector) {
        ...
        return Effect.fn(`AWS.FraudDetector.ListEventPredictions(${detector.LogicalId})`)(function* (request) {
            const detectorId = yield* DetectorId;
            return yield* op({ ...request, detectorId: { value: detectorId } });
        });
    });
}));
//# sourceMappingURL=ListEventPredictionsHttp.js.map