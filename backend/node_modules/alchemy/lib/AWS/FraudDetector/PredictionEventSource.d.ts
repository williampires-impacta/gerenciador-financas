 ...
 * ```
 */
export declare const consumePredictionEvents: <StreamReq = never, Req = never>(props: PredictionEventSourceProps, process: (events: Stream.Stream<PredictionEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=PredictionEventSource.d.ts.map