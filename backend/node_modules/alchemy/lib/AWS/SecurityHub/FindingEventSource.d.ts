 ...
 * ```
 */
export declare const consumeFindings: <StreamReq = never, Req = never>(props: FindingEventSourceProps, process: (events: Stream.Stream<FindingEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
 ...
 * ```
 */
export declare const consumeCustomActions: <StreamReq = never, Req = never>(props: CustomActionEventSourceProps, process: (events: Stream.Stream<CustomActionEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=FindingEventSource.d.ts.map