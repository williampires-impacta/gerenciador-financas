 ...
 * @binding
 */
export interface GetObject extends Binding.Service<GetObject, "AWS.S3.GetObject", (bucket: Bucket) => Effect.Effect<(request: GetObjectRequest) => Effect.Effect<S3.GetObjectOutput, S3.GetObjectError>>> {
}
