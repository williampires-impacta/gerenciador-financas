 ...
 * @binding
 */
export interface ListParts extends Binding.Service<ListParts, "AWS.S3.ListParts", (bucket: Bucket) => Effect.Effect<(request: ListPartsRequest) => Effect.Effect<S3.ListPartsOutput, S3.ListPartsError>>> {
}
