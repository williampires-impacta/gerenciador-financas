 ...
 * @binding
 */
export interface DeleteObjects extends Binding.Service<DeleteObjects, "AWS.S3.DeleteObjects", (bucket: Bucket) => Effect.Effect<(request: DeleteObjectsRequest) => Effect.Effect<S3.DeleteObjectsOutput, S3.DeleteObjectsError>>> {
}
export declare const DeleteObjects: DeleteObjects;
