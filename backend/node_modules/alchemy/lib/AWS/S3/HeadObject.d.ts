 ...
 * @binding
 */
export interface HeadObject extends Binding.Service<HeadObject, "AWS.S3.HeadObject", (bucket: Bucket) => Effect.Effect<(request: HeadObjectRequest) => Effect.Effect<S3.HeadObjectOutput, S3.HeadObjectError>>> {
}
