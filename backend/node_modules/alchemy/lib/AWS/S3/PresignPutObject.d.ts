 ...
 * @binding
 */
export interface PresignPutObject extends Binding.Service<PresignPutObject, "AWS.S3.PresignPutObject", (bucket: Bucket) => Effect.Effect<(request: PresignPutObjectRequest) => Effect.Effect<string, CredentialsError>>> {
}
export declare const PresignPutObject: PresignPutObject;
//# sourceMappingURL=PresignPutObject.d.ts.map