...
export interface AbortMultipartUploadRequest extends Omit<S3.AbortMultipartUploadRequest, "Bucket"> {
}
/**
 ...
 * @binding
 */
export interface AbortMultipartUpload extends Binding.Service<AbortMultipartUpload, "AWS.S3.AbortMultipartUpload", (bucket: Bucket) => Effect.Effect<(request: AbortMultipartUploadRequest) => Effect.Effect<S3.AbortMultipartUploadOutput, S3.AbortMultipartUploadError>>> {
}
