 ...
 * @binding
 */
export interface PresignGetObject extends Binding.Service<PresignGetObject, "AWS.S3.PresignGetObject", (bucket: Bucket) => Effect.Effect<(request: PresignGetObjectRequest) => Effect.Effect<string, CredentialsError>>> {
}
export declare const PresignGetObject: PresignGetObject;
//# sourceMappingURL=PresignGetObject.d.ts.map