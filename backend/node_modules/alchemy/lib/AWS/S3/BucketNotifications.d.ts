 ...
 * @binding
 */
export declare function consumeBucketEvents<B extends Bucket, Req = never, StreamReq = never, const Events extends S3EventType[] = S3EventType[]>(bucket: B, handler: (stream: Stream.Stream<BucketNotification, never, StreamReq>) => Effect.Effect<void, never, Req>): Effect.Effect<void, never, Req>;
export declare function consumeBucketEvents<B extends Bucket, Req = never, StreamReq = never, const Events extends S3EventType[] = S3EventType[]>(bucket: B, props: NotificationsProps<Events>, handler: (stream: Stream.Stream<BucketNotification, never, StreamReq>) => Effect.Effect<void, never, Req>): Effect.Effect<void, never, Req>;
//# sourceMappingURL=BucketNotifications.d.ts.map