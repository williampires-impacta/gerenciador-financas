 ...
 * @binding
 */
export interface DeleteObject extends Binding.Service<DeleteObject, "AWS.S3.DeleteObject", (bucket: Bucket) => Effect.Effect<(request: DeleteObjectRequest) => Effect.Effect<S3.DeleteObjectOutput, S3.DeleteObjectError>>> {
}
