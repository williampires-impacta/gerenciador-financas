 ...
 * @binding
 */
export interface CopyObject extends Binding.Service<CopyObject, "AWS.S3.CopyObject", (bucket: Bucket) => Effect.Effect<(request: CopyObjectRequest) => Effect.Effect<S3.CopyObjectOutput, S3.CopyObjectError>>> {
}
export declare const CopyObject: CopyObject;
