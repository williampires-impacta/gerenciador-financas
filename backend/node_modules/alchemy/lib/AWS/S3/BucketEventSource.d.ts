 ...
 * @binding
 */
export interface BucketEventSource extends Binding.Service<BucketEventSource, "BucketNotificationStream", BucketEventSourceService> {
}
export declare const BucketEventSource: BucketEventSource;
export type BucketEventSourceService = <Events extends S3EventType[], StreamReq = never, Req = never>(bucket: Bucket, props: NotificationsProps<Events>, process: (stream: Stream.Stream<BucketNotification, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
