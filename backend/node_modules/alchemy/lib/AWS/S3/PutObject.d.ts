 ...
 * @binding
 */
export interface PutObject extends Binding.Service<PutObject, "AWS.S3.PutObject", (bucket: Bucket) => Effect.Effect<(request: PutObjectRequest) => Effect.Effect<S3.PutObjectOutput, S3.PutObjectError>>> {
}
