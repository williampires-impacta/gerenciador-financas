...
import { FlociServiceProvider } from "../ECS/FlociServiceProvider.js";
import { FlociTaskProvider } from "../ECS/FlociTaskProvider.js";
import { FlociFunctionProvider } from "../Lambda/FlociFunctionProvider.js";
Layer.mergeAll(FlociFunctionProvider(), FlociTaskProvider(), FlociServiceProvider()).pipe(
// The ECS image pipelines (docker build / mirror / push) run in the
// sidecar and need the Docker CLI service.
Layer.provide(DockerLive), RpcServer.launch);
