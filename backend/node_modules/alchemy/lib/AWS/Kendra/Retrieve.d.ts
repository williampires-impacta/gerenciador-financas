 ...
 * @binding
 */
export interface Retrieve extends Binding.Service<Retrieve, "AWS.Kendra.Retrieve", (index: Index) => Effect.Effect<(request: RetrieveRequest) => Effect.Effect<kendra.RetrieveResult, kendra.RetrieveError>>> {
}
