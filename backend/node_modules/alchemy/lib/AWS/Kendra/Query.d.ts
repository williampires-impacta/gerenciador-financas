 ...
 * @binding
 */
export interface Query extends Binding.Service<Query, "AWS.Kendra.Query", (index: Index) => Effect.Effect<(request?: QueryRequest) => Effect.Effect<kendra.QueryResult, kendra.QueryError>>> {
}
