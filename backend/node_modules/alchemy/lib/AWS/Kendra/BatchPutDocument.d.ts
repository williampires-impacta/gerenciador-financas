 ...
 * @binding
 */
export interface BatchPutDocument extends Binding.Service<BatchPutDocument, "AWS.Kendra.BatchPutDocument", (index: Index) => Effect.Effect<(request: BatchPutDocumentRequest) => Effect.Effect<kendra.BatchPutDocumentResponse, kendra.BatchPutDocumentError>>> {
}
