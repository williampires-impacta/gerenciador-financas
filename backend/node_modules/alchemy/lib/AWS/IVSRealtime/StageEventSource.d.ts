 ...
 * ```
 */
export declare const consumeStageEvents: <StreamReq = never, Req = never>(props: StageEventSourceProps, process: (events: Stream.Stream<StageEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=StageEventSource.d.ts.map