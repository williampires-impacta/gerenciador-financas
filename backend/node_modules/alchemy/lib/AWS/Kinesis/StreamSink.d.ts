 ...
 * @binding
 */
export interface StreamSink extends Binding.Service<StreamSink, "AWS.Kinesis.StreamSink", (stream: Stream) => Effect.Effect<Sink.Sink<void, StreamSinkRecord, readonly StreamSinkRecord[], StreamSinkError>>> {
}
export declare const StreamSink: StreamSink;
//# sourceMappingURL=StreamSink.d.ts.map