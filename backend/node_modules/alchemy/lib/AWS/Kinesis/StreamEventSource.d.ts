 ...
 * @binding
 */
export interface StreamEventSource extends Binding.Service<StreamEventSource, "AWS.Kinesis.StreamEventSource", StreamEventSourceService> {
}
export declare const StreamEventSource: StreamEventSource;
export type StreamEventSourceService = <StreamReq = never, Req = never>(stream: KinesisStream, props: StreamEventSourceProps, process: (stream: Stream.Stream<KinesisEventRecord, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, never>;
/**
 ...
 * ```
 */
export declare const consumeStreamRecords: <S extends KinesisStream, Req = never, StreamReq = never>(stream: S, props: StreamEventSourceProps | undefined, process: (stream: Stream.Stream<KinesisEventRecord, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, StreamEventSource>;
