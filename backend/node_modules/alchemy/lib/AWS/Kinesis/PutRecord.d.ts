 ...
 * @binding
 */
export interface PutRecord extends Binding.Service<PutRecord, "AWS.Kinesis.PutRecord", (stream: Stream) => Effect.Effect<(request: PutRecordRequest) => Effect.Effect<Kinesis.PutRecordOutput, Kinesis.PutRecordError>>> {
}
