 ...
 * ```
 */
export declare const consumeGreengrassEvents: <StreamReq = never, Req = never>(props: GreengrassEventSourceProps, process: (events: Stream.Stream<GreengrassEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=GreengrassEventSource.d.ts.map