...
import { ListAttachedLinks, } from "./ListAttachedLinks.js";
/**
 ...
 * `SinkIdentifier`.
 */
export const ListAttachedLinksHttp = Layer.effect(ListAttachedLinks, Effect.gen(function* () {
    const listAttachedLinks = yield* oam.listAttachedLinks;
    return Effect.fn(function* (sink) {
        ...
        return Effect.fn(`AWS.OAM.ListAttachedLinks(${sink.LogicalId})`)(function* (request) {
...
//# sourceMappingURL=ListAttachedLinksHttp.js.map