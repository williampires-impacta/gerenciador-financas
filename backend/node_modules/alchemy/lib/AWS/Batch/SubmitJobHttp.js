...
import { SubmitJob } from "./SubmitJob.js";
export const SubmitJobHttp = Layer.effect(SubmitJob, Effect.gen(function* () {
    const submitJob = yield* batch.submitJob;
    return Effect.fn(function* (queue, jobDefinition) {
        ...
        return Effect.fn(`AWS.Batch.SubmitJob(${queue.LogicalId}, ${jobDefinition.LogicalId})`)(function* (request) {
...
//# sourceMappingURL=SubmitJobHttp.js.map