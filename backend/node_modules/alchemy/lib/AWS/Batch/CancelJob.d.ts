 ...
 * @binding
 */
export interface CancelJob extends Binding.Service<CancelJob, "AWS.Batch.CancelJob", (queue: JobQueue) => Effect.Effect<(request: CancelJobRequest) => Effect.Effect<batch.CancelJobResponse, batch.CancelJobError>>> {
}
