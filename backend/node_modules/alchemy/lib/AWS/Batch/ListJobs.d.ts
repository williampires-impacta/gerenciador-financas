 ...
 * @binding
 */
export interface ListJobs extends Binding.Service<ListJobs, "AWS.Batch.ListJobs", (queue: JobQueue) => Effect.Effect<(request?: ListJobsRequest) => Effect.Effect<batch.ListJobsResponse, batch.ListJobsError>>> {
}
