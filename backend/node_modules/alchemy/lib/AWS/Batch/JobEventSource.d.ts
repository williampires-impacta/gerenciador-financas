 ...
 * ```
 */
export declare const consumeJobEvents: <StreamReq = never, Req = never>(props: JobEventSourceProps, process: (events: Stream.Stream<BatchJobEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
