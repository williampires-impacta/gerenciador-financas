...
import { DescribeVirtualCluster } from "./DescribeVirtualCluster.js";
/**
 ...
 * pattern).
 */
export const DescribeVirtualClusterHttp = Layer.effect(DescribeVirtualCluster, Effect.gen(function* () {
    ...
    return Effect.fn(function* (virtualCluster) {
        ...
        return Effect.fn(`AWS.EMRContainers.DescribeVirtualCluster(${virtualCluster.LogicalId})`)(function* () {
            return yield* op({ id: yield* VirtualClusterId });
        });
    });
}));
//# sourceMappingURL=DescribeVirtualClusterHttp.js.map