 ...
 * @binding
 */
export interface DescribeSecret extends Binding.Service<DescribeSecret, "AWS.SecretsManager.DescribeSecret", (secret: Secret) => Effect.Effect<() => Effect.Effect<secretsmanager.DescribeSecretResponse, secretsmanager.DescribeSecretError>>> {
}
export declare const DescribeSecret: DescribeSecret;
//# sourceMappingURL=DescribeSecret.d.ts.map