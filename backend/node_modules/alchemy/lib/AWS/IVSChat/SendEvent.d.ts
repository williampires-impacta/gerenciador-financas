 ...
 * @binding
 */
export interface SendEvent extends Binding.Service<SendEvent, "AWS.IVSChat.SendEvent", (room: Room) => Effect.Effect<(request: SendEventRequest) => Effect.Effect<ivschat.SendEventResponse, ivschat.SendEventError>>> {
}
