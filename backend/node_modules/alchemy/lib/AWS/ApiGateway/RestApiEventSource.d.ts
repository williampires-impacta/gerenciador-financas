...
export type RestApiEventSourceService = <Req = never>(api: RestApi, props: RestApiRouteProps, handler: (event: RestApiEvent) => Effect.Effect<RestApiResult, never, Req>) => Effect.Effect<void, never, never>;
declare const RestApiEventSource_base: Context.ServiceClass<RestApiEventSource, "AWS.ApiGateway.RestApiEventSource", RestApiEventSourceService>;
/**
 ...
 * @binding
 */
export declare class RestApiEventSource extends RestApiEventSource_base {
}
/**
 ...
 * ```
 */
export declare function onRestApiRoute<Req = never>(api: RestApi, props: RestApiRouteProps, handler: (event: RestApiEvent) => Effect.Effect<RestApiResult, never, Req>): Effect.Effect<void, never, RestApiEventSource>;
export {};
