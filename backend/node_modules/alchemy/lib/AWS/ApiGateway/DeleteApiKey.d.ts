 ...
 * @binding
 */
export interface DeleteApiKey extends Binding.Service<DeleteApiKey, "AWS.ApiGateway.DeleteApiKey", () => Effect.Effect<(request: DeleteApiKeyRequest) => Effect.Effect<ag.DeleteApiKeyResponse, ag.DeleteApiKeyError>>> {
}
