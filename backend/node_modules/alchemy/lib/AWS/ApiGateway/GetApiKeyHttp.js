 ...
 */
export const GetApiKeyHttp = Layer.effect(GetApiKey, Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn("AWS.ApiGateway.GetApiKey")(function* (request) {
            return yield* getApiKey(request);
        });
    });
}));
//# sourceMappingURL=GetApiKeyHttp.js.map