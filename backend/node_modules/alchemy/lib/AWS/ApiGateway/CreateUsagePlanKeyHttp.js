...
import { CreateUsagePlanKey, } from "./CreateUsagePlanKey.js";
/**
 ...
 */
export const CreateUsagePlanKeyHttp = Layer.effect(CreateUsagePlanKey, Effect.gen(function* () {
    ...
    return Effect.fn(function* (usagePlan) {
        ...
        return Effect.fn(`AWS.ApiGateway.CreateUsagePlanKey(${usagePlan.LogicalId})`)(function* (request) {
...
//# sourceMappingURL=CreateUsagePlanKeyHttp.js.map