 ...
 * @binding
 */
export interface CreateApiKey extends Binding.Service<CreateApiKey, "AWS.ApiGateway.CreateApiKey", () => Effect.Effect<(request?: CreateApiKeyRequest) => Effect.Effect<ag.ApiKey, ag.CreateApiKeyError>>> {
}
