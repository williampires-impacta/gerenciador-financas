...
import { FlushStageAuthorizersCache } from "./FlushStageAuthorizersCache.js";
/**
 ...
 */
export const FlushStageAuthorizersCacheHttp = Layer.effect(FlushStageAuthorizersCache, Effect.gen(function* () {
    ...
    return Effect.fn(function* (stage) {
        ...
        return Effect.fn(`AWS.ApiGateway.FlushStageAuthorizersCache(${stage.LogicalId})`)(function* () {
...
//# sourceMappingURL=FlushStageAuthorizersCacheHttp.js.map