 ...
 */
export const CreateApiKeyHttp = Layer.effect(CreateApiKey, Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn("AWS.ApiGateway.CreateApiKey")(function* (request) {
            return yield* createApiKey(request ?? {});
        });
    });
}));
//# sourceMappingURL=CreateApiKeyHttp.js.map