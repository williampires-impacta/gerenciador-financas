 ...
 */
export const UpdateApiKeyHttp = Layer.effect(UpdateApiKey, Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn("AWS.ApiGateway.UpdateApiKey")(function* (request) {
            return yield* updateApiKey(request);
        });
    });
}));
//# sourceMappingURL=UpdateApiKeyHttp.js.map