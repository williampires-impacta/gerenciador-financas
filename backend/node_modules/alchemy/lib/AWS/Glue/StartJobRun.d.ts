 ...
 * @binding
 */
export interface StartJobRun extends Binding.Service<StartJobRun, "AWS.Glue.StartJobRun", (job: Job) => Effect.Effect<(request?: StartJobRunRequest) => Effect.Effect<glue.StartJobRunResponse, glue.StartJobRunError>>> {
}
