 ...
 * @binding
 */
export interface GetJobRun extends Binding.Service<GetJobRun, "AWS.Glue.GetJobRun", (job: Job) => Effect.Effect<(request: GetJobRunRequest) => Effect.Effect<glue.GetJobRunResponse, glue.GetJobRunError>>> {
}
