 ...
 * @binding
 */
export interface ResetJobBookmark extends Binding.Service<ResetJobBookmark, "AWS.Glue.ResetJobBookmark", (job: Job) => Effect.Effect<(request?: ResetJobBookmarkRequest) => Effect.Effect<glue.ResetJobBookmarkResponse, glue.ResetJobBookmarkError>>> {
}
export declare const ResetJobBookmark: ResetJobBookmark;
//# sourceMappingURL=ResetJobBookmark.d.ts.map