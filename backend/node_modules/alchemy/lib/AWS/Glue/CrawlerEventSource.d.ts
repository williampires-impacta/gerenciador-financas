 ...
 * ```
 */
export declare const consumeCrawlerEvents: <StreamReq = never, Req = never>(props: CrawlerEventSourceProps, process: (events: Stream.Stream<CrawlerEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=CrawlerEventSource.d.ts.map