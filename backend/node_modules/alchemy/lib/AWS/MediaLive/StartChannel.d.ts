 ...
 * @binding
 */
export interface StartChannel extends Binding.Service<StartChannel, "AWS.MediaLive.StartChannel", (channel: Channel) => Effect.Effect<() => Effect.Effect<medialive.StartChannelResponse, medialive.StartChannelError>>> {
}
