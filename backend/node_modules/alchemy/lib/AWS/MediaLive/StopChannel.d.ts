 ...
 * @binding
 */
export interface StopChannel extends Binding.Service<StopChannel, "AWS.MediaLive.StopChannel", (channel: Channel) => Effect.Effect<() => Effect.Effect<medialive.StopChannelResponse, medialive.StopChannelError>>> {
}
