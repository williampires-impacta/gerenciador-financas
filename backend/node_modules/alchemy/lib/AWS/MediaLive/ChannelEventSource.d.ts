...
export type MediaLiveChannelEventKind = "state-change" | "alert" | "input-change" | "multiplex-state-change" | "multiplex-alert";
 ...
 * ```
 */
export declare const consumeChannelEvents: <StreamReq = never, Req = never>(props: ChannelEventSourceProps, process: (events: Stream.Stream<MediaLiveChannelEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=ChannelEventSource.d.ts.map