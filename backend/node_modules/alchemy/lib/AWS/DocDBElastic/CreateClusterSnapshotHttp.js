...
import { makeDocDBElasticClusterHttpBinding, SNAPSHOT_ARN_WILDCARD, } from "./BindingHttp.js";
import { CreateClusterSnapshot } from "./CreateClusterSnapshot.js";
export const CreateClusterSnapshotHttp = Layer.effect(CreateClusterSnapshot, makeDocDBElasticClusterHttpBinding({
