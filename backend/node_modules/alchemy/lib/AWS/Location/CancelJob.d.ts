 ...
 * @binding
 */
export interface CancelJob extends Binding.Service<CancelJob, "AWS.Location.CancelJob", () => Effect.Effect<(request: location.CancelJobRequest) => Effect.Effect<location.CancelJobResponse, location.CancelJobError>>> {
}
