 ...
 * @binding
 */
export interface ListJobs extends Binding.Service<ListJobs, "AWS.Location.ListJobs", () => Effect.Effect<(request?: location.ListJobsRequest) => Effect.Effect<location.ListJobsResponse, location.ListJobsError>>> {
}
