 ...
 * ```
 */
export declare const consumeTrackerEvents: <StreamReq = never, Req = never>(props: TrackerEventSourceProps, process: (events: Stream.Stream<TrackerEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=TrackerEventSource.d.ts.map