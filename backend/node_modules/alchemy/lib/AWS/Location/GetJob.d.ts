 ...
 * @binding
 */
export interface GetJob extends Binding.Service<GetJob, "AWS.Location.GetJob", () => Effect.Effect<(request: location.GetJobRequest) => Effect.Effect<location.GetJobResponse, location.GetJobError>>> {
}
