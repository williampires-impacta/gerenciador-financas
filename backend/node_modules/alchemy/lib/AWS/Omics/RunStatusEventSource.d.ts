 ...
 * ```
 */
export declare const consumeRunEvents: <StreamReq = never, Req = never>(props: RunStatusEventSourceProps, process: (events: Stream.Stream<OmicsRunEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=RunStatusEventSource.d.ts.map