 ...
 */
export const fetchOmicsTags = Effect.fn(function* (resourceArn) {
    return yield* omics.listTagsForResource({ resourceArn }).pipe(Effect.map((r) => tagRecord(r.tags)), Effect.catchTag("ResourceNotFoundException", () => Effect.succeed({})));
});
/**
 ...
 */
export const syncOmicsTags = Effect.fn(function* (resourceArn, desired) {
