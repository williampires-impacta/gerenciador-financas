 ...
 * @binding
 */
export interface GetRun extends Binding.Service<GetRun, "AWS.Omics.GetRun", () => Effect.Effect<(request?: GetRunRequest) => Effect.Effect<omics.GetRunResponse, omics.GetRunError>>> {
}
export declare const GetRun: GetRun;
