 ...
 * @binding
 */
export interface GetRunTask extends Binding.Service<GetRunTask, "AWS.Omics.GetRunTask", () => Effect.Effect<(request?: GetRunTaskRequest) => Effect.Effect<omics.GetRunTaskResponse, omics.GetRunTaskError>>> {
}
export declare const GetRunTask: GetRunTask;
//# sourceMappingURL=GetRunTask.d.ts.map