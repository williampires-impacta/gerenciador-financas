...
export type InsightEventKind = "new-insight" | "severity-upgraded" | "insight-closed" | "new-anomaly" | "new-recommendation";
 ...
 * ```
 */
export declare const consumeInsightEvents: <StreamReq = never, Req = never>(props: InsightEventSourceProps, process: (events: Stream.Stream<InsightEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=InsightEventSource.d.ts.map