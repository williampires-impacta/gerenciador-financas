...
import { withPricingRegion } from "./internal.js";
/**
 ...
 * `Resource: ["*"]`.
 */
export const makePricingHttpBinding = (options) => Effect.gen(function* () {
    ...
    return Effect.fn(function* () {
        ...
        return Effect.fn(`AWS.Pricing.${options.capability}`)(function* (request) {
            ...
            return yield* withPricingRegion(op((request ?? {})));
        });
    });
});
