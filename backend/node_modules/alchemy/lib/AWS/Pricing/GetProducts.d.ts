 ...
 * @binding
 */
export interface GetProducts extends Binding.Service<GetProducts, "AWS.Pricing.GetProducts", () => Effect.Effect<(request: GetProductsRequest) => Effect.Effect<pricing.GetProductsResponse, pricing.GetProductsError>>> {
}
