 ...
 */
export const toTagRecord = (tags) => Object.fromEntries((tags ?? []).map((t) => [unredact(t.tagKey), unredact(t.tagValue)]));
/**
 ...
 */
export const readPersonalizeTags = Effect.fn(function* (arn) {
 ...
 */
export const syncPersonalizeTags = Effect.fn(function* (arn, desiredTags) {
