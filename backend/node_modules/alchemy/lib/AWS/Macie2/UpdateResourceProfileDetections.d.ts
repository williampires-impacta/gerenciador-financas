 ...
 * @binding
 */
export interface UpdateResourceProfileDetections extends Binding.Service<UpdateResourceProfileDetections, "AWS.Macie2.UpdateResourceProfileDetections", () => Effect.Effect<(request?: macie2.UpdateResourceProfileDetectionsRequest) => Effect.Effect<macie2.UpdateResourceProfileDetectionsResponse, macie2.UpdateResourceProfileDetectionsError>>> {
}
export declare const UpdateResourceProfileDetections: UpdateResourceProfileDetections;
//# sourceMappingURL=UpdateResourceProfileDetections.d.ts.map