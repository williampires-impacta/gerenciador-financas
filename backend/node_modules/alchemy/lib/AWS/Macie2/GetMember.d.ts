 ...
 * @binding
 */
export interface GetMember extends Binding.Service<GetMember, "AWS.Macie2.GetMember", () => Effect.Effect<(request: macie2.GetMemberRequest) => Effect.Effect<macie2.GetMemberResponse, macie2.GetMemberError>>> {
}
