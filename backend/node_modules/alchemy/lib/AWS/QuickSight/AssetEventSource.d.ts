 ...
 * ```
 */
export declare const consumeAssetEvents: <StreamReq = never, Req = never>(props: AssetEventSourceProps, process: (events: Stream.Stream<QuickSightAssetEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=AssetEventSource.d.ts.map