...
import { DescribeIngestion } from "./DescribeIngestion.js";
export const DescribeIngestionHttp = Layer.effect(DescribeIngestion, makeQuickSightDataSetHttpBinding({
    tag: "AWS.QuickSight.DescribeIngestion",
    operation: quicksight.describeIngestion,
    actions: ["quicksight:DescribeIngestion"],
}));
//# sourceMappingURL=DescribeIngestionHttp.js.map