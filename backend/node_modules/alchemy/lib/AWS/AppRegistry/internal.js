 ...
 */
export const clientToken = (instanceId) => instanceId.replaceAll(/[^a-zA-Z0-9]/g, "").slice(0, 64) || "alchemy";
/**
 ...
 */
export const stripAwsSystemTags = (tags) => Object.fromEntries(Object.entries(tags).filter(([key]) => !key.toLowerCase().startsWith("aws:")));
