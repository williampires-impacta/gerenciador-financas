...
export type MediaConnectFlowEventKind = "alert" | "flow-status-change" | "flow-health" | "flow-maintenance" | "flow-content-quality" | "source-health" | "output-health" | "output-status-change";
 ...
 * ```
 */
export declare const consumeFlowEvents: <StreamReq = never, Req = never>(props: FlowEventSourceProps, process: (events: Stream.Stream<MediaConnectFlowEvent, never, StreamReq>) => Effect.Effect<void, never, Req>) => Effect.Effect<void, never, import("../EventBridge/EventSource.ts").EventSource>;
//# sourceMappingURL=FlowEventSource.d.ts.map