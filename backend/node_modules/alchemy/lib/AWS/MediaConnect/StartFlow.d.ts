 ...
 * @binding
 */
export interface StartFlow extends Binding.Service<StartFlow, "AWS.MediaConnect.StartFlow", (flow: Flow) => Effect.Effect<() => Effect.Effect<mediaconnect.StartFlowResponse, mediaconnect.StartFlowError>>> {
}
