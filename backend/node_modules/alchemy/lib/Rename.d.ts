 ...
 *   namespace's subtree).
 */
export type FormerId = string | {
    fqn: string;
};
declare const RenamePolicy_base: Context.ServiceClass<RenamePolicy, "RenamePolicy", readonly FormerId[]>;
/**
 ...
 */
export declare class RenamePolicy extends RenamePolicy_base {
}
/**
 ...
 */
export declare const renamedFrom: (...formerIds: [FormerId, ...FormerId[]]) => <A, E, R>(effect: Effect.Effect<A, E, R>) => Effect.Effect<A, E, R>;
export {};
