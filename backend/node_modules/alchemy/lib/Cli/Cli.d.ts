...
export interface CLIService {
    ...
    startApplySession: <P extends Plan>(plan: P) => Effect.Effect<PlanStatusSession>;
}
declare const Cli_base: Context.ServiceClass<Cli, "CLI", CLIService>;
export declare class Cli extends Cli_base {
}
export {};
