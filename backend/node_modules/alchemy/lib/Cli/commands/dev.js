...
import { SPAWNER_URL_ENV_KEY } from "../../Local/RpcProviderProxy.js";
import * as RpcSpawner from "../../Local/RpcSpawner.js";
import { envFile, force, profile, script, stage } from "./_shared.js";
import { ExecStackOptions } from "./deploy.js";
/**
 ...
 */
const NODE_EXTRA_CA_CERTS = process.env.NODE_EXTRA_CA_CERTS ?? Floci.FLOCI_CA_PATH;
export const devCommand = Command.make("dev", {
    ...
    const command = typeof globalThis.Bun !== "undefined"
        ? [
            "bun",
            "run",
            ...process.execArgv,
...
}, (effect, args) => Effect.provide(RpcSpawner.layerServer({
