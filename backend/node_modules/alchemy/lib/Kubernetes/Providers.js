...
import { builtinAdapters } from "./BuiltinAdapters.js";
import { Deployment, DeploymentProvider } from "./Deployment.js";
import { HelmChart, HelmChartProvider } from "./HelmChart.js";
import { Job, JobProvider } from "./Job.js";
import { Manifest, ManifestProvider } from "./Manifest.js";
export class Providers extends Provider.ProviderCollection()("Kubernetes") {
}
/**
 ...
 * ```
 */
export const providers = () => Layer.effect(Providers, Provider.collection([Deployment, HelmChart, Job, Manifest])).pipe(Layer.provide(Layer.mergeAll(DeploymentProvider(), HelmChartProvider(), JobProvider(), ManifestProvider())), 
...
Layer.provideMerge(builtinAdapters()), Layer.orDie);
