...
declare const ClusterNotFoundError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Kubernetes.ClusterNotFoundError";
} & Readonly<A>;
/**
 ...
 * already gone".
 */
export declare class ClusterNotFoundError extends ClusterNotFoundError_base<{
    message: string;
}> {
}
/**
...
export interface ClusterAdapterService {
     ...
     */
    readonly connect: (connection: Connection) => Effect.Effect<ClusterTransport, ClusterNotFoundError | Error>;
    /** Workload identity provisioning (Pod Identity on EKS). */
    readonly identity?: {
        readonly reconcile: (options: WorkloadIdentityReconcileOptions) => Effect.Effect<WorkloadIdentityResult, any, AdapterLifecycleServices>;
        readonly delete: (options: WorkloadIdentityDeleteOptions) => Effect.Effect<void, any, AdapterLifecycleServices>;
    };
    /** Managed container-image registry (ECR on EKS). */
    readonly registry?: {
        readonly resolve: (options: ImageRegistryResolveOptions) => Effect.Effect<ImageRegistryResult, any, AdapterLifecycleServices>;
        /** Plan-time content hash used by `diff` to surface source drift. */
        readonly hash: (options: ImageRegistryHashOptions) => Effect.Effect<string | undefined, any, AdapterLifecycleServices>;
        readonly delete: (options: ImageRegistryDeleteOptions) => Effect.Effect<void, any, AdapterLifecycleServices>;
    };
    /**
 ...
 */
export declare const ClusterAdapter: (authKind: string) => Context.Service<ClusterAdapterService, ClusterAdapterService>;
/**
 ...
 */
export declare const findClusterAdapter: (authKind: string) => Effect.Effect<ClusterAdapterService>;
export {};
//# sourceMappingURL=ClusterAdapter.d.ts.map