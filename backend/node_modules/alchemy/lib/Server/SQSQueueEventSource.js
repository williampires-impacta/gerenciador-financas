...
import { AWSEnvironment } from "../AWS/Environment.js";
import * as SQS from "../AWS/SQS/index.js";
import { toWireSeconds } from "../Util/Duration.js";
import { ServerHost } from "./Process.js";
export const SQSQueueEventSource = Layer.effect(SQS.QueueEventSource, Effect.gen(function* () {
    ...
    return Effect.fn(function* (queue, props, process) {
        ...
        yield* run(Effect.forever(Effect.gen(function* () {
            ...
            const result = yield* receiveMessage({
                ...
                WaitTimeSeconds: toWireSeconds(props.waitTime) ??
                    toWireSeconds(props.maximumBatchingWindow),
            });
            const messages = result.Messages ?? [];
            if (messages.length === 0)
                return;
            yield* process(Stream.fromArray(messages.map((msg) => ({
...
//# sourceMappingURL=SQSQueueEventSource.js.map