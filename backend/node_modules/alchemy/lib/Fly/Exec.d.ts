 ...
 * @binding
 */
export interface Exec extends Binding.Service<Exec, "Fly.Exec", (sprite: Sprite) => Effect.Effect<(request: ExecRequest) => Effect.Effect<ExecResult, ExecCommandError, RuntimeContext>>> {
}
