import type { AppSecretsUpdateResp, DeleteAppSecretResponse, CreateSecretError, DeleteSecretError, UpdateSecretsError, SetAppSecretResponse } from "@distilled.cloud/fly-io/machines";
 ...
 * @binding
 */
export interface WriteSecret extends Binding.Service<WriteSecret, "Fly.WriteSecret", (secret: Secret) => Effect.Effect<WriteSecretClient>> {
}
export declare const WriteSecret: WriteSecret;
/**
...
export interface WriteSecretClient {
    ...
    create(name: string, value: Redacted.Redacted<string> | string): Effect.Effect<SetAppSecretResponse, CreateSecretError, RuntimeContext>;
    /** Update secrets by name (batch of one). */
    update(name: string, value: Redacted.Redacted<string> | string): Effect.Effect<AppSecretsUpdateResp, UpdateSecretsError, RuntimeContext>;
    /** Delete a secret by name. */
    delete(name: string): Effect.Effect<DeleteAppSecretResponse, DeleteSecretError, RuntimeContext>;
}
//# sourceMappingURL=WriteSecret.d.ts.map