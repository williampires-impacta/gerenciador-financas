 ...
 * @binding
 */
export interface ListSecrets extends Binding.Service<ListSecrets, "Fly.ListSecrets", (app: App) => Effect.Effect<() => Effect.Effect<AppSecrets, ListSecretsError, RuntimeContext>>> {
}
