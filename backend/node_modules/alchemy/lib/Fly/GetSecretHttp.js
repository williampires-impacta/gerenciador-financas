 ...
 */
export const GetSecretHttp = Layer.effect(GetSecret, Effect.suspend(() => makeHttpSecretBinding({
    makeClient: (auth, appName, secretName) => Effect.fn("Fly.GetSecret")(function* () {
        ...
        if (globalThis.__ALCHEMY_RUNTIME__) {
            ...
            const fromEnv = yield* Config.redacted(name).pipe(Effect.map((value) => ({
                name,
        ...
        return yield* auth.authorize(machines.getSecret({
...
//# sourceMappingURL=GetSecretHttp.js.map