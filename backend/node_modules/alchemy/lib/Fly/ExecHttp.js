 ...
 * @provides Fly.Exec
 */
export const ExecHttp = Layer.effect(Exec, Effect.suspend(() => makeHttpSpriteBinding({
    makeClient: (auth, spriteName) => Effect.fn("Fly.Exec")(function* (request) {
        return yield* auth.authorize(sprites.execCommand({
...
//# sourceMappingURL=ExecHttp.js.map