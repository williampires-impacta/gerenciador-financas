import type { Checkpoint as FlyCheckpoint, CreateCheckpointError, GetCheckpointError, ListCheckpointsError, RestoreCheckpointError, StreamEvent } from "@distilled.cloud/fly-io/sprites";
...
export interface CheckpointClient {
     ...
     */
    restore: (checkpointId: string) => Effect.Effect<ReadonlyArray<StreamEvent>, RestoreCheckpointError, RuntimeContext>;
}
/**
 ...
 * @binding
 */
export interface Checkpoint extends Binding.Service<Checkpoint, "Fly.Checkpoint", (sprite: Sprite) => Effect.Effect<CheckpointClient>> {
}
