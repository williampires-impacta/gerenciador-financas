...
import { makeHttpAppBinding } from "./SecretHttp.js";
/**
 ...
 */
export const ListSecretsHttp = Layer.effect(ListSecrets, Effect.suspend(() => makeHttpAppBinding({
    makeClient: (auth, appName) => Effect.fn("Fly.ListSecrets")(function* () {
        return yield* auth.authorize(machines.listSecrets({
