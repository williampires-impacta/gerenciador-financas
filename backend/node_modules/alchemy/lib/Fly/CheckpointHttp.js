...
import { makeHttpSpriteBinding } from "./SpriteHttp.js";
/**
 ...
 */
export const CheckpointHttp = Layer.effect(Checkpoint, Effect.suspend(() => makeHttpSpriteBinding({
    makeClient: (auth, spriteName) => ({
        create: Effect.fn("Fly.Checkpoint.create")(function* (options) {
            return yield* auth.authorize(sprites.createCheckpoint({
                name: yield* spriteName,
                comment: options?.comment,
            }));
        }),
        list: Effect.fn("Fly.Checkpoint.list")(function* () {
            return yield* auth.authorize(sprites.listCheckpoints({
                name: yield* spriteName,
            }));
        }),
        get: Effect.fn("Fly.Checkpoint.get")(function* (checkpointId) {
            return yield* auth.authorize(sprites.getCheckpoint({
                name: yield* spriteName,
                checkpoint_id: checkpointId,
            }));
        }),
        restore: Effect.fn("Fly.Checkpoint.restore")(function* (checkpointId) {
            return yield* auth.authorize(sprites.restoreCheckpoint({
                name: yield* spriteName,
                checkpoint_id: checkpointId,
            }));
        }),
...
//# sourceMappingURL=CheckpointHttp.js.map