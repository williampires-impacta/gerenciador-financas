 ...
 * @binding
 */
export interface Verify extends Binding.Service<Verify, "Fly.Verify", (key: SecretKey) => Effect.Effect<(request: VerifyRequest) => Effect.Effect<VerifyResult, VerifySecretKeyError | FlyKmsError, RuntimeContext>>> {
}
