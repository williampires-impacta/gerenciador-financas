 ...
 */
export class RenamePolicy extends Context.Service()("RenamePolicy") {
}
/**
 ...
 */
export const renamedFrom = (...formerIds) => (effect) => Effect.provideService(effect, RenamePolicy, formerIds);
