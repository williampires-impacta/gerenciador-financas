...
export declare const isInlineDockerfile: (value: unknown) => value is InlineDockerfile;
/**
 ...
 */
export declare const inline: (template: TemplateStringsArray, ...args: Array<Input<string>>) => InlineDockerfile;
