...
import { hashDirectory } from "./Memo.js";
/**
 ...
 * @resource
 */
export const Exec = Resource("Command.Exec");
export const ExecProvider = () => Provider.effect(Exec, Effect.gen(function* () {
