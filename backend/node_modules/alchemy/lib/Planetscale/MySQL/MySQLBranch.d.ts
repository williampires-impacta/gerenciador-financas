...
import { type BaseBranchAttributes, type BaseBranchProps } from "../Branch.ts";
 ...
 * ```
 */
export type MySQLBranch = Resource<"Planetscale.MySQLBranch", MySQLBranchProps, MySQLBranchAttributes, never, Providers>;
/** @resource */
export declare const MySQLBranch: import("../../Resource.ts").ResourceClass<MySQLBranch>;
export declare const MySQLBranchProvider: () => import("effect/Layer").Layer<import("../../Provider.ts").Provider<MySQLBranch>, never, never>;
//# sourceMappingURL=MySQLBranch.d.ts.map