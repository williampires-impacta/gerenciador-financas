 ...
 * ```
 */
export type PostgresBranch = Resource<"Planetscale.PostgresBranch", PostgresBranchProps, PostgresBranchAttributes, never, Providers>;
/** @resource */
export declare const PostgresBranch: import("../../Resource.ts").ResourceClass<PostgresBranch>;
export declare const PostgresBranchProvider: () => import("effect/Layer").Layer<import("../../Provider.ts").Provider<PostgresBranch>, never, never>;
//# sourceMappingURL=PostgresBranch.d.ts.map